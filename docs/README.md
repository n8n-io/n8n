...
### 2025-11-05 - 前端构建系统修复与优化
- ✅ 修复 TypeScript 错误：移除 Notice.vue 中未使用的 whiteList 导入
- ✅ 修复开发环境热重载无限循环：优化 locale 模块的动态/静态导入策略
- ✅ 新增 Telemetry 统计 API：概览、Top 事件、活跃用户
- ✅ 添加数据库迁移文件：创建 telemetry_event 表
- ✅ 构建状态：TypeScript 零错误，热重载正常工作 ✨

### 2025-11-05 早些时候 - 前后端分离架构完善
