...
> Builds on #34329 (List — Get Many + list dropdown), which has merged — the list picker and the load-options widening of `resolveSiteId` landed there. This PR is rebased onto `master` and targets it directly.
