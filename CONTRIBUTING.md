...
**NOTE**: The devcontainer allocates 8GB of memory during `pnpm build`. Using less than this may cause out-of-memory errors, especially on fresh clones that have not installed any packages before.
