...
require_rolldown_runtime.__export(google_trends_exports, { SERPGoogleTrendsTool: () => SERPGoogleTrendsTool });
/**
* Tool that queries the Google Trends API. Uses default interest over time.
*/
var SERPGoogleTrendsTool = class extends __langchain_core_tools.Tool {
	static lc_name() {
