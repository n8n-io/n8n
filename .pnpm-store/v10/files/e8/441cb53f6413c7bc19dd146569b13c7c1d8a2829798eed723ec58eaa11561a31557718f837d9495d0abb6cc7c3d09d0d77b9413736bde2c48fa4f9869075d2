...
//#region src/agents/chat_convo/prompt.ts
...
exports.FORMAT_INSTRUCTIONS = FORMAT_INSTRUCTIONS;
exports.PREFIX_END = PREFIX_END;
exports.TEMPLATE_TOOL_RESPONSE = TEMPLATE_TOOL_RESPONSE;
