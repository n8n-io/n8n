...
__export(clickhouse_exports, { ClickHouseStore: () => ClickHouseStore });
/**
...
* texts or documents.
*/
var ClickHouseStore = class ClickHouseStore extends VectorStore {
	client;
	indexType;
	indexParam;
	indexQueryParams;
...
//#endregion
export { ClickHouseStore, clickhouse_exports };
