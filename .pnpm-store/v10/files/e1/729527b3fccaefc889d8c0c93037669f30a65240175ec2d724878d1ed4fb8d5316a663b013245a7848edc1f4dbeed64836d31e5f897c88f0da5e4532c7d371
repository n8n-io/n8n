...
import type { CreateRateLimitParams, DeleteRateLimitParams, GetRateLimitParams, ListRateLimitsParams, UpdateRateLimitParams } from "./types/ratelimit/request.js";
import type { ListRateLimitResponse } from "./types/ratelimit/response.js";
import type { Response } from "../base/index.js";
/**
