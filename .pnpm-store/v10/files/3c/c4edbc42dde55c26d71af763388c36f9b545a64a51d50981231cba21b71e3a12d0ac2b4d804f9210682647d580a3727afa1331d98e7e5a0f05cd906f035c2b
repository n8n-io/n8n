...
/** @internal */
export const ClassifierTrainingParametersIn$inboundSchema: z.ZodType<
...
/** @internal */
export const ClassifierTrainingParametersIn$outboundSchema: z.ZodType<
 ...
 */
export namespace ClassifierTrainingParametersIn$ {
  /** @deprecated use `ClassifierTrainingParametersIn$inboundSchema` instead. */
  export const inboundSchema = ClassifierTrainingParametersIn$inboundSchema;
  /** @deprecated use `ClassifierTrainingParametersIn$outboundSchema` instead. */
  export const outboundSchema = ClassifierTrainingParametersIn$outboundSchema;
  /** @deprecated use `ClassifierTrainingParametersIn$Outbound` instead. */
  export type Outbound = ClassifierTrainingParametersIn$Outbound;
}

export function classifierTrainingParametersInToJSON(
  classifierTrainingParametersIn: ClassifierTrainingParametersIn,
): string {
  return JSON.stringify(
    ClassifierTrainingParametersIn$outboundSchema.parse(
      classifierTrainingParametersIn,
    ),
  );
}

export function classifierTrainingParametersInFromJSON(
  jsonString: string,
): SafeParseResult<ClassifierTrainingParametersIn, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ClassifierTrainingParametersIn$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ClassifierTrainingParametersIn' from JSON`,
  );
}
