...
var WeaviateDocument = class extends Document {
	generated;
	additional;
	vectors;
};
...
*/
var WeaviateStore = class WeaviateStore extends VectorStore {
	client;
	indexName;
	textKey;
	queryAttrs;
...
//#endregion
export { WeaviateDocument, WeaviateStore, flattenObjectForWeaviate };
