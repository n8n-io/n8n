...
export declare function _syncFromEditors(beans: BeanCollection, persist: boolean): void;
export declare function _syncFromEditor(beans: BeanCollection, position: Required<EditPosition>, persist: boolean, editorValue?: any, _source?: string, valueSameAsSource?: boolean): void;
