...
const fast_xml_parser = require_rolldown_runtime.__toESM(require("fast-xml-parser"));
...
async function fetchAndParsePDF(pdfUrl) {
	try {
		...
		const loader = new require_document_loaders_fs_pdf.PDFLoader(blob, { splitPages: false });
