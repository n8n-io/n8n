...
__export(supabase_exports, { SupabaseVectorStore: () => SupabaseVectorStore });
/**
...
* <br />
*/
var SupabaseVectorStore = class SupabaseVectorStore extends VectorStore {
	client;
	tableName;
	queryName;
	filter;
...
//#endregion
export { SupabaseVectorStore, supabase_exports };
