...
__export(vercel_postgres_exports, { VercelPostgres: () => VercelPostgres });
/**
...
*/
var VercelPostgres = class VercelPostgres extends VectorStore {
	tableName;
	idColumnName;
	vectorColumnName;
	contentColumnName;
...
//#endregion
export { VercelPostgres, vercel_postgres_exports };
