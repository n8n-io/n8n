...
require_rolldown_runtime.__export(directory_exports, {
...
* ```
*/
var DirectoryLoader = class DirectoryLoader extends __langchain_core_document_loaders_base.BaseDocumentLoader {
	...
	*/
	static async imports() {
		try {
			...
			console.error(e);
			throw new Error(`Failed to load fs/promises. DirectoryLoader available only on environment 'node'. It appears you are running environment '${(0, __langchain_core_utils_env.getEnv)()}'. See https://<link to docs> for alternatives.`);
		}
	}
};
