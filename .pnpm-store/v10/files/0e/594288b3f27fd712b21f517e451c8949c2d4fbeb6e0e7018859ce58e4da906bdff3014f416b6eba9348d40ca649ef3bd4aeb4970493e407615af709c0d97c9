...
exports.generativeParameters = {
    ...
    anthropic(config) {
        ...
        return {
            ...
            config: config
                ? Object.assign(Object.assign({}, rest), { baseUrl: baseURL, stopSequences: base_js_1.TextArray.fromPartial({ values: stopSequences }) }) : undefined,
        };
    },
    /**
    ...
    azureOpenAI: (config) => {
        ...
        return {
            ...
            config: config
                ? Object.assign(Object.assign({}, rest), { baseUrl: baseURL, isAzure: true, stop: base_js_1.TextArray.fromPartial({ values: stop }) }) : { isAzure: true },
        };
    },
    /**
    ...
    databricks: (config) => {
        ...
        return {
            ...
            config: config
                ? Object.assign(Object.assign({}, rest), { stop: base_js_1.TextArray.fromPartial({ values: stop }) }) : undefined,
        };
    },
    /**
    ...
    openAI: (config) => {
        ...
        return {
            ...
            config: config
                ? Object.assign(Object.assign({}, rest), { baseUrl: baseURL, isAzure: false, stop: base_js_1.TextArray.fromPartial({ values: stop }) }) : { isAzure: false },
        };
    },
    /**
    ...
    google: (config) => {
        ...
        return {
            ...
            config: config
                ? Object.assign(Object.assign({}, rest), { stopSequences: base_js_1.TextArray.fromPartial({ values: stopSequences }) }) : undefined,
        };
    },
    /**
