...
var DropdownMenuCheckboxItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
...
//#endregion
Object.defineProperty(exports, 'DropdownMenuCheckboxItem_default', {
  enumerable: true,
  get: function () {
    return DropdownMenuCheckboxItem_default;
  }
});
