...
__export(confluence_exports, { ConfluencePagesLoader: () => ConfluencePagesLoader });
/**
...
* ```
*/
var ConfluencePagesLoader = class extends BaseDocumentLoader {
	baseUrl;
	spaceKey;
	username;
	accessToken;
...
//#endregion
export { ConfluencePagesLoader, confluence_exports };
