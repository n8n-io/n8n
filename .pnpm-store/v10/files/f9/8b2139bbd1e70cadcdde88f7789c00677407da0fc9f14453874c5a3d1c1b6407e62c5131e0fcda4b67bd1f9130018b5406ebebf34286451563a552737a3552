...
const index_js_3 = require("../deserialize/index.js");
const utils_js_1 = require("../query/utils.js");
const index_js_4 = require("../serialize/index.js");
const metrics = () => {
    return {
...
class AggregateManager {
    constructor(connection, name, dbVersionSupport, consistencyLevel, tenant) {
        ...
        this.groupBy = {
            hybrid: (query, opts) => __awaiter(this, void 0, void 0, function* () {
                if (yield this.grpcChecker) {
                    ...
                    return this.grpc()
                        ...
                        return aggregate.withHybrid(Object.assign(Object.assign({}, (yield index_js_4.Serialize.aggregate.hybrid(query, opts))), { groupBy: index_js_4.Serialize.aggregate.groupBy(group), limit: group.limit }));
                    }))
                        .then((reply) => index_js_3.Deserialize.aggregateGroupBy(reply));
                }
            ...
            nearImage: (image, opts) => __awaiter(this, void 0, void 0, function* () {
                const [b64, usesGrpc] = yield Promise.all([yield (0, index_js_2.toBase64FromMedia)(image), yield this.grpcChecker]);
                if (usesGrpc) {
                    const group = typeof opts.groupBy === 'string' ? { property: opts.groupBy } : opts.groupBy;
                    return this.grpc()
                        .then((aggregate) => aggregate.withNearImage(Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.nearImage(b64, opts)), { groupBy: index_js_4.Serialize.aggregate.groupBy(group), limit: group.limit })))
                        .then((reply) => index_js_3.Deserialize.aggregateGroupBy(reply));
                }
            ...
            nearObject: (id, opts) => __awaiter(this, void 0, void 0, function* () {
                if (yield this.grpcChecker) {
                    const group = typeof opts.groupBy === 'string' ? { property: opts.groupBy } : opts.groupBy;
                    return this.grpc()
                        .then((aggregate) => aggregate.withNearObject(Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.nearObject(id, opts)), { groupBy: index_js_4.Serialize.aggregate.groupBy(group), limit: group.limit })))
                        .then((reply) => index_js_3.Deserialize.aggregateGroupBy(reply));
                }
            ...
            nearText: (query, opts) => __awaiter(this, void 0, void 0, function* () {
                if (yield this.grpcChecker) {
                    const group = typeof opts.groupBy === 'string' ? { property: opts.groupBy } : opts.groupBy;
                    return this.grpc()
                        .then((aggregate) => aggregate.withNearText(Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.nearText(query, opts)), { groupBy: index_js_4.Serialize.aggregate.groupBy(group), limit: group.limit })))
                        .then((reply) => index_js_3.Deserialize.aggregateGroupBy(reply));
                }
            ...
            nearVector: (vector, opts) => __awaiter(this, void 0, void 0, function* () {
                if (yield this.grpcChecker) {
                    ...
                    return this.grpc()
                        .then((aggregate) => __awaiter(this, void 0, void 0, function* () {
                        return aggregate.withNearVector(Object.assign(Object.assign({}, (yield index_js_4.Serialize.aggregate.nearVector(vector, opts))), { groupBy: index_js_4.Serialize.aggregate.groupBy(group), limit: group.limit }));
                    }))
                        .then((reply) => index_js_3.Deserialize.aggregateGroupBy(reply));
                }
            ...
            overAll: (opts) => __awaiter(this, void 0, void 0, function* () {
                if (yield this.grpcChecker) {
                    const group = typeof opts.groupBy === 'string' ? { property: opts.groupBy } : opts.groupBy;
                    return this.grpc()
                        .then((aggregate) => aggregate.withFetch(Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.overAll(opts)), { groupBy: index_js_4.Serialize.aggregate.groupBy(group), limit: group.limit })))
                        .then((reply) => index_js_3.Deserialize.aggregateGroupBy(reply));
                }
    ...
    base(metrics, filters, groupBy) {
        ...
        if (filters) {
            builder = builder.withWhere(index_js_4.Serialize.filtersREST(filters));
        }
        if (this.tenant) {
    ...
    hybrid(query, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.grpcChecker) {
                return this.grpc()
                    .then((aggregate) => __awaiter(this, void 0, void 0, function* () { return aggregate.withHybrid(yield index_js_4.Serialize.aggregate.hybrid(query, opts)); }))
                    .then((reply) => index_js_3.Deserialize.aggregate(reply));
            }
    ...
    nearImage(image, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (usesGrpc) {
                return this.grpc()
                    .then((aggregate) => aggregate.withNearImage(index_js_4.Serialize.aggregate.nearImage(b64, opts)))
                    .then((reply) => index_js_3.Deserialize.aggregate(reply));
            }
    ...
    nearObject(id, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.grpcChecker) {
                return this.grpc()
                    .then((aggregate) => aggregate.withNearObject(index_js_4.Serialize.aggregate.nearObject(id, opts)))
                    .then((reply) => index_js_3.Deserialize.aggregate(reply));
            }
    ...
    nearText(query, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.grpcChecker) {
                return this.grpc()
                    .then((aggregate) => aggregate.withNearText(index_js_4.Serialize.aggregate.nearText(query, opts)))
                    .then((reply) => index_js_3.Deserialize.aggregate(reply));
            }
    ...
    nearVector(vector, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.grpcChecker) {
                return this.grpc()
                    .then((aggregate) => __awaiter(this, void 0, void 0, function* () { return aggregate.withNearVector(yield index_js_4.Serialize.aggregate.nearVector(vector, opts)); }))
                    .then((reply) => index_js_3.Deserialize.aggregate(reply));
            }
            if (!utils_js_1.NearVectorInputGuards.is1D(vector)) {
                throw new errors_js_1.WeaviateInvalidInputError('Vector can only be a 1D array of numbers when using `nearVector` with <1.29 Weaviate versions.');
            }
    ...
    overAll(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.grpcChecker) {
                return this.grpc()
                    .then((aggregate) => aggregate.withFetch(index_js_4.Serialize.aggregate.overAll(opts)))
                    .then((reply) => index_js_3.Deserialize.aggregate(reply));
            }
