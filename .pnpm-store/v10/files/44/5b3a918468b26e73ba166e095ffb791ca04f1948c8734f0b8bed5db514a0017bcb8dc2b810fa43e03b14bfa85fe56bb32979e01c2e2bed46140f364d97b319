...
var zhipuai_exports = {};
require_rolldown_runtime.__export(zhipuai_exports, { ZhipuAIEmbeddings: () => ZhipuAIEmbeddings });
var ZhipuAIEmbeddings = class extends __langchain_core_embeddings.Embeddings {
	...
	constructor(fields) {
		...
		this.apiKey = fields?.apiKey ?? (0, __langchain_core_utils_env.getEnvironmentVariable)("ZHIPUAI_API_KEY");
