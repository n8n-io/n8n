...
__export(firestore_exports, { FirestoreChatMessageHistory: () => FirestoreChatMessageHistory });
/**
...
* ```
*/
var FirestoreChatMessageHistory = class extends BaseListChatMessageHistory {
	lc_namespace = [
		"langchain",
		"stores",
		"message",
...
//#endregion
export { FirestoreChatMessageHistory, firestore_exports };
