...
*/
var JsonOutputToolsParser = class extends __langchain_core_output_parsers.BaseLLMOutputParser {
	static lc_name() {
...
* @deprecated Import from "@langchain/core/output_parsers/openai_tools"
*/
var JsonOutputKeyToolsParser = class extends __langchain_core_output_parsers.BaseLLMOutputParser {
	static lc_name() {
