...
import { ChatOpenAIResponseFormat, OpenAIApiKey, OpenAICacheRetentionParam, OpenAICallOptions, OpenAIChatInput, OpenAICoreRequestOptions, OpenAIVerbosityParam, ResponseFormatConfiguration } from "../types.cjs";
import OpenAI, { ClientOptions, OpenAI as OpenAI$1 } from "openai";
...
interface BaseChatOpenAICallOptions extends BaseChatModelCallOptions, BaseFunctionCallOptions {
   ...
   */
  reasoningEffort?: OpenAI$1.Reasoning["effort"];
  /**
...
declare abstract class BaseChatOpenAI<CallOptions extends BaseChatOpenAICallOptions> extends BaseChatModel<CallOptions, AIMessageChunk> implements Partial<OpenAIChatInput> {
  ...
  moderateContent(input: string | string[], params?: {
    ...
    options?: OpenAICoreRequestOptions;
  }): Promise<OpenAI$1.ModerationCreateResponse>;
  /**
