...
__export(couchbase_query_exports, {
...
*/
var CouchbaseQueryVectorStore = class CouchbaseQueryVectorStore extends VectorStore {
	...
	*/
	async addVectors(vectors, documents, options) {
		...
		const documentIds = options?.ids || documents.map(() => v4());
...
//#endregion
export { CouchbaseQueryVectorStore, DistanceStrategy, IndexType, couchbase_query_exports };
//# sourceMappingURL=couchbase_query.js.map