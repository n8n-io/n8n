...
require_rolldown_runtime.__export(time_weighted_exports, {
...
* ```
*/
var TimeWeightedVectorStoreRetriever = class extends __langchain_core_retrievers.BaseRetriever {
	static lc_name() {
...
exports.LAST_ACCESSED_AT_KEY = LAST_ACCESSED_AT_KEY;
exports.TimeWeightedVectorStoreRetriever = TimeWeightedVectorStoreRetriever;
Object.defineProperty(exports, 'time_weighted_exports', {
  enumerable: true,
  get: function () {
    return time_weighted_exports;
  }
});
//# sourceMappingURL=time_weighted.cjs.map