...
//#region src/chains/question_answering/map_reduce_prompts.ts
...
const DEFAULT_COMBINE_QA_PROMPT = /* @__PURE__ */ PromptTemplate.fromTemplate(qa_template);
...
const COMBINE_QA_PROMPT_SELECTOR = /* @__PURE__ */ new ConditionalPromptSelector(DEFAULT_COMBINE_QA_PROMPT, [[isChatModel, CHAT_QA_PROMPT]]);
...
=========
FINAL ANSWER:`;
const COMBINE_PROMPT = /* @__PURE__ */ PromptTemplate.fromTemplate(combine_prompt);
...
----------------
{summaries}`;
const combine_messages = [/* @__PURE__ */ SystemMessagePromptTemplate.fromTemplate(system_combine_template), /* @__PURE__ */ HumanMessagePromptTemplate.fromTemplate("{question}")];
const CHAT_COMBINE_PROMPT = /* @__PURE__ */ ChatPromptTemplate.fromMessages(combine_messages);
const COMBINE_PROMPT_SELECTOR = /* @__PURE__ */ new ConditionalPromptSelector(COMBINE_PROMPT, [[isChatModel, CHAT_COMBINE_PROMPT]]);

//#endregion
export { COMBINE_PROMPT_SELECTOR, COMBINE_QA_PROMPT_SELECTOR };
