...
function getError(e, request) {
    if (e && e?.name === "AbortError") {
        ...
        return new restError_js_1.RestError(`Error sending request: ${e.message}`, {
            code: e?.code ?? restError_js_1.RestError.REQUEST_SEND_ERROR,
            request,
        });
    }
}
...
function buildRequestBody(request) {
    ...
    if ((0, typeGuards_js_1.isWebReadableStream)(body)) {
        return {
            streaming: true,
        ...
        // ArrayBufferView
        return { streaming: false, body: (0, arrayBuffer_js_1.arrayBufferViewToArrayBuffer)(body) };
    }
