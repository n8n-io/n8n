import CJS_COMPAT_NODE_URL_9h6hm80839w from 'node:url';
import CJS_COMPAT_NODE_PATH_9h6hm80839w from 'node:path';
import CJS_COMPAT_NODE_MODULE_9h6hm80839w from "node:module";

var __filename = CJS_COMPAT_NODE_URL_9h6hm80839w.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_9h6hm80839w.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_9h6hm80839w.createRequire(import.meta.url);
