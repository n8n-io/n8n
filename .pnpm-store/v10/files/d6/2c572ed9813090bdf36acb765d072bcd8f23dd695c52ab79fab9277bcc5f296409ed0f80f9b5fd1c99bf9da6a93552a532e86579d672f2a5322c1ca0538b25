...
//#region lib/rules/multiline-html-element-content-newline.js
/**
* @author Yosuke Ota
* See LICENSE file in root directory for full license.
*/
var require_multiline_html_element_content_newline = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
		...
		create(context) {
			...
			*/
			function isIgnoredElement(node) {
				return ignores.includes(node.name) || ignores.includes(casing.pascalCase(node.rawName)) || ignores.includes(casing.kebabCase(node.rawName));
			}
			/**
			* @param {number} lineBreaks
			*/
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_multiline_html_element_content_newline();
  }
});