...
var execute_handlers_1 = require("./utils/execute-handlers");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = __read((0, resolveExportedComponent_1.default)(ast), 2), componentDefinitions = _a[0], ievSet = _a[1];
                    ...
                    return [4 /*yield*/, (0, documentRequiredComponents_1.default)(parseFile, documentation, ievSet, undefined, options)
                ...
                case 1:
                    ...
                    _b.label = 2;
                case 2: return [2 /*return*/, (0, execute_handlers_1.addDefaultAndExecuteHandlers)(componentDefinitions, ast, options, {
                        parseFile: parseFile,
