...
const getMessageSchema = zod_v3.z.object({ messageId: zod_v3.z.string() });
var GmailGetMessage = class extends require_base.GmailBaseTool {
...
//# sourceMappingURL=get_message.cjs.map