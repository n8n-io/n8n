...
export default class UserManager {
    ...
    add(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield handleRequest(fetch(this.client.getFullUrl(`/user`), {
                method: "POST",
    ...
    get(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield handleRequest(fetch(this.client.getFullUrl(`/user/${userId}`), {
    ...
    update(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield handleRequest(fetch(this.client.getFullUrl(`/user/${user.user_id}`), {
                method: "PATCH",
                headers: Object.assign(Object.assign({}, this.client.headers), { "Content-Type": "application/json" }),
    ...
    list(limit, cursor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield handleRequest(fetch(`${this.client.getFullUrl("/user")}?${params.toString()}`, {
                headers: this.client.headers,
            }));
    ...
    getSessions(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield handleRequest(fetch(this.client.getFullUrl(`/user/${userId}/sessions`), {
                headers: this.client.headers,
