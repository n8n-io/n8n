...
* ```
*/
var WeaviateTranslator = class extends __langchain_core_structured_query.BaseTranslator {
	...
	*/
	visitComparison(comparison) {
		...
		if (typeof comparison.value === "string") if ((0, __langchain_core_structured_query.isString)(comparison.value)) result.value = comparison.value;
		else if ((0, __langchain_core_structured_query.isInt)(comparison.value)) result.value = parseInt(comparison.value, 10);
		else if ((0, __langchain_core_structured_query.isFloat)(comparison.value)) result.value = parseFloat(comparison.value);
