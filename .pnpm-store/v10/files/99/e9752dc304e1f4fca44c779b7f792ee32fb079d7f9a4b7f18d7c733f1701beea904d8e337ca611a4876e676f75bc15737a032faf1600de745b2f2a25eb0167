...
function getSaturationGradient(hsl, colorSpace) {
	const start = require_color_convert.colorToString({
		space: "hsl",
		h: hsl.h,
		s: 0,
	...
	const end = require_color_convert.colorToString({
		space: "hsl",
		h: hsl.h,
		s: 100,
		l: colorSpace === "hsl" ? hsl.l : 50,
...
function getLightnessGradient(hsl) {
	...
	const mid = require_color_convert.colorToString({
		space: "hsl",
		h: hsl.h,
		s: hsl.s,
		l: 50,
...
function getAlphaGradient(color) {
	const { r, g, b } = color.space === "rgb" ? color : require_color_convert.convertToRgb(color);
...
function getChannelGradientForArea(color, channel, colorSpace, axis) {
	...
	switch (channel) {
		case "saturation": {
			...
			const fullColor = require_color_convert.colorToString({
				space: "hsl",
				h: hsl.h,
				s: 100,
				l: 50,
...
function getAreaBackgroundColor(color, xChannel, yChannel, colorSpace) {
	const hsl = require_color_convert.convertToHsl(color);
	const hsb = require_color_convert.convertToHsb(color);
	if (colorSpace === "hsl" && xChannel === "saturation" && yChannel === "lightness") return require_color_convert.colorToString({
		space: "hsl",
		h: hsl.h,
		s: 100,
		l: 50,
	...
	if (colorSpace === "hsb" && xChannel === "saturation" && yChannel === "brightness") return require_color_convert.colorToString({
		space: "hsb",
		h: hsb.h,
		s: 100,
		b: 100,
...
function getAreaBackgroundStyle(color, xChannel, yChannel, colorSpace = color.space) {
	...
	if (xChannel === "hue") {
		...
		if (yChannel === "saturation") {
			const desatColor = require_color_convert.colorToString({
				space: "hsl",
				h: hsl.h,
				s: 0,
				l: hsl.l,
	...
	if (xChannel === "saturation" && (yChannel === "lightness" || yChannel === "brightness")) {
		if (colorSpace === "hsl") {
			const hueColor = require_color_convert.colorToString({
				space: "hsl",
				h: hsl.h,
				s: 100,
				l: 50,
			...
			const grayColor = require_color_convert.colorToString({
				space: "hsl",
				h: hsl.h,
				s: 0,
				l: 50,
	...
	if (colorSpace === "rgb" && (xChannel === "red" || xChannel === "green" || xChannel === "blue") && (yChannel === "red" || yChannel === "green" || yChannel === "blue")) {
		...
		const xGradient = `linear-gradient(to right, ${require_color_convert.colorToString(xColorStart, "rgb")}, ${require_color_convert.colorToString(xColorEnd, "rgb")})`;
		const yColorEnd = {
			space: "rgb",
		...
		const yGradient = `linear-gradient(to top, ${require_color_convert.colorToString(xColorStart, "rgb")}, ${require_color_convert.colorToString(yColorEnd, "rgb")})`;
		const bgColor = {
			space: "rgb",
		...
		return {
			backgroundColor: require_color_convert.colorToString(bgColor, "rgb"),
...
//#endregion
Object.defineProperty(exports, 'getAreaBackgroundStyle', {
  enumerable: true,
  get: function () {
    return getAreaBackgroundStyle;
  }
});
Object.defineProperty(exports, 'getAreaGradient', {
  enumerable: true,
  get: function () {
    return getAreaGradient;
  }
});
Object.defineProperty(exports, 'getSliderBackgroundStyle', {
  enumerable: true,
  get: function () {
    return getSliderBackgroundStyle;
  }
});
Object.defineProperty(exports, 'getSliderGradient', {
  enumerable: true,
  get: function () {
    return getSliderGradient;
  }
});
