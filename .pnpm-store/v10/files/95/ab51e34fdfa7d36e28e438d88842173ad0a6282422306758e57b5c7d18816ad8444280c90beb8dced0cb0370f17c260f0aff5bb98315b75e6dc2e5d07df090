...
export var PostPromptConstants;
...
})(PostPromptConstants || (PostPromptConstants = {}));
/** Constants for the `patchPrompt` operation. */
export var PatchPromptConstants;
...
})(PatchPromptConstants || (PatchPromptConstants = {}));
/** Constants for the `putPromptLock` operation. */
export var PutPromptLockConstants;
...
})(PutPromptLockConstants || (PutPromptLockConstants = {}));
/** Constants for the `postPromptSessionEntry` operation. */
export var PostPromptSessionEntryConstants;
...
})(PostPromptSessionEntryConstants || (PostPromptSessionEntryConstants = {}));
/** Constants for the `putPromptSessionLock` operation. */
export var PutPromptSessionLockConstants;
...
})(PutPromptSessionLockConstants || (PutPromptSessionLockConstants = {}));
/** Constants for the `textChat` operation. */
export var TextChatConstants;
...
})(TextChatConstants || (TextChatConstants = {}));
/** Constants for the `textChatStream` operation. */
export var TextChatStreamConstants;
...
})(TextChatStreamConstants || (TextChatStreamConstants = {}));
/** Constants for the `trainingsList` operation. */
export var TrainingsListConstants;
...
})(TrainingsListConstants || (TrainingsListConstants = {}));
/** Constants for the `createFineTuning` operation. */
export var CreateFineTuningConstants;
...
})(CreateFineTuningConstants || (CreateFineTuningConstants = {}));
export var ApiErrorTarget;
...
})(ApiErrorTarget || (ApiErrorTarget = {}));
export var DataConnectionReference;
...
})(DataConnectionReference || (DataConnectionReference = {}));
export var DeploymentEntity;
...
export var DeploymentTextGenProperties;
...
})(DeploymentTextGenProperties || (DeploymentTextGenProperties = {}));
export var FoundationModel;
...
export var TextChatParameterTools;
...
})(TextChatParameterTools || (TextChatParameterTools = {}));
export var TextChatResponseFormat;
...
})(TextChatResponseFormat || (TextChatResponseFormat = {}));
export var TextChatResultChoice;
...
})(TextChatResultChoice || (TextChatResultChoice = {}));
export var TextChatResultChoiceStream;
...
})(TextChatResultChoiceStream || (TextChatResultChoiceStream = {}));
export var TextChatToolChoiceTool;
...
})(TextChatToolChoiceTool || (TextChatToolChoiceTool = {}));
export var TextExtractionDataReference;
...
})(TextExtractionDataReference || (TextExtractionDataReference = {}));
export var TextExtractionResults;
...
})(TextExtractionResults || (TextExtractionResults = {}));
export var TextGenParameters;
...
})(TextGenParameters || (TextGenParameters = {}));
export var TextGenResponseFieldsResultsItem;
...
})(TextGenResponseFieldsResultsItem || (TextGenResponseFieldsResultsItem = {}));
...
})(WxPromptResponse || (WxPromptResponse = {}));
export var WxPromptSessionEntry;
...
})(WxPromptSessionEntry || (WxPromptSessionEntry = {}));
export var TextChatMessagesTextChatMessageAssistant;
...
})(TextChatMessagesTextChatMessageAssistant || (TextChatMessagesTextChatMessageAssistant = {}));
export var TextChatMessagesTextChatMessageSystem;
...
})(TextChatMessagesTextChatMessageSystem || (TextChatMessagesTextChatMessageSystem = {}));
export var TextChatMessagesTextChatMessageTool;
...
})(TextChatMessagesTextChatMessageTool || (TextChatMessagesTextChatMessageTool = {}));
export var TextChatMessagesTextChatMessageUser;
...
})(TextChatMessagesTextChatMessageUser || (TextChatMessagesTextChatMessageUser = {}));
export var TextChatUserContentsTextChatUserImageURLContent;
...
})(TextChatUserContentsTextChatUserImageURLContent || (TextChatUserContentsTextChatUserImageURLContent = {}));
export var TextChatUserContentsTextChatUserTextContent;
...
})(TextChatUserContentsTextChatUserTextContent || (TextChatUserContentsTextChatUserTextContent = {}));
export var FineTuningEntity;
...
})(FineTuningEntity || (FineTuningEntity = {}));
export var FineTuningPeftParameters;
...
})(FineTuningPeftParameters || (FineTuningPeftParameters = {}));
export var DocumentExtractionStatus;
...
export var SyntheticDataGenerationDataReference;
...
})(SyntheticDataGenerationDataReference || (SyntheticDataGenerationDataReference = {}));
export var SyntheticDataGenerationStatus;
...
})(SyntheticDataGenerationStatus || (SyntheticDataGenerationStatus = {}));
export var TaxonomyStatus;
...
export var ModelResourceEntity;
...
})(ModelResourceEntity || (ModelResourceEntity = {}));
...
export var DocumentExtractionObjectLocation;
...
})(DocumentExtractionObjectLocation || (DocumentExtractionObjectLocation = {}));
export var ObjectLocationGithub;
...
})(ObjectLocationGithub || (ObjectLocationGithub = {}));
export var TextClassificationDataReference;
...
})(TextClassificationDataReference || (TextClassificationDataReference = {}));
export var TextClassificationParameters;
...
})(TextClassificationParameters || (TextClassificationParameters = {}));
export var TextClassificationResults;
...
})(TextClassificationResults || (TextClassificationResults = {}));
export var TextClassificationSemanticConfig;
...
})(TextClassificationSemanticConfig || (TextClassificationSemanticConfig = {}));
