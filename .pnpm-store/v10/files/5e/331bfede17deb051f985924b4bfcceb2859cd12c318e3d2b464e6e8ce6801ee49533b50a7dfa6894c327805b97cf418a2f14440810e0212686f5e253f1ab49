...
/** @internal */
exports.ConversationRestartStreamRequestHandoffExecution$outboundSchema = z
    .nativeEnum(exports.ConversationRestartStreamRequestHandoffExecution);
/** @internal */
exports.ConversationRestartStreamRequestAgentVersion$outboundSchema = z.union([z.string(), z.number().int()]);
