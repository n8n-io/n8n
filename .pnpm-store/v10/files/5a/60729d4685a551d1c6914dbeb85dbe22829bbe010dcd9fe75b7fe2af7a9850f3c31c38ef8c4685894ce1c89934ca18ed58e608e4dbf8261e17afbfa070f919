...
* ```
*/
var FewShotPromptTemplate = class FewShotPromptTemplate extends require_string.BaseStringPromptTemplate {
	...
	constructor(input) {
		...
		if (this.validateTemplate) {
			...
			require_template.checkValidTemplate(this.prefix + this.suffix, this.templateFormat, totalInputVariables);
		}
	}
	_getPromptType() {
		return "few_shot";
	...
	*/
	async format(values) {
		...
		return require_template.renderTemplate([
			this.prefix,
			...exampleStrings,
			this.suffix
	...
	static async deserialize(data) {
		...
		const examplePrompt = await require_prompt.PromptTemplate.deserialize(example_prompt);
		let examples;
...
*/
var FewShotChatMessagePromptTemplate = class FewShotChatMessagePromptTemplate extends require_chat.BaseChatPromptTemplate {
...
//# sourceMappingURL=few_shot.cjs.map