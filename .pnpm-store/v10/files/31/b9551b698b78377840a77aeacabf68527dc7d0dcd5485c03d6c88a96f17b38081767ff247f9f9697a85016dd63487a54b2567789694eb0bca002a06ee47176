...
require_rolldown_runtime.__export(searchapi_exports, { SearchApi: () => SearchApi });
...
* ```
*/
var SearchApi = class extends __langchain_core_tools.Tool {
	static lc_name() {
		return "SearchApi";
	}
	/**
	...
	*/
	...
	apiKey;
	params;
	constructor(apiKey = (0, __langchain_core_utils_env.getEnvironmentVariable)("SEARCHAPI_API_KEY"), params = {}) {
		super(...arguments);
