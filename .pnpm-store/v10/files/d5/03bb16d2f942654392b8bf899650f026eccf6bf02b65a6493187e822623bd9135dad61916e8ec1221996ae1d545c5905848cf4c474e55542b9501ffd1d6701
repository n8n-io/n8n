    ...
    class TextClassificationsPager extends Pager {
        ...
        getNext() {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { result } = response;
                const next = ((_a = result === null || result === void 0 ? void 0 : result.next) === null || _a === void 0 ? void 0 : _a.href) ? (0, ibm_cloud_sdk_core_1.getQueryParam)(result.next.href, 'start') : undefined;
                this.pageContext.next = next;
                if (!next) {
                    this.hasNextPage = false;
                }
