...
var functions$1 = [
	...
	},
	{
		"name": "utils",
		"package": "shared",
		"lastUpdated": 1741577867e3,
		"internal": true
	},
	{
		"name": "watchArray",
		"package": "shared",
		"lastUpdated": 1741159087e3,
...
//#endregion
//#region utils.ts
function getCategories(functions$2) {
	return uniq(functions$2.filter((i) => !i.internal).map((i) => i.category).filter(Boolean)).sort((a, b) => a.startsWith("@") && !b.startsWith("@") ? 1 : b.startsWith("@") && !a.startsWith("@") ? -1 : a.localeCompare(b));
}
function uniq(a) {
