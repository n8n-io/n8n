...
var node_exports = {};
__export(node_exports, { CloseVectorNode: () => CloseVectorNode });
/**
...
*/
var CloseVectorNode = class CloseVectorNode extends CloseVector {
	constructor(embeddings, args, credentials) {
		super(embeddings, args, credentials);
		if (args.instance) this.instance = args.instance;
		else this.instance = new CloseVectorHNSWNode(embeddings, args);
	}
	uuid() {
...
//#endregion
export { CloseVectorNode, node_exports };
