...
var myscale_exports = {};
require_rolldown_runtime.__export(myscale_exports, { MyScaleStore: () => MyScaleStore });
/**
...
* texts or documents.
*/
var MyScaleStore = class MyScaleStore extends __langchain_core_vectorstores.VectorStore {
	client;
	indexType;
	indexParam;
	columnMap;
...
Object.defineProperty(exports, 'myscale_exports', {
  enumerable: true,
  get: function () {
    return myscale_exports;
  }
});
//# sourceMappingURL=myscale.cjs.map