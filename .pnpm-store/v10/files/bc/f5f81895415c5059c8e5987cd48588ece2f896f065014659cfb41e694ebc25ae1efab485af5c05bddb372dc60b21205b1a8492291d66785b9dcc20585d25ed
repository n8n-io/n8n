...
var node_param_option_name_duplicate_exports = {};
__export(node_param_option_name_duplicate_exports, {
  default: () => node_param_option_name_duplicate_default
});
module.exports = __toCommonJS(node_param_option_name_duplicate_exports);
var import_utils = require("../ast/utils");
var import_nodeParameter = require("../ast/identifiers/nodeParameter.identifiers");
var import_identifiers = require("../ast/identifiers");
var import_getters = require("../ast/getters");
var node_param_option_name_duplicate_default = import_utils.utils.createRule({
  name: import_utils.utils.getRuleName(module),
  meta: {
    type: "problem",
    docs: {
      description: "Option `name` in options-type node parameter must not be a duplicate.",
      recommended: "strict"
    },
    schema: [],
    fixable: "code",
