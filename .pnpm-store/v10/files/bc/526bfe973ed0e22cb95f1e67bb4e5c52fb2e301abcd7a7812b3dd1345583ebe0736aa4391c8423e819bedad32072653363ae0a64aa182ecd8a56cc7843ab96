...
//#region lib/rules/html-self-closing.js
/**
* @author Toru Nagashima
* @copyright 2016 Toru Nagashima. All rights reserved.
* See LICENSE file in root directory for full license.
*/
var require_html_self_closing = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	*/
	function getElementType(node) {
		if (utils.isCustomComponent(node)) return "COMPONENT";
		if (utils.isHtmlElementNode(node)) {
			if (utils.isHtmlVoidElementName(node.name)) return "VOID";
			return "NORMAL";
		}
		if (utils.isSvgElementNode(node)) return "SVG";
		if (utils.isMathElementNode(node)) return "MATH";
		return "UNKNOWN";
	}
	/**
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_html_self_closing();
  }
});