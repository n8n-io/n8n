...
require_rolldown_runtime.__export(wolframalpha_exports, { WolframAlphaTool: () => WolframAlphaTool });
/**
* @example
* ```typescript
...
* ```
*/
var WolframAlphaTool = class extends __langchain_core_tools.Tool {
	appid;
	name = "wolfram_alpha";
