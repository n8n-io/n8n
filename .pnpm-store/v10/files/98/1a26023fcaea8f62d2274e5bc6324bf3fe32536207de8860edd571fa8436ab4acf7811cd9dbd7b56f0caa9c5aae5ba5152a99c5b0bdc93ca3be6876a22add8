...
function isDev() {
  return undefined && undefined.DEV === true || process.env.NODE_ENV === "development";
}

exports.createOnBeforeUnmountHook = createOnBeforeUnmountHook;
exports.createOnBeforeUpdateHook = createOnBeforeUpdateHook;
exports.isDev = isDev;
