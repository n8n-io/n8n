...
// node_modules/.pnpm/tsup@8.3.5_jiti@2.3.3_typescript@5.6.3/node_modules/tsup/assets/esm_shims.js
...
function getSource(fileSource) {
  ...
  return new RawSource(
    typeof fileSource === "string" ? fileSource : Buffer5.from(fileSource.buffer).toString("utf-8")
  );
}
