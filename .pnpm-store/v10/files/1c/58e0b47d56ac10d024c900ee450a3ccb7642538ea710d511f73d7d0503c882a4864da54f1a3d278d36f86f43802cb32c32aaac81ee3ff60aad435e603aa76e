...
require_rolldown_runtime.__export(ensemble_exports, { EnsembleRetriever: () => EnsembleRetriever });
/**
* Ensemble retriever that aggregates and orders the results of
* multiple retrievers by using weighted Reciprocal Rank Fusion.
*/
var EnsembleRetriever = class extends __langchain_core_retrievers.BaseRetriever {
	static lc_name() {
