...
const imagedetail_js_1 = require("./imagedetail.js");
/** @internal */
exports.ImageURL$inboundSchema = z.object({
    url: z.string(),
    detail: z.nullable(imagedetail_js_1.ImageDetail$inboundSchema).optional(),
});
/** @internal */
exports.ImageURL$outboundSchema = z.object({
    url: z.string(),
    detail: z.nullable(imagedetail_js_1.ImageDetail$outboundSchema).optional(),
});
