...
const pyodide = require_rolldown_runtime.__toESM(require("pyodide"));

//#region src/experimental/tools/pyinterpreter.ts
var pyinterpreter_exports = {};
require_rolldown_runtime.__export(pyinterpreter_exports, { PythonInterpreterTool: () => PythonInterpreterTool });
var PythonInterpreterTool = class extends __langchain_core_tools.Tool {
	static lc_name() {
...
${this.availableDefaultPackages}`;
	...
	static async initialize(options) {
		const instance = await (0, pyodide.loadPyodide)(options);
		return new this({
			...options,
			instance
		});
...
Object.defineProperty(exports, 'pyinterpreter_exports', {
  enumerable: true,
  get: function () {
    return pyinterpreter_exports;
  }
});
//# sourceMappingURL=pyinterpreter.cjs.map