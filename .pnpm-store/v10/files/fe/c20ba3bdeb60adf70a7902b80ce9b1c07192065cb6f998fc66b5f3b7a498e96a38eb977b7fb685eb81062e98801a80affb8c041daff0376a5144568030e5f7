...
require_rolldown_runtime.__export(aurora_dsql_exports, { AuroraDsqlChatMessageHistory: () => AuroraDsqlChatMessageHistory });
/**
...
* ```
*/
var AuroraDsqlChatMessageHistory = class extends __langchain_core_chat_history.BaseListChatMessageHistory {
	lc_namespace = [
		"langchain",
		"stores",
		"message",
	...
	*/
	...
	async addMessage(message) {
		...
		const map = (0, __langchain_core_messages.mapChatMessagesToStoredMessages)([message])[0];
	...
	async getMessages() {
		...
		return (0, __langchain_core_messages.mapStoredMessagesToChatMessages)(storedMessages);
	}
	async clear() {
		await this.ensureTable();
...
Object.defineProperty(exports, 'aurora_dsql_exports', {
  enumerable: true,
  get: function () {
    return aurora_dsql_exports;
  }
});
//# sourceMappingURL=aurora_dsql.cjs.map