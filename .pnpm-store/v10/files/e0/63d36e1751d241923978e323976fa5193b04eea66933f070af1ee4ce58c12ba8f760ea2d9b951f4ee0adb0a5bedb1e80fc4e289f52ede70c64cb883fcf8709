...
exports.defaultServiceVersion = void 0;
exports.convertSkillsToPublic = convertSkillsToPublic;
exports.convertCognitiveServicesAccountToGenerated = convertCognitiveServicesAccountToGenerated;
exports.convertCognitiveServicesAccountToPublic = convertCognitiveServicesAccountToPublic;
exports.convertTokenFiltersToGenerated = convertTokenFiltersToGenerated;
exports.convertFieldsToPublic = convertFieldsToPublic;
exports.convertFieldsToGenerated = convertFieldsToGenerated;
exports.convertSimilarityToGenerated = convertSimilarityToGenerated;
exports.convertSimilarityToPublic = convertSimilarityToPublic;
exports.generatedIndexToPublicIndex = generatedIndexToPublicIndex;
exports.generatedVectorSearchVectorizerToPublicVectorizer = generatedVectorSearchVectorizerToPublicVectorizer;
exports.generatedVectorSearchAlgorithmConfigurationToPublicVectorSearchAlgorithmConfiguration = generatedVectorSearchAlgorithmConfigurationToPublicVectorSearchAlgorithmConfiguration;
exports.generatedVectorSearchToPublicVectorSearch = generatedVectorSearchToPublicVectorSearch;
exports.generatedSearchResultToPublicSearchResult = generatedSearchResultToPublicSearchResult;
exports.generatedSuggestDocumentsResultToPublicSuggestDocumentsResult = generatedSuggestDocumentsResultToPublicSuggestDocumentsResult;
exports.publicIndexToGeneratedIndex = publicIndexToGeneratedIndex;
exports.generatedSkillsetToPublicSkillset = generatedSkillsetToPublicSkillset;
exports.publicSkillsetToGeneratedSkillset = publicSkillsetToGeneratedSkillset;
exports.generatedSynonymMapToPublicSynonymMap = generatedSynonymMapToPublicSynonymMap;
exports.publicSynonymMapToGeneratedSynonymMap = publicSynonymMapToGeneratedSynonymMap;
exports.publicSearchIndexerToGeneratedSearchIndexer = publicSearchIndexerToGeneratedSearchIndexer;
exports.generatedSearchIndexerToPublicSearchIndexer = generatedSearchIndexerToPublicSearchIndexer;
exports.publicDataSourceToGeneratedDataSource = publicDataSourceToGeneratedDataSource;
exports.generatedDataSourceToPublicDataSource = generatedDataSourceToPublicDataSource;
exports.convertSearchIndexerDataIdentityToPublic = convertSearchIndexerDataIdentityToPublic;
exports.convertDataChangeDetectionPolicyToPublic = convertDataChangeDetectionPolicyToPublic;
exports.convertDataDeletionDetectionPolicyToPublic = convertDataDeletionDetectionPolicyToPublic;
exports.getRandomIntegerInclusive = getRandomIntegerInclusive;
const logger_js_1 = require("./logger.js");
const serviceModels_js_1 = require("./serviceModels.js");
exports.defaultServiceVersion = "2025-09-01";
const knownSkills = {
...
function convertFieldsToGenerated(fields) {
    return fields.map((field) => {
        if ((0, serviceModels_js_1.isComplexField)(field)) {
            return {
                name: field.name,
                type: field.type,
...
function generatedVectorSearchVectorizerToPublicVectorizer(generatedVectorizer) {
    ...
    logger_js_1.logger.warning(`Unsupported vectorizer kind: ${generatedVectorizer.kind}`);
    return generatedVectorizer;
}
