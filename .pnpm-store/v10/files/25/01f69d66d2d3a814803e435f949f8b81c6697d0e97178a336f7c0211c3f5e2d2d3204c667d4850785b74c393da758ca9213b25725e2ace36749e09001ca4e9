import { CloseVector } from "./common.cjs";
import { Document } from "@langchain/core/documents";
import { EmbeddingsInterface } from "@langchain/core/embeddings";
import { CloseVectorCredentials, CloseVectorHNSWLibArgs, CloseVectorHNSWWeb, HierarchicalNSWT, HnswlibModule } from "closevector-web";

//#region src/vectorstores/closevector/web.d.ts
 ...
 */
interface CloseVectorWebArgs extends CloseVectorHNSWLibArgs<HierarchicalNSWT> {
  space: "cosine" | "l2" | "ip";
 ...
 */
declare class CloseVectorWeb extends CloseVector<CloseVectorHNSWWeb> {
...
//#endregion
export { CloseVectorWeb, CloseVectorWebArgs };
