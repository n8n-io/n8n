...
import { SafeSearchType, SearchTimeType, search } from "duck-duck-scrape";

//#region src/tools/duckduckgo_search.ts
var duckduckgo_search_exports = {};
__export(duckduckgo_search_exports, {
...
* </details>
*/
var DuckDuckGoSearch = class extends Tool {
	searchOptions;
...
//#endregion
export { DuckDuckGoSearch, SafeSearchType, SearchTimeType, duckduckgo_search_exports };
//# sourceMappingURL=duckduckgo_search.js.map