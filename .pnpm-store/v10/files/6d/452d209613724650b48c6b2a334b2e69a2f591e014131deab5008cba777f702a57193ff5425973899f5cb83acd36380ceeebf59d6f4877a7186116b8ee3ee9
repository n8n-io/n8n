...
require_rolldown_runtime.__export(neo4j_graph_exports, {
...
var Neo4jGraph = class Neo4jGraph {
	...
	async addGraphDocuments(graphDocuments, config = {}) {
		...
		for (const document of graphDocuments) {
			if (!document.source.metadata.id) document.source.metadata.id = (0, __langchain_core_utils_hash.sha256)(document.source.pageContent);
