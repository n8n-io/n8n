...
require_rolldown_runtime.__export(aleph_alpha_exports, { AlephAlpha: () => AlephAlpha });
/**
...
* Aleph Alpha model.
*/
var AlephAlpha = class extends __langchain_core_language_models_llms.LLM {
	...
	aleph_alpha_api_key = (0, __langchain_core_utils_env.getEnvironmentVariable)("ALEPH_ALPHA_API_KEY");
	stop;
...
Object.defineProperty(exports, 'aleph_alpha_exports', {
  enumerable: true,
  get: function () {
    return aleph_alpha_exports;
  }
});
//# sourceMappingURL=aleph_alpha.cjs.map