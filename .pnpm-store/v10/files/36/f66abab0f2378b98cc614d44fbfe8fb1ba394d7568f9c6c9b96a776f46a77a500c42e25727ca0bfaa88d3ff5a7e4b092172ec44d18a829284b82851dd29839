...
//#region lib/rules/v-slot-style.js
/**
* @author Toru Nagashima
* See LICENSE file in root directory for full license.
*/
var require_v_slot_style = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	const { pascalCase } = require_casing$1.default;
