...
exports.LangChainToolingConfiguration = void 0;
 ...
 * ```
 */
class LangChainToolingConfiguration extends agents_a365_tooling_1.ToolingConfiguration {
    constructor(overrides) {
        super(overrides);
    }
}
exports.LangChainToolingConfiguration = LangChainToolingConfiguration;
//# sourceMappingURL=LangChainToolingConfiguration.js.map