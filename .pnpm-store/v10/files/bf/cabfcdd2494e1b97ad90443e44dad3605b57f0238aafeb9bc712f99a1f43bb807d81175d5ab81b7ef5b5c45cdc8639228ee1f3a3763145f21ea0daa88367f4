...
__export(wikipedia_query_run_exports, { WikipediaQueryRun: () => WikipediaQueryRun });
/**
...
* </details>
*/
var WikipediaQueryRun = class extends Tool {
	static lc_name() {
...
//#endregion
export { WikipediaQueryRun, wikipedia_query_run_exports };
//# sourceMappingURL=wikipedia_query_run.js.map