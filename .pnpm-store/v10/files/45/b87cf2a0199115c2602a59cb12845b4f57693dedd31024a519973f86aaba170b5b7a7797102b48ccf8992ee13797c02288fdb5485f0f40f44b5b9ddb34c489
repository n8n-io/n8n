declare const _default: {
    ...
    rules: {
        ...
        'no-unnecessary-type-arguments': import("@typescript-eslint/utils/ts-eslint").RuleModule<import("./rules/no-unnecessary-type-arguments").MessageIds, [], import("../rules").ESLintPluginDocs, import("@typescript-eslint/utils/ts-eslint").RuleListener> & {
            name: string;
        };
