...
require_rolldown_runtime.__export(cassandra_exports, { CassandraStore: () => CassandraStore });
/**
...
* texts or documents.
*/
var CassandraStore = class CassandraStore extends __langchain_core_vectorstores.VectorStore {
	table;
	idColumnAutoName = "id";
