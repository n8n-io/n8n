...
require_rolldown_runtime.__export(postgres_exports, { PostgresChatMessageHistory: () => PostgresChatMessageHistory });
/**
...
* ```
*/
var PostgresChatMessageHistory = class extends __langchain_core_chat_history.BaseListChatMessageHistory {
	lc_namespace = [
		"langchain",
		"stores",
		"message",
	...
	*/
	...
	async addMessage(message) {
		...
		const { data, type } = (0, __langchain_core_messages.mapChatMessagesToStoredMessages)([message])[0];
