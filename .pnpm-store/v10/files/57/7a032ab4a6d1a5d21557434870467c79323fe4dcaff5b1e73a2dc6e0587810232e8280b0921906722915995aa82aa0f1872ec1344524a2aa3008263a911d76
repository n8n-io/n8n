...
require_rolldown_runtime.__export(neo4j_vector_exports, { Neo4jVectorStore: () => Neo4jVectorStore });
...
*/
var Neo4jVectorStore = class Neo4jVectorStore extends __langchain_core_vectorstores.VectorStore {
	driver;
	database;
	preDeleteCollection;
	nodeLabel;
	...
	async similaritySearchVectorWithScore(vector, k, query, params = {}) {
      ...
      `;
		...
		if (results) {
			...
			const docs = results.map((result) => [new __langchain_core_documents.Document({
...
Object.defineProperty(exports, 'neo4j_vector_exports', {
  enumerable: true,
  get: function () {
    return neo4j_vector_exports;
  }
});
