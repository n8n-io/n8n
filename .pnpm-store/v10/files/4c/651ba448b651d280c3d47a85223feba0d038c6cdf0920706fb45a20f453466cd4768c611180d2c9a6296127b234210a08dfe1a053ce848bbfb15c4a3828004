 ...
 */
export declare function replaceOrCreateHeader(context: Context, markdown: string, newHeader: string, marker: string): string;
/**
 * Find the section most likely to be the top-level section for a given string.
 */
export declare function findSectionHeader(context: Context, markdown: string, str: string): string | undefined;
...
export declare function expectSectionHeaderOrFail(context: Context, contentName: string, contents: string, possibleHeaders: readonly string[], expected: boolean): void;
