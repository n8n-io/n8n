import { GoogleVertexAIBaseLLMInput, GoogleVertexAIBasePrediction } from "../../types/googlevertexai-types.cjs";
import { GoogleVertexAILLMResponse } from "../../utils/googlevertexai-connection.cjs";
