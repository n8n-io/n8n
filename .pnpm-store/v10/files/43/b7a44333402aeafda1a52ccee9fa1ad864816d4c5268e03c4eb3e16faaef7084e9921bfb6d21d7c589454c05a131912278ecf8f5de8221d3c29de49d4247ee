...
require_rolldown_runtime.__export(puppeteer_exports, { PuppeteerWebBaseLoader: () => PuppeteerWebBaseLoader });
/**
...
* ```
*/
var PuppeteerWebBaseLoader = class PuppeteerWebBaseLoader extends __langchain_core_document_loaders_base.BaseDocumentLoader {
	options;
...
Object.defineProperty(exports, 'puppeteer_exports', {
  enumerable: true,
  get: function () {
    return puppeteer_exports;
  }
});
//# sourceMappingURL=puppeteer.cjs.map