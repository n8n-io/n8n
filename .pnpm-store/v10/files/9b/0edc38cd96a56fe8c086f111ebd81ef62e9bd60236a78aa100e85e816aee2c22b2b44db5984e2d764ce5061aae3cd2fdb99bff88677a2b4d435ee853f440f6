...
var MonthRangePickerPrev_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Primitive_Primitive.Primitive), {
				...
				default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "default", { disabled: disabled.value }, () => [_cache[0] || (_cache[0] = (0, vue.createTextVNode)(" Prev year "))])]),
				_: 3
			}, 8, [
				"as",
				"as-child",
...
//#endregion
Object.defineProperty(exports, 'MonthRangePickerPrev_default', {
  enumerable: true,
  get: function () {
    return MonthRangePickerPrev_default;
  }
});
//# sourceMappingURL=MonthRangePickerPrev.cjs.map