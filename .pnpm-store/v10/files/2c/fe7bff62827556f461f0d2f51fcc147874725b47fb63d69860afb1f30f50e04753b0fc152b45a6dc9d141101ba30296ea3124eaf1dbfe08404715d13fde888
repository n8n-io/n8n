...
require_rolldown_runtime.__export(google_routes_exports, { GoogleRoutesAPI: () => GoogleRoutesAPI });
...
*/
var GoogleRoutesAPI = class extends __langchain_core_tools.StructuredTool {
	static lc_name() {
	...
	constructor(fields) {
		super(...arguments);
		const apiKey = fields?.apiKey ?? (0, __langchain_core_utils_env.getEnvironmentVariable)("GOOGLE_ROUTES_API_KEY");
