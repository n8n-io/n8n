...
var node_param_type_options_missing_from_limit_exports = {};
__export(node_param_type_options_missing_from_limit_exports, {
  default: () => node_param_type_options_missing_from_limit_default
});
module.exports = __toCommonJS(node_param_type_options_missing_from_limit_exports);
var import_utils = require("../ast/utils");
var import_identifiers = require("../ast/identifiers");
var import_getters = require("../ast/getters");
var node_param_type_options_missing_from_limit_default = import_utils.utils.createRule({
    ...
    return {
      ObjectExpression(node) {
        ...
        if (!typeOptions) {
          ...
          if (!type)
            return;
          const { indentation: baseIndentation, range } = import_utils.utils.getInsertionArgs(type);
