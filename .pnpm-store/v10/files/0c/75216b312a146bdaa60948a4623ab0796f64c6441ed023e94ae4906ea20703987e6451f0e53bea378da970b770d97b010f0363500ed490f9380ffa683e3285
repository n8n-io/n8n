...
var gcs_exports = {};
__export(gcs_exports, { GoogleCloudStorageDocstore: () => GoogleCloudStorageDocstore });
/**
...
* bucket.
*/
var GoogleCloudStorageDocstore = class extends Docstore {
	bucket;
	prefix = "";
	storage;
	constructor(config) {
...
//#endregion
export { GoogleCloudStorageDocstore, gcs_exports };
