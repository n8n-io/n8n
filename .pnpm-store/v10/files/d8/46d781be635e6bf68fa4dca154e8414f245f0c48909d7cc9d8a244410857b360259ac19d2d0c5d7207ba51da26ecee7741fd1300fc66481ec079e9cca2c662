...
var ComboboxViewport_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, [(0, vue.createVNode)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)({
				...
				_: 3
			}, 16, ["style"]), (0, vue.createVNode)((0, vue.unref)(require_Primitive_Primitive.Primitive), {
				as: "style",
...
//#endregion
Object.defineProperty(exports, 'ComboboxViewport_default', {
  enumerable: true,
  get: function () {
    return ComboboxViewport_default;
  }
});
//# sourceMappingURL=ComboboxViewport.cjs.map