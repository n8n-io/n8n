...
exports.betaObservabilityChatCompletionEventsSearch = betaObservabilityChatCompletionEventsSearch;
...
async function $do(client, request, options) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/observability/chat-completion-events/search")();
    ...
    const [result] = await M.match(M.json(200, components.ChatCompletionEvents$inboundSchema), M.jsonErr([400, 404, 408, 409, 422], errors.ObservabilityError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
