...
export declare class PrometheusSerializer {
    ...
    private _withoutScopeInfo;
    private _withoutTargetInfo;
    constructor(prefix?: string, appendTimestamp?: boolean, withResourceConstantLabels?: RegExp, withoutTargetInfo?: boolean, withoutScopeInfo?: boolean);
