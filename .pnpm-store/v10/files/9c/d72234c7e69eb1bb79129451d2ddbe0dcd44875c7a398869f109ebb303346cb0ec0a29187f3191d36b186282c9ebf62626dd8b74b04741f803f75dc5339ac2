...
//#region src/agents/toolkits/openapi/prompt.ts
...
//#endregion
exports.JSON_EXPLORER_DESCRIPTION = JSON_EXPLORER_DESCRIPTION;
exports.OPENAPI_PREFIX = OPENAPI_PREFIX;
exports.OPENAPI_SUFFIX = OPENAPI_SUFFIX;
