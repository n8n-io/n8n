...
declare const _default: {
    ...
    plugin: {
        ...
        rules: {
            ...
            'no-unnecessary-type-arguments': TSESLint.RuleModule<import("./rules/no-unnecessary-type-arguments").MessageIds, [], import("../rules").ESLintPluginDocs, TSESLint.RuleListener> & {
                name: string;
            };
