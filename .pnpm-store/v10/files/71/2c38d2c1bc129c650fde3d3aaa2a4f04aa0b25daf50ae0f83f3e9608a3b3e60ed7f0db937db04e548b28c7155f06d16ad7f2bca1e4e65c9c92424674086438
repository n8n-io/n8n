...
require_rolldown_runtime.__export(supabase_exports, { SupabaseHybridSearch: () => SupabaseHybridSearch });
/**
...
*/
var SupabaseHybridSearch = class extends __langchain_core_retrievers.BaseRetriever {
	static lc_name() {
