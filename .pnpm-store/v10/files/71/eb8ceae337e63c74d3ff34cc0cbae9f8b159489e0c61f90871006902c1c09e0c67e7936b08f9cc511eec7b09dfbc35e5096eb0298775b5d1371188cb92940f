...
var MenuPortal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	__name: "MenuPortal",
	props: {
		to: {
			type: null,
...
//#endregion
Object.defineProperty(exports, 'MenuPortal_default', {
  enumerable: true,
  get: function () {
    return MenuPortal_default;
  }
});
//# sourceMappingURL=MenuPortal.cjs.map