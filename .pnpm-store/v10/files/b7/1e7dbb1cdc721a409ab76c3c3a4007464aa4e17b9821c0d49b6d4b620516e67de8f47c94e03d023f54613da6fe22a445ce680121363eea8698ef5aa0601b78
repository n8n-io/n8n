...
//#region lib/rules/html-comment-indent.js
/**
* @author Yosuke ota
* See LICENSE file in root directory for full license.
*/
var require_html_comment_indent = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_html_comment_indent();
  }
});