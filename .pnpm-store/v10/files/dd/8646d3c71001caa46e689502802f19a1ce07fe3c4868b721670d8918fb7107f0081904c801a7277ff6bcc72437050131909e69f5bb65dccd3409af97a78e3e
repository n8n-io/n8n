import { MetaDocsProperty, RuleInfo, StringLiteral, TestInfo, ViolationAndSuppressionData } from "./types.js";
...
declare function isStringLiteral(node: Node): node is StringLiteral;
/**
