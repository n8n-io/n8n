...
var sqlite_exports = {};
require_rolldown_runtime.__export(sqlite_exports, { SQLiteRecordManager: () => SQLiteRecordManager });
var SQLiteRecordManager = class {
	...
	constructor(namespace, config) {
		...
		this.db = new better_sqlite3.default(connectionString ?? localPath);
	}
	async createSchema() {
		try {
			this.db.exec(`
...
//#endregion
exports.SQLiteRecordManager = SQLiteRecordManager;
