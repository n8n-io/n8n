...
var node_param_operation_without_no_data_expression_exports = {};
__export(node_param_operation_without_no_data_expression_exports, {
  default: () => node_param_operation_without_no_data_expression_default
});
module.exports = __toCommonJS(node_param_operation_without_no_data_expression_exports);
var import_utils = require("../ast/utils");
var import_identifiers = require("../ast/identifiers");
var import_getters = require("../ast/getters");
var node_param_operation_without_no_data_expression_default = import_utils.utils.createRule({
  name: import_utils.utils.getRuleName(module),
  meta: {
    type: "problem",
    docs: {
      description: "`noDataExpression` in an Operation node parameter must be present and enabled.",
      recommended: "strict"
    },
    fixable: "code",
    schema: [],
