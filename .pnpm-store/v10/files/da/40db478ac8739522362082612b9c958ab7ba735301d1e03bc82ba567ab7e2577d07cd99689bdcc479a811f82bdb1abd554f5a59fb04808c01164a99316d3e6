...
import { in_memory_exports } from "../stores/doc/in_memory.js";
...
var usearch_exports = {};
__export(usearch_exports, { USearch: () => USearch });
/**
...
*/
var USearch = class extends SaveableVectorStore {
	_index;
	_mapping;
	docstore;
	args;
	...
	constructor(embeddings, args) {
		...
		this.docstore = args?.docstore ?? new in_memory_exports.SynchronousInMemoryDocstore();
	}
	/**
	...
	*/
	async addVectors(vectors, documents) {
		...
		if (!this._index) this._index = new Index(dv, MetricKind.L2sq, ScalarKind.F32, 16);
...
//#endregion
export { USearch, usearch_exports };
//# sourceMappingURL=usearch.js.map