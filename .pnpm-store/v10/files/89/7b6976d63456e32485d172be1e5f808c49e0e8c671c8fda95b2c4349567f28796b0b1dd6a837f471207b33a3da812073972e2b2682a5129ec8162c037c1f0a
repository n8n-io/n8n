...
exports.FireworksConversationalTask = void 0;
/**
...
class FireworksConversationalTask extends providerHelper_js_1.BaseConversationalTask {
    constructor() {
...
exports.FireworksConversationalTask = FireworksConversationalTask;
