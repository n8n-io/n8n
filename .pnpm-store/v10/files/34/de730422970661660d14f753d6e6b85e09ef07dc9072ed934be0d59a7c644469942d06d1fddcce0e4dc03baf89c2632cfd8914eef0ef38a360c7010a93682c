...
export declare class QdrantClient {
     ...
     */
    searchBatch(collection_name: string, { searches, consistency, timeout, }: Pick<Schemas['SearchRequestBatch'], 'searches'> & {
     ...
     */
    search(collection_name: string, { shard_key, vector, limit, offset, filter, params, with_payload, with_vector, score_threshold, consistency, timeout, }: Partial<Pick<Schemas['SearchRequest'], 'limit'>> & Omit<Schemas['SearchRequest'], 'limit'> & {
        consistency?: Schemas['ReadConsistency'];
    } & {
        timeout?: number;
    }): Promise<Schemas['ScoredPoint'][]>;
     ...
     */
    recommendBatch(collection_name: string, { searches, consistency, timeout, }: Schemas['RecommendRequestBatch'] & {
        consistency?: Schemas['ReadConsistency'];
    } & {
        timeout?: number;
    }): Promise<Schemas['ScoredPoint'][][]>;
     ...
     */
    recommend_batch(collection_name: string, { searches, consistency, timeout, }: Schemas['RecommendRequestBatch'] & {
        consistency?: Schemas['ReadConsistency'];
    } & {
        timeout?: number;
    }): Promise<Schemas['ScoredPoint'][][]>;
     ...
     */
    recommend(collection_name: string, { shard_key, positive, negative, strategy, filter, params, limit, offset, with_payload, with_vector, score_threshold, using, lookup_from, consistency, timeout, }: Omit<Schemas['RecommendRequest'], 'limit'> & Partial<Pick<Schemas['RecommendRequest'], 'limit'>> & {
        consistency?: Schemas['ReadConsistency'];
    } & {
        timeout?: number;
    }): Promise<Schemas['ScoredPoint'][]>;
    ...
    searchPointGroups(collection_name: string, { consistency, timeout, shard_key, vector, filter, params, with_payload, with_vector, score_threshold, group_by, group_size, limit, }: {
        ...
        timeout?: number;
    } & Schemas['SearchGroupsRequest']): Promise<Schemas['GroupsResult']>;
    /**
    ...
    recommendPointGroups(collection_name: string, { consistency, timeout, shard_key, positive, strategy, negative, filter, params, with_payload, with_vector, score_threshold, using, lookup_from, group_by, group_size, limit, }: {
        ...
        timeout?: number;
    } & Schemas['RecommendGroupsRequest']): Promise<Schemas['GroupsResult']>;
    /**
    ...
    discoverPoints(collection_name: string, { consistency, timeout, shard_key, target, context, params, limit, offset, with_payload, with_vector, using, lookup_from, }: {
        ...
        timeout?: number;
    } & Schemas['DiscoverRequest']): Promise<Schemas['ScoredPoint'][]>;
    /**
    ...
    discoverBatchPoints(collection_name: string, { consistency, timeout, searches, }: {
        ...
        timeout?: number;
    } & Schemas['DiscoverRequestBatch']): Promise<Schemas['ScoredPoint'][][]>;
    /**
