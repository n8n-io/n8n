...
var memory_exports = {};
require_rolldown_runtime.__export(memory_exports, { MemoryVectorStore: () => MemoryVectorStore });
/**
...
* <br />
*/
var MemoryVectorStore = class MemoryVectorStore extends __langchain_core_vectorstores.VectorStore {
	memoryVectors = [];
	similarity;
	_vectorstoreType() {
		return "memory";
	...
	*/
	async similaritySearchVectorWithScore(query, k, filter) {
		...
		const result = searches.map((search) => [new __langchain_core_documents.Document({
