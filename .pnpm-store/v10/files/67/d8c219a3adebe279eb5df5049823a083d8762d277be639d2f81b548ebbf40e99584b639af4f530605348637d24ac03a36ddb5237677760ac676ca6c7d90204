...
require_rolldown_runtime.__export(vercel_kv_exports, { VercelKVStore: () => VercelKVStore });
/**
...
* ```
*/
var VercelKVStore = class extends __langchain_core_stores.BaseStore {
	...
	constructor(fields) {
		super(fields);
		this.client = fields?.client ?? __vercel_kv.kv;
		this.ttl = fields?.ttl;
