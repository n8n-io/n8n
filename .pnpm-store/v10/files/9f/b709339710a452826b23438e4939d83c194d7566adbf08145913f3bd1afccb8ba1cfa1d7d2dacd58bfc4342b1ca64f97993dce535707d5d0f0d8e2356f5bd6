...
//#region lib/utils/html-comments.js
var require_html_comments = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	/**
	...
	function defineParser(sourceCode, config) {
		...
		*/
		return function parseHTMLComment(node) {
			...
			* @returns {any}
			*/
			const createToken = (type, value$1) => {
				/** @type {Range} */
				const range = [tokenIndex, tokenIndex + value$1.length];
				tokenIndex = range[1];
				/** @type {SourceLocation} */
				let loc;
				return {
