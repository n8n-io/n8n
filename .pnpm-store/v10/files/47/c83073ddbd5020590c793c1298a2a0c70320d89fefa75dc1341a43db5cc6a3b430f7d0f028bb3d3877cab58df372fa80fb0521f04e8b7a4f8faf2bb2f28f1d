...
const parseVectorIndex = (module) => {
    ...
    if (parsing_js_1.VectorIndexGuards.isDynamic(module.config)) {
        ...
        return Object.assign(Object.assign({}, conf), { hnsw: (0, exports.parseVectorIndex)({ name: 'hnsw', config: hnsw }), flat: (0, exports.parseVectorIndex)({ name: 'flat', config: flat }) });
    }
    let multivector;
...
const makeVectorsConfig = (configVectorizers) => {
    ...
    vectorizersConfig.forEach((v) => {
        ...
        vectorConfig.vectorizer[vectorizer] = Object.assign({ properties: v.properties }, (0, exports.parseVectorizerConfig)(v.vectorizer.config));
        if (v.name === undefined) {
