...
//#region lib/rules/component-definition-name-casing.js
/**
* @fileoverview enforce specific casing for component definition name
* @author Armano
*/
var require_component_definition_name_casing = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
		...
		create(context) {
			...
			*/
			function convertName(node) {
				...
				if (!casing.getChecker(caseType)(nodeValue)) context.report({
					node,
...
Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function () {
    return require_component_definition_name_casing();
  }
});