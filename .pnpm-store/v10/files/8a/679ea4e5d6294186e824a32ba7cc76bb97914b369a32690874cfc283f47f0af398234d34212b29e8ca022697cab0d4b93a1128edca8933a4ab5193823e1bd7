...
*/
var require_no_deprecated_model_definition = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	*/
	function findPropertyValue(node, key) {
		const property = node.properties.find((property$1) => property$1.type === "Property" && property$1.key.type === "Identifier" && property$1.key.name === key);
