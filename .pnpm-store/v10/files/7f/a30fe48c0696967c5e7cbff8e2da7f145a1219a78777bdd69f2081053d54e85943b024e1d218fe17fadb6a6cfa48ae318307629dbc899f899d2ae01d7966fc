...
require_rolldown_runtime.__export(stackexchange_exports, { StackExchangeAPI: () => StackExchangeAPI });
/**
* Class for interacting with the StackExchange API
* It extends the base Tool class to perform retrieval.
*/
var StackExchangeAPI = class extends __langchain_core_tools.Tool {
	name = "stackexchange";
