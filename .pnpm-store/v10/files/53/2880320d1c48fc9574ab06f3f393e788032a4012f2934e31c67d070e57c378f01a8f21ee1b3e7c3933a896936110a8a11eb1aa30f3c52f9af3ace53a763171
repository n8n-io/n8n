...
const require_lrucache$1 = require('../internal/lrucache.cjs');
const require_comparator$1 = require('./comparator.cjs');

//#region ../../node_modules/.pnpm/semver@7.7.2/node_modules/semver/classes/range.js
var require_range = /* @__PURE__ */ require_rolldown_runtime.__commonJS({ "../../node_modules/.pnpm/semver@7.7.2/node_modules/semver/classes/range.js": ((exports, module) => {
	...
	const LRU = require_lrucache$1.require_lrucache();
	const cache = new LRU();
	...
	const { safeRe: re, t, comparatorTrimReplace, tildeTrimReplace, caretTrimReplace } = require_re$1.require_re();
	const { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = require_constants$1.require_constants();
