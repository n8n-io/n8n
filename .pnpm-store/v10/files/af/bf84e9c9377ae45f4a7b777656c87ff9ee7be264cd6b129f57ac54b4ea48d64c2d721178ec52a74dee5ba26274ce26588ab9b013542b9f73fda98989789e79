...
var MenuSubContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		const parentContentContext = require_Menu_MenuContentImpl.injectMenuContentContext();
			...
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Presence_Presence.Presence_default), { present: _ctx.forceMount || (0, vue.unref)(menuContext).open.value }, {
				default: (0, vue.withCtx)(() => [(0, vue.createVNode)(require_Menu_MenuContentImpl.MenuContentImpl_default, (0, vue.mergeProps)((0, vue.unref)(forwarded), {
					...
					onFocusOutside: _cache[2] || (_cache[2] = (event) => {
						...
						const isMovingToParentContent = (0, vue.unref)(parentContentContext).filterElement.value?.contains(event.target);
						if (event.target !== (0, vue.unref)(menuSubContext).trigger.value && !isMovingToParentContent) (0, vue.unref)(menuContext).onOpenChange(false);
					}),
					...
					onKeydown: _cache[4] || (_cache[4] = (event) => {
						...
						if (isKeyDownInside && isCloseKey) {
							...
							if ((0, vue.unref)(parentContentContext).filterElement.value) {
								(0, vue.unref)(parentContentContext).filterElement.value.focus();
								(0, vue.unref)(parentContentContext).highlightedElement.value = (0, vue.unref)(menuSubContext).trigger.value;
								(0, vue.unref)(menuSubContext).trigger.value?.scrollIntoView({ block: "nearest" });
							} else (0, vue.unref)(menuSubContext).trigger.value?.focus();
							event.preventDefault();
						}
					})
				}), {
