...
var MenubarItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	__name: "MenubarItem",
	props: {
		disabled: {
			type: Boolean,
...
//#endregion
Object.defineProperty(exports, 'MenubarItem_default', {
  enumerable: true,
  get: function () {
    return MenubarItem_default;
  }
});
