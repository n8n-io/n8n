...
var hnswlib_exports = {};
__export(hnswlib_exports, { HNSWLib: () => HNSWLib });
/**
...
*/
var HNSWLib = class HNSWLib extends SaveableVectorStore {
	_index;
	docstore;
	args;
	_vectorstoreType() {
	...
	*/
	static async load(directory, embeddings) {
		...
		args.docstore = new in_memory_exports.SynchronousInMemoryDocstore(new Map(docstoreFiles));
		args.index = index;
...
//#endregion
export { HNSWLib, hnswlib_exports };
