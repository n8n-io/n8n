import { GeminiAPIConfig, GenerateContentResponseData, GoogleAIAPI, GoogleAIModelParams, GoogleAISafetyHandler, GoogleLLMResponse, GoogleSpeechConfig, GoogleSpeechConfigSimplified } from "../types.js";
