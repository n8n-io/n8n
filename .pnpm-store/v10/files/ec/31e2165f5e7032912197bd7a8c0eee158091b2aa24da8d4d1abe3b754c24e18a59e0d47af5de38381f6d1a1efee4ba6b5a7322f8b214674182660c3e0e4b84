...
__export(fireworks_exports, { FireworksEmbeddings: () => FireworksEmbeddings });
/**
* A class for generating embeddings using the Fireworks AI API.
*/
var FireworksEmbeddings = class extends Embeddings {
...
//#endregion
export { FireworksEmbeddings, fireworks_exports };
