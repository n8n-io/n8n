...
require_rolldown_runtime.__export(typesense_exports, { Typesense: () => Typesense });
/**
* Typesense vector store.
*/
var Typesense = class Typesense extends __langchain_core_vectorstores.VectorStore {
	client;
	schemaName;
	searchParams;
	vectorColumnName;
	...
	constructor(embeddings, config) {
		...
		this.caller = new __langchain_core_utils_async_caller.AsyncCaller(config);
	}
	/**
...
Object.defineProperty(exports, 'typesense_exports', {
  enumerable: true,
  get: function () {
    return typesense_exports;
  }
});
//# sourceMappingURL=typesense.cjs.map