...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.AgentsApiV1AgentsCreateOrUpdateAliasRequest$outboundSchema
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/agents/{agent_id}/aliases")(pathParams);
