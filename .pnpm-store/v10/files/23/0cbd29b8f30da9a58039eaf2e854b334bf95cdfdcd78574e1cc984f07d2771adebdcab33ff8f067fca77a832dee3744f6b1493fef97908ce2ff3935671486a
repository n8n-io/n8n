...
class Data extends Collection_1.Collection {
     ...
     * ```
     */
    _insert(data, upsert = false, enable_cache = true) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const allowInsertAutoId = (_a = collectionInfo.properties.find(p => p.key === 'allow_insert_auto_id')) === null || _a === void 0 ? void 0 : _a.value;
            ...
            const fieldMap = new Map(collectionInfo.schema.fields.reduce((acc, v) => {
                ...
                if (v.is_function_output) {
                    ...
                    const field = {
                        name: v.name,
                        type: (0, __1.convertToDataType)(v.data_type),
                        elementType: (0, __1.convertToDataType)(v.element_type),
                        dim: Number(v.dim),
                        data: [],
                        nullable: v.nullable,
                    ...
                    if ((0, __1.convertToDataType)(v.data_type) === __1.DataType.Array &&
                        (0, __1.convertToDataType)(v.element_type) === __1.DataType.Struct &&
                        v.fields) {
                        // build struct field map
                        field.fieldMap = new Map(v.fields.map(field => [
                            field.name,
                            {
                                name: field.name,
                                type: (0, __1.isVectorType)((0, __1.convertToDataType)(field.data_type))
                                    ? 106
                                    : __1.DataType.Array,
                                elementType: (0, __1.convertToDataType)(field.data_type),
            ...
            if (isDynamic) {
                fieldMap.set(__1.DEFAULT_DYNAMIC_FIELD, {
                    ...
                    type: __1.DataType.JSON,
                    elementType: __1.DataType.None,
                    data: [],
                    nullable: false,
                    fieldMap: new Map(),
                });
            ...
            const isPartialUpdate = 'partial_update' in data && data.partial_update === true;
            const originalRowKeys = new Set();
            ...
            data.fields_data.forEach((rowData, rowIndex) => {
                ...
                fieldNames.forEach(name => {
                    ...
                    if (field.type === __1.DataType.BinaryVector &&
            ...
            const params = Object.assign(Object.assign(Object.assign({}, data), { num_rows: data.fields_data.length, schema_timestamp: collectionInfo.update_timestamp_str ||
                    collectionInfo.update_timestamp }), (upsert && data.partial_update
                ? { partial_update: true }
                : {}));
            ...
            params.fields_data = buildColumnData(fieldMap).filter(f => {
                ...
                if (isPartialUpdate) {
                    return (originalRowKeys.has(f.field_name) ||
                        f.field_name === __1.DEFAULT_DYNAMIC_FIELD);
                }
                return true;
            });
            ...
            if (promise.status.error_code === __1.ErrorCode.SchemaMismatch && enable_cache) {
                // redo the insert request with collection cache off
                promise = yield this._insert(data, upsert, false);
            }
            return promise;
        });
    }
    ...
    queryIterator(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // if limit not set, set it to count
            if (!queryData.limit || queryData.limit === __1.NO_LIMIT) {
            ...
            const batchSize = queryData.batchSize > __1.DEFAULT_MAX_SEARCH_SIZE
                    ...
                    return {
                        ...
                        next() {
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                queryData.expr = (0, __1.getQueryIteratorExpr)({
                                    expr: expr,
                                    pkField,
                                    lastPKId,
                                });
                                // search data
                                const res = yield client.query(queryData);
    ...
    flushAll(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield (0, __1.promisify)(this.channelPool, 'FlushAll', data || {}, (data === null || data === void 0 ? void 0 : data.timeout) || this.timeout);
            return res;
        });
    }
    /**
    ...
    flushAllSync(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.flushAll(data);
            let isFlushed = false;
            let flushRes = null;
            while (!isFlushed) {
                flushRes = yield this.getFlushAllState({
                    flush_all_ts: res.flush_all_ts,
                    flush_all_tss: res.flush_all_tss,
                    timeout: data === null || data === void 0 ? void 0 : data.timeout,
                });
                if (flushRes.status.error_code !== __1.ErrorCode.SUCCESS) {
     ...
     * ```
     */
    getFlushAllState(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!data || (!data.flush_all_ts && !data.flush_all_tss)) {
                throw new Error(__1.ERROR_REASONS.GET_FLUSH_ALL_STATE_CHECK_PARAMS);
            }
            const res = yield (0, __1.promisify)(this.channelPool, 'GetFlushAllState', data, data.timeout || this.timeout);
            return res;
        });
    }
    /**
    ...
    getImportState(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield (0, __1.promisify)(this.channelPool, 'GetImportState', data, data.timeout || this.timeout);
            return res;
        });
    }
}
