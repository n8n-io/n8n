...
var serpapi_exports = {};
require_rolldown_runtime.__export(serpapi_exports, { SerpAPILoader: () => SerpAPILoader });
/**
...
* ```
*/
var SerpAPILoader = class extends __langchain_core_document_loaders_base.BaseDocumentLoader {
	apiKey;
	searchQuery;
	constructor(params) {
		super();
		const { apiKey = (0, __langchain_core_utils_env.getEnvironmentVariable)("SERPAPI_API_KEY"), q } = params;
