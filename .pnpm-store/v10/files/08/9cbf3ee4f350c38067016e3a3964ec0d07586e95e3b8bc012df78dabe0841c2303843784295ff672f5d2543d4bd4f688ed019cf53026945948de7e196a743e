...
//#region src/vectorstores/zep.d.ts
 ...
 */
declare class ZepVectorStore extends VectorStore {
  client: ZepClient;
  collection: DocumentCollection;
  private initPromise;
  private autoEmbed;
...
//#endregion
export { IZepArgs, IZepConfig, IZepDeleteParams, ZepVectorStore };
