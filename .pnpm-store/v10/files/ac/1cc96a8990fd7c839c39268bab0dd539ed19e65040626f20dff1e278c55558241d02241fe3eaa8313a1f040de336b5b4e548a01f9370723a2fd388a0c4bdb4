...
const geographyPoint_js_1 = tslib_1.__importDefault(require("./geographyPoint.js"));
...
function serialize(obj) {
    return (0, walk_js_1.walk)(obj, serializeValue);
}
function deserialize(obj) {
    return (0, walk_js_1.walk)(obj, deserializeValue);
}
...
function serializeGeoPoint(input) {
    return input instanceof geographyPoint_js_1.default ? input.toJSON() : input;
}
...
function deserializeGeoPoint(input) {
    if (isGeoJSONPoint(input)) {
        ...
        return new geographyPoint_js_1.default({ longitude, latitude });
    }
    return input;
}
