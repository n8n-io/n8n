...
__export(hanavector_exports, { HanaDB: () => HanaDB });
...
var HanaDB = class HanaDB extends VectorStore {
	connection;
	distanceStrategy;
...
//#endregion
export { HanaDB, hanavector_exports };
//# sourceMappingURL=hanavector.js.map