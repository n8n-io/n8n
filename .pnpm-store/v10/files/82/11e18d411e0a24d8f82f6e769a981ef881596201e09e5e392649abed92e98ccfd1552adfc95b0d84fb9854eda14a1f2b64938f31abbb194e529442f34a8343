...
export type RetryMiddlewareProps = {
    enableRetry: boolean;
 ...
 * @return {Number}
 */
export declare const calculateExponentialRetryTime: (retryTime: number, retryConfigs: Pick<RetryMiddlewareOptions, 'factor' | 'multiplier' | 'maxRetryTimeInSecs'>) => number;
