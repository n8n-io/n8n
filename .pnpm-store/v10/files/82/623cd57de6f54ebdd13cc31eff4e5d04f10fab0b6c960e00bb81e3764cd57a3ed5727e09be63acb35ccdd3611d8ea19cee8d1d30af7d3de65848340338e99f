...
declare const configs: {
    ...
    'stage-0': import("./types.js").PluginConfig;
    react: {
        settings: {
    ...
    'flat/warnings': Linter.Config<{
        'import-x/no-named-as-default': 1;
        'import-x/no-named-as-default-member': 1;
        'import-x/no-rename-default': 1;
        'import-x/no-duplicates': 1;
    }>;
    'flat/stage-0': Linter.Config<{
        'import-x/no-deprecated': 1;
    }>;
    'flat/react': Linter.Config<{}>;
    'flat/react-native': Linter.Config<{}>;
    'flat/electron': Linter.Config<{}>;
    'flat/typescript': Linter.Config<{
        'import-x/named': "off";
    }>;
};
declare const plugin: typeof plugin_ & ESLint.Plugin & {
