...
*/
var require_no_child_content = /* @__PURE__ */ require_rolldown_runtime.__commonJSMin(((exports, module) => {
	...
	module.exports = {
		...
		create(context) {
			...
			return defineTemplateBodyVisitor(context, { "VAttribute[directive=true]"(directiveNode) {
				...
				if (elementNode.endTag === null) return;
				...
				if (directives.has(directiveName) && childNodes.some((childNode) => !isWhiteSpaceTextNode(childNode))) context.report({
					node: elementNode,
