...
var tigris_exports = {};
__export(tigris_exports, { TigrisVectorStore: () => TigrisVectorStore });
/**
...
*/
var TigrisVectorStore = class TigrisVectorStore extends VectorStore {
	index;
	_vectorstoreType() {
		return "tigris";
	}
	...
	*/
	async similaritySearchVectorWithScore(query, k, filter) {
		...
		if (!result) return [];
		return result.map(([document, score]) => [new Document({
...
//#endregion
export { TigrisVectorStore, tigris_exports };
//# sourceMappingURL=tigris.js.map