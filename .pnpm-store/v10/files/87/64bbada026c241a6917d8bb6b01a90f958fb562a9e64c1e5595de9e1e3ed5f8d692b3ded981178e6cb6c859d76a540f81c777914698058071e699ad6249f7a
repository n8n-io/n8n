...
const __mlc_ai_web_llm = require_rolldown_runtime.__toESM(require("@mlc-ai/web-llm"));

//#region src/chat_models/webllm.ts
var webllm_exports = {};
require_rolldown_runtime.__export(webllm_exports, { ChatWebLLM: () => ChatWebLLM });
/**
...
* ```
*/
var ChatWebLLM = class extends __langchain_core_language_models_chat_models.SimpleChatModel {
	static inputs;
	engine;
	appConfig;
	chatOptions;
	...
	constructor(inputs) {
		...
		this.engine = new __mlc_ai_web_llm.MLCEngine({ appConfig: this.appConfig });
	}
	_llmType() {
		return "web-llm";
	}
