	...
	*/
	getExtendedChannelSchemas(schema, effects) {
		...
		if (effects.withReducerSchema || effects.withJsonSchemaExtrasAsDescription) {
			...
			modifiedSchema = (0, _langchain_core_utils_types.extendInteropZodObject)(schema, Object.fromEntries(newShapeEntries));
			if ((0, _langchain_core_utils_types.isZodSchemaV3)(modifiedSchema)) modifiedSchema._def.unknownKeys = "strip";
		}
		if (effects.asPartial) modifiedSchema = (0, _langchain_core_utils_types.interopZodObjectPartial)(modifiedSchema);
