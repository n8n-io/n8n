...
const searchClient_js_1 = require("./generated/data/searchClient.js");
const indexDocumentsBatch_js_1 = require("./indexDocumentsBatch.js");
...
class SearchClient {
    ...
    constructor(endpoint, indexName, credential, options = {}) {
        ...
        this.client = new searchClient_js_1.SearchClient(this.endpoint, this.indexName, this.serviceVersion, internalClientPipelineOptions);
        ...
        this.client.pipeline.addPolicy((0, odataMetadataPolicy_js_1.createOdataMetadataPolicy)("none"));
    }
    /**
    ...
    async getDocumentsCount(options = {}) {
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-getDocumentsCount", options);
        try {
    ...
    async autocomplete(searchText, suggesterName, options = {}) {
        ...
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-autocomplete", options);
        try {
    ...
    async searchDocuments(searchText, options = {}, nextPageParameters = {}) {
        ...
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-searchDocuments", options);
        try {
            ...
            return (0, serialization_js_1.deserialize)(converted);
        }
        catch (e) {
            span.setStatus({
                status: "error",
    ...
    async search(searchText, options) {
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-search", options);
        try {
    ...
    async suggest(searchText, suggesterName, options = {}) {
        ...
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-suggest", options);
        try {
            ...
            return (0, serialization_js_1.deserialize)(modifiedResult);
        }
        catch (e) {
            span.setStatus({
                status: "error",
    ...
    async getDocument(key, options = {}) {
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-getDocument", options);
        try {
            const result = await this.client.documents.get(key, {
                ...updatedOptions,
                selectedFields: updatedOptions.selectedFields,
            });
            return (0, serialization_js_1.deserialize)(result);
        }
        catch (e) {
            span.setStatus({
                status: "error",
    ...
    batch, options = {}) {
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-indexDocuments", options);
        try {
            let status = 0;
            const result = await this.client.documents.index({ actions: (0, serialization_js_1.serialize)(batch.actions) }, {
                ...updatedOptions,
                onResponse: (rawResponse, flatResponse) => {
    ...
    async uploadDocuments(documents, options = {}) {
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-uploadDocuments", options);
        const batch = new indexDocumentsBatch_js_1.IndexDocumentsBatch();
    ...
    async mergeDocuments(documents, options = {}) {
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-mergeDocuments", options);
        const batch = new indexDocumentsBatch_js_1.IndexDocumentsBatch();
    ...
    async deleteDocuments(keyNameOrDocuments, keyValuesOrOptions, options = {}) {
        const { span, updatedOptions } = (0, tracing_js_1.createSpan)("SearchClient-deleteDocuments", options);
        const batch = new indexDocumentsBatch_js_1.IndexDocumentsBatch();
    ...
    encodeContinuationToken(nextLink, nextPageParameters) {
        ...
        return (0, base64_js_1.encode)(payload);
    }
    decodeContinuationToken(token) {
        if (!token) {
            return undefined;
        }
        const decodedToken = (0, base64_js_1.decode)(token);
        try {
