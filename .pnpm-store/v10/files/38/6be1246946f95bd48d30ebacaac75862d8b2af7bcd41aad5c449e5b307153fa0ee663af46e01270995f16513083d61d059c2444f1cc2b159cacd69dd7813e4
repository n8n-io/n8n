...
var text_exports = {};
require_rolldown_runtime.__export(text_exports, { TextLoader: () => TextLoader });
/**
...
* ```
*/
var TextLoader = class TextLoader extends __langchain_core_document_loaders_base.BaseDocumentLoader {
