...
const __1 = require("../");
const milvus_base_1 = __importDefault(require("../proto-json/milvus.base"));
const schema_base_1 = __importDefault(require("../proto-json/schema.base"));
/**
...
class BaseClient {
    ...
    constructor(configOrAddress, ssl, username, password, channelOptions) {
        ...
        this.schemaProto = protobufjs_1.default.Root.fromJSON(schema_base_1.default);
        this.milvusProto = protobufjs_1.default.Root.fromJSON(milvus_base_1.default);
        // options
        ...
        this.tlsMode =
            this.config.tls &&
                ...
                : this.tlsMode;
        this.tlsMode = ((_b = this.config.tls) === null || _b === void 0 ? void 0 : _b.skipCertCheck)
            ? __1.TLS_MODE.UNAUTHORIZED
            : this.tlsMode;
