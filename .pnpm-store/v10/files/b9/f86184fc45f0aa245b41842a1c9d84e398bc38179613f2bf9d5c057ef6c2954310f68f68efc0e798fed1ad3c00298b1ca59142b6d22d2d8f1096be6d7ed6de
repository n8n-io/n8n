...
declare const components: {
  ...
  autocomplete: readonly ["AutocompleteRoot", "AutocompleteInput", "AutocompleteAnchor", "AutocompleteEmpty", "AutocompleteTrigger", "AutocompleteCancel", "AutocompleteGroup", "AutocompleteLabel", "AutocompleteContent", "AutocompleteViewport", "AutocompleteVirtualizer", "AutocompleteItem", "AutocompleteItemIndicator", "AutocompleteSeparator", "AutocompleteArrow", "AutocompletePortal"];
  ...
  colorArea: readonly ["ColorAreaRoot", "ColorAreaArea", "ColorAreaThumb"];
  colorField: readonly ["ColorFieldRoot", "ColorFieldInput"];
  colorSlider: readonly ["ColorSliderRoot", "ColorSliderTrack", "ColorSliderThumb"];
  colorSwatch: readonly ["ColorSwatch"];
  colorSwatchPicker: readonly ["ColorSwatchPickerRoot", "ColorSwatchPickerItem", "ColorSwatchPickerItemSwatch", "ColorSwatchPickerItemIndicator"];
  ...
  monthPicker: readonly ["MonthPickerRoot", "MonthPickerHeader", "MonthPickerHeading", "MonthPickerGrid", "MonthPickerCell", "MonthPickerNext", "MonthPickerPrev", "MonthPickerGridBody", "MonthPickerGridRow", "MonthPickerCellTrigger"];
  monthRangePicker: readonly ["MonthRangePickerRoot", "MonthRangePickerHeader", "MonthRangePickerHeading", "MonthRangePickerGrid", "MonthRangePickerCell", "MonthRangePickerNext", "MonthRangePickerPrev", "MonthRangePickerGridBody", "MonthRangePickerGridRow", "MonthRangePickerCellTrigger"];
  ...
  timeRangeField: readonly ["TimeRangeFieldRoot", "TimeRangeFieldInput"];
  ...
  yearPicker: readonly ["YearPickerRoot", "YearPickerHeader", "YearPickerHeading", "YearPickerGrid", "YearPickerCell", "YearPickerNext", "YearPickerPrev", "YearPickerGridBody", "YearPickerGridRow", "YearPickerCellTrigger"];
  yearRangePicker: readonly ["YearRangePickerRoot", "YearRangePickerHeader", "YearRangePickerHeading", "YearRangePickerGrid", "YearRangePickerCell", "YearRangePickerNext", "YearRangePickerPrev", "YearRangePickerGridBody", "YearRangePickerGridRow", "YearRangePickerCellTrigger"];
