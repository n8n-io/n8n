...
declare const DescribeAppCommand_base: {
    new (input: DescribeAppCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAppCommandInput, DescribeAppCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeAppCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAppCommandInput, DescribeAppCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
