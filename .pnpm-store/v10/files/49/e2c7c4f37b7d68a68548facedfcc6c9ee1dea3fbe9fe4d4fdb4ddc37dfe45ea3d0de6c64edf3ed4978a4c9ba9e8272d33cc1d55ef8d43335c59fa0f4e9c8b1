...
var X = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), ge = (t, e) => {
  for (var o in e)
...
var J = (t, e, o) => (o = t != null ? ie(le(t)) : {}, z(
  ...
  t
)), be = (t) => z(y({}, "__esModule", { value: !0 }), t);

// ../node_modules/picocolors/picocolors.js
var ee = X((Re, f) => {
  var Q = process.argv || [], E = process.env, de = !("NO_COLOR" in E || Q.includes("--no-color")) && ("FORCE_COLOR" in E || Q.includes("--c\
olor") || process.platform === "win32" || require != null && require("tty").isatty(1) && E.TERM !== "dumb" || "CI" in E), pe = /* @__PURE__ */ s(
  (t, e, o = t) => (n) => {
...
ge(he, {
  ...
  GenerateNewProjectOnInitError: () => j,
  ...
  SavingGlobalSettingsFileError: () => H,
  UpgradeStorybookInWrongWorkingDirectory: () => G,
  UpgradeStorybookToLowerVersionError: () => F,
...
var a = class t extends Error {
  ...
  static getFullMessage({
    ...
    let g;
    return o === !0 ? g = `https://storybook.js.org/error/${re({ code: n, category: c })}` : typeof o == "string" ? g = o : Array.isArray(o) &&
    (g = `
${o.map((m) => `	- ${m}`).join(`
`)}`), `${u}${g != null ? `
...
WEB-COMPONENTS-WEBPACK5", r))(ne || {}), k = class extends a {
  static {
