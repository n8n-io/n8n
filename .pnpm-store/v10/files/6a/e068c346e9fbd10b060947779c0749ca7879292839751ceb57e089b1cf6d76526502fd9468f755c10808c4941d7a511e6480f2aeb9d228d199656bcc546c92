...
require_rolldown_runtime.__export(motorhead_memory_exports, { MotorheadMemory: () => MotorheadMemory });
...
var MotorheadMemory = class extends require_memory_chat_memory.chat_memory_exports.BaseChatMemory {
	...
	*/
	async loadMemoryVariables(_values) {
		...
		const result = { [this.memoryKey]: (0, __langchain_core_messages.getBufferString)(messages) };
		return result;
	}
	/**
