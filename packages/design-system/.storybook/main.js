...
module.exports = {
	stories: [
		...
		'../src/components/N8nCheckbox/*.stories.@(js|jsx|ts|tsx)',
		'../src/components/N8nColorPicker/*.stories.@(js|jsx|ts|tsx)',
		...
		'../src/components/N8nUserSelect/*.stories.@(js|jsx|ts|tsx)',
		'../src/components/N8nUsersList/*.stories.@(js|jsx|ts|tsx)',
		'../src/components/N8nResizeWrapper/*.stories.@(js|jsx|ts|tsx)',
		'../src/components/N8nRecycleScroller/*.stories.@(js|jsx|ts|tsx)',
	],
	addons: [
