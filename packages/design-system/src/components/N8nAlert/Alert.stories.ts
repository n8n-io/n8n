...
const Template: StoryFn = (args, { argTypes }) => ({
	...
	template:
		'<div style="position: relative; width: 100%; height: 300px;"><n8n-alert v-bind="$attrs"><template #aside>custom content slot</template></n8n-alert></div>',
});
