		...
		const tests: Array<{
					...
					[node1.name]: {
						[NodeConnectionTypes.Main]: [
							[
								...
								{ node: node3.name, type: NodeConnectionTypes.Main, index: 1 },
							],
						],
					},
				},
				...
				connections: {
					[node1.name]: {
						...
						[NodeConnectionTypes.AiAgent]: [
							[{ node: node3.name, type: NodeConnectionTypes.AiAgent, index: 0 }],
						],
					},
				},
				connectionsByDestinationNode: {
					...
					[node3.name]: {
						[NodeConnectionTypes.AiAgent]: [
							[{ node: node1.name, type: NodeConnectionTypes.AiAgent, index: 0 }],
						],
					},
				},
			},
			{
				...
				connectionsByDestinationNode: {
					[node2.name]: {
						[NodeConnectionTypes.Main]: [
							[{ node: node1.name, type: NodeConnectionTypes.Main, index: 1 }],
						],
					},
				},
			},
				...
				connectionsByDestinationNode: {
					[node2.name]: {
						[NodeConnectionTypes.Main]: [
							[
								{ node: node1.name, type: NodeConnectionTypes.Main, index: 0 },
								{ node: node3.name, type: NodeConnectionTypes.Main, index: 0 },
							],
						],
					},
				},
			},
			{
				...
				connections: {
					[node1.name]: {
						[NodeConnectionTypes.Main]: [
							[{ node: 'Ghost node', type: NodeConnectionTypes.Main, index: 0 }],
						],
					},
				},
