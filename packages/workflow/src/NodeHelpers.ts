 ...
 * @returns
 */
export function getSpecialNodeParameters(nodeType: INodeType): object[] {
 ...
 *
 * @export
 * @param {INodeParameters} nodeValues The data on the node which decides if the parameter should be displayed
