...
export const ALIBABA_CLOUD_MODEL_STUDIO_LANGCHAIN_NODE_TYPE =
	'@n8n/n8n-nodes-langchain.alibabaCloudModelStudio';
...
export const AI_VENDOR_NODE_TYPES = [
	...
	ALIBABA_CLOUD_MODEL_STUDIO_LANGCHAIN_NODE_TYPE,
];
