...
export interface ResourceMapperTypeOptionsBase {
	...
	// When true, the cached schema is refreshed against the source when the
	// node is opened, instead of only flagging it as stale. Use for sources
	// where the schema commonly drifts from what the workflow has cached
	// (e.g. n8n Data Tables generated by MCP).
