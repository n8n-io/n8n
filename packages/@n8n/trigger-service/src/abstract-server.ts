...
import { ServiceUnavailableError } from './stubs/errors.stub';
...
export abstract class AbstractServer {
	...
	constructor() {
		...
		// TODO(CLEANUP): Handlebars setup removed - may need to be added back if form triggers are needed
	...
	private setupDevMiddlewares() {
		// TODO(CLEANUP): CORS middleware removed - may need to be added back
	...
	async start(): Promise<void> {
		...
		if (!inTest) {
			// TODO(CLEANUP): Version logging removed
			...
			await this.externalHooks.run('n8n.ready', [this]);
		}
	}
