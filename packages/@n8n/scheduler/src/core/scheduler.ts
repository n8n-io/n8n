...
export interface SchedulerPasses {
	...
	/**
	 * One owner reconciliation pass: quarantine the jobs of owners reported
	 * gone, delete those quarantined past their grace, revive the rest. A no-op
	 * summary when the scheduler was composed without reconciliation.
	 */
