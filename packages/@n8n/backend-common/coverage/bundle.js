...
*/ var r = Object.getOwnPropertySymbols,
			...
			return (
				...
				a.createElement(
					...
					a.createElement(
						'div',
						{ className: 'layout__section' },
						a.createElement('h1', null, a.createElement(m, { fileFilter: I, setFileFilter: M })),
					),
					a.createElement(
						'div',
					...
					a.createElement(
						...
						a.createElement(
							'a',
							{ href: 'https://istanbul.js.org/', target: '_blank', rel: 'noopener noreferrer' },
							'istanbul',
						),
						' ',
						'at ',
	...
	function (e, t, n) {
		...
		function L(e, t, n, r, l) {
			var i = '';
			null != n && (i = ('' + n).replace(N, '$&/') + '/'), I(e, j, (t = F(t, i, r, l))), z(t);
		}
		var D = { current: null };
		function A() {
			var e = D.current;
	...
	function (e, t, n) {
		...
		function G(e, t, n, r) {
			...
			(null !== l
				...
				r || null === l
					? (function (e) {
							return (
								!!Q.call(B, e) || (!Q.call($, e) && (W.test(e) ? (B[e] = !0) : (($[e] = !0), !1)))
							);
		...
		function Pn(e) {
			return !(e = e[Sn] || e[Cn]) || (5 !== e.tag && 6 !== e.tag && 13 !== e.tag && 3 !== e.tag)
				? null
				: e;
		}
		function Nn(e) {
						...
						i
							? (er &&
									...
									(ar || i !== nr.compositionStart
										...
										: ((An = 'value' in (Dn = r) ? Dn.value : Dn.textContent), (ar = !0))),
		...
		function fr(e, t, n) {
			return ((e = $n.getPooled(sr.change, e, t, n)).type = 'change'), z(n), Ln(e), e;
		}
		var dr = null,
			pr = null;
		function mr(e) {
		...
		var Nr = 0,
			...
			Ir = Tr.extend({
				...
				movementX: function (e) {
					...
					var t = Nr;
					return (
						(Nr = e.screenX), Fr ? ('mousemove' === e.type ? e.screenX - t : 0) : ((Fr = !0), 0)
					);
				},
				movementY: function (e) {
					...
					var t = Or;
					return (
						(Or = e.screenY), zr ? ('mousemove' === e.type ? e.screenY - t : 0) : ((zr = !0), 0)
					);
				},
			}),
			Mr = Ir.extend({
		...
		function vi(e, t, n, r, l, i, a) {
			return 'function' == typeof (e = e.stateNode).shouldComponentUpdate
				...
				: !t.prototype || !t.prototype.isPureReactComponent || !Ar(n, r) || !Ar(l, i);
		}
		function yi(e, t, n) {
			var r = !1,
				l = sl,
			...
			function d(e, t, n) {
				...
				if ('object' == typeof t && null !== t) {
					switch (t.$$typeof) {
						case ee:
							return (
								((n = _u(t.type, t.key, t.props, null, e.mode, n)).ref = Ei(e, null, t)),
								(n.return = e),
								n
							);
						case te:
						...
						case ee:
							e: {
								...
								i.type === ne
									...
									: (((u = _u(i.type, i.key, i.props, null, e.mode, u)).ref = Ei(e, r, i)),
										(u.return = e),
										(e = u));
							}
							return o(e);
		...
		function Ki(e, t, n, r, l, i) {
			if (
				...
				do {
					...
					(i += 1), (Qi = Wi = null), (t.updateQueue = null), (Di.current = ga), (e = n(r, l));
				...
				if (t) {
					...
					if (!xa(e, t)) {
						if (!(t = En(n.nextSibling)) || !xa(e, t))
							return (e.effectTag = (-1025 & e.effectTag) | 2), (Ea = !1), void (ba = e);
						ka(ba, n);
					}
		...
		function za(e, t, n, r, l, i) {
			...
			return (
				(a = e.child),
				l < i &&
				((l = a.memoizedProps), (n = null !== (n = n.compare) ? n : Ar)(l, r) && e.ref === t.ref)
					? Ka(e, t, i)
					: ((t.effectTag |= 1), ((e = Cu(a, r)).ref = t.ref), (e.return = t), (t.child = e))
			);
		}
		function Ia(e, t, n, r, l, i) {
			return null !== e && Ar(e.memoizedProps, r) && e.ref === t.ref && ((Na = !1), l < i)
				...
				switch (l) {
					case 'forwards':
						for (n = t.child, l = null; null !== n; )
							null !== (e = n.alternate) && null === ji(e) && (l = n), (n = n.sibling);
						null === (n = l)
			...
			switch (n.tag) {
				...
				case 13:
					return void (
						...
						((n = n.alternate),
						null !== n &&
							((n = n.memoizedState), null !== n && ((n = n.dehydrated), null !== n && jt(n))))
					);
				case 19:
				case 17:
				case 20:
		...
		function so(e, t) {
			switch (t.tag) {
				...
				case 13:
					if (
						((n = t),
						null === t.memoizedState ? (r = !1) : ((r = !0), (n = t.child), (Mo = Al())),
						null !== n)
					)
						e: for (e = n; ; ) {
							if (5 === e.tag)
				...
				if (0 === t)
					...
					(e.callbackExpirationTime = t),
						...
						(t =
							1073741823 === t
								? $l(Zo.bind(null, e))
								: Ql(r, Jo.bind(null, e), { timeout: 10 * (1073741821 - t) - Al() })),
						(e.callbackNode = t);
				}
			}
		}
								...
								if (1073741823 !== No && null !== Fo) {
									...
									if (
										(0 >= (r = 0 | o.busyMinDurationMs)
											...
											: ((l = 0 | o.busyDelayMs),
												(r =
													(i = Al() - (10 * (1073741821 - i) - (0 | o.timeoutMs || 5e3))) <= l
														? 0
														: l + r - i)),
										10 < r)
									) {
		...
		function ru(e, t) {
			for (;;) {
				try {
					...
					if (((Ui = 0), (Qi = Wi = Vi = null), ($i = !1), null === To || null === To.return))
				...
				if (
					...
					null !== u &&
						...
						'selectionStart' in w
							...
							: (k = ((E = w.ownerDocument || document) && E.defaultView) || window).getSelection &&
								((k = k.getSelection()),
				...
				for (var n = e.return; null !== n; ) {
					...
					if (1 === n.tag) {
						...
						if (
							...
							('function' == typeof r.componentDidCatch && (null === Do || !Do.has(r)))
						) {
							...
							case 13:
								if (null !== t.memoizedState)
									return 0 !== (r = t.child.childExpirationTime) && r >= n
										? Qa(e, t, n)
										: (cl(Ri, 1 & Ri.current), null !== (t = Ka(e, t, n)) ? t.sibling : null);
								cl(Ri, 1 & Ri.current);
								break;
							case 19:
					...
					if (
						...
						if (
							((l = t.stateNode.hydrate) &&
								((wa = En(t.stateNode.containerInfo.firstChild)), (ba = t), (l = Ea = !0)),
							l)
						)
		...
		function _u(e, t, n, r, l, i) {
			...
			if (((r = e), 'function' == typeof e)) Tu(e) && (o = 1);
				...
				e: switch (e) {
					...
					case le:
						return (
							((e = Su(12, n, t, 8 | l)).elementType = le), (e.type = le), (e.expirationTime = i), e
						);
					case ce:
						return (
							((e = Su(13, n, t, l)).type = ce), (e.elementType = ce), (e.expirationTime = i), e
						);
					case se:
	...
	function (e, t, n) {
		...
		function A(e, n) {
			...
			var r = I;
			try {
				for (L(n), z = C(N); null !== z && (!(z.expirationTime > n) || (e && !a())); ) {
					var o = z.callback;
					if (null !== o) {
	...
	function (e, t, n) {
		...
		function o(e) {
			...
			return r.createElement(
				r.Fragment,
				null,
				r.createElement(i, { name: '%', onSort: n, sortKey: t + '.pct', activeSort: l }),
				r.createElement('th', { className: 'headercell' }),
				r.createElement(i, { name: 'Covered', onSort: n, sortKey: t + '.covered', activeSort: l }),
				r.createElement(i, { name: 'Missed', onSort: n, sortKey: t + '.missed', activeSort: l }),
				r.createElement(i, { name: 'Total', onSort: n, sortKey: t + '.total', activeSort: l }),
			);
		}
		e.exports = function (e) {
			...
			return r.createElement(
				...
				r.createElement(
					...
					l.statements &&
						r.createElement(o, { sortKeyPrefix: 'statements', onSort: t, activeSort: n }),
					l.branches && r.createElement(o, { sortKeyPrefix: 'branches', onSort: t, activeSort: n }),
					l.functions &&
						r.createElement(o, { sortKeyPrefix: 'functions', onSort: t, activeSort: n }),
					l.lines && r.createElement(o, { sortKeyPrefix: 'lines', onSort: t, activeSort: n }),
				),
			);
		};
	},
	...
	function (e, t, n) {
		...
		e.exports = function (e) {
			...
			return r.createElement(
				'div',
				{ className: 'toolbar' },
				n.statements && r.createElement(i, { data: t.statements, name: 'Statements' }),
				n.branches && r.createElement(i, { data: t.branches, name: 'Branches' }),
				n.functions && r.createElement(i, { data: t.functions, name: 'Functions' }),
				...
				r &&
					(u = (function e(t, n) {
						for (var r = [], l = 0; l < t.length; l++) {
							var a = t[l];
							a.children
								? (r = [].concat(i(r), i(e(a.children, (n ? n + '/' : '') + a.file))))
								: r.push(f(a, n));
						}
						return r;
					})(u.slice(0))),
						...
						for (var l = [], a = 0; a < t.length; a++) {
							...
							if (s) l = [].concat(i(l), i(e(o.children, n, u)));
								...
								var d = n.length - (r ? r.length : 0),
									p = o.file.slice(d);
								'/' === p[0] && (p = p.slice(1)), l.push(c(c({}, o), {}, { file: p }));
							}
						}
						return l;
					})(u, o)),
				...
				n &&
					(u = (function e(t, n) {
						...
						for (var a = 0; a < t.length; a++) {
							var o = t[a];
							o.children && (t[a] = c(c({}, o), {}, { children: e(o.children, n) }));
						}
						return t;
					})(u, n)),
				u
		...
		e.exports = function (e) {
			...
			return o.createElement(
				...
				o.createElement(
					'div',
					{ className: 'toggle__options' },
					o.createElement(u, { filter: 'low', activeFilters: t, setFilters: n }, 'Low'),
					o.createElement(u, { filter: 'medium', activeFilters: t, setFilters: n }, 'Medium'),
					o.createElement(u, { filter: 'high', activeFilters: t, setFilters: n }, 'High'),
				),
			);
		};
	},
