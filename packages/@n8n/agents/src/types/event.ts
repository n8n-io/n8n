import type { AgentMessage, ContentToolResult } from '../message';
...
// TODO: define more specific controls
export interface AgentEventControls {
	pause(params?: unknown): Promise<void>;
	abort(params?: unknown): Promise<void>;
}

export type AgentEventHandler = (data: AgentEventData, controls: AgentEventControls) => void;
