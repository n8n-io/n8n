...
export class AgentMessageList {
	 ...
	 * Prepends the system prompt, strips custom messages via filterLlmMessages.
	 */
	forLlm(systemInstruction: string): ModelMessage[] {
		return [
			{ role: 'system', content: systemInstruction },
			...toAiMessages(filterLlmMessages(this.all)),
		];
	}
