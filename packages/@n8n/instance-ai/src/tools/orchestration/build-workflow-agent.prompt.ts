...
9. **Publish** all sub-workflows and the main workflow via \`publish-workflow\` so they run on triggers in production.
10. **Report**: Call \`report-build-result\` with the final status and workflow ID.
