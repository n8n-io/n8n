...
const CUES: Array<{
	route: Exclude<IntentRoute, 'answer' | 'orchestrator'>;
	weight: number;
	pattern: RegExp;
}> = [
	{
	...
	},
	{
		route: 'agent.create',
		weight: 1,
		pattern: /\b(agent|bot|assistant|chatbot)\b[^.?!]{0,40}\b(that|which|who|to)\b/i,
	},
	{
		route: 'agent.edit',
		weight: 3,
	...
	},
	{
		route: 'workflow.create',
		weight: 2,
		pattern: /\b(POST|GET|PUT|PATCH|DELETE)\s+\/[a-z0-9_\-/]+/,
	},
	{
		route: 'workflow.edit',
		weight: 3,
