...
export const ASK_USER_FALLBACK =
	'Ask at most three questions per call, preferably one. Provide a concrete default answer for each question. Use the selected answer and continue the work. Do not split a questionnaire into consecutive calls unless the user explicitly requests an in-depth interview. ' +
