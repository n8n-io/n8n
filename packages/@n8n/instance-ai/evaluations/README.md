...
| `--source` | `disk` | Where test cases come from. `disk` (default) reads `data/workflows/`; `langtracer` pulls a suite from LangTracer over MCP — see [Sourcing from LangTracer](#sourcing-test-cases-from-langtracer) |
