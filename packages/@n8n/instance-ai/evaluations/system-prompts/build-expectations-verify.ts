...
2. **Conversation transcript**: the full multi-turn conversation, both sides, turn by turn. Each turn shows the user message, the agent's text, and compact summaries of tool interactions — plans, questions asked to the user (with answers), setup-wizard configured/skipped nodes, resumed confirmations (approved/rejected), and the names of tools called.
