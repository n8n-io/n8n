// ---------------------------------------------------------------------------
// Fixture-parsing tests: every fixture under `data/workflows/*.json` must
// validate against `WorkflowTestCaseSchema` at load time, and malformed JSON
// or missing fields must produce a clear error that names the offending file.
// ---------------------------------------------------------------------------
