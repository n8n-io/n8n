...
// name no build tools — the agent-build surface is being redesigned. The
// exam-style corpus lives in ../agents-exam; README.md has the authoring
// contract. Requires the agents module.
// ---------------------------------------------------------------------------
