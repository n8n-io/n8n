...
- **Workflow builder** (`workflow-builder/`) — TypeScript SDK source artifacts, parsing, validation, and prompt sections
...
| Kind | Executor | Tools |
|------|----------|-------|
| `build-workflow` | Builder agent | search-nodes, workflow-source, build-workflow, get-node-type-definition, etc. |
