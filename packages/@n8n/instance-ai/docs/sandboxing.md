...
| `N8N_INSTANCE_AI_SANDBOX_NAME_PREFIX` | — | Prefix prepended to every Daytona sandbox name. Visible in the Daytona dashboard list view, making sandboxes from a given context (e.g. eval-driven runs) identifiable at a glance. Empty in production. |
