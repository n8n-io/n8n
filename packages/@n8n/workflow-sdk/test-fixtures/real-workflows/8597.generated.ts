const wf = workflow('DjICkfZc3MJRxo6g', '💥 Build Your First AI Agent with ChatGPT-5 ', {
	executionOrder: 'v1',
})
	.add(
		trigger({
			...
			version: 1.3,
			config: { parameters: { options: {} }, position: [-384, 48], name: 'Chat with Your Data' },
		}),
	)
	.then(
		node({
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note7', color: 7, position: [-464, -240], width: 320, height: 480 },
		),
	)
	.add(
		sticky(
