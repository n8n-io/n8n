const wf = workflow('', '')
	...
	.add(
		sticky(
			...
			{ name: 'Test Note', color: 6, position: [1360, 1460], width: 300, height: 220 },
		),
	)
	.add(
		sticky('## 🔑 Step 1: Add Gmail Credentials 👇', {
			name: 'Sticky Note7',
			color: 5,
			position: [-680, 1380],
			width: 260,
	...
	.add(
		sticky('## 📧 Step 2: Email Processing Node\n', {
			name: 'Sticky Note8',
			color: 5,
			position: [-340, 1380],
			width: 260,
	...
	.add(
		sticky(
			"## ⚙️ Step 3: Sender Filter\n• Replace 'YOUR_SENDER_NAME_FILTER'\n• Only emails from this sender will proceed\n• Supports multiple conditions",
			{ name: 'Sticky Note9', color: 5, position: [-20, 1380], width: 260, height: 400 },
		),
	)
	.add(
		sticky(
			'## ✍️ Step 4: Customize AI Prompt\n• Default: Short email summary\n• Change tone/formality as needed',
			{ name: 'Sticky Note10', color: 5, position: [360, 1360], width: 360, height: 420 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note12', color: 4, position: [800, 1380], width: 500, height: 400 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note13', color: 4, position: [720, 1840], width: 700, height: 420 },
		),
	);
