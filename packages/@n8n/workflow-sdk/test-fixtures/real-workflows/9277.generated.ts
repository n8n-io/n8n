			...
			config: {
				...
				subnodes: {
							...
							config: {
								...
								subnodes: {
										...
										tool({
											...
											config: {
												...
												credentials: {
													googleOAuth2Api: {
														id: 'credential-id',
														name: 'googleOAuth2Api Credential',
													},
												},
												name: 'Get teacher',
											},
									...
									memory: memory({
										...
										version: 1.3,
										config: { parameters: { contextWindowLength: 10 }, name: 'Simple Memory4' },
									}),
									model: languageModel({
							...
							config: {
								...
								subnodes: {
									...
									memory: memory({
										type: '@n8n/n8n-nodes-langchain.memoryBufferWindow',
										version: 1.3,
										config: { parameters: { contextWindowLength: 10 }, name: 'Simple Memory5' },
									}),
									model: languageModel({
										type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini',
										version: 1,
							...
							config: {
								...
								subnodes: {
									memory: memory({
										type: '@n8n/n8n-nodes-langchain.memoryBufferWindow',
										version: 1.3,
										config: { parameters: { contextWindowLength: 20 }, name: 'Simple Memory7' },
									}),
									tools: [
										tool({
											type: 'n8n-nodes-base.httpRequestTool',
							...
							config: {
								...
								subnodes: {
									memory: memory({
										type: '@n8n/n8n-nodes-langchain.memoryBufferWindow',
										version: 1.3,
										config: { parameters: { contextWindowLength: 10 }, name: 'Simple Memory8' },
									}),
									tools: [
										tool({
											type: 'n8n-nodes-base.httpRequestTool',
							...
							config: {
								...
								subnodes: {
									...
									memory: memory({
										type: '@n8n/n8n-nodes-langchain.memoryBufferWindow',
										version: 1.3,
										config: { parameters: { contextWindowLength: 10 }, name: 'Simple Memory3' },
									}),
									model: languageModel({
										type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini',
										version: 1,
							...
							config: {
								...
								subnodes: {
									...
									memory: memory({
										type: '@n8n/n8n-nodes-langchain.memoryBufferWindow',
										version: 1.3,
										config: { parameters: { contextWindowLength: 10 }, name: 'Simple Memory10' },
									}),
									model: languageModel({
										type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini',
										version: 1,
							...
							config: {
								...
								subnodes: {
									...
									memory: memory({
										type: '@n8n/n8n-nodes-langchain.memoryBufferWindow',
										version: 1.3,
										config: { parameters: { contextWindowLength: 10 }, name: 'Simple Memory12' },
									}),
									model: languageModel({
										type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini',
										version: 1,
					...
					memory: memory({
						type: '@n8n/n8n-nodes-langchain.memoryBufferWindow',
						version: 1.3,
						config: { parameters: { contextWindowLength: 100 }, name: 'Simple Memory18' },
					}),
					model: languageModel({
						type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini',
						version: 1,
