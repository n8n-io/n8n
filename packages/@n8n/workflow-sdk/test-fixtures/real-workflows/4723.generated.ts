const wf = workflow('F0DFXdSTdGjIk0V5', 'Email - PA', { executionOrder: 'v1' })
	.add(
		trigger({
			type: 'n8n-nodes-base.manualTrigger',
			version: 1,
			config: { position: [440, -60], name: 'When clicking ‘Test workflow’' },
		}),
	)
	.then(
		node({
