const wf = workflow('QIkMJhue2s5le6jM', 'Reranks #1', { executionOrder: 'v1' })
	.add(
		trigger({
			...
			config: {
				parameters: {
					...
					folderToWatch: {
						...
						cachedResultUrl:
							'https://drive.google.com/drive/folders/1dh1Rr2yrhSdoSYpiR8s1yXiSWLYxpoLJ',
	...
	.add(
		trigger({
			...
			version: 1,
			config: { position: [2080, 180], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
	...
	.then(
		node({
			...
			version: 4.2,
			config: {
				parameters: { url: '<your apify get>', options: {} },
				position: [2740, 180],
				name: 'Get Result',
			},
		}),
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1DKXYqpb0EWNYsbq2x8h5xqUWXy772toNDVrl8d-8nfA/edit#gid=0',
					...
					documentId: {
						...
						mode: 'url',
						value:
							'https://docs.google.com/spreadsheets/d/1DKXYqpb0EWNYsbq2x8h5xqUWXy772toNDVrl8d-8nfA/edit?usp=sharing',
					},
	...
	.then(
		node({
			...
			version: 4.2,
			config: {
				parameters: { url: '<your webhook>', options: {} },
				position: [3180, 180],
				name: 'HTTP Request1',
			},
		}),
			...
			config: {
				parameters: {
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1DKXYqpb0EWNYsbq2x8h5xqUWXy772toNDVrl8d-8nfA/edit?usp=drivesdk',
	...
	.add(
		node({
			...
			version: 1,
			config: {
				parameters: { modelName: 'rerank-multilingual-v3.0' },
				credentials: {
	...
	.add(
		sticky('# Scrapping and data Cleaning\n', {
			name: 'Sticky Note1',
			color: 7,
			position: [2020, 80],
			width: 1360,
	...
	.add(
		sticky('# Potential Leads Knowledge Base\n', {
			name: 'Sticky Note2',
			color: 5,
			position: [3420, 940],
			width: 1100,
