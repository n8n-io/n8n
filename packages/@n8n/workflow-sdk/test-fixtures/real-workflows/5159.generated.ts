const wf = workflow('', '')
						...
						parameters: [
							{
								...
								value:
									'=attachment; filename="cover-{{ $(\'Create WordPress Post\').item.json.id }}.jpg"',
							},
						],
					},
			...
			config: {
				parameters: {
					...
					documentId: {
						...
						value: '1UDaTATWOnYorewjEF5-G9edgSBjc2_Rb50BZVFbAu8U',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1UDaTATWOnYorewjEF5-G9edgSBjc2_Rb50BZVFbAu8U/edit?usp=drivesdk',
	...
	.add(
		sticky(
			...
			{ name: 'Workflow Instructions', position: [-1640, -200], width: 500, height: 940 },
		),
	);
