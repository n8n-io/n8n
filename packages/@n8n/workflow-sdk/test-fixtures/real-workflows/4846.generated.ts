const wf = workflow('g1hmK8jw38TOYX7D', 'Create Video with Google Veo3 and Upload to Youtube', {
	executionOrder: 'v1',
})
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-220, 840], name: 'When clicking ‘Test workflow’' },
		}),
	)
	.then(
		node({
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note4', position: [-220, -140], width: 740, height: 200 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note5', position: [-220, 520], width: 740, height: 100 },
		),
	)
	.add(
		sticky(
			'## STEP 2 - GET API KEY (YOURAPIKEY)\nCreate an account [here](https://fal.ai/) and obtain API KEY.\nIn the node "Create Image" set "Header Auth" and set:\n- Name: "Authorization"\n- Value: "Key YOURAPIKEY"',
			{ name: 'Sticky Note6', position: [-220, 100], width: 740, height: 140 },
		),
	)
	.add(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note8', position: [-220, 280], width: 740, height: 200 },
		),
	);
