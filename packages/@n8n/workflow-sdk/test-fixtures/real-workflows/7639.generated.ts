const wf = workflow('', '')
	.add(
		trigger({
			...
			version: 1.3,
			config: { parameters: { options: {} }, position: [192, 848], name: 'Chat with Your Data' },
		}),
	)
	.then(
		node({
	...
	.add(
		node({
			...
			version: 1.3,
			config: { position: [736, 880], name: 'Memory' },
		}),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note7', color: 7, position: [16, 576], width: 480, height: 432 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note10', color: 3, position: [560, 1056], width: 512, height: 432 },
		),
	)
