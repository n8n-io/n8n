return workflow('MGxb1ugenLCp7pGW', 'AI content summarization from URLs, text, and PDFs using OpenAI and n8n', {
  ...
  .add(trigger({ type: 'n8n-nodes-base.webhook', version: 2, config: { parameters: {
    ...
    }, position: [-1344, 1040], name: 'Initial Trigger' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [-1120, 1040], name: 'Parse Input Parameters' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: { url: '={{ $json.url }}', options: {} }, position: [-288, 960], name: 'Fetch URL Content' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [448, 1040], name: 'Clean & Format Content' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: { url: '={{ $json.file_content }}', options: {} }, position: [-608, 1296], name: 'Fetch PDF File' } })], { version: 3, parameters: {
      rules: {
        values: [
          {
            outputKey: 'url',
  ...
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      promptType: 'define'
        ...
        }, name: 'OpenAI GPT-4.1 (Unified)' } }) }, position: [672, 1040], name: 'Generate AI Summary (Unified)' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1024, 1040], name: 'Structure Final Output' } }))
  .then(node({ type: 'n8n-nodes-base.respondToWebhook', version: 1.4, config: { parameters: {
      options: {},
      respondWith: 'text',
      responseBody: '={{ $json.content }}'
    }, position: [1248, 1040], name: 'Return Summary Response' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'pdf' }, position: [-464, 1296] } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.function', version: 1, config: { parameters: {
    ...
    }, position: [16, 1344], name: 'Map Language Code' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [448, 1040], name: 'Clean & Format Content' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [176, 1344], name: 'OCR.Space' } }))
  .add(trigger({ type: 'n8n-nodes-base.webhook', version: 2, config: { parameters: {
    ...
    }, position: [-1328, 1664], name: 'summarize-url' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-1104, 1664], name: 'Extract URL Parameters' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: { url: '={{ $json.url }}', options: {} }, position: [-880, 1664], name: 'Scrape Web Page Content' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-656, 1664], name: 'Clean Scraped Content' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      text: '=Summarize: {{ $json.raw_content }}',
      options: {
      ...
      promptType: 'define'
          ...
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'OpenAI GPT-4.1 (URL)' } }) }, position: [-432, 1664], name: 'Summarize URL Content' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-80, 1664], name: 'Format URL Summary' } }))
  .then(node({ type: 'n8n-nodes-base.respondToWebhook', version: 1.4, config: { parameters: {
      options: {},
      respondWith: 'text',
      responseBody: '={{ $json.content }}'
    }, position: [144, 1664], name: 'Return URL Summary' } }))
  .add(trigger({ type: 'n8n-nodes-base.webhook', version: 2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [-1312, 2192], name: 'summarize-text' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-1088, 2192], name: 'Extract Text Parameters' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-864, 2192], name: 'Process Raw Text Input' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      text: '=Summarize: {{ $json.raw_content }}',
      options: {
      ...
      promptType: 'define'
          ...
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'OpenAI GPT-4.1 (Text)' } }) }, position: [-640, 2192], name: 'Summarize Text Input' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-288, 2192], name: 'Format Text Summary' } }))
  .then(node({ type: 'n8n-nodes-base.respondToWebhook', version: 1.4, config: { parameters: {
      options: {},
      respondWith: 'text',
      responseBody: '={{ $json.content }}'
    }, position: [-64, 2192], name: 'Return Text Summary' } }))
  .add(trigger({ type: 'n8n-nodes-base.webhook', version: 2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [-1312, 2800], name: 'summarize-file' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-1088, 2800], name: 'Extract File Parameters' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: { url: '={{ $json.file_content }}', options: {} }, position: [-864, 2800], name: 'Download PDF File' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'pdf' }, position: [-640, 2800], name: 'Extract Text from PDF' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.function', version: 1, config: { parameters: {
      functionCode: 'const lang = $json.language?.toLowerCase() || \'english\';\nlet code = \'eng\';\nif (lang.includes(\'spanish\')) code = \'spa\';\nelse if (lang.includes(\'french\')) code = \'fra\';\nelse if (lang.includes(\'german\')) code = \'ger\';\nreturn { json: { language_code: code } };'
    }, position: [-192, 2624], name: 'Map OCR Language Code' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [160, 2816], name: 'Process Extracted Text' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      headerParameters: { parameters: [{ name: 'apikey', value: 'YOUR_OCR_API_KEY' }] }
    }, position: [-32, 2624], name: 'OCR Fallback Processing' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      text: '=Summarize: {{ $json.raw_content }}',
      options: {
      ...
      promptType: 'define'
          ...
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'OpenAI GPT-4.1 (PDF)' } }) }, position: [480, 2800], name: 'Summarize PDF Content' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [832, 2800], name: 'Format PDF Summary' } }))
  .then(node({ type: 'n8n-nodes-base.respondToWebhook', version: 1.4, config: { parameters: {
      options: {},
      respondWith: 'text',
      responseBody: '={{ $json.content }}'
