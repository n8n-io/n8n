const wf = workflow('', 'Generate 5-level AI explanations from Telegram to Google Docs', {
	...
	.add(
		sticky(
			...
			{ color: 7, position: [784, 560], width: 576, height: 448 },
		),
	)
	.add(
		sticky('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n', {
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note7', position: [80, 112], width: 672, height: 1200 },
		),
	)
	.add(
	...
	.add(
		sticky(
			'## Collection of responses  & Formatting\n\n\n**Combines all five responses into a single result**\n\n**Organizes the data & formats it for final output**',
			{ name: 'Sticky Note15', color: 5, position: [2960, 544], width: 224, height: 560 },
		),
	)
	.add(
		sticky(
