return workflow('FqIyXIEKFojlkN9k', 'FalAI_SeeDanceV1.0_Eng_Template', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.manualTrigger', version: 1, config: { position: [-340, -220], name: 'When clicking ‘Execute workflow’' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [-200, -220], name: 'Get Data' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Structured Output Parser' } }) }, position: [-60, -220], name: 'Generate Full Narrative from Prompt' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Structured Output Parser1' } }) }, position: [260, -220], name: 'Break Narrative into {{n}} Scenes' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: 'const scenes = $json.output?.scenes || [];\n\nreturn [\n  {\n    sceneCount: scenes.length,\n    scenes: scenes\n  }\n];'
    }, position: [600, -220], name: 'Verify number of scene' } }))
  .then(ifBranch([node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      hasOutputParser: true
          ...
          schemaType: 'manual',
          inputSchema: '{\n    "type": "object",\n    "properties": {\n        "scenes": {\n            "type": "array",\n            "description": "the scenes",\n            "items": {\n                "type": "string"\n            }\n        }\n    },\n    "required": [\n        "scenes"\n    ]\n}'
        }, name: 'Structured Output Parser1' } }) }, position: [260, -220], name: 'Break Narrative into {{n}} Scenes' } }), node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'scenes' }, position: [940, -180] } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Structured Output Parser2' } }) }, position: [-300, 40], name: 'Describe Each Scene for Video' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [20, 40], name: 'Call Fal.ai API (Seedance)' } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [200, 40], name: 'Loop Over Items' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [-540, 340], name: 'Start adding audio to the video' } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [-540, 520], name: 'Loop Over Items1' } }))
  .add(node({ type: 'n8n-nodes-base.aggregate', version: 1, config: { parameters: { options: {}, aggregate: 'aggregateAllItemData' }, position: [200, 500], name: 'Aggregate videos with audio' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [400, 320], name: 'Start merging videos' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 1 }, position: [620, 320], name: 'Wait for the merge to complete' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [780, 320], name: 'Get merge videos status' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [400, 480], name: 'Get merged video' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 1 }, position: [620, 320], name: 'Wait for the merge to complete' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 1 }, position: [620, 320], name: 'Wait for the merge to complete' } })], { version: 3.2, parameters: {
      rules: {
        values: [
          {
            outputKey: 'COMPLETED',
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [600, 540], name: 'Get the  video1' } }))
  .then(node({ type: 'n8n-nodes-base.youTube', version: 1, config: { parameters: {
    ...
    }, position: [780, 540], name: 'YouTube' } }))
  .add(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 1 }, position: [-320, 320], name: 'Wait for adding the audio' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [-320, 460], name: 'Get audio status' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [-120, 320], name: 'Get video with audio' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 1 }, position: [-320, 320], name: 'Wait for adding the audio' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 1 }, position: [-320, 320], name: 'Wait for adding the audio' } })], { version: 3.2, parameters: {
      rules: {
        values: [
          {
            outputKey: 'COMPLETED',
  ...
  .add(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { position: [380, 80], name: 'Wait for the video' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [540, 80], name: 'Get the video status' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [920, 60], name: 'Get the  video' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { position: [380, 80], name: 'Wait for the video' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { position: [380, 80], name: 'Wait for the video' } })], { version: 3.2, parameters: {
      rules: {
        values: [
          {
            outputKey: 'COMPLETED',
