return workflow('eFkkWqS5KdrxZ43P', 'Automate video creation with Veo3 and auto-post to Instagram, TikTok via Blotato - vide', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1.2, config: { parameters: { rule: { interval: [{}] } }, position: [500, 560], name: 'Trigger: Run Daily Script Generator' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.9, config: { parameters: {
      ...
      hasOutputParser: true
    }, subnodes: { tools: [tool({ type: '@n8n/n8n-nodes-langchain.toolThink', version: 1, config: { name: 'Tool: Inject Creativity' } })], outputParser: outputParser({ type: '@n8n/n8n-nodes-langchain.outputParserStructured', version: 1.2, config: { parameters: {
        ...
        }, name: 'Parser: Extract JSON from Idea' } }), model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatOpenAi', version: 1.2, config: { parameters: {
          model: {
            __rl: true,
            mode: 'list',
            value: 'gpt-4.1',
        ...
        }, name: 'LLM: Generate Idea & Caption (GPT-4.1)' } }) }, position: [660, 560], name: 'AI Agent: Generate Video Concept' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [1020, 560], name: 'Google Sheets: Save Script Idea' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.9, config: { parameters: {
      ...
      promptType: 'define',
      hasOutputParser: true
    }, subnodes: { tools: [tool({ type: '@n8n/n8n-nodes-langchain.toolThink', version: 1, config: { name: 'Tool: Build Prompt Structure' } })], model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatOpenAi', version: 1.2, config: { parameters: {
          model: {
            __rl: true,
            mode: 'list',
            value: 'gpt-4.1',
          ...
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'LLM: Format Prompt for Veo3 (GPT-4.1)' } }) }, position: [1180, 560], name: 'AI Agent: Create Veo3-Compatible Prompt' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [520, 1100], name: 'Call Veo3 API to Generate Video' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { position: [740, 1100], name: 'Wait for Veo3 Processing (5 mins)' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [1020, 1100], name: 'Retrieve Final Video URL from Veo3' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [1340, 1100], name: 'Google Sheets: Log Final Video Output' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      sheetName: { __rl: true, mode: 'id', value: '=' },
      documentId: { __rl: true, mode: 'id', value: '=' }
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [640, 1680], name: 'Upload Video to Blotato' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [920, 1440], name: 'INSTAGRAM' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1140, 1440], name: 'YOUTUBE' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1340, 1440], name: 'TIKTOK' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [920, 1680], name: 'FACEBOOK' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1140, 1680], name: 'THREADS' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1340, 1680], name: 'TWETTER' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [920, 1920], name: 'LINKEDIN' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1140, 1920], name: 'BLUESKY' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1340, 1920], name: 'PINTEREST' } }))
