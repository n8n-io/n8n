return workflow('', '')
  ...
  .add(sticky('Run this workflow manually to import and index Google Docs product documentation into MongoDB with vector embeddings for fast search.', { color: 5, position: [-420, -500] }))
