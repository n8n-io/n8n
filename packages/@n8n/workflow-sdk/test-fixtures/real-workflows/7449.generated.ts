return workflow('', '')
  .add(trigger({ type: '@n8n/n8n-nodes-langchain.chatTrigger', version: 1.3, config: { parameters: { options: {} }, position: [-1840, 1056], name: 'Chat with Your Data' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2.2, config: { parameters: {
      ...
      hasOutputParser: true
          ...
          options: {}
        }, name: 'OpenAI Chat Model1' } }) }, position: [-1328, 896], name: 'Talk to Your Data' } }))
