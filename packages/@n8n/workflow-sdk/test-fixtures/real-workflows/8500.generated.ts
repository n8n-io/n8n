const wf = workflow('zcYVtmH3JmlnFoOB', 'Jarvis template', { executionOrder: 'v1' })
	.add(
		trigger({
			type: '@n8n/n8n-nodes-langchain.mcpTrigger',
			version: 1,
			config: {
				parameters: { path: '906a5e01-3f46-444e-a3b7-51d2105eac16' },
				subnodes: {
					tools: [
						tool({
						...
						tool({
							...
							config: {
								parameters: {
									...
									descriptionType: 'manual',
									toolDescription:
										'Retrieve a list of labels. AI-configurable parameters: Return_All (boolean) - whether to return all labels.',
								},
								credentials: {
									gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' },
								},
							...
							config: {
								parameters: {
									...
									options: {
										...
										bccList:
											"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('BCC', ``, 'string') }}",
									},
									subject:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Subject', ``, 'string') }}",
									resource: 'draft',
									...
									descriptionType: 'manual',
									toolDescription:
										'Create an email draft. AI-configurable parameters: Subject (string) - the subject of the draft; Message (string) - the body of the draft; Attachment_Field_Name__in_Input_ (string) - input field name containing attachments; BCC (string) - comma-separated BCC recipients; CC (string) - comma-separated CC recipients.',
								},
								credentials: {
									gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' },
								},
								...
								parameters: {
									...
									options: {
										...
										bccList:
											"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('BCC', ``, 'string') }}",
										threadId:
											"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Thread_ID', ``, 'string') }}",
									},
									subject:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Subject', ``, 'string') }}",
									resource: 'draft',
									...
									descriptionType: 'manual',
									toolDescription:
										'Draft a reply to an email. Use the thread_id parameter to pass the thread for which the email must be drafted',
								},
								credentials: {
									gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' },
								},
						...
						tool({
							...
							config: {
								parameters: {
									...
									options: {
										...
										attachmentsUi: {
											attachmentsBinary: [
												{
													property:
														"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Attachment_Field_Name', ``, 'string') }}",
												},
											],
										},
									...
									descriptionType: 'manual',
									toolDescription:
										'Reply to an email message. AI-configurable parameters: Message_ID (string) - the ID of the message; Message (string) - the reply content; Attachment_Field_Name (string) - input field name containing attachments; BCC (string) - comma-separated BCC recipients; CC (string) - comma-separated CC recipients.',
								},
								credentials: {
									gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' },
								},
						...
						tool({
							...
							config: {
								parameters: {
									labelIds:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Label_Names_or_IDs', ``, 'string') }}",
									messageId:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Message_ID', ``, 'string') }}",
									operation: 'addLabels',
									descriptionType: 'manual',
									toolDescription:
										'Add one or more labels to an email message. AI-configurable parameters: Message_ID (string) - the ID of the message to label; Label_Names_or_IDs (string) - comma-separated label names or IDs to apply.',
								},
								credentials: {
									gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' },
								},
	...
	.add(
		trigger({
			...
			version: 1,
			config: {
				parameters: { path: '64e72cc1-3df0-4090-9522-d534c3f245aa' },
				subnodes: {
					tools: [
						tool({
							...
							config: {
								parameters: {
									eventId:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Event_ID', `Pass the event id`, 'string') }}",
									options: {},
									calendar: {
										__rl: true,
										mode: 'list',
						...
						tool({
							...
							config: {
								parameters: {
									...
									timeMin:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('After', `Should be a future date and time`, 'string') }}",
									calendar: {
										__rl: true,
										mode: 'list',
										value: 'user@example.com',
						...
						tool({
							...
							config: {
								parameters: {
									eventId:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Event_ID', `Pass the id of the event to reschedule or update`, 'string') }}",
									calendar: {
										__rl: true,
										mode: 'list',
										value: 'user@example.com',
						...
						tool({
							...
							config: {
								parameters: {
									...
									timeMax:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('End_Time', ``, 'string') }}",
									timeMin:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Start_Time', ``, 'string') }}",
									calendar: {
										__rl: true,
										mode: 'list',
										value: 'user@example.com',
						...
						tool({
							...
							config: {
								parameters: {
									eventId:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Event_ID', `Pass the event id of the event to delete`, 'string') }}",
									options: {},
									calendar: {
										__rl: true,
										mode: 'list',
	...
	.add(
		trigger({
			...
			version: 2,
			config: {
				parameters: { path: '7bf1c961-4feb-4c31-919e-ff300c40406d' },
				subnodes: {
					tools: [
						tool({
							...
							config: {
								parameters: {
									...
									taskId:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Task_ID', ``, 'string') }}",
									operation: 'get',
								},
								credentials: {
						...
						tool({
							...
							config: {
								parameters: {
									...
									additionalFields: {
										notes:
											"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Notes', ``, 'string') }}",
										dueDate:
											"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Due_Date', `Always use future dates`, 'string') }}",
									},
								},
								credentials: {
									googleTasksOAuth2Api: {
						...
						tool({
							...
							config: {
								parameters: {
									...
									additionalFields: {
										showCompleted:
											"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Show_Completed', ``, 'boolean') }}",
									},
								},
								credentials: {
									googleTasksOAuth2Api: {
						...
						tool({
							...
							config: {
								parameters: {
									task: 'MDM1NDg1NzcxMjIyNzg5NzQ1ODI6MDow',
									taskId:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Task_ID', `Pass the task_id of the task to be completed`, 'string') }}",
									operation: 'update',
									updateFields: {
										status: 'completed',
										completed:
											"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Completion_Date', `Pass the date when the task is completed`, 'string') }}",
									},
								},
								credentials: {
									googleTasksOAuth2Api: {
		...
		node({
			...
			config: {
				parameters: {
					...
					additionalFields: {
						caption:
							"={{ $('Set Reply Message').item.json.message.replace(/[_*\\[\\]()~`>#+=\\-|{}.!\\\\]/g, '\\\\$&') }}",
	...
	.add(
		trigger({
			...
			version: 1.1,
			config: {
				parameters: { path: 'f226741c-0f79-4f23-96bf-d8eb47206bcf' },
				subnodes: {
					tools: [
						tool({
								...
								parameters: {
									columns: {
										value: {
											...
											Amount:
												"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Amount', ``, 'string') }}",
											Category:
												"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Category', ``, 'string') }}",
											Description:
												"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Description', ``, 'string') }}",
										},
										schema: [
									...
									sheetName: {
										...
										value: 'gid=0',
										cachedResultUrl:
											'https://docs.google.com/spreadsheets/d/1QCS8_RA5neEDAmgotpzgbBbeEjdYi-LAmCSJVeNWVxs/edit#gid=0',
									...
									documentId: {
										...
										cachedResultUrl:
											'https://docs.google.com/spreadsheets/d/1QCS8_RA5neEDAmgotpzgbBbeEjdYi-LAmCSJVeNWVxs/edit?usp=drivesdk',
	...
	.add(
		trigger({
			...
			version: 2,
			config: {
				parameters: { path: '01e90a0b-6f53-40d0-a8d3-a05c34a46fbb' },
				subnodes: {
					tools: [
						tool({
							...
							config: {
								parameters: {
									...
									rawData: true,
									useQuery:
										"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Use_Query', ``, 'boolean') }}",
									operation: 'getAll',
								},
								credentials: {
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', position: [144, 144], width: 720, height: 704 },
		),
	)
	.add(
		sticky(
			'## Gmail MCP 📧\nFull email management.  \n- Send & draft messages  \n- Reply, label, and fetch emails  ',
			{ name: 'Sticky Note4', color: 3, position: [224, 880], width: 768, height: 640 },
		),
	)
	.add(
		sticky(
			'## Finance Manager MCP 💵\nTrack personal or business expenses.  \n- Create new expenses  \n- Get expense reports  \n- Delete outdated entries  ',
			{ name: 'Sticky Note5', color: 4, position: [1024, 528], width: 496, height: 544 },
		),
	)
	.add(
		sticky(
			'## Google Contacts MCP 👥\nAccess and manage your contact list.  \n- Fetch contacts for quick communication  ',
			{ name: 'Sticky Note6', color: 6, position: [1056, 1088], width: 448, height: 416 },
		),
	)
	.add(
		sticky(
			'## Calendar MCP 📅\nYour scheduling hub.  \n- Check availability  \n- Create, reschedule, or delete events ',
			{ name: 'Sticky Note3', color: 5, position: [-512, 720], width: 624, height: 704 },
		),
	)
	.add(
		sticky(
			'## Task Manager MCP ✅\nManages to-dos with ease:  \n- Create / Complete / Delete tasks  \n- Retrieve individual or bulk tasks ',
			{ name: 'Sticky Note2', color: 6, position: [-1104, 592], width: 560, height: 624 },
		),
	);
