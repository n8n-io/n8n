return workflow('Zwz315okMu0UwtRQ', '💥 Automate AI Video Creation & Multi-Platform Publishing with Veo 3.1 & Blotato - vide', { executionOrder: 'v1' })
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [672, 2000], name: 'Parse Sheet Input' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [896, 2000], name: 'Workflow Configuration' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
    ...
    }, position: [1072, 2000], name: 'GPT-4 API Call' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1376, 2000], name: 'Parse GPT Response' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
      ...
      includeOtherFields: true
    }, position: [672, 2224], name: 'Optimize Prompt for Veo' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [896, 2224], name: 'Prepare Veo Request Body' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [1136, 2224], name: 'Veo Generation1' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1376, 2224], name: 'Extract Video Data' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '={{ $json.video_url }}',
      options: { response: { response: { responseFormat: 'file' } } }
    }, position: [672, 2464], name: 'Download Video' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [896, 2464], name: 'Google Drive Upload' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.7, config: { parameters: {
    ...
    }, position: [1136, 2464], name: 'Google Sheets Append' } }))
  .then(node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: { mediaUrl: '={{ $json.url_final }}', resource: 'media' }, credentials: {
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1376, 2464], name: 'Upload Video to BLOTATO' } }))
  .then(merge([node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1632, 2000], name: 'Tiktok' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'linkedin',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1840, 2000], name: 'Linkedin' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'facebook',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1632, 2224], name: 'Facebook' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      accountId: {
        __rl: true,
        mode: 'list',
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1840, 2224], name: 'Instagram' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'twitter',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1632, 2464], name: 'Twitter (X)' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'youtube',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1856, 2464], name: 'Youtube' } })], { version: 3.2, parameters: { mode: 'chooseBranch', numberInputs: 6 }, name: 'Merge1' }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.7, config: { parameters: {
      columns: {
        value: {
          status: 'Published',
