const wf = workflow('', '')
			...
			config: {
				parameters: {
					...
					folderToWatch: {
						...
						cachedResultUrl:
							'https://drive.google.com/drive/folders/1E8rvLEWKguorMT36yCD1jY78G0u8g6g7',
	...
	.then(
		node({
			...
			version: 1,
			config: {
				parameters: { domain: 'healthcare.claims-processing' },
				position: [1504, 560],
				name: 'VLM Run',
			},
		}),
				...
				parameters: {
					columns: {
						value: {
							...
							'INSURED ADDRESS':
								'={{ $json.response.insured_address.street }}, {{ $json.response.insured_address.city }}, {{ $json.response.insured_address.state }}, {{ $json.response.insured_address.zip_code }}',
							'PATIENT ADDRESS':
								'={{ $json.response.patient_address.street }}, {{ $json.response.patient_address.city }}, {{ $json.response.patient_address.state }}, {{ $json.response.patient_address.zip_code }}',
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1wZQDu7Hd0iV8dqiLbfUzAwUqKnn8J0ZQFO1weZ_ShxQ/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1wZQDu7Hd0iV8dqiLbfUzAwUqKnn8J0ZQFO1weZ_ShxQ/edit?usp=drivesdk',
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note2', color: 7, position: [1792, 0], width: 416, height: 816 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note3', position: [1344, 0], width: 416, height: 816 },
		),
	)
	.add(
		sticky(
