const wf = workflow('IIQhSqMWv4u6e0Jh', 'Create Video with Sora2 Pro and Upload to Youtube', {
	executionOrder: 'v1',
})
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-528, 976], name: 'When clicking ‘Test workflow’' },
		}),
	)
	.then(
		node({
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note4', position: [-528, -16], width: 740, height: 200 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note5', position: [-528, 656], width: 740, height: 100 },
		),
	)
	.add(
		sticky(
			'## STEP 2 - GET API KEY (YOURAPIKEY)\nCreate an account [here](https://fal.ai/) and obtain API KEY.\nIn the node "Create Image" set "Header Auth" and set:\n- Name: "Authorization"\n- Value: "Key YOURAPIKEY"',
			{ name: 'Sticky Note6', position: [-528, 224], width: 740, height: 140 },
		),
	)
	.add(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note8', position: [-528, 416], width: 740, height: 200 },
		),
	);
