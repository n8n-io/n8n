const wf = workflow('', '')
			...
			config: {
				...
				subnodes: {
					model: languageModel({
						...
						version: 1,
						config: {
							parameters: { model: 'qwen/qwen3-8b:free', options: {} },
							credentials: {
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', position: [-900, -300], width: 1900, height: 1080 },
		),
	);
