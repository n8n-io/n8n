const wf = workflow('oJXYeAsW2fEXu2CM', 'LinkedIn Post To Personalized Opener', {
	executionOrder: 'v1',
})
	.add(
		trigger({
			...
			config: {
				parameters: {
					...
					formDescription:
						'Paste any LinkedIn post and get a personalized cold email opener that actually sounds human.',
				},
				position: [1140, 760],
	...
	.add(
		sticky(
			...
			{ name: 'What This Does', position: [1420, 140], width: 400, height: 560 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Output & Next Steps', position: [1420, 980], width: 400, height: 280 },
		),
	)
	.add(
		sticky(
			'** Further connect to your tools:**\n- Google Sheets for logging\n- CRM for prospect data\n- Email tools for sending\n- Slack for notifications',
			{ name: 'Why This Works', position: [2060, 740], width: 400, height: 140 },
		),
	);
