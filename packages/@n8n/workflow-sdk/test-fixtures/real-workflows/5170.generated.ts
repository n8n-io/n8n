const wf = workflow('', '')
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-3456, 1056], name: 'Execute to Start' },
		}),
	)
	.then(
		node({
						...
						assignments: [
							{
								...
								type: 'object',
								value:
									'{"key":"value","array":[1,2,3],"boolean":false,"integer":123,"sub_object":{"sub_key":"Find me!"}}',
							},
						],
					},
				},
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note2', color: 7, position: [-2896, 704], width: 260, height: 516 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note3', color: 7, position: [-2608, 704], width: 260, height: 516 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note4', color: 7, position: [-2320, 704], width: 260, height: 516 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note9', color: 6, position: [-784, 704], width: 340, height: 516 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note10', color: 3, position: [-416, 16], width: 540, height: 1200 },
		),
	)
	.add(
		sticky(
			'## [Video Tutorial](https://youtu.be/PAmgrwYnzWs?si=yXG1oHIL3UiBcAPa)\n@[youtube](PAmgrwYnzWs)',
			{ name: 'Sticky Note11', color: 2, position: [-3680, 240], width: 460, height: 300 },
		),
	)
	.add(
		sticky(
			'[![Execute Workflow](https://supastudio.ia2s.app/storage/v1/object/public/assets/n8n/execute_workflow_json_tutorial.gif)](https://www.youtube.com/watch?v=PAmgrwYnzWs)',
			{ name: 'Sticky Note14', color: 7, position: [-3184, 288], width: 576, height: 392 },
		),
	)
	.add(
		sticky(
			'## [>> Go to Eval Workflow <<](https://n8n.io/workflows/6232)\n\nVerify your skills with a complete eval workflow to put your JSON Skills to the test.\n[![Test Skills](https://supastudio.ia2s.app/storage/v1/object/public/assets/n8n/test_your_skillls_button.gif)](https://n8n.io/workflows/6232)',
			{ name: 'Sticky Note15', color: 6, position: [-784, 368], width: 336, height: 312 },
		),
	);
