const wf = workflow('', '')
	.add(
		trigger({
			...
			version: 1,
			config: { position: [2704, 7360], name: 'When clicking ‘Test workflow’' },
		}),
	)
	.then(
		node({
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note4', position: [3552, 6544], width: 708, height: 584 },
		),
	);
