return workflow('Cki3H3LKIaoXKG1r', 'Website Down Time Monitoring for n8n', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1.2, config: { parameters: { rule: { interval: [{}] } }, position: [-1120, 2425] } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [-900, 2425], name: 'Website URLs' } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [-680, 2425], name: 'Loop Over Items' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-460, 1900], name: 'Check website status' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [-20, 1800], name: 'Get Active Down Record' } }), node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
          {
    ...
    }, position: [-20, 2200], name: 'Get Existing Down Records' } })], { version: 1, parameters: {
      conditions: {
        number: [
          {
  ...
  .then(ifBranch([node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [420, 1800], name: 'Update Uptime and Total Downtime' } }), node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [-680, 2425], name: 'Loop Over Items' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .add(node({ type: 'n8n-nodes-base.gmail', version: 2.1, config: { parameters: {
    ...
    }, position: [640, 1600], name: 'Email Notification for Up' } }))
  .add(node({ type: 'n8n-nodes-base.slack', version: 2.3, config: { parameters: {
    ...
    }, position: [640, 1800], name: 'Slack Notification for Up' } }))
  .add(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
    ...
    }, position: [640, 2000], name: 'Telegram Notification for Up' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [200, 2200], name: 'Find Existing Record' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [-680, 2425], name: 'Loop Over Items' } }), node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [640, 2200], name: 'Add Downtime Record' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .add(node({ type: 'n8n-nodes-base.gmail', version: 2.1, config: { parameters: {
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [860, 1975], name: 'Email Notification for Down' } }))
  .add(node({ type: 'n8n-nodes-base.slack', version: 2.3, config: { parameters: {
      ...
      slackOAuth2Api: { id: 'credential-id', name: 'slackOAuth2Api Credential' }
    }, position: [860, 2175], name: 'Slack Notification for Down' } }))
  .add(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      text: '=🚨 Alert: Hi there, | The {{ $json[\'Website URL\'] }} website is currently down. Kindly look into this issue and take necessary action as soon as possible.  Thank you.',
      chatId: '123456789',
      additionalFields: {}
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [860, 2375], name: 'Telegram Notification for Down' } }))
