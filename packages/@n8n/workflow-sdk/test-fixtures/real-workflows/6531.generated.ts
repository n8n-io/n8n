const wf = workflow('', '')
			...
			config: {
				parameters: {
					fileId: {
						...
						mode: 'url',
						value:
							'=https://drive.google.com/file/d/1Bt2wh1a3IkWrf8VRIMJL4sRwiKDbWfhC/view?usp=sharing',
					},
					options: {},
					operation: 'download',
				},
			...
			config: {
				parameters: {
					...
					folderId: {
						...
						cachedResultUrl:
							'https://drive.google.com/drive/folders/1e1USeEsOByu-n5cR5o1IeyzJFfkf8O4i',
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1S3vi0R9cjbB1A7ZXFz7jCwrBbBjn-lqEVP78QsfMS_A/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1S3vi0R9cjbB1A7ZXFz7jCwrBbBjn-lqEVP78QsfMS_A/edit?usp=drivesdk',
	...
	.then(
		node({
			...
			version: 1,
			config: { position: [1240, 680], name: 'Pick One' },
		}),
	)
	.then(
		node({
	...
	.add(
		sticky('## Generate a New Post Idea and All Materials', {
			name: 'Sticky Note7',
			color: 6,
			position: [800, 80],
			width: 980,
	...
	.add(
		sticky('## Generate an Image and Save', {
			name: 'Sticky Note8',
			color: 6,
			position: [1800, 80],
			width: 1140,
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note4', color: 5, position: [820, 940], width: 440, height: 240 },
		),
	);
