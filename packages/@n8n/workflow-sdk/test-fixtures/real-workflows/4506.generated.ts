return workflow('', 'YTB Metadata Generator', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.rssFeedReadTrigger', version: 1, config: { parameters: {
    ...
    }, position: [-880, 20], name: 'Trigger New Video Posted' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-440, -80], name: 'Scrape Video' } }), node({ type: 'n8n-nodes-base.noOp', version: 1, config: { position: [-440, 120], name: 'No Operation, do nothing' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      options: {}
    }, position: [-160, -80], name: 'Check IF Finished' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.apify.com/v2/acts/streamers~youtube-scraper/runs/last/dataset/items?token=YOUR_TOKEN_HERE',
      options: {}
    }, position: [240, -100], name: 'Get DataSet' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { position: [180, 120] } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(ifBranch([node({ type: '@n8n/n8n-nodes-langchain.chainLlm', version: 1.5, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Mistral Cloud Chat Model' } }), outputParser: outputParser({ type: '@n8n/n8n-nodes-langchain.outputParserStructured', version: 1.2, config: { parameters: {
        ...
        }, name: 'Structured Output Parser' } }) }, position: [700, -200], name: 'Generate Description' } }), node({ type: 'n8n-nodes-base.noOp', version: 1, config: { position: [700, 100], name: 'No Operation, do nothing1' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
