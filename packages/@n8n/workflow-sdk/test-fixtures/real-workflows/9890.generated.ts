const wf = workflow(
	...
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-16, 208], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 1084488211,
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/18sw7io0yJOTDzvcknGmjBBqtK154CLk3k0FoWJZbfI0/edit#gid=1084488211',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/18sw7io0yJOTDzvcknGmjBBqtK154CLk3k0FoWJZbfI0/edit?usp=drivesdk',
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note - How to Use', position: [-640, 448], width: 592, height: 192 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note - Need Help', position: [-32, 448], width: 592, height: 184 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky('', { name: 'Sticky Note1', color: 6, position: [448, 176], width: 272, height: 192 }),
	)
	.add(
		sticky('', { name: 'Sticky Note2', color: 3, position: [736, 192], width: 384, height: 192 }),
	);
