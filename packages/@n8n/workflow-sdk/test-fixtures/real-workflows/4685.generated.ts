return workflow('Dbzu6lmK6zWsyyQP', 'Lead 1', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.formTrigger', version: 2.2, config: { parameters: {
    ...
    }, position: [220, 140], name: 'On form submission' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [460, 140], name: 'Generate Leads with Apollo.io1' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'people' }, position: [660, 140] } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [880, 140], name: 'Clean Data' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [1080, 140], name: 'Add Leads to Google Sheet' } }))
  .add(trigger({ type: 'n8n-nodes-base.googleSheetsTrigger', version: 1, config: { parameters: {
    ...
    }, position: [20, 580], name: 'Google Sheets Trigger2' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
    ...
    }, position: [260, 580], name: 'Get Pending Email Statuses' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [480, 580], name: 'Get Email from Apollo11' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [740, 580], name: 'Confirm Email Validity' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [1340, 500], name: 'Add Email Address' } }), node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
          apollo_id: '={{ $(\'Get Pending Email Statuses\').item.json.apollo_id }}',
    ...
    }, position: [1340, 700], name: 'Mark Invalid Email' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .add(trigger({ type: 'n8n-nodes-base.googleSheetsTrigger', version: 1, config: { parameters: {
    ...
    }, position: [-40, 1060], name: 'Google Sheets Trigger3' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
    ...
    }, position: [220, 1060], name: 'Get Pending About and Posts Rows' } }))
  .then(node({ type: 'n8n-nodes-base.limit', version: 1, config: { parameters: { maxItems: 2 }, position: [440, 1060] } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [760, 1060], name: 'Get About Profile' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-60, 1360], name: 'Clean Profile Data' } }))
  .add(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [200, 1280], name: 'Stringify Profile Data1' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
    ...
    }, position: [420, 1280], name: 'AI Profile Summarizer' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [900, 1280], name: 'Update Profile Summary' } }))
  .add(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [200, 1440], name: 'update status to failed' } }))
  .add(trigger({ type: 'n8n-nodes-base.googleSheetsTrigger', version: 1, config: { parameters: {
      event: 'rowAdded',
      options: {},
      pollTimes: { item: [{ mode: 'everyMinute' }] },
    ...
    }, position: [-80, 1900], name: 'Google Sheets Trigger4' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
    ...
    }, position: [160, 1900], name: 'Get Pending About and Posts Rows1' } }))
  .then(node({ type: 'n8n-nodes-base.limit', version: 1, config: { parameters: { maxItems: 8 }, position: [380, 1900], name: 'Limit1' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [640, 1900], name: 'Get Profile Posts' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      mode: 'runOnceForEachItem',
    ...
    }, position: [920, 1900], name: 'Clean Posts Data' } }))
  .add(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      mode: 'runOnceForEachItem',
      jsCode: 'const profile = item.json;\n\nreturn {\n  json: {\n    postsString: JSON.stringify(profile, null, 2) // Pretty print with 2-space indentation\n  }\n};'
    }, position: [1320, 1820], name: 'Stringify Posts Data' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      modelId: {
        __rl: true,
        mode: 'list',
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [1560, 1820], name: 'Posts AI Summarizer' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [2020, 1820], name: 'Update Posts Summary' } }))
  .add(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
          apollo_id: '={{ $(\'Get Pending About and Posts Rows1\').item.json.apollo_id }}',
  ...
  .add(trigger({ type: 'n8n-nodes-base.googleSheetsTrigger', version: 1, config: { parameters: {
    ...
    }, position: [1200, 2420], name: 'Google Sheets Trigger5' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
    ...
    }, position: [1420, 2420], name: 'Get Completely Enriched Profiles' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
          Position: '={{ $json.title }}',
    ...
    }, position: [1620, 2420], name: 'Append to Enriched Leads Database' } }))
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1.2, config: { parameters: {
    ...
    }, position: [2120, 340], name: 'Schedule Trigger2' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
    ...
    }, position: [2340, 340], name: 'get_failed_profile_summary_rows' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [2560, 340], name: 'update_to_pending1' } }))
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1.2, config: { parameters: {
      rule: {
        interval: [
          {
    ...
    }, position: [2180, 800], name: 'Schedule Trigger3' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
          { lookupValue: 'failed', lookupColumn: 'posts_scrape_status' }
        ]
      },
      sheetName: {
        __rl: true,
    ...
    }, position: [2400, 800], name: 'get_failed_posts_summary_rows1' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
          apollo_id: '={{ $json.apollo_id }}',
    ...
    }, position: [2600, 800], name: 'update_to_unscraped' } }))
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1.2, config: { parameters: {
      rule: {
        interval: [
          {
    ...
    }, position: [2140, 1180], name: 'Schedule Trigger1' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
        values: [
    ...
    }, position: [2360, 1180], name: 'get invalid email rows' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
          apollo_id: '={{ $json.apollo_id }}',
    ...
    }, position: [2580, 1180], name: 'update_to_pending' } }))
  .add(trigger({ type: 'n8n-nodes-base.googleSheetsTrigger', version: 1, config: { parameters: {
      event: 'rowAdded',
      options: {},
      pollTimes: { item: [{ mode: 'everyMinute' }] },
  ...
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [500, 380], name: 'Get Pending Username Row' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      modelId: {
        __rl: true,
        mode: 'list',
  ...
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [1080, 380], name: 'Add Linkedin Username' } }))
  ...
  .add(sticky('## Automated Lead Generation and Enrichment Workflow\n\nDescription: This workflow automates lead generation by collecting job title, location, and lead count via a form, using Apollo.io to fetch leads, and OpenAI to extract LinkedIn usernames. It stores and updates lead data in Google Sheets, validating email addresses and tracking scrape statuses for efficient lead management.\n', { name: 'Sticky Note1', position: [-200, -60], width: 1820, height: 1020 }))
  .add(sticky('## LinkedIn Profile Summary Enrichment Workflow\nThis workflow automates the enrichment of lead data by fetching LinkedIn profile details for records marked as "pending" in a Google Sheets document, using the LinkedIn Data API. It cleans and summarizes the profile data with OpenAI, then updates the Google Sheet with the summarized profile and status, marking failed attempts if errors occur.', { name: 'Sticky Note4', color: 6, position: [-180, 960], width: 1320, height: 700 }))
  .add(sticky('## LinkedIn Posts Scraping and Lead Enrichment Workflow\nThis workflow retrieves recent LinkedIn posts for leads marked "unscraped" in a Google Sheet, using the LinkedIn Data API, and summarizes them with OpenAI to enhance lead profiles for personalized outreach. It updates the Google Sheet with post summaries, tracks failed attempts, and transfers fully enriched profiles (with validated emails, profile summaries, and post summaries) to a separate Enriched Leads Database.', { name: 'Sticky Note6', color: 4, position: [-220, 1680], width: 2420, height: 560 }))
  .add(sticky('## Update Completely Enriched Profile to Final Database', { name: 'Sticky Note', color: 4, position: [1060, 2300], width: 960, height: 360 }))
  .add(sticky('## Update posts summary status from failed back to pending', { name: 'Sticky Note10', color: 7, position: [2040, 660], width: 800, height: 360 }))
  .add(sticky('## Update Contact Scrape Status from Invalid back to Pending', { name: 'Sticky Note3', color: 5, position: [2040, 1100], width: 800, height: 360 }))
  .add(sticky('## Update profile summary status from failed back to pending', { name: 'Sticky Note8', color: 6, position: [2000, 220], width: 820, height: 360 }))
  .add(sticky('## Scheduled Lead Status Reset Workflow\nThis workflow runs on a schedule every four weeks to identify Google Sheets rows with invalid email addresses or failed post summary scrapes. It updates the status of these rows to "pending" for email revalidation and "unscraped" for post rescraping, enabling automated retry attempts for lead enrichment.', { name: 'Sticky Note2', color: 4, position: [1720, 40], width: 1280, height: 1540 }))