const wf = workflow('', '')
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-736, 32], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
