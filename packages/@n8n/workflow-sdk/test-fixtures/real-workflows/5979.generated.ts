return workflow('', '')
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1, config: { parameters: { rule: { interval: [{}] } }, position: [-340, 120], name: 'Daily Schedule Trigger' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 2, config: { parameters: {
      ...
      options: {}
    }, position: [-120, 120], name: '📋 Configuration Settings' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4, config: { parameters: {
    ...
    }, position: [100, 140], name: '📊 SEMrush Competitor Keywords' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [540, 80], name: '🔄 Process Competitor Data' } }))
  .add(node({ type: 'n8n-nodes-base.if', version: 2, config: { parameters: {
      options: {},
      conditions: {
        options: {
          version: 1,
    ...
    }, position: [760, 20], name: '✅ Data Quality Check' } }))
  .add(node({ type: 'n8n-nodes-base.airtable', version: 2, config: { parameters: {
      ...
      options: {},
      operation: 'create'
    }, position: [1200, 20], name: '💾 Save to Airtable - Competitors' } }))
  .then(merge([node({ type: 'n8n-nodes-base.airtable', version: 2, config: { parameters: {
      base: { __rl: true, mode: 'list', value: 'content-research-base' },
      table: { __rl: true, mode: 'list', value: 'competitor-intelligence' },
      columns: {
        value: {
      ...
      options: {},
      operation: 'create'
    }, position: [1200, 20], name: '💾 Save to Airtable - Competitors' } }), node({ type: 'n8n-nodes-base.airtable', version: 2, config: { parameters: {
      base: { __rl: true, mode: 'list', value: 'content-research-base' },
      ...
      options: {},
      operation: 'create'
    }, position: [1200, 140], name: '💾 Save to Airtable - Keywords' } }), node({ type: 'n8n-nodes-base.notion', version: 2, config: { parameters: {
      pageId: { __rl: true, mode: 'url', value: '' },
      simple: false,
      options: {}
    }, position: [1200, 260], name: '📝 Save to Notion' } }), node({ type: 'n8n-nodes-base.slack', version: 2, config: { parameters: {
    ...
    }, position: [1200, 380], name: '📢 Send Slack Alert' } })], { version: 2, parameters: { mode: 'combine', options: {}, combinationMode: 'multiplex' }, name: '🔗 Merge All Data' }))
  .add(node({ type: 'n8n-nodes-base.stopAndError', version: 1, config: { position: [960, 120], name: 'Stop and Error' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 2, config: { parameters: {
      values: {
        string: [
          {
            name: 'user_prompt',
      ...
      options: {}
    }, position: [760, 200], name: '📝 Prepare AI Prompt' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4, config: { parameters: {
    ...
    }, position: [960, 320], name: '🔧 OpenAI HTTP Request Alternative' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [100, 260], name: '📈 BuzzSumo Content Performance' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4, config: { parameters: {
    ...
    }, position: [320, 20], name: '📊 Google Trends Data' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [540, 200], name: '📈 Process Keyword Trends' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [320, 140], name: '❓ AnswerThePublic Questions' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4, config: { parameters: {
    ...
    }, position: [320, 260], name: '💬 Reddit Audience Insights' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [540, 320], name: '👥 Process Audience Insights' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4, config: { parameters: {
