const wf = workflow('', '')
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-200, 120], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1OGX1bKAOeym8tEENP-zJAYXyZD6XnH6T5FV85J38H54/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1OGX1bKAOeym8tEENP-zJAYXyZD6XnH6T5FV85J38H54/edit?usp=drivesdk',
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 6484598,
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1OGX1bKAOeym8tEENP-zJAYXyZD6XnH6T5FV85J38H54/edit#gid=6484598',
	...
	.add(
		node({
			...
			version: 1,
			config: {
				parameters: { model: 'google/gemini-2.5-flash-preview-05-20', options: {} },
				credentials: {
	...
	.add(
		node({
			...
			version: 1.3,
			config: { position: [360, 1440], name: 'Simple Memory' },
		}),
	)
	.add(
		node({
			...
			config: {
				parameters: {
					columns: {
						value: {
							username:
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('username', ``, 'string') }}",
						},
						schema: [
							{
								id: 'username',
					...
					sheetName: {
						...
						value: 395221622,
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1OGX1bKAOeym8tEENP-zJAYXyZD6XnH6T5FV85J38H54/edit#gid=395221622',
				...
				parameters: {
					columns: {
						value: {
							...
							GitHub:
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('GitHub', ``, 'string') }}",
							TikTok:
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('TikTok', ``, 'string') }}",
							Facebook:
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Facebook', ``, 'string') }}",
							LinkedIn:
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('LinkedIn', ``, 'string') }}",
							username:
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('username__using_to_match_', ``, 'string') }}",
							' Instagram':
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('_Instagram', ``, 'string') }}",
							'Twitter (X)':
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('Twitter__X_', ``, 'string') }}",
							'short Description':
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('short_Description', ``, 'string') }}",
						},
						schema: [
							{
								id: 'username',
					...
					columns: {
						value: {
							...
							avatarAccessibilityText:
								"={{ /*n8n-auto-generated-fromAI-override*/ $fromAI('avatarAccessibilityText__using_to_match_', ``, 'string') }}",
						},
						schema: [
							{
								id: 'author',
	...
	.add(
		sticky('## ⚙️ **Section 1: 🎥 YouTube Comment Extraction**', {
			name: 'Sticky Note2',
			color: 3,
			position: [-320, -180],
			width: 1240,
