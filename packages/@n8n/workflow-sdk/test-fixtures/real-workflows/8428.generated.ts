return workflow('GWiHdxtRvqh14vln', '💥 Create viral Ads with NanoBanana & Seedance, publish on socials via upload-post - version II - vide', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.telegramTrigger', version: 1.2, config: { parameters: { updates: ['message'], additionalFields: {} }, credentials: {
    ...
    }, position: [592, 64], name: 'Trigger: Receive Idea via Telegram' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [816, 64], name: 'Telegram: Get Image File' } }))
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [2048, 64], name: 'NanoBanana: Create Image' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 2 }, position: [2256, 64], name: 'Wait for Image Edit' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [2240, 352], name: 'Download Edited Image' } }))
  .add(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [608, 352], name: 'Rewrite Caption (TikTok/Instagram)' } }))
  .then(node({ type: 'n8n-nodes-upload-post.uploadPost', version: 1, config: { parameters: {
      user: 'DRFIRAS',
  ...
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [608, 688], name: 'Seedance: Generate Video from Image' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 4 }, position: [816, 688], name: 'Wait for Rendering' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [1024, 688], name: 'Download Video from Seedance' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [1232, 688], name: 'Set: Video URL' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [1696, 688], name: 'Wait: Music Rendering1' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes' }, position: [1904, 688], name: 'Wait: Music Rendering' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [2112, 688], name: 'Download Music File' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [2320, 688], name: 'Set: Audio URL' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [624, 1008], name: 'Merge Audio + Video' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 3 }, position: [832, 1008], name: 'Wait: Merge Process' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '={{ $json.response_url }}',
      options: {},
      authentication: 'genericCredentialType',
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [1040, 1008], name: 'Check Merge Status' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: { url: '={{ $json.video.url }}', options: {} }, position: [1248, 1008], name: 'Download Final Video' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
      name: '={{ $(\'Trigger: Receive Idea via Telegram\').item.json.message.photo[2].file_unique_id }}',
      driveId: { __rl: true, mode: 'id', value: '=' },
      options: {},
    ...
    }, position: [2304, 1008], name: 'Upload Final Video to Google Drive' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.7, config: { parameters: {
    ...
    }, position: [608, 1424], name: 'Read Brand Settings' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [816, 1424], name: 'Extract Brand Info' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [1024, 1424], name: 'Message a model' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.7, config: { parameters: {
      columns: {
        value: {
          STATUS: 'CREATE',
    ...
    }, position: [1344, 1424], name: 'Save Ad Data to Google Sheets' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1552, 1424], name: 'Send Video URL via Telegram' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1760, 1424], name: 'Send a video' } }))
  .then(node({ type: 'n8n-nodes-upload-post.uploadPost', version: 1, config: { parameters: {
      user: 'DRFIRAS',
      ...
      uploadPostApi: { id: 'credential-id', name: 'uploadPostApi Credential' }
    }, position: [1968, 1424], name: 'Post Video on Social Media (FB, TikTok, YT)' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.7, config: { parameters: {
      columns: {
        value: {
          STATUS: 'Published',
    ...
    }, position: [2176, 1424], name: 'Save Publishing Status to Google Sheets' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      text: 'Published',
      chatId: '={{ $(\'Trigger: Receive Idea via Telegram\').first().json.message.chat.id }}',
      additionalFields: {}
