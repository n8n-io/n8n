return workflow('', '')
  .add(trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
    ...
    }, position: [-768, 368], name: 'Look for Invoices' } }))
  .then(node({ type: 'n8n-nodes-base.gmail', version: 2.1, config: { parameters: {
      ...
      operation: 'getAll'
    }, position: [-544, 368], name: 'Get Email Content' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.guardrails', version: 1, config: { parameters: {
    ...
    }, subnodes: { model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini', version: 1, config: { parameters: { options: {} }, name: 'Gemini 2.5 flash' } }) }, position: [-336, 368], name: 'Guardrail: Is Finance?' } }))
  ...
  .then(ifBranch([node({ type: 'n8n-nodes-base.filter', version: 2.2, config: { parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
    ...
    }, position: [592, 432], name: 'Filter Finance Keywords' } }), null], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(ifBranch([node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: {
      options: {},
      operation: 'pdf',
      binaryPropertyName: '={{ Object.keys($json.binary || {})[0] || \'attachment_0\' }}'
    }, position: [-240, 816], name: 'Extract PDF Data' } }), node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.9, config: { parameters: {
      text: '={{ $(\'Get Email Content\').item.json.text }}',
      options: {
      ...
      hasOutputParser: true
        ...
        }, name: 'gpt 4o mini' } }) }, position: [-32, 1088], name: 'AI Agent (Email OCR)' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.9, config: { parameters: {
      ...
      hasOutputParser: true
          ...
          model: { __rl: true, mode: 'list', value: 'gpt-4o-mini' },
          options: { temperature: 0.2, responseFormat: 'json_object' }
        }, name: 'gpt 4o mini' } }) }, position: [-32, 800], name: 'AI Agent (PDF OCR)' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [528, 992], name: 'Validate Extraction' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1040, 672], name: 'Apply Finance Rules' } }), node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [1088, 1248], name: 'Log Error to Sheet' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [1376, 672], name: 'Log to Invoices Sheet' } }))
  .then(node({ type: 'n8n-nodes-base.gmail', version: 2.1, config: { parameters: {
    ...
    }, position: [1632, 672], name: 'Send Confirmation Email' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [1904, 672], name: 'Log Success Metrics' } }))
  .then(node({ type: 'n8n-nodes-base.gmail', version: 2.1, config: { parameters: {
      sendTo: '={{ $(\'Configuration: User Settings\').item.json.adminEmailForErrors }}',
