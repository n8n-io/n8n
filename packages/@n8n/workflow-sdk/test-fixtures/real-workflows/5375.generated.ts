return workflow('qS9W7d2IVCxZZKaN', '选题捕手模板', { executionOrder: 'v1' })
  ...
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [-3160, 300], name: 'Analysis Parameters' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-2940, 340], name: 'YouTube: Search Videos' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'items' }, position: [-2760, 340] } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-2580, 340], name: 'Format YouTube Data' } }))
  .then(merge([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [-2760, 160], name: 'Format Reddit Data' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [-2580, 340], name: 'Format YouTube Data' } }), node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-2760, 520], name: 'Parse Twitter Data' } })], { version: 3, parameters: { numberInputs: 3 }, name: 'Merge: All Sources' }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {}, batchSize: 10 }, position: [-2200, 360], name: 'Loop Over Items' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.chainLlm', version: 1.7, config: { parameters: {
      ...
      promptType: 'define'
        ...
        }, name: 'Pre-filter Content' } }) }, position: [-2040, 360], name: 'AI Pre-filtering' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-1740, 360], name: 'Parse AI Filter Results' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.aggregate', version: 1, config: { parameters: { options: {}, aggregate: 'aggregateAllItemData' }, position: [-1340, 240], name: 'Aggregate: Relevant Items' } }), node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-1340, 520], name: 'Handle Filter Errors' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: '@n8n/n8n-nodes-langchain.chainLlm', version: 1.7, config: { parameters: {
      ...
      promptType: 'define'
          ...
          googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
        }, name: 'Deep Analysis' } }) }, position: [-1180, 240], name: 'AI Deep Analysis' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-840, 240], name: 'Structure Analysis Result' } }))
  .then(node({ type: 'n8n-nodes-base.aggregate', version: 1, config: { parameters: { options: {}, aggregate: 'aggregateAllItemData' }, position: [-600, 240], name: 'Aggregate: Deep Analysis Results' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
    ...
    }, subnodes: { model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini', version: 1, config: { parameters: { options: {}, modelName: 'models/gemini-2.5-flash' }, credentials: {
          googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
        }, name: 'Synthesis' } }) }, position: [-440, 240], name: 'AI: Synthesize Final Report' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-120, 240], name: 'Format Report Payloads' } }))
  .add(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [140, 480], name: 'Archive Data' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [120, 0], name: 'Splicing final report' } }))
  .then(node({ type: 'n8n-nodes-base.gmail', version: 2.1, config: { parameters: {
    ...
    }, position: [320, 0], name: 'Send HTML Report' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      method: 'POST',
      options: {},
      sendBody: true,
    ...
    }, position: [140, 240], name: 'Send Feishu Card' } }))
  .add(node({ type: 'n8n-nodes-base.reddit', version: 1, config: { parameters: {
    ...
    }, position: [-2940, 160], name: 'Reddit: Search Posts' } }))
  .add(node({ type: 'n8n-nodes-base.twitter', version: 2, config: { parameters: {
      operation: 'search',
      searchText: '={{ $json.keyword }}',
      additionalFields: {}
    }, credentials: {
      twitterOAuth2Api: { id: 'credential-id', name: 'twitterOAuth2Api Credential' }
    }, position: [-2940, 520], name: 'X: Search Tweets' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-2780, 1120], name: 'Apify抓取x推文' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpQueryAuth: { id: 'credential-id', name: 'httpQueryAuth Credential' }
    }, position: [-2980, 1120], name: 'ScrapingBee抓取x推文' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
