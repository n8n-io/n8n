return workflow('', '')
  .add(trigger({ type: 'n8n-nodes-base.formTrigger', version: 2.3, config: { parameters: {
    ...
    }, position: [5392, 2448], name: 'Video Input Form' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [5888, 2320], name: 'Temp Image Upload' } }), node({ type: '@n8n/n8n-nodes-langchain.chainLlm', version: 1.7, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Refiner Model' } }), outputParser: outputParser({ type: '@n8n/n8n-nodes-langchain.outputParserStructured', version: 1.3, config: { parameters: {
          schemaType: 'manual',
        ...
        }, name: 'JSON Output Parser' } }) }, position: [5840, 2592], name: 'Prompt Refiner' } })], { version: 3.3, parameters: {
      rules: {
        values: [
          {
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [6064, 2320], name: 'Image-to-Video Call' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 60 }, position: [6336, 2416], name: 'Wait 60 Seconds' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [6544, 2416], name: 'Status Check' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [6944, 2400], name: 'Retrieve Video' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 60 }, position: [6336, 2416], name: 'Wait 60 Seconds' } })], { version: 3.2, parameters: {
      rules: {
        values: [
          {
            outputKey: 'Done',
  ...
  .then(node({ type: 'n8n-nodes-base.form', version: 2.3, config: { parameters: {
      options: {},
      operation: 'completion',
      redirectUrl: '={{ $json.video.url }}',
      respondWith: 'redirect'
    }, position: [7152, 2400], name: 'Video Redirect' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
