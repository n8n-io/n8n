return workflow('mGgSDkJTDBI4mq1J', 'Categorize Keywords', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.manualTrigger', version: 1, config: { position: [-1024, 864], name: 'When clicking ‘Test workflow’' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [-736, 864], name: 'Set Airtable Fields' } }))
  .then(node({ type: 'n8n-nodes-base.airtable', version: 2.1, config: { parameters: {
    ...
    }, position: [-480, 864], name: 'Airtable Get All KWs' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-208, 864], name: 'Set WF Fields' } }))
  .add(node({ type: 'n8n-nodes-base.aggregate', version: 1, config: { parameters: {
    ...
    }, position: [64, 1200], name: 'Aggregate Keywords for Agent' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [272, 1200], name: 'Set Field for Agent' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.7, config: { parameters: {
      ...
      promptType: 'define'
        ...
        }, name: 'OpenAI Chat Model3' } }) }, position: [480, 1200], name: 'AI Agent Analyze and Cluster KWs' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [992, 1168], name: 'Edit Fields1' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'items' }, position: [1200, 1168] } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1424, 1168], name: 'Set Fields for Airtable' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'keywords' }, position: [1648, 1168], name: 'Split Out1' } }))
  .then(node({ type: 'n8n-nodes-base.airtable', version: 2.1, config: { parameters: {
      base: {
        __rl: true,
        mode: 'id',
      ...
      airtableTokenApi: { id: 'credential-id', name: 'airtableTokenApi Credential' }
    }, position: [1872, 1168], name: 'Clusters table' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1024, 1504], name: 'Edit Fields2' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'items' }, position: [1248, 1504], name: 'Split Out2' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.7, config: { parameters: {
      ...
      promptType: 'define'
    }, subnodes: { model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatOpenAi', version: 1.1, config: { parameters: { model: 'gpt-4o', options: {} }, credentials: {
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'OpenAI Chat Model' } }) }, position: [1440, 1504], name: 'Agent Create Content Opps' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1792, 1504], name: 'Edit Fields3' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'items' }, position: [2000, 1504], name: 'Split Out3' } }))
  .then(node({ type: 'n8n-nodes-base.airtable', version: 2.1, config: { parameters: {
      base: {
        __rl: true,
        mode: 'id',
      ...
      airtableTokenApi: { id: 'credential-id', name: 'airtableTokenApi Credential' }
    }, position: [2240, 1504], name: 'Clusters Ideas Table' } }))
  .add(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.7, config: { parameters: {
      ...
      promptType: 'define'
          ...
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'OpenAI Chat Model1' } }) }, position: [192, 368], name: 'Category AI Agent' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [944, 240], name: 'Set Category Table Fields' } }))
  .then(node({ type: 'n8n-nodes-base.airtable', version: 2.1, config: { parameters: {
      base: {
        __rl: true,
        mode: 'id',
      ...
      airtableTokenApi: { id: 'credential-id', name: 'airtableTokenApi Credential' }
    }, position: [1168, 240], name: 'Category Table' } }))
  .then(node({ type: 'n8n-nodes-base.filter', version: 2.2, config: { parameters: {
    ...
    }, position: [880, 560], name: 'Filter Out Unknown' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1104, 560], name: 'Set Content from Category Fields' } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [1360, 560], name: 'Loop Over Items' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.7, config: { parameters: {
      ...
      promptType: 'define'
          ...
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'OpenAI Chat Model2' } }) }, position: [1584, 640], name: 'Content Ideas from Category AI Agent' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1952, 640], name: 'Set Content Ideas Table Field' } }))
  .then(node({ type: 'n8n-nodes-base.airtable', version: 2.1, config: { parameters: {
      base: {
        __rl: true,
        mode: 'id',
