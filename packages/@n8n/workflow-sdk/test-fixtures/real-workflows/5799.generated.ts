		...
		trigger({
			...
			config: {
				parameters: {
					...
					formDescription:
						'Provide brand and product info, and an optional reference image to generate image variations with AI.',
				},
				position: [240, 55],
			...
			config: {
				parameters: {
					...
					folderId: {
						...
						cachedResultUrl:
							'https://drive.google.com/drive/folders/1R5bTxrKmi9NDMFJIh3aQgbNuZwmCybLV',
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/12bBSaMdX-jE7QtIlEX4CBUEGScmJx3xK7bwFtHWan64/edit#gid=0',
					...
					documentId: {
						...
						value: '',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/12bBSaMdX-jE7QtIlEX4CBUEGScmJx3xK7bwFtHWan64/edit?usp=drivesdk',
