const wf = workflow(
	'd43MQMcUi1o2LV9P',
	'ProBanana: AI Product Mockup Generator using Gemini 2.5 Flash Image (Nano Banana)',
	{ executionOrder: 'v1' },
)
	.add(
		trigger({
						...
						assignments: [
							{
								...
								type: 'string',
								value:
									"={{ $('On form submission').item.json['Pls describe what you want to do?'] }}",
							},
							{
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note2', position: [-576, -160], width: 448, height: 240 },
		),
	)
	.add(
