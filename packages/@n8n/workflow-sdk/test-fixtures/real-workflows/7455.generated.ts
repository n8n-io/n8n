return workflow('', '')
  .add(trigger({ type: 'n8n-nodes-base.postgresTrigger', version: 1, config: { parameters: {
      schema: {
        __rl: true,
        mode: 'list',
        value: 'public',
    ...
    }, position: [624, 704], name: 'Media_queue Trigger' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [800, 704], name: 'get_chat_id' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { position: [960, 704], name: 'Wait for all the files' } }))
  .then(node({ type: 'n8n-nodes-base.postgres', version: 2.6, config: { parameters: {
      ...
      postgres: { id: 'credential-id', name: 'postgres Credential' }
    }, position: [1152, 704], name: 'Get all files from group_id' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1328, 704], name: 'unified_variables' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1488, 704], name: 'Get_message (multiple files)' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [3584, 688], name: 'Normalize input' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2.1, config: { parameters: {
      ...
      promptType: 'define'
    }, subnodes: { memory: memory({ type: '@n8n/n8n-nodes-langchain.memoryPostgresChat', version: 1.3, config: { parameters: {
          tableName: 'chat_histories',
          sessionKey: '={{ $json.chat_id }}',
          sessionIdType: 'customKey'
        }, credentials: {
          postgres: { id: 'credential-id', name: 'postgres Credential' }
        }, name: 'Postgres Chat Memory' } }), model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini', version: 1, config: { parameters: { options: {}, modelName: 'models/gemini-2.5-pro' }, credentials: {
          googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
        }, name: 'Google Gemini Chat Model' } }) }, position: [3776, 688], name: 'AI Agent1' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [4080, 688], name: 'MarkdownV2' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
    ...
    }, position: [4272, 688], name: 'Send a text message1' } }))
  .add(trigger({ type: 'n8n-nodes-base.manualTrigger', version: 1, config: { position: [624, 464], name: 'When clicking ‘Execute workflow’' } }))
  .then(node({ type: 'n8n-nodes-base.postgres', version: 2.6, config: { parameters: {
      ...
      postgres: { id: 'credential-id', name: 'postgres Credential' }
    }, position: [800, 464], name: ' Create Tables' } }))
  ...
  .then(switchCase([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [1152, 928], name: 'get_message (text)' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ $json.message.voice.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 1072], name: 'Download Voice Message' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 1232], name: 'Download VIDEO NOTE' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ $json.message.photo[3]?.file_id || $json.message.photo[2]?.file_id || $json.message.photo[1]?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 1376], name: 'Download IMAGE' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ $json.message.audio.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 1520], name: 'Download AUDIO' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 1664], name: 'Download VIDEO' } }), node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [608, 2864], name: 'Group Similar Documents' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [1152, 1808], name: 'get_error_message1' } })], { version: 3.2, parameters: {
      rules: {
        values: [
          {
            outputKey: 'Text',
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1328, 1072], name: 'Fix mime' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.googleGemini', version: 1, config: { parameters: {
      ...
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [1488, 1072], name: 'Analyze voice message' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1840, 1152], name: 'get_message (Audio/Video message)' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: '// --- Mapa Extendido de Tipos MIME ---\n// Una lista completa para cubrir la mayoría de los formatos de archivo comunes.\nconst mimeMap = {\n  // --- Formatos de Documentos ---\n  \'pdf\': \'application/pdf\',\n  \'txt\': \'text/plain\',\n  \'rtf\': \'application/rtf\',\n  \'csv\': \'text/csv\',\n  \'html\': \'text/html\',\n  \'htm\': \'text/html\',\n  \'json\': \'application/json\',\n  \'xml\': \'application/xml\', // \'text/xml\' también es válido pero \'application/xml\' es más común\n  \'yaml\': \'application/x-yaml\',\n  \'yml\': \'application/x-yaml\',\n\n  // --- Formatos de Microsoft Office ---\n  \'doc\': \'application/msword\',\n  \'docx\': \'application/vnd.openxmlformats-officedocument.wordprocessingml.document\',\n  \'xls\': \'application/vnd.ms-excel\',\n  \'xlsx\': \'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\',\n  \'ppt\': \'application/vnd.ms-powerpoint\',\n  \'pptx\': \'application/vnd.openxmlformats-officedocument.presentationml.presentation\',\n  \'pub\': \'application/vnd.ms-publisher\',\n\n  // --- Formatos de OpenOffice / LibreOffice ---\n  \'odt\': \'application/vnd.oasis.opendocument.text\',\n  \'ods\': \'application/vnd.oasis.opendocument.spreadsheet\',\n  \'odp\': \'application/vnd.oasis.opendocument.presentation\',\n  \'odg\': \'application/vnd.oasis.opendocument.graphics\',\n\n  // --- Formatos de Apple iWork ---\n  \'pages\': \'application/vnd.apple.pages\',\n  \'numbers\': \'application/vnd.apple.numbers\',\n  \'key\': \'application/vnd.apple.keynote\',\n\n  // --- Formatos de Imagen ---\n  \'png\': \'image/png\',\n  \'jpg\': \'image/jpeg\',\n  \'jpeg\': \'image/jpeg\',\n  \'gif\': \'image/gif\',\n  \'webp\': \'image/webp\',\n  \'svg\': \'image/svg+xml\',\n  \'bmp\': \'image/bmp\',\n  \'ico\': \'image/vnd.microsoft.icon\',\n  \'tif\': \'image/tiff\',\n  \'tiff\': \'image/tiff\',\n  \'heic\': \'image/heic\',\n  \'heif\': \'image/heif\',\n\n  // --- Formatos de Audio ---\n  \'mp3\': \'audio/mpeg\',\n  \'wav\': \'audio/wav\',\n  \'oga\': \'audio/ogg\',\n  \'ogg\': \'audio/ogg\',\n  \'flac\': \'audio/flac\',\n  \'m4a\': \'audio/mp4\',\n  \'aac\': \'audio/aac\',\n  \'opus\': \'audio/opus\',\n  \'wma\': \'audio/x-ms-wma\',\n  \'mid\': \'audio/midi\',\n  \'midi\': \'audio/midi\',\n\n  // --- Formatos de Video ---\n  \'mp4\': \'video/mp4\',\n  \'mov\': \'video/quicktime\',\n  \'webm\': \'video/webm\',\n  \'mpeg\': \'video/mpeg\',\n  \'mpg\': \'video/mpeg\',\n  \'avi\': \'video/x-msvideo\',\n  \'wmv\': \'video/x-ms-wmv\',\n  \'flv\': \'video/x-flv\',\n  \'mkv\': \'video/x-matroska\',\n\n  // --- Formatos de Archivos y Compresión ---\n  \'zip\': \'application/zip\',\n  \'rar\': \'application/vnd.rar\',\n  \'7z\': \'application/x-7z-compressed\',\n  \'tar\': \'application/x-tar\',\n  \'gz\': \'application/gzip\',\n  \'bz2\': \'application/x-bzip2\',\n\n  // --- Otros Formatos ---\n  \'epub\': \'application/epub+zip\',\n  \'ics\': \'text/calendar\',\n  \'vcf\': \'text/vcard\',\n  \'js\': \'text/javascript\',\n  \'css\': \'text/css\',\n  \'sh\': \'application/x-sh\',\n  \'py\': \'text/x-python\',\n};\n\n// --- Lógica de Procesamiento (sin cambios) ---\n\n// Obtenemos todos los items que llegan al nodo\nconst items = $input.all();\n\n// Iteramos sobre cada item para procesarlo\nfor (const item of items) {\n  // Verificamos que el item tenga datos binarios para procesar\n  if (item.binary && item.binary[\'data\']) {\n    // Obtenemos el nombre del archivo de forma segura\n    const fileName = item.binary[\'data\'].fileName || \'\';\n    if (!fileName) {\n      continue; // Si no hay nombre de archivo, pasamos al siguiente item\n    }\n\n    // Extraemos la extensión del archivo de forma robusta\n    const extension = fileName.slice((fileName.lastIndexOf(".") - 1 >>> 0) + 2).toLowerCase();\n\n    // Buscamos la extensión en nuestro mapa\n    const newMimeType = mimeMap[extension];\n\n    // Si encontramos una coincidencia en el mapa, actualizamos el mimeType\n    if (newMimeType) {\n      if(item.binary[\'data\'].mimeType !== newMimeType) {\n        console.log(`Cambiando mimeType para \'${fileName}\' de \'${item.binary[\'data\'].mimeType}\' a \'${newMimeType}\'.`);\n        item.binary[\'data\'].mimeType = newMimeType;\n      }\n    }\n  }\n}\n\n// Devolvemos todos los items, modificados o no\nreturn items;'
    }, position: [1328, 1232], name: 'Fix mime1' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.googleGemini', version: 1, config: { parameters: {
      ...
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [1488, 1232], name: 'Analyze video note' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: '// --- Mapa Extendido de Tipos MIME ---\n// Una lista completa para cubrir la mayoría de los formatos de archivo comunes.\nconst mimeMap = {\n  // --- Formatos de Documentos ---\n  \'pdf\': \'application/pdf\',\n  \'txt\': \'text/plain\',\n  \'rtf\': \'application/rtf\',\n  \'csv\': \'text/csv\',\n  \'html\': \'text/html\',\n  \'htm\': \'text/html\',\n  \'json\': \'application/json\',\n  \'xml\': \'application/xml\', // \'text/xml\' también es válido pero \'application/xml\' es más común\n  \'yaml\': \'application/x-yaml\',\n  \'yml\': \'application/x-yaml\',\n\n  // --- Formatos de Microsoft Office ---\n  \'doc\': \'application/msword\',\n  \'docx\': \'application/vnd.openxmlformats-officedocument.wordprocessingml.document\',\n  \'xls\': \'application/vnd.ms-excel\',\n  \'xlsx\': \'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\',\n  \'ppt\': \'application/vnd.ms-powerpoint\',\n  \'pptx\': \'application/vnd.openxmlformats-officedocument.presentationml.presentation\',\n  \'pub\': \'application/vnd.ms-publisher\',\n\n  // --- Formatos de OpenOffice / LibreOffice ---\n  \'odt\': \'application/vnd.oasis.opendocument.text\',\n  \'ods\': \'application/vnd.oasis.opendocument.spreadsheet\',\n  \'odp\': \'application/vnd.oasis.opendocument.presentation\',\n  \'odg\': \'application/vnd.oasis.opendocument.graphics\',\n\n  // --- Formatos de Apple iWork ---\n  \'pages\': \'application/vnd.apple.pages\',\n  \'numbers\': \'application/vnd.apple.numbers\',\n  \'key\': \'application/vnd.apple.keynote\',\n\n  // --- Formatos de Imagen ---\n  \'png\': \'image/png\',\n  \'jpg\': \'image/jpeg\',\n  \'jpeg\': \'image/jpeg\',\n  \'gif\': \'image/gif\',\n  \'webp\': \'image/webp\',\n  \'svg\': \'image/svg+xml\',\n  \'bmp\': \'image/bmp\',\n  \'ico\': \'image/vnd.microsoft.icon\',\n  \'tif\': \'image/tiff\',\n  \'tiff\': \'image/tiff\',\n  \'heic\': \'image/heic\',\n  \'heif\': \'image/heif\',\n\n  // --- Formatos de Audio ---\n  \'mp3\': \'audio/mpeg\',\n  \'wav\': \'audio/wav\',\n  \'oga\': \'audio/ogg\',\n  \'ogg\': \'audio/ogg\',\n  \'flac\': \'audio/flac\',\n  \'m4a\': \'audio/mp4\',\n  \'aac\': \'audio/aac\',\n  \'opus\': \'audio/opus\',\n  \'wma\': \'audio/x-ms-wma\',\n  \'mid\': \'audio/midi\',\n  \'midi\': \'audio/midi\',\n\n  // --- Formatos de Video ---\n  \'mp4\': \'video/mp4\',\n  \'mov\': \'video/quicktime\',\n  \'webm\': \'video/webm\',\n  \'mpeg\': \'video/mpeg\',\n  \'mpg\': \'video/mpeg\',\n  \'avi\': \'video/x-msvideo\',\n  \'wmv\': \'video/x-ms-wmv\',\n  \'flv\': \'video/x-flv\',\n  \'mkv\': \'video/x-matroska\',\n\n  // --- Formatos de Archivos y Compresión ---\n  \'zip\': \'application/zip\',\n  \'rar\': \'application/vnd.rar\',\n  \'7z\': \'application/x-7z-compressed\',\n  \'tar\': \'application/x-tar\',\n  \'gz\': \'application/gzip\',\n  \'bz2\': \'application/x-bzip2\',\n\n  // --- Otros Formatos ---\n  \'epub\': \'application/epub+zip\',\n  \'ics\': \'text/calendar\',\n  \'vcf\': \'text/vcard\',\n  \'js\': \'text/javascript\',\n  \'css\': \'text/css\',\n  \'sh\': \'application/x-sh\',\n  \'py\': \'text/x-python\',\n};\n\n// --- Lógica de Procesamiento (sin cambios) ---\n\n// Obtenemos todos los items que llegan al nodo\nconst items = $input.all();\n\n// Iteramos sobre cada item para procesarlo\nfor (const item of items) {\n  // Verificamos que el item tenga datos binarios para procesar\n  if (item.binary && item.binary[\'data\']) {\n    // Obtenemos el nombre del archivo de forma segura\n    const fileName = item.binary[\'data\'].fileName || \'\';\n    if (!fileName) {\n      continue; // Si no hay nombre de archivo, pasamos al siguiente item\n    }\n\n    // Extraemos la extensión del archivo de forma robusta\n    const extension = fileName.slice((fileName.lastIndexOf(".") - 1 >>> 0) + 2).toLowerCase();\n\n    // Buscamos la extensión en nuestro mapa\n    const newMimeType = mimeMap[extension];\n\n    // Si encontramos una coincidencia en el mapa, actualizamos el mimeType\n    if (newMimeType) {\n      if(item.binary[\'data\'].mimeType !== newMimeType) {\n        console.log(`Cambiando mimeType para \'${fileName}\' de \'${item.binary[\'data\'].mimeType}\' a \'${newMimeType}\'.`);\n        item.binary[\'data\'].mimeType = newMimeType;\n      }\n    }\n  }\n}\n\n// Devolvemos todos los items, modificados o no\nreturn items;'
    }, position: [1328, 1376], name: 'Fix mime5' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.googleGemini', version: 1, config: { parameters: {
      ...
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [1488, 1376], name: 'Analyze image' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1824, 1520], name: 'get_message (Media  message)' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.if', version: 2.2, config: { parameters: {
    ...
    }, position: [2448, 1376], name: 'Media_group?2' } }), node({ type: 'n8n-nodes-base.if', version: 2.2, config: { parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
    ...
    }, position: [2448, 1648], name: 'Media_group?3' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .add(node({ type: 'n8n-nodes-base.postgres', version: 2.6, config: { parameters: {
      ...
      postgres: { id: 'credential-id', name: 'postgres Credential' }
    }, position: [2656, 1280], name: 'Insert documents in media_group' } }))
  .then(node({ type: 'n8n-nodes-base.postgres', version: 2.6, config: { parameters: {
      table: {
        __rl: true,
        mode: 'list',
      ...
      postgres: { id: 'credential-id', name: 'postgres Credential' }
    }, position: [2832, 1280], name: 'Insert media_queue with captions (Trigger)' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [2656, 1440], name: 'Get_file_and_captions' } }))
  .add(node({ type: 'n8n-nodes-base.postgres', version: 2.6, config: { parameters: {
      table: {
        __rl: true,
        mode: 'list',
      ...
      postgres: { id: 'credential-id', name: 'postgres Credential' }
    }, position: [2656, 1600], name: 'Insert documents in media_group1' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 2 }, position: [2832, 1600] } }))
  .then(node({ type: 'n8n-nodes-base.postgres', version: 2.6, config: { parameters: {
      table: {
        __rl: true,
        mode: 'list',
      ...
      postgres: { id: 'credential-id', name: 'postgres Credential' }
    }, position: [3008, 1600], name: 'Insert media_queue (Trigger)' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [2656, 1760], name: 'Get_only_file' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: '// --- Mapa Extendido de Tipos MIME ---\n// Una lista completa para cubrir la mayoría de los formatos de archivo comunes.\nconst mimeMap = {\n  // --- Formatos de Documentos ---\n  \'pdf\': \'application/pdf\',\n  \'txt\': \'text/plain\',\n  \'rtf\': \'application/rtf\',\n  \'csv\': \'text/csv\',\n  \'html\': \'text/html\',\n  \'htm\': \'text/html\',\n  \'json\': \'application/json\',\n  \'xml\': \'application/xml\', // \'text/xml\' también es válido pero \'application/xml\' es más común\n  \'yaml\': \'application/x-yaml\',\n  \'yml\': \'application/x-yaml\',\n\n  // --- Formatos de Microsoft Office ---\n  \'doc\': \'application/msword\',\n  \'docx\': \'application/vnd.openxmlformats-officedocument.wordprocessingml.document\',\n  \'xls\': \'application/vnd.ms-excel\',\n  \'xlsx\': \'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\',\n  \'ppt\': \'application/vnd.ms-powerpoint\',\n  \'pptx\': \'application/vnd.openxmlformats-officedocument.presentationml.presentation\',\n  \'pub\': \'application/vnd.ms-publisher\',\n\n  // --- Formatos de OpenOffice / LibreOffice ---\n  \'odt\': \'application/vnd.oasis.opendocument.text\',\n  \'ods\': \'application/vnd.oasis.opendocument.spreadsheet\',\n  \'odp\': \'application/vnd.oasis.opendocument.presentation\',\n  \'odg\': \'application/vnd.oasis.opendocument.graphics\',\n\n  // --- Formatos de Apple iWork ---\n  \'pages\': \'application/vnd.apple.pages\',\n  \'numbers\': \'application/vnd.apple.numbers\',\n  \'key\': \'application/vnd.apple.keynote\',\n\n  // --- Formatos de Imagen ---\n  \'png\': \'image/png\',\n  \'jpg\': \'image/jpeg\',\n  \'jpeg\': \'image/jpeg\',\n  \'gif\': \'image/gif\',\n  \'webp\': \'image/webp\',\n  \'svg\': \'image/svg+xml\',\n  \'bmp\': \'image/bmp\',\n  \'ico\': \'image/vnd.microsoft.icon\',\n  \'tif\': \'image/tiff\',\n  \'tiff\': \'image/tiff\',\n  \'heic\': \'image/heic\',\n  \'heif\': \'image/heif\',\n\n  // --- Formatos de Audio ---\n  \'mp3\': \'audio/mpeg\',\n  \'wav\': \'audio/wav\',\n  \'oga\': \'audio/ogg\',\n  \'ogg\': \'audio/ogg\',\n  \'flac\': \'audio/flac\',\n  \'m4a\': \'audio/mp4\',\n  \'aac\': \'audio/aac\',\n  \'opus\': \'audio/opus\',\n  \'wma\': \'audio/x-ms-wma\',\n  \'mid\': \'audio/midi\',\n  \'midi\': \'audio/midi\',\n\n  // --- Formatos de Video ---\n  \'mp4\': \'video/mp4\',\n  \'mov\': \'video/quicktime\',\n  \'webm\': \'video/webm\',\n  \'mpeg\': \'video/mpeg\',\n  \'mpg\': \'video/mpeg\',\n  \'avi\': \'video/x-msvideo\',\n  \'wmv\': \'video/x-ms-wmv\',\n  \'flv\': \'video/x-flv\',\n  \'mkv\': \'video/x-matroska\',\n\n  // --- Formatos de Archivos y Compresión ---\n  \'zip\': \'application/zip\',\n  \'rar\': \'application/vnd.rar\',\n  \'7z\': \'application/x-7z-compressed\',\n  \'tar\': \'application/x-tar\',\n  \'gz\': \'application/gzip\',\n  \'bz2\': \'application/x-bzip2\',\n\n  // --- Otros Formatos ---\n  \'epub\': \'application/epub+zip\',\n  \'ics\': \'text/calendar\',\n  \'vcf\': \'text/vcard\',\n  \'js\': \'text/javascript\',\n  \'css\': \'text/css\',\n  \'sh\': \'application/x-sh\',\n  \'py\': \'text/x-python\',\n};\n\n// --- Lógica de Procesamiento (sin cambios) ---\n\n// Obtenemos todos los items que llegan al nodo\nconst items = $input.all();\n\n// Iteramos sobre cada item para procesarlo\nfor (const item of items) {\n  // Verificamos que el item tenga datos binarios para procesar\n  if (item.binary && item.binary[\'data\']) {\n    // Obtenemos el nombre del archivo de forma segura\n    const fileName = item.binary[\'data\'].fileName || \'\';\n    if (!fileName) {\n      continue; // Si no hay nombre de archivo, pasamos al siguiente item\n    }\n\n    // Extraemos la extensión del archivo de forma robusta\n    const extension = fileName.slice((fileName.lastIndexOf(".") - 1 >>> 0) + 2).toLowerCase();\n\n    // Buscamos la extensión en nuestro mapa\n    const newMimeType = mimeMap[extension];\n\n    // Si encontramos una coincidencia en el mapa, actualizamos el mimeType\n    if (newMimeType) {\n      if(item.binary[\'data\'].mimeType !== newMimeType) {\n        console.log(`Cambiando mimeType para \'${fileName}\' de \'${item.binary[\'data\'].mimeType}\' a \'${newMimeType}\'.`);\n        item.binary[\'data\'].mimeType = newMimeType;\n      }\n    }\n  }\n}\n\n// Devolvemos todos los items, modificados o no\nreturn items;'
    }, position: [1328, 1520], name: 'Fix mime6' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.googleGemini', version: 1, config: { parameters: {
      ...
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [1488, 1520], name: 'Analyze audio' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: '// --- Mapa Extendido de Tipos MIME ---\n// Una lista completa para cubrir la mayoría de los formatos de archivo comunes.\nconst mimeMap = {\n  // --- Formatos de Documentos ---\n  \'pdf\': \'application/pdf\',\n  \'txt\': \'text/plain\',\n  \'rtf\': \'application/rtf\',\n  \'csv\': \'text/csv\',\n  \'html\': \'text/html\',\n  \'htm\': \'text/html\',\n  \'json\': \'application/json\',\n  \'xml\': \'application/xml\', // \'text/xml\' también es válido pero \'application/xml\' es más común\n  \'yaml\': \'application/x-yaml\',\n  \'yml\': \'application/x-yaml\',\n\n  // --- Formatos de Microsoft Office ---\n  \'doc\': \'application/msword\',\n  \'docx\': \'application/vnd.openxmlformats-officedocument.wordprocessingml.document\',\n  \'xls\': \'application/vnd.ms-excel\',\n  \'xlsx\': \'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\',\n  \'ppt\': \'application/vnd.ms-powerpoint\',\n  \'pptx\': \'application/vnd.openxmlformats-officedocument.presentationml.presentation\',\n  \'pub\': \'application/vnd.ms-publisher\',\n\n  // --- Formatos de OpenOffice / LibreOffice ---\n  \'odt\': \'application/vnd.oasis.opendocument.text\',\n  \'ods\': \'application/vnd.oasis.opendocument.spreadsheet\',\n  \'odp\': \'application/vnd.oasis.opendocument.presentation\',\n  \'odg\': \'application/vnd.oasis.opendocument.graphics\',\n\n  // --- Formatos de Apple iWork ---\n  \'pages\': \'application/vnd.apple.pages\',\n  \'numbers\': \'application/vnd.apple.numbers\',\n  \'key\': \'application/vnd.apple.keynote\',\n\n  // --- Formatos de Imagen ---\n  \'png\': \'image/png\',\n  \'jpg\': \'image/jpeg\',\n  \'jpeg\': \'image/jpeg\',\n  \'gif\': \'image/gif\',\n  \'webp\': \'image/webp\',\n  \'svg\': \'image/svg+xml\',\n  \'bmp\': \'image/bmp\',\n  \'ico\': \'image/vnd.microsoft.icon\',\n  \'tif\': \'image/tiff\',\n  \'tiff\': \'image/tiff\',\n  \'heic\': \'image/heic\',\n  \'heif\': \'image/heif\',\n\n  // --- Formatos de Audio ---\n  \'mp3\': \'audio/mpeg\',\n  \'wav\': \'audio/wav\',\n  \'oga\': \'audio/ogg\',\n  \'ogg\': \'audio/ogg\',\n  \'flac\': \'audio/flac\',\n  \'m4a\': \'audio/mp4\',\n  \'aac\': \'audio/aac\',\n  \'opus\': \'audio/opus\',\n  \'wma\': \'audio/x-ms-wma\',\n  \'mid\': \'audio/midi\',\n  \'midi\': \'audio/midi\',\n\n  // --- Formatos de Video ---\n  \'mp4\': \'video/mp4\',\n  \'mov\': \'video/quicktime\',\n  \'webm\': \'video/webm\',\n  \'mpeg\': \'video/mpeg\',\n  \'mpg\': \'video/mpeg\',\n  \'avi\': \'video/x-msvideo\',\n  \'wmv\': \'video/x-ms-wmv\',\n  \'flv\': \'video/x-flv\',\n  \'mkv\': \'video/x-matroska\',\n\n  // --- Formatos de Archivos y Compresión ---\n  \'zip\': \'application/zip\',\n  \'rar\': \'application/vnd.rar\',\n  \'7z\': \'application/x-7z-compressed\',\n  \'tar\': \'application/x-tar\',\n  \'gz\': \'application/gzip\',\n  \'bz2\': \'application/x-bzip2\',\n\n  // --- Otros Formatos ---\n  \'epub\': \'application/epub+zip\',\n  \'ics\': \'text/calendar\',\n  \'vcf\': \'text/vcard\',\n  \'js\': \'text/javascript\',\n  \'css\': \'text/css\',\n  \'sh\': \'application/x-sh\',\n  \'py\': \'text/x-python\',\n};\n\n// --- Lógica de Procesamiento (sin cambios) ---\n\n// Obtenemos todos los items que llegan al nodo\nconst items = $input.all();\n\n// Iteramos sobre cada item para procesarlo\nfor (const item of items) {\n  // Verificamos que el item tenga datos binarios para procesar\n  if (item.binary && item.binary[\'data\']) {\n    // Obtenemos el nombre del archivo de forma segura\n    const fileName = item.binary[\'data\'].fileName || \'\';\n    if (!fileName) {\n      continue; // Si no hay nombre de archivo, pasamos al siguiente item\n    }\n\n    // Extraemos la extensión del archivo de forma robusta\n    const extension = fileName.slice((fileName.lastIndexOf(".") - 1 >>> 0) + 2).toLowerCase();\n\n    // Buscamos la extensión en nuestro mapa\n    const newMimeType = mimeMap[extension];\n\n    // Si encontramos una coincidencia en el mapa, actualizamos el mimeType\n    if (newMimeType) {\n      if(item.binary[\'data\'].mimeType !== newMimeType) {\n        console.log(`Cambiando mimeType para \'${fileName}\' de \'${item.binary[\'data\'].mimeType}\' a \'${newMimeType}\'.`);\n        item.binary[\'data\'].mimeType = newMimeType;\n      }\n    }\n  }\n}\n\n// Devolvemos todos los items, modificados o no\nreturn items;'
    }, position: [1328, 1664], name: 'Fix mime4' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.googleGemini', version: 1, config: { parameters: {
      ...
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [1488, 1664], name: 'Analyze video' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 2048], name: 'Download CSV' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 2192], name: 'Download HTML' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 2336], name: 'Download ICS' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 2480], name: 'Download JSON' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 2624], name: 'Download ODS' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 2864], name: 'Download PDF' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 3088], name: 'Download RTF' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 3232], name: 'Download TEXT FILE' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 3376], name: 'Download XML' } }), node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      fileId: '={{ ($json.message.photo?.[3]?.file_id ?? $json.message.photo?.[2]?.file_id ?? $json.message.photo?.[1]?.file_id ?? $json.message.photo?.[0]?.file_id) ?? $json.message.document?.file_id ?? $json.message.video?.file_id ?? $json.message.voice?.file_id ?? $json.message.video_note?.file_id }}',
      resource: 'file',
      additionalFields: {}
    }, credentials: {
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1152, 3520], name: 'Download XLSX' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [1152, 3680], name: 'get_error_message' } })], { version: 3.2, parameters: {
      rules: {
        values: [
          {
            outputKey: 'csv',
  ...
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {} }, position: [1312, 2048], name: 'Extract from CSV' } }))
  .then(node({ type: 'n8n-nodes-base.aggregate', version: 1, config: { parameters: { options: {}, aggregate: 'aggregateAllItemData' }, position: [1488, 2048] } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1680, 2048], name: 'Normalize CSV' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [2096, 2832], name: 'get_message (File message)' } }))
  .then(node({ type: 'n8n-nodes-base.html', version: 1.2, config: { parameters: {
    ...
    }, position: [1312, 2192], name: 'HTML Extract Generic1' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1488, 2192], name: 'Normalize HTML' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'fromIcs' }, position: [1312, 2336], name: 'Extract from ICS' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1488, 2336], name: 'Normalize ICS' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'fromJson' }, position: [1312, 2480], name: 'Extract from JSON' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1488, 2480], name: 'Normalize JSON' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'ods' }, position: [1312, 2624], name: 'Extract from ODS' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1488, 2624], name: 'Get ODS data' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1648, 2624], name: 'Normalize ODS' } }))
  .add(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'pdf' }, position: [1312, 2784], name: 'Extract from PDF' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [1648, 2768], name: 'Normalize PDF' } }), node({ type: 'n8n-nodes-base.merge', version: 3.2, config: { parameters: { mode: 'chooseBranch', useDataOfInput: 2 }, position: [1312, 2928] } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: '@n8n/n8n-nodes-langchain.googleGemini', version: 1, config: { parameters: {
      ...
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [1488, 2928], name: 'Analyze document' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1648, 2928], name: 'Normalize PDF (AI)' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'rtf' }, position: [1312, 3088], name: 'Extract from RTF' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: '// Get the first item from the input array.\nconst firstItem = items[0];\n\n// Create a new object that has a single key: "data".\n// The value of "data" will be the entire json object from the input.\n// This gathers all fields (First Name, Last Name, Age, etc.) dynamically.\nconst result = {\n  data: firstItem.json\n};\n\n// Return the newly structured object.\n// It will be outputted as a single item with a \'json\' property\n// containing the \'data\' object.\nreturn result;'
    }, position: [1488, 3088], name: 'Get RTF data' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1648, 3088], name: 'Normalize RTF' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'text' }, position: [1312, 3232], name: 'Extract from File' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1488, 3232], name: 'Normalize text file' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'xml' }, position: [1312, 3376], name: 'Extract from XML' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1488, 3376], name: 'Normalize XML' } }))
  .then(node({ type: 'n8n-nodes-base.extractFromFile', version: 1, config: { parameters: { options: {}, operation: 'xlsx' }, position: [1312, 3520], name: 'Extract from XLSX' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: '// Get the first item from the input array.\nconst firstItem = items[0];\n\n// Create a new object that has a single key: "data".\n// The value of "data" will be the entire json object from the input.\n// This gathers all fields (First Name, Last Name, Age, etc.) dynamically.\nconst result = {\n  data: firstItem.json\n};\n\n// Return the newly structured object.\n// It will be outputted as a single item with a \'json\' property\n// containing the \'data\' object.\nreturn result;'
    }, position: [1488, 3520], name: 'Get RTF data1' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [1648, 3520], name: 'Normalize XLSX' } }))
