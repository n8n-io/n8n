const wf = workflow('FnlDCNDV3x4pYVyC', 'Hybrid Search with Qdrant & n8n, Legal AI: Indexing', {
	executionOrder: 'v1',
})
	.add(
		trigger({
	...
	.add(
		node({
			...
			version: 3,
			config: {
				parameters: { options: { reset: false }, batchSize: 8 },
				position: [2640, 496],
	...
	.add(
		sticky(
			...
			{ position: [-1056, 192], width: 592, height: 864 },
		),
	)
	.add(
		sticky(
