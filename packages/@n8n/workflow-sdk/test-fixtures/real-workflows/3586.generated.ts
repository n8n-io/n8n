const wf = workflow(
	...
	.add(
		sticky('## Voice', { name: 'Sticky Note1', position: [120, -240], width: 1340, height: 240 }),
	)
	.add(sticky('## Image', { name: 'Sticky Note2', position: [120, 80], width: 1340, height: 240 }))
	.add(
		sticky('## Document', { name: 'Sticky Note3', position: [120, 420], width: 1340, height: 240 }),
	)
	.add(
		sticky('## Response', {
			name: 'Sticky Note4',
