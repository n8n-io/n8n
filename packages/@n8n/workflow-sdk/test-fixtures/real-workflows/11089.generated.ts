const wf = workflow('mXgQJT7qXMEFQAow', 'Server-Side Meta Ads Tracking Template [PUBLIC]', {
	executionOrder: 'v1',
})
	.add(
		trigger({
	...
	.add(
		sticky(
			...
			{ position: [-1840, -448], width: 592, height: 880 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note3', position: [752, 176], width: 512, height: 224 },
		),
	);
