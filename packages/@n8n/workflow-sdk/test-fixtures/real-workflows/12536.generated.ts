const wf = workflow(
	'ksAl8KwMcTo0Pq5S',
	'Create Viral Selfie Videos With Celebrities Using Veo 3.1',
	{ executionOrder: 'v1' },
)
	.add(
		trigger({
			...
			version: 1,
			config: { position: [208, 496], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1QLZmenUJ-vQAw2UzCe-zKTeWU9ybC1aVfi4ThVq3aUg/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1QLZmenUJ-vQAw2UzCe-zKTeWU9ybC1aVfi4ThVq3aUg/edit?usp=drivesdk',
	...
	.then(
		node({
			...
			version: 3,
			config: { parameters: { options: {} }, position: [640, 496], name: 'Loop Over Items' },
		}),
	)
	.output(0)
	.then(
	...
	.then(
		node({
			...
			config: {
				...
				credentials: { httpHeaderAuth: { id: 'GIEq2Y2xhJSgjqyG', name: 'Postiz' } },
				position: [3280, 400],
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1MisBkHc1RmsYit1ndaPS7oOvSQV1VBMW7nyehTuiRQs/edit#gid=0',
						cachedResultName: 'Foglio1',
					},
					documentId: {
						__rl: true,
	...
	.add(
		sticky(
			...
			{ color: 7, position: [3232, 112], width: 468, height: 200 },
		),
	)
	.add(
		sticky(
			'Set Channel_ID and TITLE for [Postiz](https://affiliate.postiz.com/n3witalia) (TikTok, Instagram, Facebook, X, Youtube)',
			{ name: 'Sticky Note1', color: 7, position: [3232, 336], width: 468, height: 200 },
		),
	)
	.add(
		sticky('Upload final video to Google Drive', {
			name: 'Sticky Note2',
			color: 7,
			position: [3232, -112],
			width: 468,
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note7', color: 7, position: [944, 16], width: 1888, height: 496 },
		),
	)
	.add(
		sticky('## STEP 5 - Upload video\nUpload video to Google Drive and social media platforms', {
			name: 'Sticky Note8',
			color: 7,
			position: [3200, -208],
			width: 528,
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note9', color: 7, position: [2096, -768], width: 736, height: 736 },
		),
	);
