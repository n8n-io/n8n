return workflow('z8nPpsFFe7kDBQUm', '💥 Generate AI viral videos with NanoBanana & VEO3, shared on socials via Blotato - vide', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.telegramTrigger', version: 1.2, config: { parameters: { updates: ['message'], additionalFields: {} }, credentials: {
    ...
    }, position: [-208, -752], name: 'Telegram Trigger: Receive Video Idea' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [480, -752], name: 'Set: Bot Token (Placeholder)' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      options: {}
    }, position: [672, -752], name: 'Telegram API: Get File URL' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
    ...
    }, position: [1088, -752], name: 'OpenAI Vision: Analyze Reference Image' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.7, config: { parameters: {
    ...
    }, position: [1328, -752], name: 'Google Sheets: Update Image Description' } }))
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [1888, -752], name: 'NanoBanana: Create Image' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 20 }, position: [2096, -752], name: 'Wait for Image Edit' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [2096, -528], name: 'Download Edited Image' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [32, -192], name: 'Google Sheets: Read Video Parameters (CONFIG)' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [240, -192], name: 'Set Master Prompt' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      hasOutputParser: true
          ...
          jsonSchemaExample: '{\n  "title": "string",\n  "final_prompt": "string"\n}\n'
        }, name: 'Structured Output Parser' } }) }, position: [560, -192], name: 'AI Agent: Generate Video Script' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-160, 16], name: 'Format Prompt' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [-160, 320], name: 'Generate Video with VEO3' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 20 }, position: [48, 320], name: 'Wait for VEO3 Rendering' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [256, 320], name: 'Download Video from VEO3' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      modelId: {
        __rl: true,
        mode: 'list',
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [416, 320], name: 'Rewrite Caption with GPT-4o' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
      columns: {
        value: {
          STATUS: 'CREATE',
    ...
    }, position: [720, 320], name: 'Save Caption Video to Google Sheets' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1008, -176], name: 'Send Video URL via Telegram' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [1024, 64], name: 'Send Final Video Preview' } }))
  .then(node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
    ...
    }, position: [1024, 320], name: 'Upload Video to BLOTATO' } }))
  .then(merge([node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1280, -64], name: 'Tiktok' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'linkedin',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1472, -64], name: 'Linkedin' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'facebook',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1648, -64], name: 'Facebook' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      accountId: {
        __rl: true,
        mode: 'list',
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1280, 112], name: 'Instagram' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'twitter',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1472, 112], name: 'Twitter (X)' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'youtube',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1648, 112], name: 'Youtube' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'threads',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1280, 320], name: 'Threads' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'bluesky',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1472, 320], name: 'Bluesky' } }), node({ type: '@blotato/n8n-nodes-blotato.blotato', version: 2, config: { parameters: {
      options: {},
      platform: 'pinterest',
      accountId: {
        __rl: true,
      ...
      blotatoApi: { id: 'credential-id', name: 'blotatoApi Credential' }
    }, position: [1648, 320], name: 'Pinterest' } })], { version: 3.2, parameters: { mode: 'chooseBranch', numberInputs: 9 } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [2112, 128], name: 'Update Status to "DONE"' } }))
  .then(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      text: 'Published',
      chatId: '={{ $(\'Telegram Trigger: Receive Video Idea\').item.json.message.chat.id }}',
      additionalFields: {}
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [2112, 336], name: 'Telegram: Send notification' } }))
  .add(node({ type: 'n8n-nodes-base.telegram', version: 1.2, config: { parameters: {
      ...
      telegramApi: { id: 'credential-id', name: 'telegramApi Credential' }
    }, position: [224, -880], name: 'Telegram: Get Image File' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [240, -688], name: 'Google Drive: Upload Image' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.7, config: { parameters: {
      columns: {
        value: {
          STATUS: 'EN COURS',
