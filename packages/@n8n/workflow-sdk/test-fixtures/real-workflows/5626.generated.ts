const wf = workflow(
	'cmncRJ2rlecEwZxU',
	"[Agent Circle's N8N Workflow] Automated AI Image Creator",
	{ executionOrder: 'v1' },
)
	.add(
		trigger({
