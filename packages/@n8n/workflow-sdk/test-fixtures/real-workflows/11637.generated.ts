return workflow('', 'Zyte AI Web Scraper')
  .add(trigger({ type: 'n8n-nodes-base.formTrigger', version: 2.3, config: { parameters: {
    ...
    }, position: [-3728, 1472], name: 'Main form submission' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.form', version: 2.3, config: { parameters: {
      options: {},
      formFields: {
        values: [
          {
    ...
    }, position: [-3152, 1152], name: 'AI Extraction Goal Form' } }), node({ type: 'n8n-nodes-base.form', version: 2.3, config: { parameters: {
      options: {},
      formFields: {
        values: [
          {
    ...
    }, position: [-3152, 1152], name: 'AI Extraction Goal Form' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-1248, 1504], name: 'HTTP Node: SERP Extraction' } }), node({ type: 'n8n-nodes-base.form', version: 2.3, config: { parameters: {
      options: {},
      formFields: {
        values: [
          {
    ...
    }, position: [-3168, 1760], name: 'General Extraction Goal Form' } })], { version: 3.3, parameters: {
      rules: {
        values: [
          {
            conditions: {
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-2928, 1152], name: 'Zyte Config Generator' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-192, -1296], name: 'HTTP Node: [Single Item] Get Details' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
      sendBody: true,
    ...
    }, position: [-192, -992], name: 'HTTP Node: [List] Get Current Page' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
      sendBody: true,
    ...
    }, position: [-192, -640], name: 'HTTP Node: [Current Page] Get Item URLs' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [-464, -80], name: '[List-All] Init State' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [-464, 496], name: '[Details-All] Init State' } })], { version: 3.3, parameters: {
      rules: {
        values: [
          {
            conditions: {
  ...
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [1312, -1280], name: 'Format Output [ Single || List ]' } }))
  .then(node({ type: 'n8n-nodes-base.convertToFile', version: 1.1, config: { parameters: { options: {} }, position: [3248, -368], name: 'Extracted AI Output' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: {
    ...
    }, position: [128, -640], name: '[Current Page] Split Items' } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: { reset: false }, batchSize: 5 }, position: [1104, -640], name: '[Current Page] Item Loop' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [1312, -624], name: 'HTTP Node: [Current Page] Get Item Details' } }))
  .then(merge([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [1488, -48], name: '[List-All] Set Next URL' } })], { version: 3.2, name: '[List-All] Merge Pages' }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [144, -64], name: 'HTTP Node: [List-All] Get Page URLs' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [352, -64], name: '[List-All] Page Controller' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1280, -240], name: '[List-All] Final Output' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
      sendBody: true,
    ...
    }, position: [1072, -48], name: '[List-All] Get Item List' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1280, -48], name: '[List-All] List Accumulator' } }))
  .then(merge([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-464, 496], name: '[Details-All] Init State' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [752, 608], name: '[Details-All] Set Next URL' } })], { version: 3.2, name: '[Details-All] Merge Pages' }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
    ...
    }, position: [144, 512], name: 'HTTP Node: [Details-All] Crawler (Phase 1)' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [336, 512], name: '[Details-All] URL Collector' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [752, 416], name: '[Details-All] Unpack List (Phase 2)' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [752, 608], name: '[Details-All] Set Next URL' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: {
      options: { reset: '={{ $prevNode.name === \'Split Out4\' }}' },
      batchSize: 100
    }, position: [1088, 416], name: '[Details-All] Batch Processor' } }))
  .add(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1600, 240], name: '[Details-All] Final Output' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
    ...
    }, position: [1376, 432], name: 'HTTP Node: [Details-All] Get Details' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1600, 432], name: '[Details-All] Accumulator' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [3248, 1504], name: 'serp response' } }))
  .then(switchCase([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
    ...
    }, position: [-1328, 2192], name: 'HTTP BrowserHtml' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
      sendBody: true,
    ...
    }, position: [-1328, 2496], name: 'HTTP Response Body' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
    ...
    }, position: [-1328, 2816], name: 'HTTP Node: Capture Network API' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
      jsonBody: '={\n  "url": "{{ $json.URL }}",\n  "browserHtml": true,\n  "actions": [\n    {\n      "action": "scrollBottom"\n    }\n  ]\n}',
    ...
    }, position: [-1328, 3136], name: 'HTTP Node: Infinite Scroll' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.zyte.com/v1/extract',
      method: 'POST',
      options: {},
      sendBody: true,
    ...
    }, position: [-1328, 3456], name: 'HTTP Node: Capture Page Screenshot' } })], { version: 3.3, parameters: {
      rules: {
        values: [
          {
            conditions: {
  ...
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [3264, 2720], name: 'Custom Output' } }))
