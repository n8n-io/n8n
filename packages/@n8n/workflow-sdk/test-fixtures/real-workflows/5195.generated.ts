const wf = workflow('icW2uoM7g7pFZhsR', 'AI-Powered Product Research & SEO Content Automation', {
	executionOrder: 'v1',
})
	.add(
		trigger({
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note8', position: [1600, -300], height: 340 },
		),
	);
