return workflow('', '')
  ...
  .then(merge([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [0, 2140], name: 'medium4' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [0, 2400], name: 'medium5' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [-20, 1860], name: 'medium6' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [-20, 1560], name: 'medium7' } }), trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
      simple: false,
      filters: {},
      options: {},
      pollTimes: { item: [{ mode: 'everyMinute' }] }
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [-220, 1560] } }), trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
      simple: false,
      filters: {},
      options: {},
      pollTimes: { item: [{ mode: 'everyMinute' }] }
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [-200, 1860], name: 'Gmail Trigger1' } }), trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
      simple: false,
      filters: {},
      options: {},
      pollTimes: { item: [{ mode: 'everyMinute' }] }
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [-200, 2400], name: 'Gmail Trigger2' } }), trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
      simple: false,
      filters: {},
      options: {},
      pollTimes: { item: [{ mode: 'everyMinute' }] }
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [-200, 2140], name: 'Gmail Trigger3' } })], { version: 3.1, parameters: {
      mode: 'combine',
      options: {},
  ...
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Get spam list1' } })], model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatOpenAi', version: 1.2, config: { parameters: {
          model: {
            __rl: true,
            mode: 'list',
            value: 'gpt-4o-mini',
        ...
        }, name: 'OpenAI Chat Model3' } }), outputParser: outputParser({ type: '@n8n/n8n-nodes-langchain.outputParserStructured', version: 1.3, config: { parameters: {
        ...
        }, name: 'Structured Output Parser1' } }) }, position: [600, 1600], name: 'AI Agent2' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.discord', version: 2, config: { parameters: {
      embeds: {
        values: [
          {
    ...
    }, position: [1160, 1580], name: 'Send a message' } }), null], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .add(trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [-200, 1860], name: 'Gmail Trigger1' } }))
  .add(trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
      simple: false,
      filters: {},
      options: {},
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [-200, 2400], name: 'Gmail Trigger2' } }))
  .add(trigger({ type: 'n8n-nodes-base.gmailTrigger', version: 1.2, config: { parameters: {
      simple: false,
      filters: {},
      options: {},
      ...
      gmailOAuth2: { id: 'credential-id', name: 'gmailOAuth2 Credential' }
    }, position: [-200, 2140], name: 'Gmail Trigger3' } }))
  .add(trigger({ type: 'n8n-nodes-base.webhook', version: 2, config: { parameters: { path: 'email-feedback', options: {}, httpMethod: 'POST' }, position: [360, 2160] } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      ...
      promptType: 'define'
        ...
        }, name: 'Get spam list' } }), tool({ type: 'n8n-nodes-base.googleSheetsTool', version: 4.5, config: { parameters: {
          columns: {
            value: {
        ...
        }, name: 'update spam list' } }), tool({ type: 'n8n-nodes-base.discordTool', version: 2, config: { parameters: {
          guildId: {
            __rl: true,
            mode: 'id',
          ...
          discordOAuth2Api: { id: 'credential-id', name: 'discordOAuth2Api Credential' }
        }, name: 'Get a message in Discord' } })], model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatOpenAi', version: 1.2, config: { parameters: {
          model: {
            __rl: true,
            mode: 'list',
            value: 'gpt-4o-mini',
          ...
          openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
        }, name: 'OpenAI Chat Model1' } }) }, position: [580, 2160], name: 'AI Agent1' } }))
  ...
  .add(sticky('## Filter incoming message\n### Send important emails only', { name: 'Sticky Note5', color: 7, position: [280, 1480], width: 1060, height: 580 }))