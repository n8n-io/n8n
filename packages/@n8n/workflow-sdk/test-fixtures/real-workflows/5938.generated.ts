const wf = workflow('', '')
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-1320, -100], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1nYii2KQDrKZNUPbLJ6r2ogNnGGZggJOJR6b6CGM3slY/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1nYii2KQDrKZNUPbLJ6r2ogNnGGZggJOJR6b6CGM3slY/edit?usp=drivesdk',
		...
		node({
			...
			config: {
				parameters: {
					options: {},
					filtersUI: {
						values: [{ lookupValue: '={{ $json.Status }}', lookupColumn: 'Tahap' }],
					},
					sheetName: {
						__rl: true,
						mode: 'list',
						value: 102550433,
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1nYii2KQDrKZNUPbLJ6r2ogNnGGZggJOJR6b6CGM3slY/edit#gid=102550433',
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 1197995458,
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1nYii2KQDrKZNUPbLJ6r2ogNnGGZggJOJR6b6CGM3slY/edit#gid=1197995458',
				...
				parameters: {
					columns: {
						value: {
							Perusahaan: "={{ $('If1').item.json.Perusahaan }}",
							'Kirim email':
								'=https://n8n-brccptxv.ap-southeast-1.clawcloudrun.com/webhook/18169b76-7b07-4fce-95c4-7e5bb6244ed1/send-email/{{ $json.perusahaan_url_encoded }}',
						},
						schema: [
							{
								id: 'Nama',
	...
	.add(
		sticky(
			...
			{ color: 4, position: [-1380, -340], width: 720, height: 380 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note3', color: 7, position: [-1380, 80], width: 720, height: 940 },
		),
	);
