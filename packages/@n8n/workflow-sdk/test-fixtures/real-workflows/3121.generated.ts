return workflow('aqLL3BAXqQIjeJDt', 'AI Automated TikTok/Youtube Shorts/Reels Generator', {
    timezone: 'America/Los_Angeles',
    callerPolicy: 'workflowsFromSameOwner',
    executionOrder: 'v1'
  })
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1.2, config: { parameters: { rule: { interval: [{ triggerAtHour: 7 }] } }, position: [-1540, 780], name: 'Once Per Day' } }))
  ...
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [-1120, 780], name: 'Load Google Sheet' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
    ...
    }, position: [-980, 780], name: 'Generate Video Captions' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-660, 700], name: 'Create List' } }))
  .then(ifBranch([node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [-540, 120], name: 'Generate Image Prompts' } }), node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      modelId: {
        __rl: true,
        mode: 'list',
        value: 'gpt-4o-mini',
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [-980, 780], name: 'Generate Video Captions' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-240, 120], name: 'Calculate Token Usage' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-60, 40], name: 'Generate Image' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 3 }, position: [80, 40], name: 'Wait 3min' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [220, 40], name: 'Get image' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes' }, position: [540, -40], name: 'Wait 5min' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://api.piapi.ai/api/v1/task',
    ...
    }, position: [-420, 560], name: 'Image-to-Video' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 10 }, position: [-280, 560], name: 'Wait 10min' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '=https://api.piapi.ai/api/v1/task/{{ $json.data.task_id }}',
      options: {},
      sendHeaders: true,
    ...
    }, position: [-160, 560], name: 'Get Video' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes' }, position: [120, 520], name: 'Wait to retry' } }), node({ type: 'n8n-nodes-base.merge', version: 3, config: { parameters: {
      mode: 'combine',
      options: {},
      combineBy: 'combineByPosition'
    }, position: [300, 600], name: 'Match captions with videos' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [460, 600], name: 'List Elements' } }))
  .then(merge([node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: 'return [\n  {\n    scene_titles: items.map(item => item.json.response.text),\n    video_urls: items.map(item => item.json.data.output.video_url),\n    input_tokens: $(\'Calculate Token Usage\').first().json.total_prompt_tokens,\n    output_tokens: $(\'Calculate Token Usage\').first().json.total_completion_tokens,\n    model: $(\'Generate Image Prompts\').first().json.model\n  }\n];'
    }, position: [460, 600], name: 'List Elements' } }), node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: 'return [\n  {\n    sound_urls: items.map(item => $(\'Upload Voice Audio\').first().json.webContentLink)\n  }\n];'
    }, position: [460, 820], name: 'List Elements1' } })], { version: 3, parameters: {
      mode: 'combine',
      options: {},
      combineBy: 'combineByPosition'
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [860, 700], name: 'Render Final Video' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 3 }, position: [980, 700], name: 'Wait1' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [1100, 700], name: 'Get Final Video' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '={{ $json.url }}',
      options: { response: { response: { responseFormat: 'file' } } }
    }, position: [1220, 700], name: 'Get Raw File' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [1360, 700], name: 'Upload Final Video' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [1500, 700], name: 'Set Permissions' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [1660, 700], name: 'Update Google Sheet' } }))
  .then(node({ type: 'n8n-nodes-base.discord', version: 2, config: { parameters: {
    ...
    }, position: [1840, 700], name: 'Notify me on Discord' } }))
  ...
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-60, 1020], name: 'Generate voice' } }))
  ...
  .add(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [-420, 1020], name: 'Generate Script' } }))
  ...
  .add(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [140, 1020], name: 'Upload Voice Audio' } }))
