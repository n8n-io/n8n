const wf = workflow('qhZvZVCoV3HLjRkq', 'Google Maps FULL', { executionOrder: 'v1' })
	.add(
		trigger({
			...
			config: {
				...
				subnodes: {
					memory: memory({
						...
						version: 1.3,
						config: {
							parameters: { contextWindowLength: 50 },
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 1886744055,
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1JewfKbdS6gJhVFz0Maz6jpoDxQrByKyy77I5s7UvLD4/edit#gid=1886744055',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1JewfKbdS6gJhVFz0Maz6jpoDxQrByKyy77I5s7UvLD4/edit?usp=drivesdk',
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', color: 4, position: [-780, 380], width: 1300, height: 440 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note2', color: 5, position: [-780, 860], width: 1300, height: 400 },
		),
	);
