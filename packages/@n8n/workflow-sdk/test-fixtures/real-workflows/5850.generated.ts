						...
						tool({
							...
							config: {
								parameters: {
									...
									start:
										'={{ $fromAI("start", "Event Start date, time and local timezone", "string") }}',
									calendar: {
										__rl: true,
										mode: 'list',
						...
						tool({
							...
							config: {
								parameters: {
									...
									options: {},
									toolDescription:
										'Makes an HTTP request to browse a URL and returns the response data. ',
								},
								name: 'HTTP Request',
							},
						}),
						...
						tool({
							...
							config: {
								parameters: {
									...
									descriptionType: 'manual',
									toolDescription:
										'Create a post referring to an external article via url in LinkedIn',
									additionalFields: {
										title:
