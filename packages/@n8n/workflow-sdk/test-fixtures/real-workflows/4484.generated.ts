return workflow('STzi96JfL52BUuQD', 'AI Voice Chat Agent with ElevenLabs and InfraNodus Graph RAG Knowledge', { executionOrder: 'v1' })
  ...
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 1.9, config: { parameters: {
      ...
      promptType: 'define'
        ...
        }, name: 'Simple Memory' } }), model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini', version: 1, config: { parameters: {
          options: {},
          modelName: 'models/gemini-2.5-flash-preview-04-17'
        }, credentials: {
          googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
        }, name: 'Google Gemini Chat Model' } }), tools: [tool({ type: 'n8n-nodes-base.httpRequestTool', version: 4.2, config: { parameters: {
        ...
        }, name: 'The Flow and the Notion Book' } }), tool({ type: 'n8n-nodes-base.httpRequestTool', version: 4.2, config: { parameters: {
          url: 'https://infranodus.com/api/v1/graphAndAdvice?doNotSave=true&addStats=true&optimize=develop&includeGraph=false&includeGraphSummary=true&includeStatements=true',
          method: 'POST',
          options: {},
          sendBody: true,
          ...
          httpBearerAuth: { id: 'credential-id', name: 'httpBearerAuth Credential' }
        }, name: 'Waves into Patterns Book Expert' } }), tool({ type: 'n8n-nodes-base.httpRequestTool', version: 4.2, config: { parameters: {
          url: 'https://infranodus.com/api/v1/graphAndAdvice?doNotSave=true&addStats=true&optimize=develop&includeGraph=false&includeGraphSummary=true&includeStatements=true',
          method: 'POST',
          options: {},
          sendBody: true,
          ...
          httpBearerAuth: { id: 'credential-id', name: 'httpBearerAuth Credential' }
        }, name: 'The Polysingularity Letters Book' } }), tool({ type: 'n8n-nodes-base.httpRequestTool', version: 4.2, config: { parameters: {
          url: 'https://infranodus.com/api/v1/graphAndAdvice?doNotSave=true&addStats=true&optimize=develop&includeGraph=false&includeGraphSummary=true&includeStatements=true',
          method: 'POST',
          options: {},
          sendBody: true,
          ...
          httpBearerAuth: { id: 'credential-id', name: 'httpBearerAuth Credential' }
        }, name: 'Special Agent\'s Manual Book Expert' } })] }, position: [520, -20], name: 'AI Agent' } }))
  .then(node({ type: 'n8n-nodes-base.respondToWebhook', version: 1.2, config: { parameters: { options: {} }, position: [1060, -20], name: 'Respond to Webhook' } }))
  .add(node({ type: '@n8n/n8n-nodes-langchain.lmChatOpenAi', version: 1, config: { parameters: { model: 'gpt-4o', options: {} }, credentials: {
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [400, 540], name: 'OpenAI Model' } }))
  .add(sticky('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n## Expert #1\n\nAdd your InfraNodus graph here via the HTTP node using its name in the `body.name` field.\n\nDescribe what the expert does in the Description of the tool. You can use auto-generated Graph RAG summary from InfraNodus > Graph > Project Notes\n\n![Book Screenshot](https://i.ibb.co/rfxsJ4MV/circadian-special-agents-manual.png)', { name: 'Sticky Note1', position: [840, 260], width: 200, height: 740 }))
  .add(sticky('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n## Expert #2\n\nAdd your InfraNodus graph here via the HTTP node using its name in the `body.name` field.\n\nDescribe what the expert does in the Description of the tool. You can use auto-generated Graph RAG summary from InfraNodus > Graph > Project Notes\n\n![waves into patterns screen](https://i.ibb.co/1tDJSgVq/circadian-waves-into-patterns.png)', { name: 'Sticky Note2', position: [1060, 260], width: 200, height: 740 }))
