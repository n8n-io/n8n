const wf = workflow('M7saccCy1gO4g2zr', 'Agent_Builder', { executionOrder: 'v1' })
	.add(
		trigger({
						...
						tool({
							...
							config: {
								parameters: {
									...
									toolDescription:
										"This vectorstore contains some of n8n's technical documentations.",
								},
								credentials: {
						...
						values: [
							{
								role: 'system',
								content:
									'Transform the input into valid n8n template JSON format. make sure all nodes are correctly set up and CONNECTED!\n\nmake especially sure the AI agent(s) are correctly set up and connected. here is an example:\n\n{\n  "id": "ai-agent-gpt4o-serpapi-manual",\n  "name": "GPT-4o Agent with SerpAPI & Memory (Manual Trigger)",\n  "nodes": [\n  {\n  "id": "dba53fd3-6bf0-46c9-9659-286f643fd6d1",\n  "name": "Manual Trigger",\n  "type": "n8n-nodes-base.manualTrigger",\n  "position": [\n  -420,\n  -40\n  ],\n  "parameters": {},\n  "typeVersion": 1\n  },\n  {\n  "id": "dd16c4ff-c7d4-45fc-b75a-29bdb6dcc0c2",\n  "name": "Window Buffer Memory",\n  "type": "@n8n/n8n-nodes-langchain.memoryBufferWindow",\n  "position": [\n  -140,\n  -40\n  ],\n  "parameters": {},\n  "typeVersion": 1.3\n  },\n  {\n  "id": "32a1cc05-dab8-4be1-bd6a-8396fbe0df0e",\n  "name": "GPT-4o Chat Model",\n  "type": "@n8n/n8n-nodes-langchain.lmChatOpenAi",\n  "position": [\n  -140,\n  -220\n  ],\n  "parameters": {\n  "model": {\n  "__rl": true,\n  "mode": "list",\n  "value": "gpt-4o",\n  "cachedResultName": "gpt-4o"\n  },\n  "options": {}\n  },\n  "credentials": {\n  "openAiApi": {\n  "id": "<OPENROUTER_CREDENTIAL_ID>",\n  "name": "OpenRouter API Key"\n  }\n  },\n  "typeVersion": 1.2\n  },\n  {\n  "id": "ea7379d9-b6dd-49ff-ac01-2d9c608f7c11",\n  "name": "SerpAPI",\n  "type": "@n8n/n8n-nodes-langchain.toolSerpApi",\n  "position": [\n  -140,\n  140\n  ],\n  "parameters": {\n  "options": {}\n  },\n  "credentials": {\n  "serpApi": {\n  "id": "<SERPAPI_CREDENTIAL_ID>",\n  "name": "SerpAPI Key"\n  }\n  },\n  "typeVersion": 1\n  },\n  {\n  "id": "10a3f41d-4f1a-4efa-92b3-7adb3f98f604",\n  "name": "AI Agent",\n  "type": "@n8n/n8n-nodes-langchain.agent",\n  "position": [\n  160,\n  -40\n  ],\n  "parameters": {\n  "text": "=Respond to the user’s request given in the trigger item.",\n  "options": {\n  "systemMessage": "You are an AI assistant that can perform web searches with SerpAPI when helpful."\n  },\n  "promptType": "define"\n  },\n  "typeVersion": 1.7\n  },\n  {\n  "id": "f8b0c3ae-8423-4db9-a287-3e3c640ef0bb",\n  "name": "Set Response",\n  "type": "n8n-nodes-base.set",\n  "position": [\n  400,\n  -40\n  ],\n  "parameters": {\n  "assignments": {\n  "assignments": [\n  {\n  "id": "acb7e4d0-f718-4eae-8f50-0ca15c5c68e2",\n  "name": "answer",\n  "type": "string",\n  "value": "={{ $json.output }}"\n  }\n  ]\n  },\n  "options": {}\n  },\n  "typeVersion": 3.4\n  }\n  ],\n  "connections": {\n  "Manual Trigger": {\n  "main": [\n  [\n  {\n  "node": "Window Buffer Memory",\n  "type": "main",\n  "index": 0\n  }\n  ]\n  ]\n  },\n  "Window Buffer Memory": {\n  "main": [\n  [\n  {\n  "node": "AI Agent",\n  "type": "main",\n  "index": 0\n  }\n  ]\n  ],\n  "ai_memory": [\n  [\n  {\n  "node": "AI Agent",\n  "type": "ai_memory",\n  "index": 0\n  }\n  ]\n  ]\n  },\n  "GPT-4o Chat Model": {\n  "ai_languageModel": [\n  [\n  {\n  "node": "AI Agent",\n  "type": "ai_languageModel",\n  "index": 0\n  }\n  ]\n  ]\n  },\n  "SerpAPI": {\n  "ai_tool": [\n  [\n  {\n  "node": "AI Agent",\n  "type": "ai_tool",\n  "index": 0\n  }\n  ]\n  ]\n  },\n  "AI Agent": {\n  "main": [\n  [\n  {\n  "node": "Set Response",\n  "type": "main",\n  "index": 0\n  }\n  ]\n  ]\n  }\n  },\n  "active": true,\n  "settings": {\n  "executionOrder": "v1"\n  }\n  }\n',
							},
							{ content: '={{ $json.output }}' },
						],
					},
	...
	.then(
		node({
			...
			config: {
				parameters: {
					mode: 'each',
					options: { format: true, encoding: 'utf8', fileName: '' },
					operation: 'toJson',
					binaryPropertyName: '=',
				},
				position: [-720, 240],
	...
	.add(
		trigger({
			type: 'n8n-nodes-base.manualTrigger',
			version: 1,
			config: { position: [-2320, -1060], name: 'When clicking ‘Test workflow’' },
		}),
	)
	.then(
		node({
	...
	.then(
		node({
			type: 'n8n-nodes-base.wait',
			version: 1.1,
			config: { position: [-1660, -1060], name: '30 Secs' },
		}),
	)
	.then(
		node({
			type: 'n8n-nodes-base.httpRequest',
			version: 4.2,
			config: { parameters: { options: {} }, position: [-1440, -1060], name: 'Get Results' },
		}),
	)
	.then(
		node({
	...
	.add(
		sticky(
			...
			{ name: 'Configure SerpAPI', color: 4, position: [-3100, 360], width: 620, height: 100 },
		),
	)
	.add(
		sticky(
			'⚙️ **Pinecone Vector Store**\nNodes: **“Train Pinecone Vector Store”** & **“Pinecone Vector Store”**\n• Add a *Pinecone API* credential with **Environment**, **API Key**, and **Index Name**.\n• Make sure both nodes point to the same index.',
			{ name: 'Configure Pinecone1', color: 4, position: [-3100, 480], width: 620, height: 100 },
		),
	)
	.add(
		sticky(
			'⚙️ **OpenAI / Azure OpenAI**\nNodes: **“Embeddings OpenAI”**, **“Embeddings OpenAI 2”**, **“OpenAI (validator)”**\n1. Create an *OpenAI API* credential (or Azure equivalent).\n2. Select the credential in all three nodes.\n3. Ensure the embedding model (e.g. `text-embedding-3-small`) is available in your account.',
			{ name: 'Configure OpenAI API1', color: 4, position: [-3100, 600], width: 620 },
		),
	);
