return workflow('', '')
  .add(trigger({ type: 'n8n-nodes-base.scheduleTrigger', version: 1.2, config: { parameters: { rule: { interval: [{}] } }, position: [-2220, 2160] } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      ...
      sheetName: {
        ...
        mode: 'list',
        value: 1782913168,
        cachedResultUrl: 'https://docs.google.com/spreadsheets/d/1tRjZTbM10koP6kpXzfIf9LzuuvnDcPAtv7fTTC36SnE/edit#gid=1782913168',
      ...
      documentId: {
        ...
        cachedResultUrl: 'https://docs.google.com/spreadsheets/d/1tRjZTbM10koP6kpXzfIf9LzuuvnDcPAtv7fTTC36SnE/edit?usp=drivesdk',
    ...
    }, position: [-2020, 2160], name: 'Get Settings1' } }))
  ...
  .then(ifBranch([node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      ...
      sheetName: {
        ...
        mode: 'list',
        value: 'gid=0',
        cachedResultUrl: 'https://docs.google.com/spreadsheets/d/1tRjZTbM10koP6kpXzfIf9LzuuvnDcPAtv7fTTC36SnE/edit#gid=0',
    ...
    }, position: [-1360, 2160], name: 'Companies Recovery' } }), node({ type: 'n8n-nodes-base.stopAndError', version: 1, config: { parameters: {
      errorMessage: 'Missing API Key or Account ID in the Google Sheet'
    }, position: [-1340, 2420], name: 'Missing API Key or Account ID1' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.filter', version: 2.2, config: { parameters: {
    ...
    }, position: [-1160, 2160], name: 'Filter Score and State' } }))
  .then(node({ type: 'n8n-nodes-base.limit', version: 1, config: { parameters: { maxItems: 100 }, position: [-960, 2160] } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [-640, 2160], name: 'Loop Over Items' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-420, 2160], name: 'Find Employees' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'data' }, position: [40, 2160], name: 'Split Profiles' } }), node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [40, 2420], name: 'No decision maker found' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [260, 2160], name: 'Get Profile details' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [480, 2160], name: 'Get Email' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [700, 2160], name: 'Keep relevant information' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
    ...
    }, position: [1020, 2160], name: 'Create Personalization' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      modelId: {
        __rl: true,
        mode: 'list',
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [1380, 2160], name: 'Generate Emails Messages' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      modelId: {
        __rl: true,
        mode: 'list',
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [1740, 2160], name: 'Generate Emails Subjects' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
    ...
    }, position: [2100, 2160], name: 'Add lead(s)' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
          State: 'Enriched',
    ...
    }, position: [2300, 2160], name: 'Lead(s) found' } }))
  .add(trigger({ type: 'n8n-nodes-base.manualTrigger', version: 1, config: { position: [-1620, 1100], name: 'Start' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      sheetName: {
        __rl: true,
    ...
    }, position: [-1420, 1100], name: 'Get Settings' } }))
  .then(node({ type: 'n8n-nodes-base.aggregate', version: 1, config: { parameters: {
      options: {},
      aggregate: 'aggregateAllItemData',
      destinationFieldName: 'settings'
    }, position: [-1220, 1100], name: 'Aggregate1' } }))
  .then(ifBranch([node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [-860, 1100], name: 'Make the perfect request' } }), node({ type: 'n8n-nodes-base.stopAndError', version: 1, config: { parameters: {
      errorMessage: 'Missing API Key or Account ID in the Google Sheet'
    }, position: [-760, 1360], name: 'Missing API Key or Account ID' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-500, 1100], name: 'Search Companies' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'data' }, position: [-300, 1100], name: 'Extract Company Data' } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [20, 1100], name: 'Process Each Company' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [240, 1100], name: 'Get Company Info' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      options: {},
      filtersUI: {
    ...
    }, position: [660, 1100], name: 'Check If Company Exists' } }), node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [20, 1100], name: 'Process Each Company' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
    ...
    }, name: 'Filter Valid Companies', onError: 'continueRegularOutput' }))
  .then(ifBranch([node({ type: '@n8n/n8n-nodes-langchain.openAi', version: 1.8, config: { parameters: {
      modelId: {
        __rl: true,
        mode: 'list',
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' }
    }, position: [1220, 1100], name: 'AI Company Scoring' } }), node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [20, 1100], name: 'Process Each Company' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
