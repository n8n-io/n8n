return workflow('ZLvtiRLuKIdbuPvG', 'SEO Strategy Director', { executionOrder: 'v1' })
  ...
  .add(sticky('## The Manager Core\nThe **SEO Director Agent** is the brain. It receives your prompt, pulls context from **Memory**, and gathers live data via **SerpAPI** before deciding which specialists to hire for the job.', { color: 7, position: [-208, -1088], width: 864, height: 528 }))
