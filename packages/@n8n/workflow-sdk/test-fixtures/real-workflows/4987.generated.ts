return workflow('Njfc4Qsoi6p35Bfj', '3D Product Video', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.formTrigger', version: 2.2, config: { parameters: {
    ...
    }, position: [-1080, 80], name: 'On Form Submission' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-860, 80], name: 'Create Slug' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [-640, 80], name: 'Create Folder' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
      fileId: {
        __rl: true,
        mode: 'id',
    ...
    }, position: [-420, 80], name: 'Give Access to folder' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: 'let results = [];\nconst items = $("On Form Submission").all()\n\nfor (item of items) {\n    for (key of Object.keys(item.binary)) {\n        results.push({\n            json: {\n                fileName: item.binary[key].fileName\n            },\n            binary: {\n                data: item.binary[key],\n            }\n        });\n    }\n}\n\nreturn results;'
    }, position: [-200, 80], name: 'Get Image File' } }))
  .add(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [20, -20], name: 'Upload Original Image' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
    ...
    }, position: [240, -20], name: 'Insert New Product' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [20, 180], name: 'Remove Image Background' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [240, 180], name: 'Upload Remove BG image' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [900, 180], name: 'Create Video' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 40 }, position: [1120, 180] } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '={{ $json.status_url }}',
      options: {},
      sendHeaders: true,
    ...
    }, position: [1340, 105], name: 'Check Video Status' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 40 }, position: [1120, 180] } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [1780, 180], name: 'Get Video Link' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [2000, 180], name: 'Convert to Binary File' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
      name: '=Video-file',
      driveId: { __rl: true, mode: 'list', value: 'My Drive' },
      options: {},
    ...
    }, position: [2220, 180], name: 'Upload Video' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.5, config: { parameters: {
      columns: {
        value: {
          Slug: '={{ $(\'Create Folder\').item.json.name }}',
    ...
    }, position: [2440, 180], name: 'Update Video Link' } }))
