const wf = workflow('szS5RoHWF5QAzxqk', 'B2B AI Leads Automation', { executionOrder: 'v1' })
	.add(
		trigger({
				...
				parameters: {
					columns: {
						value: {
							...
							'Job Title ': "={{ $('HTTP Request').item.json.person.title }}",
							'Linkedin URL':
								"={{ $('On form submission').item.json[\"What's your Linkedin Profile URL\"] }}",
							Organization:
								"={{ $('HTTP Request').item.json.person.employment_history[0].organization_name }}",
						},
						schema: [
							{
								id: 'Name',
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1Z3BuYjWFsGjCjTmpyCUqtjL_gHPZDBriDzfMUudmArA/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1Z3BuYjWFsGjCjTmpyCUqtjL_gHPZDBriDzfMUudmArA/edit?usp=drivesdk',
