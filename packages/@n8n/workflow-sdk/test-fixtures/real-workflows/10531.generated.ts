const wf = workflow('I7d4x1yTzFgp0Eib', 'Smart Inventory Replenishment & Auto-Purchase Orders', {
	executionOrder: 'v1',
})
	.add(
		trigger({
	...
	.then(
		node({
			...
			version: 1.3,
			config: {
				parameters: { resource: '__CUSTOM_API_CALL__' },
				credentials: {
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', position: [0, -176], width: 176, height: 736 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note3', position: [1776, -320], width: 192, height: 880 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note5', position: [2224, -320], height: 864 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note8', position: [1328, -96], width: 208, height: 672 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note6', position: [1104, 32], width: 208, height: 496 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note9', position: [896, 0], width: 192, height: 528 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note10', position: [688, -80], width: 176, height: 640 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note11', position: [480, -96], width: 160, height: 672 },
		),
	);
