return workflow('6Bn6KSpg1le9mG4Y', 'Alapaca Trade automation', {
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-140, 680], name: 'Alpaca-get-account-info' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [80, 680], name: 'write_account_balace_today' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
      options: {},
      filtersUI: {
    ...
    }, position: [300, 680], name: 'read_sentiments_score_today' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [520, 680], name: 'filter_top_sentiment_score' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpQueryAuth: { id: 'credential-id', name: 'httpQueryAuth Credential' },
      httpCustomAuth: { id: 'credential-id', name: 'httpCustomAuth Credential' }
    }, position: [740, 680], name: 'Alpaca_get_open_positions' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [960, 680], name: 'create_positions_to_close_and_positions_two_open' } }))
  .add(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: {
      options: {},
      fieldToSplitOut: 'positions_not_in_top_sentiment'
    }, position: [1400, 580], name: 'positions_to_close' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpQueryAuth: { id: 'credential-id', name: 'httpQueryAuth Credential' },
      httpCustomAuth: { id: 'credential-id', name: 'httpCustomAuth Credential' }
    }, position: [1620, 580], name: 'Alpaca-post-order-sell' } }))
  .then(merge([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpQueryAuth: { id: 'credential-id', name: 'httpQueryAuth Credential' },
      httpCustomAuth: { id: 'credential-id', name: 'httpCustomAuth Credential' }
    }, position: [1620, 580], name: 'Alpaca-post-order-sell' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpQueryAuth: { id: 'credential-id', name: 'httpQueryAuth Credential' },
      httpCustomAuth: { id: 'credential-id', name: 'httpCustomAuth Credential' }
    }, position: [1620, 780], name: 'Alpaca-post-order-buy' } })], { version: 3.2, name: 'merge_orders_to_write_to_sheets' }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
      columns: {
        value: {
          date: '={{ $today }}',
