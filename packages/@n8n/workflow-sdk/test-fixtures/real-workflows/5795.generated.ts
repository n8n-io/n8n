return workflow('', 'Reels Trends Watcher')
  .add(trigger({ type: 'n8n-nodes-base.manualTrigger', version: 1, config: { position: [-640, 660], name: 'When clicking ‘Execute workflow’' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-420, 660], name: 'Variables' } }))
  .then(node({ type: 'n8n-nodes-base.notion', version: 2.2, config: { parameters: {
    ...
    }, position: [-200, 660], name: 'Get Sources' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [20, 660], name: 'Apify Payload' } }))
  .then(node({ type: '@apify/n8n-nodes-apify.apify', version: 1, config: { parameters: {
    ...
    }, position: [240, 660], name: 'Run an Actor' } }))
  .then(node({ type: '@apify/n8n-nodes-apify.apify', version: 1, config: { parameters: {
      ...
      apifyApi: { id: 'credential-id', name: 'apifyApi Credential' }
    }, position: [460, 660], name: 'Get Status' } }))
  .then(switchCase([node({ type: '@apify/n8n-nodes-apify.apify', version: 1, config: { parameters: {
      limit: null,
      resource: 'Datasets',
      ...
      apifyApi: { id: 'credential-id', name: 'apifyApi Credential' }
    }, position: [900, 540], name: 'Get dataset items' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 1 }, position: [900, 760] } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 1 }, position: [900, 760] } })], { version: 3.2, parameters: {
      rules: {
        values: [
          {
            outputKey: 'Done',
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1120, 540], name: 'Map Reels' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.notion', version: 2, config: { parameters: {
      ...
      notionApi: { id: 'credential-id', name: 'notionApi Credential' }
    }, position: [1560, 540], name: 'Update Accounts' } }), null], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1780, 540], name: 'Many to One' } }))
  .then(node({ type: 'n8n-nodes-base.notion', version: 2.2, config: { parameters: {
      filters: {
        conditions: [
          {
      ...
      notionApi: { id: 'credential-id', name: 'notionApi Credential' }
    }, position: [2000, 540], name: 'Get Reels' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
  ...
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [-400, 1400], name: 'Loop Over Items' } }))
  .add(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
      jsCode: '// Loop over input items and add a new field called \'myNewField\' to the JSON of each one\nfor (const item of $input.all()) {\n  item.json.myNewField = 1;\n}\n\nreturn $input.all();'
    }, position: [-180, 1100], name: 'Stats' } }))
  .add(node({ type: 'n8n-nodes-base.switch', version: 3.2, config: { parameters: {
      rules: {
        values: [
          {
            outputKey: 'Create',
      ...
      options: {}
    }, position: [-180, 1300], name: 'Is Created?' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: { url: '={{ $json.videoUrl }}', options: {} }, position: [40, 1220], name: 'Download Video' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [260, 1220], name: 'Upload to Gemini' } }))
  .then(node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 1 }, position: [480, 1220], name: 'Processing Delay' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '={{ $json.file.uri }}',
      options: {},
      authentication: 'predefinedCredentialType',
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' },
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [700, 1160], name: 'Get File State' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [1160, 1240], name: 'Set Prompt' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { unit: 'minutes', amount: 1 }, position: [480, 1220], name: 'Processing Delay' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      openAiApi: { id: 'credential-id', name: 'openAiApi Credential' },
      googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
    }, position: [1360, 1220], name: 'Gemini Analyze' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1580, 1220], name: 'Format Response' } }))
  .then(node({ type: 'n8n-nodes-base.notion', version: 2.2, config: { parameters: {
      ...
      notionApi: { id: 'credential-id', name: 'notionApi Credential' }
    }, position: [1800, 1360], name: 'Create' } }))
