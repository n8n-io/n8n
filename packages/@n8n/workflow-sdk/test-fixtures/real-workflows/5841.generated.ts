const wf = workflow('59a8WDMIKKo9faYP', 'Posting', { executionOrder: 'v1' })
	.add(
		trigger({
				...
				parameters: {
					...
					messages: {
						values: [
							{
								content:
									'Create a 50 character title of a topic related to very specific problem related to n8n or automation.',
							},
						],
					},
				},
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1P18TjyEEsgUey_gqXoNsE5GlsaGDmJYVl0ZWVzxCU7U/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1P18TjyEEsgUey_gqXoNsE5GlsaGDmJYVl0ZWVzxCU7U/edit?usp=drivesdk',
	...
	.then(
		node({
			...
			version: 2,
			config: {
				parameters: { text: '={{ $json.Description }}', additionalFields: {} },
				credentials: {
