return workflow('', '')
  ...
  .add(sticky('## 1. Add MCP Server Trigger\n[Read more about the MCP server trigger](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.mcptrigger/)', { color: 7, position: [-3920, 80], width: 720, height: 740 }))
