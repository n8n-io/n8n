return workflow('iicQhN2T4dTs1xcU', '💥 Convert YouTube videos to viral Shorts with Klap and auto-post with Blotato -VIDE', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.telegramTrigger', version: 1.2, config: { parameters: { updates: ['message'], additionalFields: {} }, credentials: {
    ...
    }, position: [-760, -100], name: 'Trigger: Receive YouTube URL via Telegram' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-580, -100], name: 'Extract YouTube URL & Number of Shorts' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-400, -100], name: 'Send Video to Klap for Shorts Generation' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '=https://api.klap.app/v2/tasks/{{ $json.id }}',
      options: {},
      sendHeaders: true,
      headerParameters: { parameters: [{ name: 'Authorization', value: 'YOUR_API' }] }
    }, position: [-200, -100], name: 'Check Shorts Generation Status' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      sendHeaders: true,
      headerParameters: { parameters: [{ name: 'Authorization', value: 'YOUR_API' }] }
    }, position: [240, -100], name: 'List Generated Clip Ideas' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 60 }, position: [240, 80], name: 'Wait Before Checking Status Again' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      sendHeaders: true,
      headerParameters: { parameters: [{ name: 'Authorization', value: 'YOUR_API' }] }
    }, position: [460, -100], name: 'Export HD Short from Klap' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      sendHeaders: true,
      headerParameters: { parameters: [{ name: 'Authorization', value: 'YOUR_API' }] }
    }, position: [700, -100], name: 'Fetch Final Shorts URLs' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [980, -100], name: 'Are All Shorts Ready?' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '=https://www.youtube.com/oembed?url={{ $(\'Extract YouTube URL & Number of Shorts\').item.json[\'YouTube URL\'] }}&format=json ',
      options: {}
    }, position: [-760, 540], name: 'Fetch YouTube Video Title' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 60 }, position: [1200, 60], name: 'Wait Before Rechecking Final Shorts' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
    ...
    }, position: [-500, 540], name: 'Load Publishing Schedule from Google Sheets' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-240, 540], name: 'Extract Scheduling Parameters (Posts/Day, Hours)' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
      options: {},
      sheetName: { __rl: true, mode: 'id', value: '=' },
      documentId: { __rl: true, mode: 'id', value: '=' }
    ...
    }, position: [40, 540], name: 'Fetch Already Scheduled Shorts' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-760, 800], name: 'Determine Last Scheduled Time' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-500, 800], name: 'Calculate Publication Times for New Shorts' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-240, 800], name: 'Convert Times to Local Timezone (Paris)' } }))
  .then(node({ type: 'n8n-nodes-base.googleSheets', version: 4.6, config: { parameters: {
      columns: {
        value: {
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [560, 680], name: 'Upload Video to Blotato' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [840, 420], name: 'INSTAGRAM' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1060, 420], name: 'YOUTUBE' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
  ...
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [840, 680], name: 'FACEBOOK' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1060, 680], name: 'THREADS' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1260, 680], name: 'TWITTER' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [840, 920], name: 'LINKEDIN' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1060, 920], name: 'BLUESKY' } }))
  .add(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://backend.blotato.com/v2/posts',
      method: 'POST',
      options: {},
    ...
    }, position: [1260, 920], name: 'PINTEREST' } }))
