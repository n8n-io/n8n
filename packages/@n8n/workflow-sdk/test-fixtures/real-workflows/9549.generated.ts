return workflow('AJch0Bi1L5u67nRO', 'Fathom Meeting Summary & Actions AI Agent', {
  ...
  .add(sticky('## Capture Meeting and Validate\nGet all Fathom meeting data, extract + format relevant contents, and validate there\'s transcript data before triggering the Gemini API request.', { position: [-624, -272], width: 640, height: 464 }))
