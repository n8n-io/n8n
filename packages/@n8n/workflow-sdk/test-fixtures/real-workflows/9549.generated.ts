return workflow('AJch0Bi1L5u67nRO', 'Fathom Meeting Summary & Actions AI Agent', {
  ...
  .add(trigger({ type: 'n8n-nodes-base.webhook', version: 2.1, config: { parameters: {
      ...
      httpMethod: 'POST'
    }, position: [-560, -96], name: 'Get Fathom Meeting' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [-368, -96], name: 'Format Key Parts' } }))
  .then(ifBranch([node({ type: '@n8n/n8n-nodes-langchain.chainLlm', version: 1.7, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Structured Output Parser' } }) }, position: [96, -144], name: 'AI Meeting Analysis' } }), null], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [432, -112], name: 'Set Fields' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [704, -112], name: 'Create as HTML' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [912, -112], name: 'Upload File as HTML' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [1120, -112], name: 'Convert to Google Doc' } }))
  .add(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [1344, 16], name: 'Delete HTML File' } }))
