const wf = workflow('MKPGGcZ4kNS2VaAd', 'Auto Gmail Labeling (Powered by OpenAI)', {
	...
	.then(
		node({
			...
			version: 1,
			config: { position: [1000, -600], name: 'Replace Me' },
		}),
	)
	.add(
		node({
	...
	.add(
		sticky('## Auto Gmail Labeling (Powered by OpenAI)', {
			position: [-2440, -960],
			width: 3820,
			height: 740,
		}),
