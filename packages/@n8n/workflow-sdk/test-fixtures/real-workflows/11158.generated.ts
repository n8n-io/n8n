return workflow('B01FguFGfZeVurIi', 'Olostep Amazon scraper', { executionOrder: 'v1' })
  .add(trigger({ type: 'n8n-nodes-base.formTrigger', version: 2.3, config: { parameters: {
    ...
    }, position: [-1424, 480], name: 'On form submission' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [-1248, 480], name: 'Edit Fields' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'counter' }, position: [-1040, 480], name: 'Split Out2' } }))
  .then(node({ type: 'n8n-nodes-base.splitInBatches', version: 3, config: { parameters: { options: {} }, position: [-832, 480], name: 'Loop Over Items' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [-608, 496], name: 'scrape amazon products' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [-432, 496], name: 'parsedInfo' } }))
  .then(node({ type: 'n8n-nodes-base.splitOut', version: 1, config: { parameters: { options: {}, fieldToSplitOut: 'parsedJson' }, position: [-224, 496] } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [176, 368], name: 'Edit Fields1' } }), node({ type: 'n8n-nodes-base.dataTable', version: 1, config: { parameters: {
      columns: {
    ...
    }, position: [368, 512], name: 'Insert row' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
