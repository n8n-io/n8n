const wf = workflow('e63GF6KHkhFUFKfz', 'Build your first email agent with fall back model', {
	executionOrder: 'v1',
})
	.add(
		trigger({
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', position: [1072, -512], width: 640, height: 1360 },
		),
	)
	.add(
		sticky(
