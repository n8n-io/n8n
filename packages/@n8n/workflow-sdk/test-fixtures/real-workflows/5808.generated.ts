return workflow('94ZTfrnyRHFV3xxr', 'DocAgentForTemplate', { executionOrder: 'v1' })
  .add(trigger({ type: '@n8n/n8n-nodes-langchain.chatTrigger', version: 1.1, config: { parameters: {
      public: true,
      options: {},
      initialMessages: 'Merhaba! 👋\nMy name is DocAgent. '
    }, position: [-60, -20], name: 'When chat message received' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.agent', version: 2, config: { parameters: {
      options: {
        ...
        }, name: 'DocProcess' } }), tool({ type: 'n8n-nodes-base.httpRequestTool', version: 4.2, config: { parameters: {
        ...
        }, name: 'GetMetaData' } })], memory: memory({ type: '@n8n/n8n-nodes-langchain.memoryPostgresChat', version: 1.3, config: { credentials: {
        ...
        }, name: 'Google Gemini Chat Model' } }) }, position: [240, -20], name: 'DocAgent' } }))
  .add(trigger({ type: 'n8n-nodes-base.executeWorkflowTrigger', version: 1.1, config: { parameters: {
    ...
    }, position: [80, 1020], name: 'When Executed by Another Workflow' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.chainLlm', version: 1.7, config: { parameters: {
      ...
      hasOutputParser: true
        ...
        }, name: 'Structured Output Parser' } }), model: languageModel({ type: '@n8n/n8n-nodes-langchain.lmChatGoogleGemini', version: 1, config: { parameters: { options: {}, modelName: 'models/gemini-2.5-pro' }, credentials: {
          googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
        }, name: 'Google Gemini Chat Model2' } }) }, position: [300, 1020], name: 'User Choice Match Check' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [880, 920], name: 'User Choice Match Correct' } }), node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
          {
    ...
    }, position: [880, 1120], name: 'User Choice Matching Error' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      headerParameters: { parameters: [{ name: 'accept', value: 'application/json' }] }
    }, position: [1100, 920], name: 'GetMetaData2' } }))
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: { assignments: [] },
      includeOtherFields: true
    }, position: [1320, 920], name: 'Edit Fields' } }))
  .then(node({ type: '@n8n/n8n-nodes-langchain.chainLlm', version: 1.7, config: { parameters: {
      ...
      hasOutputParser: true
          ...
          googlePalmApi: { id: 'credential-id', name: 'googlePalmApi Credential' }
        }, name: 'Google Gemini Chat Model1' } }) }, position: [1540, 920], name: 'Format Control' } }))
  .then(node({ type: 'n8n-nodes-base.code', version: 2, config: { parameters: {
    ...
    }, position: [1900, 920], name: 'Formatting Correction' } }))
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [2120, 920], name: 'CopyTemplate' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [2560, 820], name: 'Cop. Document ID Matching Error' } }), node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: 'https://script.google.com/macros/s/<YOUR_DEPLOY_ID>/exec',
      method: 'POST',
      options: {},
      sendBody: true,
    ...
    }, position: [2560, 1020], name: 'FillDocument' } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(ifBranch([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
    ...
    }, position: [3000, 820], name: 'Generate Download Link' } }), node({ type: 'n8n-nodes-base.switch', version: 3.2, config: { parameters: {
      rules: {
        values: [
          {
      ...
      options: {}
    }, position: [3000, 1120] } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
  ...
  .then(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [3220, 820], name: 'Download Link Format' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
    ...
    }, position: [3220, 1220], name: 'Template Technical Error' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [3220, 1020], name: 'Incomplete Information Error' } }))
  .add(node({ type: 'n8n-nodes-base.set', version: 3.4, config: { parameters: {
      options: {},
      assignments: {
        assignments: [
    ...
    }, position: [3220, 1420], name: 'Other Errors' } }))
