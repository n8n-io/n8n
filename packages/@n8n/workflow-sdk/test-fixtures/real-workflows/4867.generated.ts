return workflow('e5XxiuYXr5atCH64', 'Stock Analysis Assistant', {
  ...
  .add(sticky('# 🧠 Stock Analysis Assistant\n\nThis workflow analyzes selected S&P 500 stocks using RSI and MACD indicators, summarizes the insights into plain English, and posts an update to Slack every hour during U.S. market hours (Mon–Fri).', { name: 'Sticky Note', position: [-640, -360], width: 660 }))
