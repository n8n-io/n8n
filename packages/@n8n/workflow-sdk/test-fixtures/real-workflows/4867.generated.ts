const wf = workflow('e5XxiuYXr5atCH64', 'Stock Analysis Assistant', {
	...
	.add(
		trigger({
			...
			config: {
				parameters: {
					rule: {
						interval: [{ field: 'cronExpression', expression: '0 30 6-14 * * 1-5' }],
					},
				},
				position: [120, 0],
			},
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', color: 7, position: [40, -360], height: 700 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note2', color: 7, position: [280, -360], width: 460, height: 700 },
		),
	)
	.add(
		sticky(
			'## 📈 Ticker Setup\n\n**Node:** `Ticker List`  \nSets the stock symbols to be analyzed.\n\n📌 You can update this list to monitor different stocks.',
			{ name: 'Sticky Note3', color: 4, position: [740, -360], width: 220, height: 540 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note4', color: 4, position: [960, -360], width: 220, height: 540 },
		),
	)
	.add(
		sticky(
			'## 🧮 Interpret Data\n\n**Node:** `Interpret Data`  \nPython code calculates:\n- RSI(14)\n- MACD(12,26,9)\n- Decision status: `"Buy"`, `"Hold"`, or `"Sell"`\n\nOutputs:\n- `stocks`: a list of indicator values and status\n- `summary`: JSON string version for GPT',
			{ name: 'Sticky Note5', color: 4, position: [1180, -360], width: 220, height: 540 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note6', color: 4, position: [1400, -360], width: 360, height: 540 },
		),
	)
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note8', color: 4, position: [1760, -360], width: 220, height: 540 },
		),
	)
	.add(
		sticky('', { name: 'Sticky Note9', color: 4, position: [1980, -360], width: 220, height: 540 }),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note10', color: 5, position: [-640, -180], width: 660, height: 940 },
		),
	);
