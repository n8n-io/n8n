const wf = workflow('', '')
	...
	.add(
		trigger({
			...
			version: 1,
			config: {
				parameters: { form: '252862840518058', onlyAnswers: false },
				credentials: {
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', position: [1296, -208], width: 1600, height: 656 },
		),
	);
