const wf = workflow('EPSFcDt1f8LdRzZU', 'Amazon Affiliate Marketing Automation', {
	executionOrder: 'v1',
})
	.add(
		trigger({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1unoIMG4dKLP1Fw0euo64deo_FyBJp4viN4_Sy4LT0Dc/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1unoIMG4dKLP1Fw0euo64deo_FyBJp4viN4_Sy4LT0Dc/edit?usp=drivesdk',
	...
	.add(
		sticky(
			...
			{ position: [-1088, -352], width: 528, height: 272 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note5', position: [-1584, -464], width: 387, height: 390 },
		),
	);
