const wf = workflow(
						...
						values: [
							{
								fieldLabel: 'Topic',
								placeholder:
									'Provide a concise and clear title or main topic for your post (e.g., "New Product Launch," "Exciting Company Update"). This helps the AI accurately capture the focus of your content.',
								requiredField: true,
							},
							{
								fieldLabel: 'Keywords or Hashtags (optional)',
								placeholder:
									"Include any specific keywords or hashtags you'd like the AI to incorporate into the post. This ensures the content aligns with your branding and campaign objectives.",
								requiredField: '={{ false }}',
							},
							{
								fieldLabel: 'Link (optional)',
								placeholder:
									'=Provide the URL of any product, service, form, support page, or other resource. This link will be included in the generated post to direct your audience to the relevant content.\n',
							},
						],
					},
		...
		node({
			...
			config: {
				parameters: {
					...
					options: {
						systemMessage:
							'=Use the provided tools to research the topic based on latest information.  Todays date is {{ $now }}',
					},
					promptType: 'define',
		...
		node({
			...
			config: {
				parameters: {
					...
					subject:
						"=🔥FOR APPROVAL🔥{{ $('Social Media Content Factory').item.json.output.name }} - {{ $('Social Media Content Factory').item.json.output.description }}",
	...
	.add(
		sticky('# 🧑‍🦱 User Input for Social Media Posts \n💡 Unpin default data to get started', {
			color: 4,
			position: [-300, -900],
			width: 360,
			height: 360,
	...
	.add(
		sticky(
			'# 🛠️ Social Media Content Factory\n- LinkedIn\n- Instagram\n- Facebook\n- X\n- TikTok\n- Threads\n- YouTube Shorts\n',
			{ name: 'Sticky Note1', color: 6, position: [100, -940], width: 640, height: 600 },
		),
	)
	.add(
		sticky('# 👍 Approve Content Before Proceeding', {
			name: 'Sticky Note2',
			color: 4,
			position: [1840, -700],
			width: 400,
	...
	.add(
		sticky('# ✉️ Prepare & Format Approval Email', {
			name: 'Sticky Note5',
			color: 5,
			position: [1300, -900],
			width: 500,
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note6', position: [880, 620], width: 300, height: 340 },
		),
	)
	.add(
		sticky('## Publish to Social Media', {
			name: 'Sticky Note3',
			color: 6,
			position: [1600, -140],
			width: 300,
	...
	.add(
		sticky('# Step 4️⃣: Send Final Results of Social Media Factory', {
			name: 'Sticky Note7',
			color: 7,
			position: [-360, 240],
			width: 1020,
	...
	.add(
		sticky('## Final Approval before Publishing to Social Feeds\n(optional)', {
			name: 'Sticky Note9',
			position: [880, 240],
			width: 300,
			height: 340,
	...
	.add(
		sticky(
			'# Step 1️⃣: Create Social Media Written Content\nNote:  \nYou could use the output of step 1 to create your written content and manually post if required.  \nYou so not have to implement step 2.',
			{ name: 'Sticky Note10', color: 7, position: [-360, -1060], width: 2640, height: 760 },
		),
	)
	.add(
		sticky('# Step 2️⃣: Create Image or Upload Image for Social Post', {
			name: 'Sticky Note11',
			color: 7,
			position: [-360, -260],
			width: 1020,
	...
	.add(
		sticky('# Step 3️⃣: Publish Final Social Media Posts', {
			name: 'Sticky Note12',
			color: 7,
			position: [840, -260],
			width: 1680,
	...
	.add(
		sticky('', { name: 'Sticky Note13', color: 4, position: [-320, 340], width: 940, height: 620 }),
	)
	.add(
		sticky('## Alternative User Uploaded Image\n(optional)', {
			name: 'Sticky Note14',
			position: [-700, -260],
			width: 300,
			height: 580,
	...
	.add(
		sticky('## Implement Additional Approval Here\n(optional)', {
			name: 'Sticky Note15',
			position: [880, -140],
			width: 460,
			height: 340,
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note16', position: [780, -900], width: 480, height: 500 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note17', position: [1940, -140], width: 300, height: 180 },
		),
	);
