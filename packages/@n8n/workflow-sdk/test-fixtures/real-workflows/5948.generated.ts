const wf = workflow('mV1Dg3cHIDTFuUAG', '4 Track Competitor Website Updates', {
	executionOrder: 'v1',
})
	.add(
		trigger({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1olDNB5lFN8NGfVK8otJF2A8aYiR5jG6ve7cqwPyPXrY/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1olDNB5lFN8NGfVK8otJF2A8aYiR5jG6ve7cqwPyPXrY/edit?usp=drivesdk',
		...
		ifBranch(
			[
				node({
					...
					version: 1,
					config: { position: [1520, -140], name: 'No Operation, do nothing' },
				}),
				node({
					type: 'n8n-nodes-base.googleSheets',
					version: 4.6,
	...
	.add(
		sticky(
			...
			{ color: 6, position: [20, -1260], width: 580, height: 1440 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note3', color: 7, position: [1760, -1240], width: 380, height: 240 },
		),
	)
	.add(
		sticky(
