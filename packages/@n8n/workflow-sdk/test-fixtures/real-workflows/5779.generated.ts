return workflow('yNlNZi8P0wL4Tj5u', 'Google Text-to-Speech Generator', { executionOrder: 'v1' })
  ...
  .then(node({ type: 'n8n-nodes-base.googleDrive', version: 3, config: { parameters: {
    ...
    }, position: [420, 40], name: 'Upload file' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [600, 40], name: 'Request Duration' } }))
  .then(node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      url: '={{ $json.status_url }}',
      options: {},
      authentication: 'genericCredentialType',
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [820, 40], name: 'Get Status' } }))
  .then(ifBranch([node({ type: 'n8n-nodes-base.httpRequest', version: 4.2, config: { parameters: {
      ...
      httpHeaderAuth: { id: 'credential-id', name: 'httpHeaderAuth Credential' }
    }, position: [1180, 20], name: 'Get Duration' } }), node({ type: 'n8n-nodes-base.wait', version: 1.1, config: { parameters: { amount: 1 }, position: [1180, 180] } })], { version: 2.2, parameters: {
      options: {},
      conditions: {
        options: {
          version: 2,
