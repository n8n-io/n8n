const wf = workflow('8dpOtivR6zGMa8Nf', 'Automated Lead Scraper: Apify to Google Sheets', {
	executionOrder: 'v1',
})
	.add(
		trigger({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'Sheet1',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1UHkd_OuK1Xzc0ZXo7FPrsd5M1JlsIY9pJDC3fsJ3oq8/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1UHkd_OuK1Xzc0ZXo7FPrsd5M1JlsIY9pJDC3fsJ3oq8/edit?usp=drivesdk',
