const wf = workflow('mP0xzDliHhlMDrkO', 'ElevenLabs AI Voice Cloning from YouTube', {
	...
	.add(
		trigger({
			...
			version: 1,
			config: { position: [-112, 224], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
			...
			config: {
				parameters: {
					...
					sheetName: {
						...
						value: 'gid=0',
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1pZt5RZy6JkcnnxoSG1MFuIrNTLa0P4pVCptuk8uFJdI/edit#gid=0',
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/1pZt5RZy6JkcnnxoSG1MFuIrNTLa0P4pVCptuk8uFJdI/edit?usp=drivesdk',
	...
	.add(
		sticky(
			...
			{ color: 7, position: [64, 128], width: 560, height: 272 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note1', color: 7, position: [672, 128], width: 592, height: 272 },
		),
	)
	.add(
		sticky(
			...
			{ name: 'Sticky Note2', color: 7, position: [672, 448], width: 592, height: 288 },
		),
	)
	.add(
		sticky(
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note4', color: 7, position: [1296, -656], width: 736, height: 736 },
		),
	);
