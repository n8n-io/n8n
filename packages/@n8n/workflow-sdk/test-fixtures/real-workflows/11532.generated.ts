return workflow('mP0xzDliHhlMDrkO', 'ElevenLabs AI Voice Cloning from YouTube', { availableInMCP: false, executionOrder: 'v1' })
  ...
  .add(sticky('## STEP 1\n[Clone this Sheet](https://docs.google.com/spreadsheets/d/1pZt5RZy6JkcnnxoSG1MFuIrNTLa0P4pVCptuk8uFJdI/edit?usp=sharing) and fill the columns "Youtube Video" and "Voice Name"', { name: 'Sticky Note', color: 7, position: [64, 128], width: 560, height: 272 }))
