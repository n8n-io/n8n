const wf = workflow(
	...
	.add(
		trigger({
			...
			version: 1,
			config: { position: [240, 920], name: 'When clicking ‘Execute workflow’' },
		}),
	)
	.then(
		node({
			...
			config: {
				parameters: {
					...
					documentId: {
						...
						cachedResultUrl:
							'https://docs.google.com/spreadsheets/d/{YOUR_GOOGLE_DOCUMENT_ID}/edit?usp=drivesdk',
	...
	.add(
		sticky(
			...
			{ name: 'Sticky Note6', color: 6, position: [2740, 1120], width: 420 },
		),
	);
