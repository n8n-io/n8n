...
const SKIP_DEEP_CONNECTION_CHECK = new Set<string>([
	'2', // SIB deferred merge: duplicate connections on output 0
	'2749', // Switch sparse cases: case indices collapsed
	'3820', // AI sub-node: multiple models at index 0 in original, parser assigns 0,1
	'4557', // SIB deferred merge: duplicate connections on output 0
	...
	'5449', // trigger sparse output: connections only on output 1
	'5750', // SIB deferred merge: duplicate connections on output 0
	'5988', // SIB deferred merge: duplicate connections on output 0
	'6278', // SIB deferred merge: duplicate connections on output 0
	'6518', // IF continueErrorOutput: error connection not generated by codegen
	'6783', // non-consecutive multi-output: output index not preserved
	'10132', // non-consecutive multi-output: output index not preserved
	'10256', // non-consecutive multi-output: output index not preserved
