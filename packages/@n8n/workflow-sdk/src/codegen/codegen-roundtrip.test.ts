...
const SKIP_DEEP_CONNECTION_CHECK = new Set<string>([
	'1', // pre-existing: complex convergence pattern
	'2', // pre-existing: complex convergence pattern
	'2749', // pre-existing: complex convergence pattern
	'3820', // AI sub-node: multiple models at index 0 in original, parser assigns 0,1
	'4557', // pre-existing: connection mismatch in complex workflow
	'5081', // pre-existing: connection mismatch in complex workflow
	'5160', // AI sub-node: multiple models at index 0 in original, parser assigns 0,1
	'5383', // name collision: "Get_Analysis" vs "Get Analysis" → same varName
	'5449', // pre-existing: connection mismatch in complex workflow
	'5750', // pre-existing: connection mismatch in complex workflow
	'5988', // pre-existing: connection mismatch in complex workflow
	'6278', // pre-existing: connection mismatch in complex workflow
	'6518', // IF continueErrorOutput: error connection not generated by codegen
	'6783', // pre-existing: connection mismatch in complex workflow
	'10132', // pre-existing: connection mismatch in complex workflow
	'10256', // pre-existing: connection mismatch in complex workflow
	'10406', // name collision: trailing period+space difference → same varName
	'10749', // pre-existing: connection mismatch in complex workflow
	'12447', // name collision: "do nothing" vs "Do nothing" → same varName
]);
