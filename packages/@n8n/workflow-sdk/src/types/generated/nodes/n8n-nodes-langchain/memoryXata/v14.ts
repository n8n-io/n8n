...
export interface LcMemoryXataV14Config {
/**
...
export type LcMemoryXataV14Node = LcMemoryXataV14NodeBase & {
	config: NodeConfig<LcMemoryXataV14Config>;
};

export type LcMemoryXataV14Node = LcMemoryXataV14Node;