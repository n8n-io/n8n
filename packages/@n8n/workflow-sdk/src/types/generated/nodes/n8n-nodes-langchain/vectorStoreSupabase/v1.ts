...
export type LcVectorStoreSupabaseV1LoadConfig = {
	mode: 'load';
...
export type LcVectorStoreSupabaseV1InsertConfig = {
	mode: 'insert';
	ragStarterCallout?: unknown;
	tableName: ResourceLocatorValue;
	options?: Record<string, unknown>;
...
export type LcVectorStoreSupabaseV1RetrieveConfig = {
	mode: 'retrieve';
	ragStarterCallout?: unknown;
	tableName: ResourceLocatorValue;
/**
...
export type LcVectorStoreSupabaseV1RetrieveAsToolConfig = {
...
export type LcVectorStoreSupabaseV1UpdateConfig = {
	mode: 'update';
	ragStarterCallout?: unknown;
	tableName: ResourceLocatorValue;
/**
...
export interface LcVectorStoreSupabaseV1Credentials {
