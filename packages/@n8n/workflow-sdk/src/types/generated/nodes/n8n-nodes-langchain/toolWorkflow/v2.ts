...
export interface LcToolWorkflowV2Config {
...
export type LcToolWorkflowV2Node = LcToolWorkflowV2NodeBase & {
	config: NodeConfig<LcToolWorkflowV2Config>;
};

export type LcToolWorkflowV2Node = LcToolWorkflowV2Node;