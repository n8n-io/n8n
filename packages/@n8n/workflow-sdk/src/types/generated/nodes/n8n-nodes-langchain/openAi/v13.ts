...
export type LcOpenAiV13AssistantCreateConfig = {
	resource: 'assistant';
	operation: 'create';
...
export type LcOpenAiV13AssistantDeleteAssistantConfig = {
	resource: 'assistant';
...
export type LcOpenAiV13AssistantListConfig = {
	resource: 'assistant';
	operation: 'list';
/**
...
export type LcOpenAiV13AssistantMessageConfig = {
	resource: 'assistant';
	operation: 'message';
/**
 * Assistant to respond to the message. You can add, modify or remove assistants in the &lt;a href="https://platform.openai.com/playground?mode=assistant" target="_blank"&gt;playground&lt;/a&gt;.
...
export type LcOpenAiV13AssistantUpdateConfig = {
	resource: 'assistant';
	operation: 'update';
/**
 * Assistant to respond to the message. You can add, modify or remove assistants in the &lt;a href="https://platform.openai.com/playground?mode=assistant" target="_blank"&gt;playground&lt;/a&gt;.
...
/** Send messages to an assistant */
export type LcOpenAiV13TextMessageConfig = {
	resource: 'text';
	operation: 'message';
	modelId: ResourceLocatorValue;
	messages?: {
...
export type LcOpenAiV13TextClassifyConfig = {
	resource: 'text';
	operation: 'classify';
/**
...
export type LcOpenAiV13ImageAnalyzeConfig = {
	resource: 'image';
	operation: 'analyze';
	text?: string | Expression<string>;
...
export type LcOpenAiV13ImageGenerateConfig = {
	resource: 'image';
	operation: 'generate';
/**
...
/** Creates audio from a text prompt */
export type LcOpenAiV13AudioGenerateConfig = {
	resource: 'audio';
	operation: 'generate';
...
export type LcOpenAiV13AudioTranscribeConfig = {
	resource: 'audio';
...
export type LcOpenAiV13AudioTranslateConfig = {
	resource: 'audio';
	operation: 'translate';
/**
 * Name of the binary property which contains the audio file in one of these formats: flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, or webm
...
export type LcOpenAiV13FileDeleteFileConfig = {
	resource: 'file';
...
/** List assistants in the organization */
export type LcOpenAiV13FileListConfig = {
	resource: 'file';
	operation: 'list';
	options?: Record<string, unknown>;
};
...
export type LcOpenAiV13FileUploadConfig = {
	resource: 'file';
	operation: 'upload';
/**
...
export type LcOpenAiV13Params =
	| LcOpenAiV13AssistantCreateConfig
	| LcOpenAiV13AssistantDeleteAssistantConfig
	| LcOpenAiV13AssistantListConfig
	| LcOpenAiV13AssistantMessageConfig
	| LcOpenAiV13AssistantUpdateConfig
	| LcOpenAiV13TextMessageConfig
	| LcOpenAiV13TextClassifyConfig
	| LcOpenAiV13ImageAnalyzeConfig
	| LcOpenAiV13ImageGenerateConfig
	| LcOpenAiV13AudioGenerateConfig
	| LcOpenAiV13AudioTranscribeConfig
	| LcOpenAiV13AudioTranslateConfig
	| LcOpenAiV13FileDeleteFileConfig
	| LcOpenAiV13FileListConfig
	| LcOpenAiV13FileUploadConfig
	;
...
export interface LcOpenAiV13Credentials {
...
interface LcOpenAiV13NodeBase {
	type: '@n8n/n8n-nodes-langchain.openAi';
	version: 1.3;
	credentials?: LcOpenAiV13Credentials;
}

export type LcOpenAiV13AssistantCreateNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AssistantCreateConfig>;
};

export type LcOpenAiV13AssistantDeleteAssistantNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AssistantDeleteAssistantConfig>;
};

export type LcOpenAiV13AssistantListNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AssistantListConfig>;
};

export type LcOpenAiV13AssistantMessageNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AssistantMessageConfig>;
};

export type LcOpenAiV13AssistantUpdateNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AssistantUpdateConfig>;
};

export type LcOpenAiV13TextMessageNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13TextMessageConfig>;
};

export type LcOpenAiV13TextClassifyNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13TextClassifyConfig>;
};

export type LcOpenAiV13ImageAnalyzeNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13ImageAnalyzeConfig>;
};

export type LcOpenAiV13ImageGenerateNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13ImageGenerateConfig>;
};

export type LcOpenAiV13AudioGenerateNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AudioGenerateConfig>;
};

export type LcOpenAiV13AudioTranscribeNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AudioTranscribeConfig>;
};

export type LcOpenAiV13AudioTranslateNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13AudioTranslateConfig>;
};

export type LcOpenAiV13FileDeleteFileNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13FileDeleteFileConfig>;
};

export type LcOpenAiV13FileListNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13FileListConfig>;
};

export type LcOpenAiV13FileUploadNode = LcOpenAiV13NodeBase & {
	config: NodeConfig<LcOpenAiV13FileUploadConfig>;
};
...
export type LcOpenAiV13Node =
	...
	| LcOpenAiV13ImageAnalyzeNode
	| LcOpenAiV13ImageGenerateNode
