...
export interface LcMcpTriggerV1Config {
/**
...
export type LcMcpTriggerV1Node = LcMcpTriggerV1NodeBase & {
	config: NodeConfig<LcMcpTriggerV1Config>;
};

export type LcMcpTriggerV1Node = LcMcpTriggerV1Node;