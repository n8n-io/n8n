...
export interface LcToolWorkflowV12Config {
...
export type LcToolWorkflowV12Node = LcToolWorkflowV12NodeBase & {
	config: NodeConfig<LcToolWorkflowV12Config>;
};

export type LcToolWorkflowV12Node = LcToolWorkflowV12Node;