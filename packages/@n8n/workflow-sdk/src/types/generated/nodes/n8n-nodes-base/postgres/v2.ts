...
export interface PostgresV2Config {
	resource?: unknown;
...
export type PostgresV2Node = PostgresV2NodeBase & {
	config: NodeConfig<PostgresV2Config>;
};

export type PostgresV2Node = PostgresV2Node;