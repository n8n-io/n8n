...
export type MicrosoftExcelV2TableAppendConfig = {
	resource: 'table';
	operation: 'append';
...
/** Represents an Excel table */
export type MicrosoftExcelV2TableConvertToRangeConfig = {
	resource: 'table';
...
/** Represents an Excel table */
export type MicrosoftExcelV2TableAddTableConfig = {
	resource: 'table';
	operation: 'addTable';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** Represents an Excel table */
export type MicrosoftExcelV2TableDeleteTableConfig = {
	resource: 'table';
...
/** Represents an Excel table */
export type MicrosoftExcelV2TableGetColumnsConfig = {
	resource: 'table';
...
/** Represents an Excel table */
export type MicrosoftExcelV2TableGetRowsConfig = {
	resource: 'table';
	operation: 'getRows';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** Represents an Excel table */
export type MicrosoftExcelV2TableLookupConfig = {
	resource: 'table';
	operation: 'lookup';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
export type MicrosoftExcelV2WorkbookAddWorksheetConfig = {
	resource: 'workbook';
...
/** A workbook is the top level object which contains one or more worksheets */
export type MicrosoftExcelV2WorkbookDeleteWorkbookConfig = {
	resource: 'workbook';
...
/** A workbook is the top level object which contains one or more worksheets */
export type MicrosoftExcelV2WorkbookGetAllConfig = {
	resource: 'workbook';
	operation: 'getAll';
/**
 * Whether to return all results or only up to a given limit
...
export type MicrosoftExcelV2WorksheetAppendConfig = {
	resource: 'worksheet';
	operation: 'append';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV2WorksheetUpsertConfig = {
	resource: 'worksheet';
	operation: 'upsert';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV2WorksheetClearConfig = {
	resource: 'worksheet';
	operation: 'clear';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV2WorksheetDeleteWorksheetConfig = {
	resource: 'worksheet';
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV2WorksheetGetAllConfig = {
	resource: 'worksheet';
	operation: 'getAll';
	workbook: ResourceLocatorValue;
/**
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV2WorksheetReadRowsConfig = {
	resource: 'worksheet';
	operation: 'readRows';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV2WorksheetUpdateConfig = {
	resource: 'worksheet';
	operation: 'update';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
export interface MicrosoftExcelV2Credentials {
