...
export interface FormTriggerV23Config {
...
export type FormTriggerV23Node = FormTriggerV23NodeBase & {
	config: NodeConfig<FormTriggerV23Config>;
};

export type FormTriggerV23Node = FormTriggerV23Node;