...
export type MicrosoftExcelV21TableAppendConfig = {
	resource: 'table';
	operation: 'append';
...
/** Represents an Excel table */
export type MicrosoftExcelV21TableConvertToRangeConfig = {
	resource: 'table';
...
/** Represents an Excel table */
export type MicrosoftExcelV21TableAddTableConfig = {
	resource: 'table';
	operation: 'addTable';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** Represents an Excel table */
export type MicrosoftExcelV21TableDeleteTableConfig = {
	resource: 'table';
...
/** Represents an Excel table */
export type MicrosoftExcelV21TableGetColumnsConfig = {
	resource: 'table';
...
/** Represents an Excel table */
export type MicrosoftExcelV21TableGetRowsConfig = {
	resource: 'table';
	operation: 'getRows';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** Represents an Excel table */
export type MicrosoftExcelV21TableLookupConfig = {
	resource: 'table';
	operation: 'lookup';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
export type MicrosoftExcelV21WorkbookAddWorksheetConfig = {
	resource: 'workbook';
...
/** A workbook is the top level object which contains one or more worksheets */
export type MicrosoftExcelV21WorkbookDeleteWorkbookConfig = {
	resource: 'workbook';
...
/** A workbook is the top level object which contains one or more worksheets */
export type MicrosoftExcelV21WorkbookGetAllConfig = {
	resource: 'workbook';
	operation: 'getAll';
/**
 * Whether to return all results or only up to a given limit
...
export type MicrosoftExcelV21WorksheetAppendConfig = {
	resource: 'worksheet';
	operation: 'append';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV21WorksheetUpsertConfig = {
	resource: 'worksheet';
	operation: 'upsert';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV21WorksheetClearConfig = {
	resource: 'worksheet';
	operation: 'clear';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV21WorksheetDeleteWorksheetConfig = {
	resource: 'worksheet';
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV21WorksheetGetAllConfig = {
	resource: 'worksheet';
	operation: 'getAll';
	workbook: ResourceLocatorValue;
/**
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV21WorksheetReadRowsConfig = {
	resource: 'worksheet';
	operation: 'readRows';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
/** A sheet is a grid of cells which can contain data, tables, charts, etc */
export type MicrosoftExcelV21WorksheetUpdateConfig = {
	resource: 'worksheet';
	operation: 'update';
	workbook: ResourceLocatorValue;
	worksheet: ResourceLocatorValue;
...
export interface MicrosoftExcelV21Credentials {
