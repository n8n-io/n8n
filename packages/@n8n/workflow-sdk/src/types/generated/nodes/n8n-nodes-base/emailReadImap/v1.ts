...
export interface EmailReadImapV1Config {
...
export type EmailReadImapV1Node = EmailReadImapV1NodeBase & {
	config: NodeConfig<EmailReadImapV1Config>;
};

export type EmailReadImapV1Node = EmailReadImapV1Node;