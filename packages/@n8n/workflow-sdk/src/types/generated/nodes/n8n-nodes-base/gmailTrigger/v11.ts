...
export interface GmailTriggerV11Config {
/**
...
export type GmailTriggerV11Node = GmailTriggerV11NodeBase & {
	config: NodeConfig<GmailTriggerV11Config>;
};

export type GmailTriggerV11Node = GmailTriggerV11Node;