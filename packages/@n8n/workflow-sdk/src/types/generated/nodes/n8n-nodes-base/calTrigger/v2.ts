...
export interface CalTriggerV2Config {
...
export type CalTriggerV2Node = CalTriggerV2NodeBase & {
	config: NodeConfig<CalTriggerV2Config>;
};

export type CalTriggerV2Node = CalTriggerV2Node;