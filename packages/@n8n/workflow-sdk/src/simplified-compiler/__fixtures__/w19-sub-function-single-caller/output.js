...
const fn_notifyTeam_t0 = trigger({ type: 'n8n-nodes-base.executeWorkflowTrigger', version: 1.1, config: { name: 'When Executed by Another Workflow', parameters: { inputSource: 'passthrough' } } });
        ...
        "assignments": [
          {
            ...
            "name": "message",
            "type": "string",
            "value": "={{ $('Collect data').first().json.data.summary }}"
          }
        ]
      }
    },
