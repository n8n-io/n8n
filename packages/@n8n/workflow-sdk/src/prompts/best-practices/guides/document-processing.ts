...
Output: Extracted text is returned under the "data" key in JSON (e.g., access with {{ $json.data }}) by default. The output key can be configured via the "Destination Output Field" parameter.
Pitfalls:
