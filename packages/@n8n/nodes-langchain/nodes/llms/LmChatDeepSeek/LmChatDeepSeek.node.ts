	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				builderHint: {
					message:
						'Always default to the latest DeepSeek (deepseek-chat = V3.2 non-thinking, deepseek-reasoner = V3.2 thinking / R-series reasoning). Avoid older V3 and R1 snapshots.',
				},
			},
			{
				displayName: 'Options',
