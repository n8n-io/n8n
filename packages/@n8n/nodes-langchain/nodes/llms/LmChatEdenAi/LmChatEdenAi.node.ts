...
export class LmChatEdenAi implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				type: 'options',
				description:
					'The model which will generate the completion. Uses provider/model format (e.g. openai/gpt-4, anthropic/claude-sonnet-4-5). <a href="https://docs.edenai.run/v3/llms/listing-models">Learn more</a>.',
				typeOptions: {
					loadOptions: {
						routing: {
							request: {
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		const credentials = await this.getCredentials<OpenAICompatibleCredential>('edenAiApi');
