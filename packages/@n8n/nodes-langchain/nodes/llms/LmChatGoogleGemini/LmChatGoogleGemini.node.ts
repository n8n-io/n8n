...
const modelRLC: INodeProperties = {
	...
	builderHint: {
		message:
			'Always default to the latest flagship Gemini (models/gemini-3.1-pro-preview). Use models/gemini-3.1-flash-lite for cost-efficient builds. Avoid Gemini 2.x, 1.x, and earlier.',
	},
};
