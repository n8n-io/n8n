...
import { ChatRouterAI, type ClientOptions } from '@langchain/openai';
...
export class LmChatOpenRouter implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				type: 'options',
				description:
					'The model which will generate the completion. <a href="https://openrouter.ai/docs">Learn more</a>.',
				typeOptions: {
					loadOptions: {
						routing: {
							request: {
	...
	async supplyData(this: IExecuteFunctions, itemIndex: number): Promise<SupplyData> {
		...
		const model = new ChatRouterAI({
			openRouterApiKey: credentials.apiKey as string,
			modelName,
			...options,
