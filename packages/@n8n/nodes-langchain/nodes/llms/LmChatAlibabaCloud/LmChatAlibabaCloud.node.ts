	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				builderHint: {
					message:
						'Always default to the latest Qwen flagship (qwen3.6-max-preview or qwen3.6-plus). Use qwen-plus for cost-efficient builds. Avoid qwen-turbo, Qwen 3.5 and earlier, and older dated snapshots.',
				},
			},
			{
				displayName: 'Options',
