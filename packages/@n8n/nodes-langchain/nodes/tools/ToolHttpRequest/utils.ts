...
export const prepareToolDescription = (toolDescription: string, parameters: ToolParameter[]) => {
	let description = `
	`;
...
---
	...
	if (parameters.length) {
		description += `
	This tool expects the following data passed in:
	{
			`;
	...
	Expected input data description:
	${parameterDescription}
		`;
	}

	description += `
INPUT DATA SHOULD BE STRING AND VALID JSON
