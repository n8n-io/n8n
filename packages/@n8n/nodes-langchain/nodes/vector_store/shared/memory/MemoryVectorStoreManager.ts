...
export class MemoryVectorStoreManager {
	...
	protected constructor(protected embeddings: Embeddings) {
		// Initialize storage
	...
	recalculateMemoryUsage(): void {
		...
		if (process.env.NODE_ENV !== 'production') {
			console.debug(`Recalculated vector store memory: ${this.getMemoryUsageFormatted()}`);
		}
	}
