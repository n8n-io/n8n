...
/**
 * Types fix:
 * Delete import of 'openai/resources/responses/responses' 
 * It exists in newer versions of SDK.
 */

export type ChatResponse = OpenAI.Chat.Completions.ChatCompletion;
export type ChatContent = OpenAI.Chat.Completions.ChatCompletionContentPart[];
export type ChatInputItem = OpenAI.Chat.Completions.ChatCompletionMessageParam;
...
> & {
    ...
    input: any[]; // Keep 'input' for internal compatibility of n8n, but with any[]
    top_logprobs?: number;
    tools?: ChatTool[];
};
