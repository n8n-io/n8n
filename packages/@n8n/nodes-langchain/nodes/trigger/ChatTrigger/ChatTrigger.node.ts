...
export class ChatTrigger extends Node {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Your n8n users will be able to use this agent in <a href="/home/chat/" target="_blank">Chat</a> once this workflow is published. Make sure to share this workflow with at least \'workflow:chat\' access to all users who should use it. Currently, only streaming response mode is supported.',
