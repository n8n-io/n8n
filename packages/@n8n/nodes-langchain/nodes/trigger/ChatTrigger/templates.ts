...
export function createPage({
	...
	<html lang="en">
		<head>
			...
			<link href="https://cdn.jsdelivr.net/npm/@olegivaniv/chat@0.23.0/style.css" rel="stylesheet" />
			<style>
				html,
				body,
				#n8n-chat {
		...
		<body>
			<script type="module">
				import { createChat } from 'https://cdn.jsdelivr.net/npm/@olegivaniv/chat@0.23.0/chat.bundle.es.js';
