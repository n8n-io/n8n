...
export function createPage({
	...
	<html lang="en">
		<head>
			...
			<link href="https://cdn.jsdelivr.net/npm/@n8n/chat@rc/dist/style.css" rel="stylesheet" />
			<style>
				html,
				body,
				#n8n-chat {
		...
		<body>
			<script type="module">
				import { createChat } from 'https://cdn.jsdelivr.net/npm/@n8n/chat@rc/dist/chat.bundle.es.js';
