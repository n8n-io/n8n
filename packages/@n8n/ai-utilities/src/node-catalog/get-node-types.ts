/**
 * Simplified Node Get lookup for CodeWorkflowBuilder (pure-function form).
 *
 * Returns the full TypeScript type definition for a specific node
 * from the generated workflow-sdk types.
 *
 * The LangChain `tool(...)` wrapper that exposes this to the code-builder
 * agent lives in `@n8n/ai-workflow-builder` and is intentionally kept out
 * of this package so that ai-utilities has no LangChain integration coupling.
 */
 ...
 *
 * @internal - exported only for direct unit testing within this package; not part
 * of the public API and not re-exported from `node-catalog/index.ts`.
 */
