...
async function runEval() {
	...
	console.log(
		`Execute workflows: ${args.execute}${args.execute ? ' (via ' + args.n8nBaseUrl + ')' : ''}`,
	);
	...
	const run: Run = {
		...
		status: 'running',
		config: { prompts, model: args.model, variant: 'default' },
		results: [],
	};
...
Options:
  ...
  --execute               Execute generated workflows via live n8n instance
