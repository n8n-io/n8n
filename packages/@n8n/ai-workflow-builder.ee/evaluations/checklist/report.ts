		...
		<div class="run-section" data-variant="${variant}">
			<div class="run-header" onclick="toggleRun('run-${runIndex}')">
				<h3>
					...
					<span class="badge badge-variant-${variant}">${variant.toUpperCase()}</span>
...
<style>
	* { margin: 0; padding: 0; box-sizing: border-box; }
	...
	.badge-variant-sdk { background: #30363d; color: #8b949e; }
	.badge-variant-dataflow { background: #1f6feb33; color: #58a6ff; }
