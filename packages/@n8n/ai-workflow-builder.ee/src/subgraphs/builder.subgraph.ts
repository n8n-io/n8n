...
- Static nodes (HTTP Request, Edit Fields, Code): reasoning="Static inputs/outputs", parameters={{}}
...
Example: HTTP Request → Edit Fields (HTTP Request is source, Edit Fields is target)
...
- Trigger → HTTP Request → Edit Fields → Email
