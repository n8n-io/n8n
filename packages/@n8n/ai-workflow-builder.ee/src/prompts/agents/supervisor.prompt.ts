...
8. Does the user share a URL and ask you to use it for building/configuring? → builder
   The builder can fetch external documentation from user-provided URLs.
...
5. Does the user share a URL and ask you to use it for building/configuring? → builder
   The builder can fetch external documentation from user-provided URLs.
   Examples: "Here's the API docs: https://... — use this to configure the HTTP Request node"
   Examples: "Use https://docs.example.com/api to set up the request"`;
