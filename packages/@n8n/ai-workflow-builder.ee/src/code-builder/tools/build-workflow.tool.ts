...
export const BUILD_WORKFLOW_TOOL = {
	name: 'build_workflow',
	description:
		'Build or modify an n8n workflow. Use this when the user wants to create a new workflow, add or remove nodes, change connections, fix workflow issues, or modify an existing workflow.',
	schema: z.object({
