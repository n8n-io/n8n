	...
	it('should set entity relation of a given entity by entity objects', () =>
		Promise.all(
			connections.map(async (connection) => {
				...
				await connection.createQueryBuilder().relation(Post, 'image').of(post1).set(image1);
				...
				await connection.createQueryBuilder().relation(Post, 'image').of(post1).set(null);
	...
	it('should set entity relation of a given entity by entity id', () =>
		Promise.all(
			connections.map(async (connection) => {
				...
				await connection.createQueryBuilder().relation(Post, 'image').of(2).set(2);
				...
				await connection.createQueryBuilder().relation(Post, 'image').of(2).set(null);
	...
	it('should set entity relation of a given entity by entity id map', () =>
		Promise.all(
			connections.map(async (connection) => {
				...
				await connection.createQueryBuilder().relation(Post, 'image').of({ id: 3 }).set({ id: 3 });
				...
				await connection.createQueryBuilder().relation(Post, 'image').of({ id: 3 }).set(null);
