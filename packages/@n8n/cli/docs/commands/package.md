...
| `-p, --project-id` | Target project ID. Defaults to your personal project. Also accepts the legacy `--project` alias. |
| `-f, --folder-id` | Target folder ID within the project. Defaults to the project root. Also accepts the legacy `--folder` alias. |
