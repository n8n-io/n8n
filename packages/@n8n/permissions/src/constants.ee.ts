...
export const RESOURCES = {
	...
	// `manageUsers` gates changes to a project's membership list: adding a member
	...
	project: [...DEFAULT_OPERATIONS, 'export', 'manageUsers'] as const,
...
export const API_KEY_RESOURCES = {
	...
	project: ['create', 'update', 'delete', 'list', 'export', 'manageUsers'] as const,
