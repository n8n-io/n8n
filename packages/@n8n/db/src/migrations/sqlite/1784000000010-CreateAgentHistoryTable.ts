import { CreateAgentHistoryTable1784000000010 as BaseMigration } from '../common/1784000000010-CreateAgentHistoryTable';
 ...
 */
export class CreateAgentHistoryTable1784000000010 extends BaseMigration {
