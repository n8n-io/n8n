...
import type { TestCaseExecution } from '../entities/test-case-execution.ee';
import type { AggregatedTestRunMetrics } from '../entities/test-run.ee';
...
export class TestRunRepository extends Repository<TestRun> {
	...
	async getMany(testDefinitionId: string, options: ListQueryOptions) {
