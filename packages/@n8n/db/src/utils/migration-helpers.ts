...
import type { BaseMigration, Migration, MigrationContext, MigrationFn } from '../types';

// import { NodeTypes } from '@/node-types'; // @TODO: Restore
...
const createContext = (queryRunner: QueryRunner, migration: Migration): MigrationContext => ({
	...
	// nodeTypes: Container.get(NodeTypes), // @TODO: Restore
	loadSurveyFromDisk,
	parseJson,
	escape: {
