...
async function main() {
	...
	const k6ResultWebhookUrl =
		argv.k6ResultWebhookUrl || process.env.K6_RESULT_WEBHOOK_URL || undefined;
	const k6ResultWebhookAuthHeader =
		argv.k6ResultWebhookAuthHeader || process.env.K6_RESULT_WEBHOOK_AUTH_HEADER || undefined;
	...
	const dockerComposeClient = new DockerComposeClient({
		$: $({
			...
			env: {
				...
				K6_RESULT_WEBHOOK_URL: k6ResultWebhookUrl,
				K6_RESULT_WEBHOOK_AUTH_HEADER: k6ResultWebhookAuthHeader,
				RUN_DIR: runDir,
