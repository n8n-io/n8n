 ...
 * completed segment replays as a coalesced `text-block`/`reasoning-block`
 * fact instead. One list, shared by the writer (what to persist) and the
 * frontend (which frames to dedup by id), so the two sides cannot drift.
 */
