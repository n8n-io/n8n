...
export const communityPackageInstalledNodeOpenApi = {
	type: 'object',
	description: 'A node included in this package.',
	properties: {
		name: { type: 'string' },
		type: { type: 'string' },
...
export const updateCommunityPackageFieldDocs = {
	...
	verify: {
		description:
			'Whether to verify the package against the n8n-vetted package list. Setting to false allows an update to an unverified version. Default is true.',
	},
} as const satisfies Record<string, ZodOpenAPIMetadata>;
