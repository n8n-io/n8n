...
| [no-ai-codex-category](docs/rules/no-ai-codex-category.md)                               | Disallow the reserved "AI" codex category in community nodes that do not import the AI Node SDK                                                                                        | ✅ ☑️ |      | 🔧 |    |    |
...
| [no-codex-subcategories](docs/rules/no-codex-subcategories.md)                           | Disallow the codex.subcategories field in community nodes that do not import the AI Node SDK                                                                                           | ✅ ☑️ |      | 🔧 |    |    |
