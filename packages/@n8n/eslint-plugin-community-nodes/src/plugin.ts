...
const configs = {
	recommended: {
		...
		rules: {
			...
			'@n8n/community-nodes/no-dead-files': 'warn',
			'@n8n/community-nodes/no-forbidden-lifecycle-scripts': 'error',
			'@n8n/community-nodes/no-hardcoded-secrets': 'error',
			...
			'@n8n/community-nodes/no-unsafe-connection-type-cast': 'error',
			...
			'@n8n/community-nodes/require-files-array': 'warn',
			'@n8n/community-nodes/require-homepage': 'warn',
