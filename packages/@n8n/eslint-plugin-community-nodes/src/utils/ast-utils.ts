...
/** Matches a class that extends `VersionedNodeType` (the entry file of a versioned node). */
export function isVersionedNodeTypeClass(node: TSESTree.ClassDeclaration): boolean {
	return (
