...
export class InstanceAiConfig {
	 ...
	 * Default 1 day. `0` uses Daytona's maximum interval.
	 */
	@Env('N8N_INSTANCE_AI_SANDBOX_AUTO_ARCHIVE_MINUTES')
	sandboxAutoArchiveMinutes: number = 24 * 60;

	/**
	 * Minutes a stopped Daytona sandbox waits before it is deleted. Default 14 days. A negative
	...
	sandboxAutoDeleteMinutes: number = 14 * 24 * 60;
