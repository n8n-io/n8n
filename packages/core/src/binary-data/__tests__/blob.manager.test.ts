...
describe('deletion', () => {
	...
	it('deleteManyByFileId warns and skips malformed ids without aborting the batch', async () => {
	...
	it('deleteManyByFileId does not touch the store when every id is malformed', async () => {
