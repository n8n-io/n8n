 ...
 * - Deletion by file id works on all backends. Location-wide deletion
 * happens only on backends that can delete by prefix (FS); others delegate
 * it, e.g. to bucket lifecycle policies.
 */
