 ...
 * This holds context for a root AI node like an Agent.
 * This is passed down to SupplyDataContext, which represents AI sub-nodes.
 */
export class AiRootNodeContext implements AiRootNodeFunctions {
	constructor(readonly rootContext: IExecuteFunctions | IWebhookFunctions) {}
