...
import { ApplicationError, createDeferredPromise, createRunExecutionData } from 'n8n-workflow';
...
export class WebhookContext extends NodeExecutionContext implements IWebhookFunctions {
	...
	async getInputConnectionData(
		...
		const runExecutionData = this.runExecutionData ?? createRunExecutionData();
