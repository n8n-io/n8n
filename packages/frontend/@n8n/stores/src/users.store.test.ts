...
<<<<<<< HEAD:packages/frontend/editor-ui/src/features/settings/users/users.store.test.ts
import type { FrontendSettings } from '@n8n/api-types';
import { useUsersStore } from './users.store';
import { useSettingsStore } from '@/app/stores/settings.store';
import { PERSONALIZATION_MODAL_KEY } from './users.constants';
=======
>>>>>>> 891dba318100e072fc55bba909ef6b316f78abcf:packages/frontend/@n8n/stores/src/users.store.test.ts
