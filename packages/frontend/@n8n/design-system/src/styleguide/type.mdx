...
{/* Rebrand: uses locally installed Baumer. Come back and add served @font-face files, then drop the system-font fallbacks. */}
export const typography = {
	type: {
		primary:
			"Baumer, 'EK Baumer Uniwidth UNLICENSED', 'EK Baumer Uniwidth', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
		monospace:
			"'Baumer Mono', 'EK Baumer Mono UNLICENSED', 'EK Baumer Mono', ui-monospace, Menlo, Consolas, 'DejaVu Sans Mono', monospace",
	},
	weight: {
		regular: '400',
		medium: '500',
