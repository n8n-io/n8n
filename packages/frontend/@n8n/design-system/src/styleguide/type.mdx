...
export const typography = {
	type: {
		primary:
			"'EK Baumer Uniwidth UNLICENSED', 'EK Baumer Uniwidth', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
		monospace:
			"'EK Baumer Mono UNLICENSED', 'EK Baumer Mono', ui-monospace, Menlo, Consolas, 'DejaVu Sans Mono', monospace",
	},
	weight: {
		regular: '400',
		medium: '500',
