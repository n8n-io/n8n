...
export const typography = {
	type: {
		...
		primary:
			"'EK Baumer Uniwidth UNLICENSED', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
		monospace:
			"'EK Baumer Mono UNLICENSED', ui-monospace, Menlo, Consolas, 'DejaVu Sans Mono', monospace",
	},
	weight: {
		regular: '400',
		medium: '500',
