...
import MotionPlayground from './components/MotionPlayground.vue';
...
| `motion.shimmer-surface`        | Whole panes waiting for content     | Same sweep over a box. Keep the two colors close.          |
