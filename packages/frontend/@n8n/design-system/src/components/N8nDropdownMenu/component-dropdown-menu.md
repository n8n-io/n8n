...
- A selectable sub-menu parent uses Enter or a label click for selection. Use ArrowRight or the chevron to open its children. In external search mode, a keyboard open highlights the first child; a pointer open leaves the highlight where it is.
