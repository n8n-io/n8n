	...
	>
		<div v-if="showRatingButtons" :class="$style.buttons">
			<template v-if="!minimal">
				<N8nButton
					variant="subtle"
					size="small"
					:label="t('aiAssistant.rating.thumbsUp')"
				...
				<N8nButton
					...
					:label="t('aiAssistant.rating.thumbsDown')"
					icon="thumbs-down"
		...
		<div v-if="showFeedbackArea" :class="$style.feedbackContainer">
			<N8nInput
				...
				type="textarea"
				:placeholder="t('aiAssistant.rating.feedbackPlaceholder')"
			...
			<div :class="$style.feedbackActions">
				...
				<N8nButton
					...
					:label="t('aiAssistant.rating.feedbackSubmit')"
