...
<template>
	<ExtensionPoint name="views.workflows.layout" :context="{ onAdd: addWorkflow }">
		<ResourcesListLayout
		...
		>
			<template #header>
				...
				>
					<ExtensionPoint name="views.workflows.headerBefore" />
					<InsightsSummary
						v-if="showInsights"
						...
						time-range="week"
					/>
					<ExtensionPoint name="views.workflows.headerAfter" />
				</ProjectHeader>
			</template>
