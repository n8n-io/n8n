...
function updateCredentialModal() {
	// Update any provided props

	props.mode = 'new';

	if (newProps.activeId !== undefined) activeId.value = newProps.activeId;
	if (newProps.modalName !== undefined) modalName.value = newProps.modalName;
