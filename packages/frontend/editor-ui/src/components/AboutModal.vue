		...
		<template #content>
			<div :class="$style.container">
				...
				<el-row>
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/n8n-plus/n8n-plus"
							>https://github.com/n8n-plus/n8n-plus</n8n-link
						>
					</el-col>
				</el-row>
				<el-row>
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/n8n-plus/n8n-plus/blob/master/LICENSE.md">
