		...
		<template #content>
			<div :class="$style.container">
				...
				<el-row>
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/ADECOM-Solutions/n8n">https://github.com/ADECOM-Solutions/n8n</n8n-link>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="8" class="info-name">
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/ADECOM-Solutions/n8n/blob/master/LICENSE.md">
