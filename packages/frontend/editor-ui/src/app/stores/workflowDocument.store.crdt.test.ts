 ...
 * workflowDocument store (experiment enabled). Unlike the mirror's unit tests
...
// Enable the CRDT collaboration experiment for every store created here.
vi.mock('@/app/stores/posthog.store', () => ({
	usePostHog: () => ({ isVariantEnabled: () => true }),
}));
...
describe('workflowDocument.store CRDT integration (experiment on)', () => {
	beforeEach(() => {
