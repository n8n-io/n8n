...
describe('useCanvasOperations', () => {
	...
	describe('requireNodeTypeDescription', () => {
		it('should return node type description when type and version match', () => {
			...
			const { requireNodeTypeDescription } = useCanvasOperations(workflowId);
	...
	describe('addNode', () => {
		it('should create node with default version when version is undefined', () => {
			const { addNode } = useCanvasOperations(workflowId);
	...
	describe('resolveNodePosition', () => {
		it('should return the node position if it is already set', () => {
			...
			const { resolveNodePosition } = useCanvasOperations(workflowId);
		...
		it('should place the node at the last clicked position if no other position is set', () => {
			...
			const { resolveNodePosition, lastClickPosition } = useCanvasOperations(workflowId);
	...
	describe('updateNodesPosition', () => {
		it('records history for multiple node position updates when tracking is enabled', () => {
			...
			const { updateNodesPosition } = useCanvasOperations(workflowId);
	...
	describe('tidyUp', () => {
		it('records history for multiple node position updates', () => {
			...
			const { tidyUp } = useCanvasOperations(workflowId);
			tidyUp(event);
	...
	describe('updateNodePosition', () => {
		it('should update node position', () => {
			...
			const { updateNodePosition } = useCanvasOperations(workflowId);
	...
	describe('setNodeSelected', () => {
		it('should set last selected node when node id is provided and node exists', () => {
			...
			const { setNodeSelected } = useCanvasOperations(workflowId);
	...
	describe('addNodes', () => {
		it('should add nodes at specified positions', async () => {
			...
			const { addNodes } = useCanvasOperations(workflowId);
	...
	describe('revertAddNode', () => {
		it('deletes node if it exists', async () => {
			...
			const { revertAddNode } = useCanvasOperations(workflowId);
	...
	describe('deleteNode', () => {
		it('should delete node and track history', () => {
			...
			const { deleteNode } = useCanvasOperations(workflowId);
	...
	describe('revertDeleteNode', () => {
		it('should revert delete node', () => {
			...
			const { revertDeleteNode } = useCanvasOperations(workflowId);
	...
	describe('revertRenameNode', () => {
		it('should revert node renaming', async () => {
			...
			const { revertRenameNode } = useCanvasOperations(workflowId);
	...
	describe('setNodeActiveByName', () => {
		it('should set active node name', () => {
			...
			const { setNodeActiveByName } = useCanvasOperations(workflowId);
	...
	describe('toggleNodesDisabled', () => {
		it('disables nodes based on provided ids', async () => {
			...
			const { toggleNodesDisabled } = useCanvasOperations(workflowId);
	...
	describe('revertToggleNodeDisabled', () => {
		it('re-enables a previously disabled node', () => {
			...
			const { revertToggleNodeDisabled } = useCanvasOperations(workflowId);
	...
	describe('toggleNodesPinned', () => {
		...
		it('should only pin pinnable nodes when mix of pinnable and non-pinnable nodes are selected', () => {
			...
			const { toggleNodesPinned } = useCanvasOperations(workflowId);
	...
	describe('addConnections', () => {
		it('should create connections between nodes', async () => {
			...
			const { addConnections } = useCanvasOperations(workflowId);
	...
	describe('createConnection', () => {
		it('should not create a connection if source node does not exist', () => {
			...
			const { createConnection } = useCanvasOperations(workflowId);
		...
		it('should create a connection if source and target nodes exist and connection is allowed', () => {
			...
			const { createConnection, editableWorkflowObject } = useCanvasOperations(workflowId);
	...
	describe('revertCreateConnection', () => {
		it('deletes connection if both source and target nodes exist', () => {
			...
			const { revertCreateConnection } = useCanvasOperations(workflowId);
	...
	describe('isConnectionAllowed', () => {
		it('should return false if target node type does not have inputs', () => {
			...
			const { isConnectionAllowed } = useCanvasOperations(workflowId);
		...
		it('should return false if source node does not have connection type', () => {
			...
			const { isConnectionAllowed, editableWorkflowObject } = useCanvasOperations(workflowId);
	...
	describe('deleteConnection', () => {
		it('should not delete a connection if source node does not exist', () => {
			...
			const { deleteConnection } = useCanvasOperations(workflowId);
	...
	describe('revertDeleteConnection', () => {
		it('should revert delete connection', () => {
			...
			const { revertDeleteConnection } = useCanvasOperations(workflowId);
	...
	describe('revalidateNodeInputConnections', () => {
		it('should not delete connections when target node does not exist', () => {
			...
			const { revalidateNodeInputConnections } = useCanvasOperations(workflowId);
	...
	describe('revalidateNodeOutputConnections', () => {
		it('should not delete connections when source node does not exist', () => {
			...
			const { revalidateNodeOutputConnections } = useCanvasOperations(workflowId);
	...
	describe('deleteConnectionsByNodeId', () => {
		it('should delete all connections for a given node ID', () => {
			const workflowsStore = mockedStore(useWorkflowsStore);
			const { deleteConnectionsByNodeId } = useCanvasOperations(workflowId);
	...
	describe('copyNodes', () => {
		it('should copy nodes', async () => {
			...
			const { copyNodes } = useCanvasOperations(workflowId);
			await copyNodes(['1', '2']);
	...
	describe('cutNodes', () => {
		it('should copy and delete nodes', async () => {
			...
			const { cutNodes } = useCanvasOperations(workflowId);
			await cutNodes(['1', '2']);
			expect(useClipboard().copy).toHaveBeenCalledTimes(1);
			expect(vi.mocked(useClipboard().copy).mock.calls).toMatchSnapshot();
		});
	...
	describe('resolveNodeWebhook', () => {
		...
		it("should set webhookId if it doesn't already exist", () => {
			...
			const { resolveNodeWebhook } = useCanvasOperations(workflowId);
	...
	describe('initializeWorkspace', () => {
		it('should initialize the workspace', async () => {
			...
			const { initializeWorkspace } = useCanvasOperations(workflowId);
	...
	describe('initializeUnknownNodes', () => {
		it('should initialize nodes', () => {
			...
			workflowsStore.workflow.nodes = nodes;
			const { initializeUnknownNodes } = useCanvasOperations(workflowId);
	...
	describe('resetWorkspace', () => {
		it('should reset the workspace', () => {
			...
			const { resetWorkspace } = useCanvasOperations(workflowId);
	...
	describe('filterConnectionsByNodes', () => {
		it('should return filtered connections when all nodes are included', () => {
			...
			const { filterConnectionsByNodes } = useCanvasOperations(workflowId);
	...
	describe('openExecution', () => {
		it('should initialize workspace and set execution data when execution is found', async () => {
			...
			const { openExecution } = useCanvasOperations(workflowId);
	...
	describe('connectAdjacentNodes', () => {
		it('should connect nodes that were connected through the removed node', () => {
			...
			const { connectAdjacentNodes } = useCanvasOperations(workflowId);
	...
	describe('importTemplate', () => {
		it('should import template to canvas', async () => {
			...
			const { importTemplate } = useCanvasOperations(workflowId);
	...
	describe('replaceNodeParameters', () => {
		it('should replace node parameters and track history', () => {
			...
			const { replaceNodeParameters } = useCanvasOperations(workflowId);
		...
		it('should revert replaced node parameters', async () => {
			...
			const { revertReplaceNodeParameters } = useCanvasOperations(workflowId);
	...
	describe('replaceNodeConnections', () => {
		...
		describe('common cases', () => {
			...
			it('should replace connections for a node and track history', () => {
				...
				const { replaceNodeConnections } = useCanvasOperations(workflowId);
	...
	describe('replaceNode', () => {
		...
		describe('common cases', () => {
			...
			it('should replace an existing node and track history', () => {
				...
				const { replaceNode } = useCanvasOperations(workflowId);
	...
	describe('openWorkflowTempalateFromJSON', () => {
		...
		it('should open workflow template from JSON', async () => {
			...
			const { openWorkflowTemplateFromJSON } = useCanvasOperations(workflowId);
	...
	describe('getNodesToShift', () => {
		it('should not shift downstream nodes unless they are to the right of the insertion point', () => {
			...
			const { getNodesToShift } = useCanvasOperations(workflowId);
