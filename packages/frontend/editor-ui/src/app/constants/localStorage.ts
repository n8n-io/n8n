...
export const LOCAL_STORAGE_AGENT_PREVIEW_CHAT_PANEL_WIDTH = 'N8N_AGENT_PREVIEW_CHAT_PANEL_WIDTH';
export const LOCAL_STORAGE_AGENT_GOAL_PREVIEW_CHAT_WIDTH = 'N8N_AGENT_GOAL_PREVIEW_CHAT_WIDTH';
