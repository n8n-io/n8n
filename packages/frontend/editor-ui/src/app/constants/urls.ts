...
export const CUSTOM_NODES_DOCS_URL = `https://${DOCS_DOMAIN}/deploy/host-n8n/configure-n8n/basic-configuration/configuration-examples/specify-custom-nodes-location`;
