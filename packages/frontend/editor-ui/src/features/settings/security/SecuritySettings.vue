...
<template>
	<N8nSettingsLayout>
		...
		<N8nSettingsSection
			:title="i18n.baseText('settings.personal.mfa.enforce.title')"
			:description="i18n.baseText('settings.personal.mfa.enforce.message')"
		>
			<N8nSettingsRowGroup>
				<N8nSettingsRow :description="i18n.baseText('settings.personal.mfa.enforce.description')">
					<template #info>
		...
		<N8nSettingsSection
			...
			:description="i18n.baseText('settings.security.personalSpace.description')"
		>
			<N8nSettingsRowGroup>
				<N8nSettingsRow
					:description="i18n.baseText('settings.security.personalSpace.sharing.description')"
				>
					<template #info>
						<N8nText bold size="medium" color="text-dark">
				...
				<N8nSettingsRow data-test-id="security-sharing-count">
					<template #info>
						<N8nText size="small">
			...
			<N8nSettingsRowGroup>
				<N8nSettingsRow
					:description="i18n.baseText('settings.security.personalSpace.publishing.description')"
				>
					<template #info>
						<N8nText bold size="medium" color="text-dark">
				...
				<N8nSettingsRow data-test-id="security-publishing-count">
					<template #info>
						<N8nText size="small">
		...
		<N8nSettingsSection
			...
			:description="i18n.baseText('settings.security.workflowReviews.description')"
		>
