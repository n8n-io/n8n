...
const executionRef = reactive<{ status?: string }>({});
...
describe('ExecuteMessage', () => {
	...
	beforeEach(() => {
		...
		Object.defineProperty(workflowsStore, 'execution', {
			get: () => executionRef,
		});
