...
const isComposerStreaming = computed(
	() => !props.isPlanEditMode && props.isStreaming && !canChatWhileAwaitingConfirmation.value,
);
const isBusy = computed(() =>
	props.isPlanEditMode ? props.isSubmitting : isComposerStreaming.value || props.isSubmitting,
);
...
<template>
	<div :class="$style.composer">
		<ChatInputBase
			...
			:autosize="resizable"
			show-voice
			:show-attach="!props.isPlanEditMode && !canChatWhileAwaitingConfirmation"
			@submit="handleSubmit"
			@stop="handleStop"
