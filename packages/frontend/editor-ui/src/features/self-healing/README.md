...
| Three inbox kinds: Fix ready, Needs you, Could not fix | `components/SelfHealingInboxKindBadge.vue`, `components/SelfHealingOutcomeDetail.vue` | `WorkflowReviewRequestsSidebar.vue`, `WorkflowReviewRequestsView.vue` |
