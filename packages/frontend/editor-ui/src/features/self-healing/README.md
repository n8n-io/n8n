...
3. Open a workflow's **Executions** and select a failed one. A one-time
   coachmark points at **Let AI Assistant fix this**; click either. After a short delay the banner links to the
