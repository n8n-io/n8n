...
import CanvasNodeCollapsedGroup from './render-types/CanvasNodeCollapsedGroup.vue';
...
const Render = () => {
	...
	switch (renderType) {
		...
		case CanvasNodeRenderType.ChoicePrompt:
			...
			break;
		case CanvasNodeRenderType.CollapsedGroup:
			Component = CanvasNodeCollapsedGroup;
			break;
		default:
