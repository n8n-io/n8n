...
- When rendering popovers/dropdowns/selects inside `N8nDialog`, ALWAYS keep them in the dialog stacking context with `:teleported="false"` unless they intentionally need to escape.
