...
- When reviewing CSS/SCSS/Vue changes in `@n8n/design-system` or `editor-ui`, always use `n8n:design-system` skill (includes v2 conventions; Tree is the canonical reference).
