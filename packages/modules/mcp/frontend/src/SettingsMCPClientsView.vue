...
import OAuthClientsTable from './components/tabs/OAuthClientsTable.vue';
import RevokeOAuthClientConfirmModal from './components/RevokeOAuthClientConfirmModal.vue';
