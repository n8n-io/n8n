...
import MCPAgentsSelect from '../components/MCPAgentsSelect.vue';
...
// typescript-eslint reads an SFC import as `any`, so the ref names the one method it calls.
const selectRef = ref<{ focusOnInput: () => void } | null>(null);
