...
```bash
pnpm turbo typecheck --filter=@n8n/frontend-module-mcp
pnpm turbo lint --filter=@n8n/frontend-module-mcp
pnpm turbo lint:styles --filter=@n8n/frontend-module-mcp
pnpm turbo test --filter=@n8n/frontend-module-mcp
```
