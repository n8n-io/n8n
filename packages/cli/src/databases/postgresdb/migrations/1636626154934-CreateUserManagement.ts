	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			'CREATE TABLE "' +
				...
				'CONSTRAINT "PK_' +
				tablePrefixPure +
				'e853ce24e8200abe5721d2c6ac552b73" PRIMARY KEY ("id"),' +
				'CONSTRAINT "UQ_' +
				tablePrefixPure +
				'5b49d0f504f7ef31045a1fb2eb8" UNIQUE ("scope", "name")' +
				');',
		);
		...
		await queryRunner.query(
			'CREATE TABLE "' +
				...
				'CONSTRAINT "PK_' +
				tablePrefixPure +
				'ea8f538c94b6e352418254ed6474a81f" PRIMARY KEY ("id"),' +
				'CONSTRAINT "UQ_' +
				tablePrefixPure +
				'e12875dfb3b1d92d7d7c5377e2" UNIQUE (email),' +
				'CONSTRAINT "FK_' +
				tablePrefixPure +
				'f0609be844f9200ff4365b1bb3d" FOREIGN KEY ("globalRoleId") REFERENCES "role"(id)' +
				');',
		);
		...
		await queryRunner.query(
			'CREATE TABLE "' +
				...
				'CONSTRAINT "PK_' +
				tablePrefixPure +
				'cc5d5a71c7b2591f5154ffb0c785e85e" PRIMARY KEY ("userId", "workflowId"), ' +
				'CONSTRAINT "FK_' +
				tablePrefixPure +
		...
		await queryRunner.query(
			'CREATE TABLE "' +
				...
				'CONSTRAINT "PK_' +
				tablePrefixPure +
				'10dd1527ffb639609be7aadd98f628c6" PRIMARY KEY ("userId", "credentialsId"), ' +
				'CONSTRAINT "FK_' +
				tablePrefixPure +
		...
		await queryRunner.query(
			'INSERT INTO "' +
				tablePrefix +
				'shared_workflow" ("createdAt", "updatedAt", "roleId", "userId", "workflowId")  ' +
				" select NOW(), NOW(), '" +
				workflowOwnerRole[0].insertId +
				"', '" +
				ownerUserId +
				'\', "id" from "' +
				tablePrefix +
		...
		await queryRunner.query(
			'INSERT INTO "' +
				tablePrefix +
				'shared_credentials" ("createdAt", "updatedAt", "roleId", "userId", "credentialsId")  ' +
				" select NOW(), NOW(), '" +
				credentialOwnerRole[0].insertId +
				"', '" +
				ownerUserId +
				'\', "id" from "' +
				tablePrefix +
