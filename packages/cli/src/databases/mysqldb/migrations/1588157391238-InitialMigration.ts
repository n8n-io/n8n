...
export class InitialMigration1588157391238 implements MigrationInterface {
	...
	async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query('DROP INDEX `IDX_' + tablePrefix + 'c4d999a5e90784e8caccf5589d` ON `' + tablePrefix + 'execution_entity`', void 0);
		await queryRunner.query('DROP TABLE `' + tablePrefix + 'execution_entity`', void 0);
		await queryRunner.query('DROP INDEX `IDX_' + tablePrefix + '07fde106c0b471d8cc80a64fc8` ON `' + tablePrefix + 'credentials_entity`', void 0);
