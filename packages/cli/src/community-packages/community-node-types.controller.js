...
const community_node_types_service_1 = require('@/community-packages/community-node-types.service');
let CommunityNodeTypesController = class CommunityNodeTypesController {
	...
	async getCommunityNodeType(req) {
...
__decorate(
	...
	CommunityNodeTypesController.prototype,
	'getCommunityNodeType',
	null,
);
__decorate(
	[
