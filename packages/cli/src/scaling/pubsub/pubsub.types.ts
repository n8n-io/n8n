...
export namespace PubSub {
	...
	namespace Commands {
		...
		export type RelayAgentChatEvent = ToCommand<'relay-agent-chat-event'>;
		...
		export type DrainAgentMessageQueue = ToCommand<'drain-agent-message-queue'>;
	...
	export type Command =
		...
		| Commands.DrainAgentMessageQueue
