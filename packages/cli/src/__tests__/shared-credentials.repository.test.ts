...
import type { CredentialsEntity } from '../../../@n8n/db/src/entities/credentials-entity';
import { SharedCredentials } from '../../../@n8n/db/src/entities/shared-credentials';
import type { User } from '../../../@n8n/db/src/entities/user';
import { SharedCredentialsRepository } from '../../../@n8n/db/src/repositories/shared-credentials.repository';
