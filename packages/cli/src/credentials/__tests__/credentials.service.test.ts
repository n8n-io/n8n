...
import * as validation from '@/credentials/validation.js';
...
import type { CredentialsTester } from '@/services/credentials-tester.service.js';
...
import { mockExistingCredential } from './credentials.test-data.js';
