...
const createMockConnection = () => {
	const req = (0, jest_mock_extended_1.mock)(new node_events_1.default());
	req.socket = (0, jest_mock_extended_1.mock)();
	const res = (0, jest_mock_extended_1.mock)(new node_events_1.default());
	return { req, res };
};
describe('SSEPush', () => {
	...
	const pushMessage = { type: 'executionRecovered', data: { executionId } };
	const expectedMsg = JSON.stringify(pushMessage);
	let ssePush;
	beforeEach(() => {
		jest.resetAllMocks();
		ssePush = new sse_push_1.SSEPush(
...
//# sourceMappingURL=sse.push.test.js.map
