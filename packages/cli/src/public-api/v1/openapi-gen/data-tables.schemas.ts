...
/**
 * Registered as a named component (`ref`) rather than embedded inline in the request body —
 * mirrors master's `data-tables.yml`, which `$ref`s a standalone `createDataTableRequest.yml`
 * schema file instead of inlining it. Generated separately from the path (see
