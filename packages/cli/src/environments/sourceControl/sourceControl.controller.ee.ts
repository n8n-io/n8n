...
import { Authorized, Get, Post, Patch, RestController, Scoped } from '@/decorators';
import {
...
export class SourceControlController {
	...
	@Scoped('sourceControl:manage', { globalOnly: true })
	...
	@Scoped('sourceControl:push', { globalOnly: true })
	...
	@Scoped('sourceControl:pull', { globalOnly: true })
