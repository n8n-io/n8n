import type { ComputedHandle } from './crdt-state';

/**
 * Node size calculation for CRDT workflow documents.
 *
 * This mirrors the frontend calculation in nodeViewUtils.ts but runs server-side
 * to ensure consistent layouts across all connected clients.
 *
