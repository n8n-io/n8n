...
export class E2EController {
	private enabledFeatures: Record<BooleanLicenseFeature, boolean> = {
		...
		[LICENSE_FEATURES.INSIGHTS_OVERVIEW]: false,
		[LICENSE_FEATURES.INSIGHTS_DETAILS]: false,
	};
	...
	private static readonly numericFeaturesDefaults: Record<NumericLicenseFeature, number> = {
		...
		[LICENSE_QUOTAS.INSIGHTS_MAX_HISTORY_DAYS]: 14,
		[LICENSE_QUOTAS.INSIGHTS_LOWEST_GRANULARITY_HOURS]: 24,
	...
	private numericFeatures: Record<NumericLicenseFeature, number> = {
		...
		[LICENSE_QUOTAS.INSIGHTS_LOWEST_GRANULARITY_HOURS]:
			E2EController.numericFeaturesDefaults[LICENSE_QUOTAS.INSIGHTS_LOWEST_GRANULARITY_HOURS],
