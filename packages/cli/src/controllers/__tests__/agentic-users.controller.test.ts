...
import { callExternalAgent } from '@/services/agentic-users/agent-external-client';
import { callLlm } from '@/services/agentic-users/agent-llm-client';
import { buildSystemPrompt } from '@/services/agentic-users/agent-prompt-builder';
import { findSupportedTrigger, buildPinData } from '@/services/agentic-users/agent-workflow-runner';
import type {
	ExternalAgentConfig,
	AgentDto,
	LlmConfig,
} from '@/services/agentic-users/agents.types';
import { sseWrite, scrubSecrets } from '@/services/agentic-users/agents.types';
...
describe('AgenticUsersController', () => {
