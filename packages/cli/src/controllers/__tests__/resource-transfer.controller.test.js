...
const resource_transfer_controller_1 = require('../resource-transfer.controller');
describe('ResourceTransferController', () => {
	let resourceTransferController;
	...
	beforeEach(() => {
		...
		mockUser = (0, jest_mock_extended_1.mock)({ id: 'user-123', role: 'global:admin' });
		mockRequest = { user: mockUser };
		mockResponse = (0, jest_mock_extended_1.mock)();
		resourceTransferController = new resource_transfer_controller_1.ResourceTransferController(
	...
	describe('batchTransferWorkflows', () => {
		...
		it('should handle service errors gracefully', async () => {
			...
			await expect(
				resourceTransferController.batchTransferWorkflows(mockRequest, mockResponse, validRequest),
	...
	describe('previewTransfer', () => {
		...
		it('should throw BadRequestError when no resources are specified', async () => {
			const invalidRequest = { destinationProjectId: 'project-456' };
			await expect(
				resourceTransferController.previewTransfer(mockRequest, mockResponse, invalidRequest),
			).rejects.toThrow(bad_request_error_1.BadRequestError);
			await expect(
				resourceTransferController.previewTransfer(mockRequest, mockResponse, invalidRequest),
...
//# sourceMappingURL=resource-transfer.controller.test.js.map
