...
/**
 * @TODO_ON_COMPLETION: Update to actual path for desktop and cloud,
 * as `posthog-hooks.js` will not be in `master`.
 */
export const postHogHooksScript = '<script src="/posthog-hooks.js"></script>';
