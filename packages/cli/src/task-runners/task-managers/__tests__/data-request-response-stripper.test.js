...
const triggerNode = (0, jest_mock_extended_1.mock)({
	name: 'Trigger',
});
const debugHelperNode = (0, jest_mock_extended_1.mock)({
	name: 'DebugHelper',
});
const codeNode = (0, jest_mock_extended_1.mock)({
	name: 'Code',
});
const workflow = (0, jest_mock_extended_1.mock)();
const debugHelperNodeOutItems = [
	{
		json: {
			idx: 0,
...
const codeNodeInputItems = debugHelperNodeOutItems;
const envProviderState = (0, jest_mock_extended_1.mock)({
	env: {},
...
describe('DataRequestResponseStripper', () => {
	...
	const newRequestParam = (opts) => ({
		...allDataParam,
		...opts,
	});
	describe('all data', () => {
		it('should build the runExecutionData as is when everything is requested', () => {
			const dataRequestResponseBuilder =
				new data_request_response_stripper_1.DataRequestResponseStripper(taskData, allDataParam);
	...
	describe('envProviderState', () => {
		it("should filter out envProviderState when it's not requested", () => {
			const dataRequestResponseBuilder =
				new data_request_response_stripper_1.DataRequestResponseStripper(
					taskData,
					newRequestParam({
						env: false,
					}),
	...
	describe('input data', () => {
		...
		it('drops input data from result', () => {
			const result = new data_request_response_stripper_1.DataRequestResponseStripper(
				taskData,
				allExceptInputParam,
			).strip();
...
//# sourceMappingURL=data-request-response-stripper.test.js.map
