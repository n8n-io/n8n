...
describe('dataTable', () => {
	...
	describe('json datatype', () => {
		it.each<[DataTableColumnJsType, DataTableColumnJsType, DataTableFilterConditionType, boolean]>([
			...
			[{}, 0, 'neq', true],
			[{}, null, 'eq', false],
			[{ key: 'value' }, 0, 'eq', false],
			[{ key: 'value' }, { key: 'value' }, 'eq', true],
			[{ key: 'value' }, { key: 'value' }, 'neq', false],
			[{ key: 'value' }, { key: 'value', key2: 'value' }, 'eq', false],
			[{ key: 'value' }, { key: 'value', key2: 'value' }, 'neq', true],
			[true, 1, 'eq', false],
			[false, 0, 'eq', false],
			[{ a: 3 }, { a: 3 }, 'eq', true],
			[{ a: 3 }, { a: 4 }, 'neq', true],
