...
import type {
	...
	SerializedProject,
} from '../spec/serialized/project.serialized';
...
export class ProjectImporter {
	...
	async import(
		...
		// On reuse we deliberately do NOT overwrite icon/description to avoid
		// clobbering changes the user has made on the target instance.
