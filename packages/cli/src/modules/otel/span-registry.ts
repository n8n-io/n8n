...
export class SpanRegistry {
	...
	addWorkflowContext(executionId: string, ctx: Context): void {
		this.contexts.set(executionId, ctx);
	}

	getWorkflowContext(executionId: string): Context | undefined {
		return this.contexts.get(executionId);
	}

	removeWorkflowContext(executionId: string): void {
