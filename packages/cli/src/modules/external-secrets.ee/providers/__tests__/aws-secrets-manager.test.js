...
describe('AwsSecretsManager', () => {
	...
	const context = (0, jest_mock_extended_1.mock)();
	const listSecretsSpy = jest.spyOn(
		client_secrets_manager_1.SecretsManager.prototype,
		'listSecrets',
	);
	const batchGetSpy = jest.spyOn(
		client_secrets_manager_1.SecretsManager.prototype,
		'batchGetSecretValue',
	);
	...
	beforeEach(() => {
		jest.resetAllMocks();
		awsSecretsManager = new aws_secrets_manager_1.AwsSecretsManager();
	});
...
//# sourceMappingURL=aws-secrets-manager.test.js.map
