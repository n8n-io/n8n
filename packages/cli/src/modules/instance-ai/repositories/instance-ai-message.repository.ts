...
export class InstanceAiMessageRepository extends Repository<InstanceAiMessage> {
	 ...
	 * used the assistant" is the question the activation lock asks. Only `user` messages
	 * count — assistant and tool rows could exist for runs the user never initiated.
	 */
