...
export type FileStorageSizeData = {
	totalBytes: number;
};

export type FileStorageSizeStatus = 'ok' | 'warn' | 'error';

export type FileStorageSizeResult = FileStorageSizeData & {
	maxBytes: number;
	quotaStatus: FileStorageSizeStatus;
};
