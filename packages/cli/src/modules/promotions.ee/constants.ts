...
/** Commit message for the demo full-instance promote button. The client sends no message. */
export const PROMOTE_INSTANCE_COMMIT_MESSAGE = 'Promote all team projects';
