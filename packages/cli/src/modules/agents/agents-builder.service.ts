...
- Always import from '@n8n/agents', '@n8n/agents-utils' (for WorkflowTool and N8nMemory), and 'zod' — these are the only available modules
...
- The only imports available at runtime are '@n8n/agents', '@n8n/agents-utils' (WorkflowTool, N8nMemory), and 'zod'
