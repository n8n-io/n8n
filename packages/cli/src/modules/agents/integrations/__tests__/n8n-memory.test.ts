...
import type { AgentMemoryEntryLockEntity } from '../../entities/agent-memory-entry-lock.entity.js';
...
import type { AgentMemoryEntryCursorRepository } from '../../repositories/agent-memory-entry-cursor.repository.js';
import type { AgentMemoryEntryLockRepository } from '../../repositories/agent-memory-entry-lock.repository.js';
import type { AgentMemoryEntrySourceRepository } from '../../repositories/agent-memory-entry-source.repository.js';
import type { AgentMemoryEntryRepository } from '../../repositories/agent-memory-entry.repository.js';
import type { AgentMessageRepository } from '../../repositories/agent-message.repository.js';
import type { AgentObservationCursorRepository } from '../../repositories/agent-observation-cursor.repository.js';
import type { AgentObservationLockRepository } from '../../repositories/agent-observation-lock.repository.js';
import type { AgentObservationRepository } from '../../repositories/agent-observation.repository.js';
import type { AgentResourceRepository } from '../../repositories/agent-resource.repository.js';
import type { AgentThreadRepository } from '../../repositories/agent-thread.repository.js';
import { N8nMemory } from '../n8n-memory.js';
