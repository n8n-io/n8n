...
export class AuthService {
	...
	constructor(
		...
		this.skipBrowserIdCheckEndpoints = [
			...
			`${basePath}/${restEndpoint}/credentials/:id/authorize`,
			...
			new RegExp(
				`^${escapeRegExp(basePath)}/${escapeRegExp(restEndpoint)}/projects/[^/]+/agents/v2/:agentId/chat/attachments/:attachmentId$`,
			),
		];
	}
