...
const { NODE_ENV, E2E_TESTS, CYPRESS_E2E_TESTS, CYPRESS_RUN_ENV } = process.env;
export const inProduction = NODE_ENV === 'production';
export const inDevelopment = !NODE_ENV || NODE_ENV === 'development';
export const inTest = NODE_ENV === 'test';
export const inE2ETests = E2E_TESTS === 'true';
console.log(
	'___DEBUG inE2ETests:', inE2ETests,
	'E2E_TESTS: ', E2E_TESTS,
	'CYPRESS_E2E_TESTS: ', CYPRESS_E2E_TESTS,
	'CYPRESS_RUN_ENV: ', CYPRESS_RUN_ENV
);
