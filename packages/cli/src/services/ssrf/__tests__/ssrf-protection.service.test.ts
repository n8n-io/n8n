...
function createMockDnsResolver(): jest.Mocked<DnsResolver> {
	return {
...
function createService(
	...
	dnsResolver?: jest.Mocked<DnsResolver>,
): { service: SsrfProtectionService; dnsResolver: jest.Mocked<DnsResolver> } {
