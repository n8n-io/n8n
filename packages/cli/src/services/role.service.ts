...
import { RoleScopeEnricherService } from '@/services/role-scope-enrichers/role-scope-enricher.service';
...
export class RoleService {
	constructor(
		...
		private readonly roleScopeEnricherService: RoleScopeEnricherService
	) {}
