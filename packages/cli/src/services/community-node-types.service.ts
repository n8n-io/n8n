...
const NODES_PREVIEW_STUB = [
	{
		...
		communityNodeMetadata: {
			packageName: 'n8n-nodes-chatwoot',
			author: 'hugodeco',
		},
	},
	{
...
export class CommunityNodeTypesService {
	nodesDescriptions: INodeTypeDescription[] | null = null;

	async getDescriptions(): Promise<INodeTypeDescription[]> {
		if (!this.nodesDescriptions) {
	...
	async fetchNodeTypes() {
		this.nodesDescriptions = NODES_PREVIEW_STUB as INodeTypeDescription[];
	}
}
