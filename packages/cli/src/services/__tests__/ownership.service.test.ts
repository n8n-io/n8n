...
describe('OwnershipService', () => {
	...
	describe('setupOwner()', () => {
		it('should throw a BadRequestError if the instance owner is already setup', async () => {
			userRepository.hasActiveInstanceOwner.mockResolvedValueOnce(true);
		...
		it('should throw a BadRequestError if the shell user is not found', async () => {
			userRepository.hasActiveInstanceOwner.mockResolvedValueOnce(false);
		...
		it('should skip hasInstanceOwner check when override is true', async () => {
			...
			expect(userRepository.hasActiveInstanceOwner).not.toHaveBeenCalled();
		});
