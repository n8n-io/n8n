...
const resource_transfer_service_1 = require('../resource-transfer.service');
describe('ResourceTransferService', () => {
	let resourceTransferService;
	...
	let eventService;
	let enterpriseWorkflowService;
	let enterpriseCredentialsService;
	let roleService;
	beforeEach(() => {
		workflowRepository = (0, jest_mock_extended_1.mock)();
		credentialsRepository = (0, jest_mock_extended_1.mock)();
		sharedWorkflowRepository = (0, jest_mock_extended_1.mock)();
		sharedCredentialsRepository = (0, jest_mock_extended_1.mock)();
		...
		enterpriseCredentialsService = (0, jest_mock_extended_1.mock)();
		roleService = (0, jest_mock_extended_1.mock)();
		resourceTransferService = new resource_transfer_service_1.ResourceTransferService(
	...
	describe('batchTransferWorkflows', () => {
		const mockUser = (0, jest_mock_extended_1.mock)({ id: 'user-123', role: 'global:admin' });
		const mockProject = (0, jest_mock_extended_1.mock)({
			id: 'project-456',
		...
		it('should successfully transfer multiple workflows', async () => {
			const mockWorkflow1 = (0, jest_mock_extended_1.mock)({
				id: 'workflow-1',
				name: 'Workflow 1',
			});
			const mockWorkflow2 = (0, jest_mock_extended_1.mock)({
				id: 'workflow-2',
				name: 'Workflow 2',
			});
			const mockSharing = (0, jest_mock_extended_1.mock)({ projectId: 'project-123' });
		...
		it('should handle partial failures in batch transfer', async () => {
			...
			workflowRepository.findOneBy.mockResolvedValueOnce(mockWorkflow1).mockResolvedValueOnce(null);
			sharedWorkflowRepository.findOne.mockResolvedValueOnce(
				(0, jest_mock_extended_1.mock)({ projectId: 'project-123' }),
			);
		...
		it('should skip workflows without move permissions', async () => {
			const mockWorkflow = (0, jest_mock_extended_1.mock)({ id: 'workflow-1', name: 'Workflow 1' });
			workflowRepository.findOneBy.mockResolvedValue(mockWorkflow);
			roleService.hasScope.mockResolvedValueOnce(true).mockResolvedValueOnce(false);
			const result = await resourceTransferService.batchTransferWorkflows(mockUser, batchRequest);
		...
		it('should skip workflows already in destination project', async () => {
			const mockWorkflow = (0, jest_mock_extended_1.mock)({ id: 'workflow-1', name: 'Workflow 1' });
			const mockSharing = (0, jest_mock_extended_1.mock)({ projectId: 'project-456' });
			workflowRepository.findOneBy.mockResolvedValue(mockWorkflow);
	...
	describe('batchTransferCredentials', () => {
		...
		it('should successfully transfer multiple credentials', async () => {
			const mockCredential1 = (0, jest_mock_extended_1.mock)({
				id: 'credential-1',
				name: 'Credential 1',
				type: 'httpBasicAuth',
			});
			const mockCredential2 = (0, jest_mock_extended_1.mock)({
				id: 'credential-2',
				name: 'Credential 2',
				type: 'oauth2Api',
			});
		...
		it('should handle transfer errors gracefully', async () => {
			const mockCredential = (0, jest_mock_extended_1.mock)({
				id: 'credential-1',
				name: 'Credential 1',
				type: 'httpBasicAuth',
			});
	...
	describe('analyzeTransferDependencies', () => {
		...
		it('should analyze workflow dependencies successfully', async () => {
			const mockWorkflow = (0, jest_mock_extended_1.mock)({
				id: 'workflow-1',
				name: 'Test Workflow',
				nodes: [
					{
				...
				shared: [(0, jest_mock_extended_1.mock)({ projectId: 'project-123' })],
			});
			const mockCredential = (0, jest_mock_extended_1.mock)({
				id: 'credential-1',
				...
				type: 'httpBasicAuth',
				shared: [
					(0, jest_mock_extended_1.mock)({ projectId: 'project-123', project: mockProject }),
				],
			});
...
//# sourceMappingURL=resource-transfer.service.test.js.map
