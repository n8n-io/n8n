...
describe('SearchEngineService', () => {
	...
	beforeEach(() => {
		...
		mockGlobalConfig.getEnv.mockImplementation((key: string) => {
		...
		service = new SearchEngineService(mockLogger, mockGlobalConfig);

		// Mock the dynamic import for Elasticsearch client
	...
	describe('Configuration', () => {
		...
		it('should return false for isAvailable when disabled', () => {
			...
			const disabledService = new SearchEngineService(mockLogger, mockGlobalConfig);
	...
	describe('Initialization', () => {
		...
		it('should handle initialization failure', async () => {
			...
			await expect(service.initialize()).rejects.toThrow(ApplicationError);
	...
	describe('Search Operations', () => {
		...
		it('should handle search errors', async () => {
			...
			await expect(service.search('test_index', searchQuery)).rejects.toThrow(ApplicationError);
		});
	});
	...
	describe('Health Check', () => {
		...
		it('should return unavailable status when not initialized', async () => {
			const uninitializedService = new SearchEngineService(mockLogger, mockGlobalConfig);
