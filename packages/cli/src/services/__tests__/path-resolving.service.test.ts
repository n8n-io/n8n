...
describe('PathResolvingService', () => {
	...
	describe('resolveWebhookTestEndpoint', () => {
		it('should resolve webhook test endpoint', () => {
			const service = createService({ basePath: '/custom-path' });
			expect(service.resolveWebhookTestEndpoint('my-webhook')).toBe('/custom-path/webhook-test/my-webhook');
		});
	...
	describe('resolveWebhookWaitingEndpoint', () => {
		it('should resolve webhook waiting endpoint', () => {
			const service = createService({ basePath: '/custom-path' });
			expect(service.resolveWebhookWaitingEndpoint('path')).toBe('/custom-path/webhook-waiting/path');
		});
	...
	describe('resolvePublicApiEndpoint', () => {
		it('should resolve public API endpoint', () => {
			const service = createService({ basePath: '/custom-path' });
			expect(service.resolvePublicApiEndpoint('v1/workflows')).toBe('/custom-path/api/v1/workflows');
		});
	...
	describe('resolveIconsEndpoint', () => {
		it('should resolve icons endpoint', () => {
			const service = createService({ basePath: '/custom-path' });
			expect(service.resolveIconsEndpoint('n8n-nodes-base/icon.svg')).toBe('/custom-path/icons/n8n-nodes-base/icon.svg');
		});
	...
	describe('resolveSchemasEndpoint', () => {
		it('should resolve schemas endpoint', () => {
			const service = createService({ basePath: '/custom-path' });
			expect(service.resolveSchemasEndpoint('node/1.0/resource.json')).toBe('/custom-path/schemas/node/1.0/resource.json');
		});
