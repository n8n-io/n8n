...
const expression_docs_service_1 = require('../expression-docs.service');
...
describe('ExpressionDocsService', () => {
	...
	describe('getCategories', () => {
		...
		it('should exclude hidden functions from function count', () => {
			...
			expect(stringCategory?.functionCount).toBe(2);
		});
	});
	...
	describe('searchFunctions', () => {
		...
		it('should return multiple matches when applicable', () => {
			const results = service.searchFunctions('the');
...
//# sourceMappingURL=expression-docs.service.test.js.map
