/**
 * Tests for enforceAccessLevel and resolveLlmConfig on AgenticUsersService.
 *
 * We construct a real AgenticUsersService instance with all dependencies mocked,
...
import { AgenticUsersService } from '../agents.service';
...
function createMockedService() {
	...
	const service = new AgenticUsersService(
