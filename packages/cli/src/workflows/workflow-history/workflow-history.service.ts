...
export class WorkflowHistoryService {
	...
	async updateVersion(
		...
		// Cast to the exact TypeORM param type: post-merge the cumulative type-instantiation
		// at this call site exceeds TS's depth limit (TS2589). Matches the existing
		// QueryDeepPartialEntity cast pattern used across the cli package.
