...
function copyAgentBuiltinSkills() {
	const sourceDir = path.resolve(ROOT_DIR, 'src', 'modules', 'agents', 'skills', 'builtin');
	const destinationDir = path.resolve(ROOT_DIR, 'dist', 'modules', 'agents', 'skills', 'builtin');
