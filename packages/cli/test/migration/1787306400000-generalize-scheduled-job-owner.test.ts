...
const MIGRATION_NAME = 'GeneralizeScheduledJobOwner1787306400000';
...
describe('GeneralizeScheduledJobOwner Migration', () => {
	...
	/**
	 * A published workflow, so a job's `workflowId` satisfies the foreign key this
	 * migration drops (and the one `down()` restores).
	 */
