...
describe('AiHelpersService', () => {
	...
	beforeEach(() => {
		...
		service = new ai_helpers_service_1.AiHelpersService(logger, nodeTypes);
		user = {
			id: 'user-123',
	...
	describe('helper methods', () => {
		it('should categorize nodes correctly', async () => {
			const service = new ai_helpers_service_1.AiHelpersService(logger, nodeTypes);
			const getNodeCategory = service.getNodeCategory.bind(service);
		...
		it('should determine node difficulty correctly', async () => {
			const service = new ai_helpers_service_1.AiHelpersService(logger, nodeTypes);
			const getNodeDifficulty = service.getNodeDifficulty.bind(service);
		...
		it('should calculate node popularity correctly', async () => {
			const service = new ai_helpers_service_1.AiHelpersService(logger, nodeTypes);
			const getNodePopularity = service.getNodePopularity.bind(service);
