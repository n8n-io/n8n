...
exports.getWorkflow = exports.THIRD_CREDENTIAL_ID = exports.SECOND_CREDENTIAL_ID = exports.FIRST_CREDENTIAL_ID = void 0;
const WorkflowEntity_1 = require("@db/entities/WorkflowEntity");
...
function getWorkflow(options) {
    ...
    workflow.nodes = [];
    if (options === null || options === void 0 ? void 0 : options.addNodeWithoutCreds) {
        workflow.nodes.push(nodeWithNoCredentials);
    }
    if (options === null || options === void 0 ? void 0 : options.addNodeWithOneCred) {
        workflow.nodes.push(nodeWithOneCredential);
    }
    if (options === null || options === void 0 ? void 0 : options.addNodeWithTwoCreds) {
