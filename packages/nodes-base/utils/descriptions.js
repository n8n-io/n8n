...
export const looseTypeValidationProperty = {
...
export const appendAttributionOption = {
    displayName: 'Append n8n Attribution',
    name: 'appendAttribution',
    type: 'boolean',
    default: true,
};
export const encodeDecodeOptions = [
    {
        name: 'armscii8',
        value: 'armscii8',
    },
