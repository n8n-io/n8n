...
export class CoinGecko {
    ...
    methods = {
        loadOptions: {
            async getCurrencies() {
                const returnData = [];
                const currencies = await coinGeckoApiRequest.call(this, 'GET', '/simple/supported_vs_currencies');
                currencies.sort();
            ...
            try {
                if (resource === 'coin') {
                    ...
                    if (operation === 'get') {
                        ...
                        if (searchBy === 'coinId') {
                            ...
                            responseData = await coinGeckoApiRequest.call(this, 'GET', `/coins/${coinId}`, {}, qs);
                        }
                        if (searchBy === 'contractAddress') {
                            ...
                            responseData = await coinGeckoApiRequest.call(this, 'GET', `/coins/${platformId}/contract/${contractAddress}`, {}, qs);
                        }
                    }
                    ...
                    if (operation === 'market') {
                        ...
                        if (returnAll) {
                            responseData = await coinGeckoRequestAllItems.call(this, '', 'GET', '/coins/markets', {}, qs);
                        }
                        else {
                    ...
                    if (operation === 'price') {
                        ...
                        if (searchBy === 'contractAddress') {
                            ...
                            responseData = await coinGeckoApiRequest.call(this, 'GET', `/simple/token_price/${platformId}`, {}, qs);
                        }
                    }
                    ...
                    if (operation === 'ticker') {
                        ...
                        if (returnAll) {
                            responseData = await coinGeckoRequestAllItems.call(this, 'tickers', 'GET', `/coins/${coinId}/tickers`, {}, qs);
                        }
                        else {
                            const limit = this.getNodeParameter('limit', i);
                            responseData = await coinGeckoApiRequest.call(this, 'GET', `/coins/${coinId}/tickers`, {}, qs);
                    ...
                    if (operation === 'history') {
                        ...
                        responseData = await coinGeckoApiRequest.call(this, 'GET', `/coins/${coinId}/history`, {}, qs);
                    }
                    ...
                    if (operation === 'marketChart') {
                        ...
                        if (searchBy === 'coinId') {
                            ...
                            respData = await coinGeckoApiRequest.call(this, 'GET', `/coins/${coinId}/market_chart`, {}, qs);
                        }
                        if (searchBy === 'contractAddress') {
                            const platformId = this.getNodeParameter('platformId', i);
                            const contractAddress = this.getNodeParameter('contractAddress', i);
                            respData = await coinGeckoApiRequest.call(this, 'GET', `/coins/${platformId}/contract/${contractAddress}/market_chart`, {}, qs);
                        }
                        responseData = [];
                    ...
                    if (operation === 'candlestick') {
                        ...
                        qs.vs_currency = quoteCurrency;
                        qs.days = days;
                        responseData = await coinGeckoApiRequest.call(this, 'GET', `/coins/${baseCurrency}/ohlc`, {}, qs);
                ...
                if (resource === 'event') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        Object.assign(qs, options);
                        if (returnAll) {
                            responseData = await coinGeckoRequestAllItems.call(this, 'data', 'GET', '/events', {}, qs);
                        }
                        else {
                            const limit = this.getNodeParameter('limit', i);
                            qs.per_page = limit;
                ...
                if (resource === 'simple') {
                    ...
                    if (operation === 'tokenPrice') {
                        ...
                        qs.vs_currencies = currencies.join(',');
                        Object.assign(qs, options);
                        responseData = await coinGeckoApiRequest.call(this, 'GET', `/simple/token_price/${id}`, {}, qs);
                    }
                }
