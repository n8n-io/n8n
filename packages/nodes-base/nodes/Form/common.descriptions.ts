...
// Dynamic form fields - shown when useDynamicAttributes feature is enabled (v2.5+)
// This is a separate definition to allow independent development of new form field features
