...
import { formWebhook, createDescriptionMetadata, prepareFormData, prepareFormReturnItem, resolveRawData, isFormConnected, sanitizeHtml, sanitizeCustomCss, validateResponseModeConfiguration, prepareFormFields, addFormResponseDataToReturnItem, validateSafeRedirectUrl, handleNewlines, parseFormFields, validateFormPageAuth, generateFormUserAuthToken, verifyFormUserAuthToken, } from '../utils/utils';
...
describe('FormTrigger, parseFormDescription', () => {
    it('should remove HTML tags and truncate to 150 characters', () => {
        const descriptions = [
            ...
            {
                description: 'Beneath the golden hues of a setting sun, waves crashed against the rugged shore, carrying whispers of ancient tales etched in natures timeless and soothing song.',
                expected: 'Beneath the golden hues of a setting sun, waves crashed against the rugged shore, carrying whispers of ancient tales etched in natures timeless and so',
            },
            {
                description: '<p>Beneath the golden hues of a setting sun, waves crashed against the rugged shore, carrying whispers of ancient tales etched in natures timeless and soothing song.</p>',
                expected: 'Beneath the golden hues of a setting sun, waves crashed against the rugged shore, carrying whispers of ancient tales etched in natures timeless and so',
            },
        ];
    ...
    it('should remove forbidden HTML tags', () => {
        const givenHtml = [
            ...
            },
            {
                ...
                expected: '<video width="640" height="360" controls><source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"></source>Your browser does not support the video tag.</video>',
            },
            {
                ...
                expected: '<video controls width="640" height="360"><source type="video/mp4"></source>Fallback text</video>',
            },
            {
            ...
            },
            {
                ...
                expected: '<iframe referrerpolicy="strict-origin-when-cross-origin" allow="fullscreen; autoplay; encrypted-media"></iframe>',
            },
        ];
    ...
    it('should allow table elements and preserve structure', () => {
        const tableTestCases = [
            ...
            },
            {
                ...
                expected: '<table><thead><tr><th>Header</th></tr></thead><tbody><tr><td>Data</td></tr></tbody></table>',
            },
            {
    ...
    it('should allow tfoot elements and preserve table footer structure', () => {
        const tfootTestCases = [
            ...
            },
            {
                ...
                expected: '<table><thead><tr><th>Header</th></tr></thead><tbody><tr><td>Data</td></tr></tbody><tfoot><tr><td>Footer</td></tr></tfoot></table>',
            },
            {
    ...
    it('should preserve table cell attributes (colspan, rowspan, scope, headers)', () => {
        const cellAttributeTestCases = [
            ...
            },
            {
                ...
                expected: '<table><tr><th rowspan="3">Header</th><td>Data 1</td></tr><tr><td>Data 2</td></tr><tr><td>Data 3</td></tr></table>',
            },
            {
                html: '<table><tr><th scope="col">Column Header</th></tr><tr><th scope="row">Row Header</th><td>Data</td></tr></table>',
                expected: '<table><tr><th scope="col">Column Header</th></tr><tr><th scope="row">Row Header</th><td>Data</td></tr></table>',
            },
            {
                ...
                expected: '<table><tr><th>Name</th><th>Age</th></tr><tr><td headers="header1">John</td><td headers="header2">30</td></tr></table>',
            },
            {
                html: '<table><tr><td colspan="2" rowspan="2">Complex cell</td><td>Simple cell</td></tr></table>',
                expected: '<table><tr><td colspan="2" rowspan="2">Complex cell</td><td>Simple cell</td></tr></table>',
            },
        ];
        ...
        const complexTableTestCases = [
            {
                ...
                expected: '<table><thead><tr><th colspan="2" scope="colgroup">Sales Report</th></tr><tr><th scope="col">Product</th><th scope="col">Revenue</th></tr></thead><tbody><tr><th scope="row">Widget A</th><td>$1,000</td></tr><tr><th scope="row">Widget B</th><td>$2,000</td></tr></tbody><tfoot><tr><th scope="row">Total</th><td colspan="1">$3,000</td></tr></tfoot></table>',
            },
            {
                ...
                expected: '<table><tbody><tr><td rowspan="2">Multi-row cell</td><td>Cell 1</td></tr><tr><td>Cell 2</td></tr></tbody><tfoot><tr><td colspan="2">Footer spans both columns</td></tr></tfoot></table>',
            },
        ];
    ...
    it('should handle nested content within table elements', () => {
        const nestedTableCases = [
            ...
            },
            {
                ...
                expected: '<table><thead><tr><th><a href="https://example.com">Link Header</a></th></tr></thead></table>',
            },
            {
                html: '<table><tbody><tr><td><ul><li>Item 1</li><li>Item 2</li></ul></td></tr></tbody></table>',
                expected: '<table><tbody><tr><td><ul><li>Item 1</li><li>Item 2</li></ul></td></tr></tbody></table>',
            },
            {
                html: '<table><tr><td><code>code snippet</code> and <pre>preformatted text</pre></td></tr></table>',
                expected: '<table><tr><td><code>code snippet</code> and <pre>preformatted text</pre></td></tr></table>',
            },
        ];
    ...
    it('should prevent XSS attacks through table elements', () => {
        const xssTableCases = [
            ...
            },
            {
                ...
                expected: '<table><tr><td><iframe referrerpolicy="strict-origin-when-cross-origin" allow="fullscreen; autoplay; encrypted-media"></iframe></td></tr></table>',
            },
        ];
        ...
        const complexTableCases = [
            {
                ...
                expected: '<table><thead><tr><th>Product</th><th>Price</th><th>Stock</th></tr></thead><tbody><tr><td>Widget A</td><td>$10.99</td><td>50</td></tr><tr><td>Widget B</td><td>$15.99</td><td>25</td></tr></tbody></table>',
            },
            {
                html: '<table><tr><th>Q1</th><th>Q2</th><th>Q3</th><th>Q4</th></tr><tr><td>100</td><td>150</td><td>200</td><td>175</td></tr></table>',
                expected: '<table><tr><th>Q1</th><th>Q2</th><th>Q3</th><th>Q4</th></tr><tr><td>100</td><td>150</td><td>200</td><td>175</td></tr></table>',
            },
        ];
...
describe('FormTrigger, formWebhook', () => {
    ...
    executeFunctions.getNode.mockReturnValue({ typeVersion: 2.1 });
    ...
    executeFunctions.getRequestObject.mockReturnValue({ method: 'GET', query: {} });
    ...
    it('renders the form when the node has no stored authentication parameter', async () => {
        const ctx = mock();
        ctx.getNode.mockReturnValue({ typeVersion: 1, name: 'Form Trigger' });
        ...
        ctx.getRequestObject.mockReturnValue({ method: 'GET', query: {}, headers: {} });
        ctx.getResponseObject.mockReturnValue({ render: vi.fn(), setHeader: vi.fn() });
    ...
    it('should call response render', async () => {
        ...
        expect(mockRender).toHaveBeenCalledWith('form-trigger', {
            ...
            formTitle: 'Test Form',
            n8nWebsiteLink: 'https://n8n.io/?utm_source=n8n-internal&utm_medium=form-trigger&utm_campaign=instanceId',
            testRun: true,
    ...
    it('should return workflowData on POST request', async () => {
        ...
        executeFunctions.getNodeParameter.calledWith('formFields.values').mockReturnValue(formFields);
        executeFunctions.getResponseObject.mockReturnValue({ status: mockStatus, end: mockEnd });
        executeFunctions.getRequestObject.mockReturnValue({
            method: 'POST',
            contentType: 'multipart/form-data',
        });
        executeFunctions.getBodyData.mockReturnValue({ data: bodyData, files: {} });
        executeFunctions.getWorkflowSettings.mockReturnValue(mock({}));
    ...
    it('should set Content-Security-Policy header with sandbox CSP on GET request', async () => {
        ...
        await formWebhook(executeFunctions);
        expect(mockSetHeader).toHaveBeenCalledWith('Content-Security-Policy', 'sandbox allow-downloads allow-forms allow-modals allow-orientation-lock allow-pointer-lock allow-popups allow-presentation allow-scripts allow-top-navigation-by-user-activation allow-top-navigation-to-custom-protocols');
    });
    it('should include sandbox directive in CSP header for security', async () => {
        ...
        await formWebhook(executeFunctions);
        expect(mockSetHeader).toHaveBeenCalledWith('Content-Security-Policy', expect.stringContaining('sandbox'));
    });
    describe('n8nUserAuth with OAuth2 flow', () => {
        ...
        const setupContext = (ctx, overrides = { method: 'GET' }) => {
            const send = vi.fn();
            const json = vi.fn();
            ...
            ctx.getRequestObject.mockReturnValue(request);
            ...
            ctx.getWorkflowSettings.mockReturnValue(mock({}));
            ctx.getChildNodes.mockReturnValue([]);
            ctx.logger = { warn: vi.fn(), error: vi.fn(), debug: vi.fn(), info: vi.fn() };
        ...
        it('redirects to a clean URL with the token in a cookie on a valid callback', async () => {
            ...
            expect(cookie).toHaveBeenCalledWith('n8n-form-oauth', 'as-token', expect.objectContaining({ httpOnly: true, sameSite: 'lax' }));
            expect(result).toEqual({ noWebhookResponse: true });
        });
        ...
        it('renders the form on the clean GET carrying the oauth cookie', async () => {
            ...
            expect(render).toHaveBeenCalledWith('form-trigger', expect.objectContaining({ authToken: 'as-token' }));
            expect(result).toEqual({ noWebhookResponse: true });
        });
        ...
        describe('submit-time credential readiness gate', () => {
            ...
            const setupAuthedPost = (ctx, nodeType) => {
            ...
            it('fails closed with 503 when the check throws', async () => {
                ...
                expect(ctx.logger.error).toHaveBeenCalledWith('Form submit credential readiness check failed', { error });
                expect(result).toEqual({ noWebhookResponse: true });
            });
        ...
        describe('hosting shell on GET', () => {
            ...
            const setupAuthedGet = (ctx, overrides = {}) => {
                const res = setupContext(ctx, {
                    method: 'GET',
                    query: overrides.query,
            ...
            it('renders the shell while an account is still missing', async () => {
                ...
                const result = await formWebhook(ctx);
                expect(render).toHaveBeenCalledWith('form-shell', expect.objectContaining({ total: 2, connectedCount: 1, allConnected: false }));
                expect(result).toEqual({ noWebhookResponse: true });
            });
            ...
            it('keeps rendering the shell once every account is connected', async () => {
                ...
                const result = await formWebhook(ctx);
                expect(render).toHaveBeenCalledWith('form-shell', expect.objectContaining({
                    total: 1,
                    connectedCount: 1,
                    allConnected: true,
                    credentials: [
            ...
            it('renders the plain form for the shell inner iframe GET', async () => {
                ...
                const result = await formWebhook(ctx);
                expect(render).toHaveBeenCalledWith('form-trigger', expect.objectContaining({ shellInner: true }));
                expect(result).toEqual({ noWebhookResponse: true });
            });
...
describe('FormTrigger, prepareFormData', () => {
    it('should return valid form data with given parameters', () => {
        ...
        expect(result).toEqual({
            ...
            formSubmittedText: 'Thank you for your submission',
            n8nWebsiteLink: 'https://n8n.io/?utm_source=n8n-internal&utm_medium=form-trigger&utm_campaign=test-instance',
            formFields: [
                {
                    id: 'field-0',
                    errorId: 'error-field-0',
...
describe('prepareFormReturnItem', () => {
    ...
    const formNode = mock({ type: 'n8n-nodes-base.formTrigger' });
    beforeEach(() => {
        vi.clearAllMocks();
        ...
        mockContext.getWorkflowSettings.mockReturnValue(mock({}));
    });
    ...
    describe('binaryMode feature', () => {
        describe('binaryMode === "combined"', () => {
            beforeEach(() => {
                mockContext.getWorkflowSettings.mockReturnValue(mock({ binaryMode: BINARY_MODE_COMBINED }));
            });
            it('should place single file binary data in bodyData when binaryMode is "combined"', async () => {
                ...
                mockContext.nodeHelpers.copyBinaryFile.mockResolvedValue(mockBinaryData);
                const formFields = [
            ...
            it('should place multiple files binary data in bodyData array when binaryMode is "combined"', async () => {
                ...
                mockContext.nodeHelpers.copyBinaryFile
...
describe('resolveRawData', () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks();
        mockContext.evaluateExpression.mockImplementation((expression) => {
            const key = expression.replace(/[{}]/g, '').trim();
            return key.split('.').reduce((obj, prop) => obj?.[prop], dummyData);
        });
    });
    ...
    it('should handle object resolutions', () => {
        ...
        expect(resolveRawData(mockContext, input)).toBe('Grades: {"math":95,"science":88,"history":92}');
    });
    ...
    it('should handle mixed resolvable and non-resolvable content', () => {
        ...
        expect(resolveRawData(mockContext, input)).toBe('Hanna lives in New York and enjoys programming.');
    });
    it('should handle boolean values correctly', () => {
        const input = '={{name}} is a student: {{isStudent}}. {{name}} has a job: {{hasJob}}.';
        expect(resolveRawData(mockContext, input)).toBe('Hanna is a student: false. Hanna has a job: true.');
    });
    it('should handle arrays correctly', () => {
        const input = "={{name}}'s hobbies are {{hobbies}}.";
        expect(resolveRawData(mockContext, input)).toBe('Hanna\'s hobbies are ["reading","painting","coding"].');
    });
    ...
    it('should handle a mix of different data types', () => {
        const input = '={{name}} ({{age}}) knows {{languages.length}} languages. First project: {{projects.0.name}}.';
        expect(resolveRawData(mockContext, input)).toBe('Hanna (30) knows 2 languages. First project: Project A.');
    });
    ...
    it('should handle object-to-string conversion', () => {
        ...
        expect(resolveRawData(mockContext, input)).toBe('Address object: {"street":"123 Main St","zipCode":"10001","country":"USA"}.');
    });
});
...
describe('validateResponseModeConfiguration', () => {
    ...
    test('throws error if responseMode is "responseNode" but no Respond to Webhook node is connected', () => {
        ...
        expect(() => validateResponseModeConfiguration(webhookFunctions)).toThrow('No Respond to Webhook node found in the workflow');
    });
    test('throws error if "Respond to Webhook" node is connected but "responseMode" is not "responseNode" in typeVersion <= 2.1', () => {
        ...
        expect(() => validateResponseModeConfiguration(webhookFunctions)).toThrow('Unused Respond to Webhook node found in the workflow');
    });
    test('throws error if "Respond to Webhook" node is connected, version >= 2.2', () => {
        ...
        expect(() => validateResponseModeConfiguration(webhookFunctions)).toThrow('The "Respond to Webhook" node is not supported in workflows initiated by the "n8n Form Trigger"');
    });
...
describe('addFormResponseDataToReturnItem', () => {
    ...
    test('should use fieldName if fieldLabel is missing', () => {
        ...
        const bodyData = { 'field-0': 'Test Value' };
        addFormResponseDataToReturnItem(returnItem, formFields, bodyData);
        expect(returnItem.json['Alternative Field']).toBe('Test Value');
    });
    it('should handle null values', () => {
        const formFields = [{ fieldLabel: 'Test Field', fieldType: 'text' }];
        const bodyData = {};
        addFormResponseDataToReturnItem(returnItem, formFields, bodyData);
    ...
    it('should convert single file values to an array if multipleFiles is true', () => {
        ...
        const bodyData = { 'field-0': 'file1.pdf' };
        addFormResponseDataToReturnItem(returnItem, formFields, bodyData);
    ...
    describe('Version 2.4+ fieldName support', () => {
        it('should use fieldName for output data keys in v2.4+', () => {
            ...
            const bodyData = { 'field-0': 'John Doe' };
...
describe('parseFormFields - HTML field expression resolution', () => {
    ...
    it('should handle multiple expressions in html fields', () => {
        ...
        mockWebhookFunctions.evaluateExpression.mockImplementation((expression) => {
            if (expression === '{{ $json.title }}')
                return 'Welcome';
            if (expression === '{{ $json.description }}')
...
describe('validateFormPageAuth', () => {
    ...
    const pageNode = { id: 'page-node', webhookId: 'page-webhook' };
    const WORKFLOW_ID = 'workflow-1';
    const EXECUTION_ID = 'exec-id';
    const buildContext = (method, cookie) => {
        const res = {
            writeHead: vi.fn(),
            end: vi.fn(),
            setHeader: vi.fn(),
        ...
        ctx.getResponseObject.mockReturnValue(res);
    ...
    const formAuthCookieName = (binding) => binding.executionId
     ...
     * page looks for. */
    const pageAuthCookie = (binding, cookieName = formAuthCookieName(binding)) => `${cookieName}=${generateFormUserAuthToken(pageNode, authedUser, binding)}`;
    ...
    it('responds with 302 redirect to /signin on GET when no cookie is present, using an absolute URL', async () => {
        ...
        expect(res.writeHead).toHaveBeenCalledWith(302, {
            Location: '/signin?redirect=' + encodeURIComponent('http://localhost:5678/form-waiting/exec-id'),
        });
    ...
    it('honours x-forwarded-proto/host when building the redirect URL', async () => {
        ...
        expect(res.writeHead).toHaveBeenCalledWith(302, {
            Location: '/signin?redirect=' + encodeURIComponent('https://forms.example.com/form-waiting/exec-id'),
        });
    });
    it('responds with 401 on POST when no cookie is present', async () => {
        ...
        const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
        expect(res.setHeader).toHaveBeenCalledWith('WWW-Authenticate', 'Basic realm="Enter credentials"');
    ...
    it('responds with 302 redirect when cookie is invalid on GET', async () => {
        ...
        expect(res.writeHead).toHaveBeenCalledWith(302, expect.objectContaining({ Location: expect.stringContaining('/signin?redirect=') }));
        expect(result.responded).toBe(true);
    });
    ...
    it('falls back to the x-auth-token header when no cookie is present', async () => {
        const node = { id: 'node-1', webhookId: 'webhook-1' };
    ...
    describe('form page auth cookie', () => {
        ...
        it('returns the authedUser from a cookie bound to the execution being served', async () => {
            const { ctx } = buildContext('GET', pageAuthCookie({ workflowId: WORKFLOW_ID, executionId: EXECUTION_ID }));
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(result.authedUser).toEqual(authedUser);
        });
        it('parses the cookie alongside other cookies', async () => {
            const { ctx } = buildContext('GET', `other=value; ${pageAuthCookie({ workflowId: WORKFLOW_ID })}; another=thing`);
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(result.authedUser).toEqual(authedUser);
        });
        ...
        it('ignores a token bound to another workflow sitting under the expected name', async () => {
            const { ctx, res } = buildContext('GET', pageAuthCookie({ workflowId: 'other-workflow' }, formAuthCookieName({ workflowId: WORKFLOW_ID })));
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(result.responded).toBe(true);
            expect(res.writeHead).toHaveBeenCalledWith(302, expect.objectContaining({ Location: expect.stringContaining('/signin?redirect=') }));
        });
        it('ignores a token bound to another execution sitting under the expected name', async () => {
            const { ctx, res } = buildContext('GET', pageAuthCookie({ workflowId: WORKFLOW_ID, executionId: 'other-execution' }, formAuthCookieName({ workflowId: WORKFLOW_ID, executionId: EXECUTION_ID })));
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(result.responded).toBe(true);
            expect(res.writeHead).toHaveBeenCalledWith(302, expect.any(Object));
        });
        it('ignores a token that carries no workflow binding', async () => {
            const { ctx, res } = buildContext('GET', pageAuthCookie({}, formAuthCookieName({ workflowId: WORKFLOW_ID })));
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(result.responded).toBe(true);
            expect(res.writeHead).toHaveBeenCalledWith(302, expect.any(Object));
        });
        ...
        it('falls back to the session cookie when the form cookie does not verify', async () => {
            const { ctx } = buildContext('GET', 'n8n-form-auth-ex-exec-id=garbage; n8n-auth=valid.jwt.token');
            ctx.validateCookieAuth.mockResolvedValue(authedUser);
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(ctx.validateCookieAuth).toHaveBeenCalledWith('valid.jwt.token');
            expect(result.authedUser).toEqual(authedUser);
        ...
        it('falls back to the session cookie when the form cookie value cannot be decoded', async () => {
            const { ctx } = buildContext('GET', 'n8n-form-auth-ex-exec-id=%E0%A4%A; n8n-auth=valid.jwt.token');
            ctx.validateCookieAuth.mockResolvedValue(authedUser);
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(ctx.validateCookieAuth).toHaveBeenCalledWith('valid.jwt.token');
            expect(result.authedUser).toEqual(authedUser);
        ...
        it("discards the cookie when the request also carries a different user's session", async () => {
            ...
            const { ctx } = buildContext('GET', `${pageAuthCookie({ workflowId: WORKFLOW_ID })}; n8n-auth=valid.jwt.token`);
        ...
        it('keeps the cookie when the session alongside it no longer validates', async () => {
            const { ctx } = buildContext('GET', `${pageAuthCookie({ workflowId: WORKFLOW_ID })}; n8n-auth=stale.jwt.token`);
            ctx.validateCookieAuth.mockRejectedValue(new Error('Unauthorized'));
            const result = await validateFormPageAuth(ctx, 'n8nUserAuth');
            expect(result.authedUser).toEqual(authedUser);
            expect(result.responded).toBeFalsy();
...
describe('generateFormUserAuthToken / verifyFormUserAuthToken', () => {
    const node = { id: 'node-id', webhookId: 'webhook-id' };
    const user = {
        id: 'user-1',
        email: 'user@example.com',
        firstName: 'Test',
    ...
    it('rejects a token signed for a different node', () => {
        const token = generateFormUserAuthToken(node, user, binding);
        const otherNode = { id: 'node-2', webhookId: 'webhook-2' };
    ...
    it('accepts a token carrying neither binding claim', () => {
        const token = jwt.sign({
            ...
            nid: node.id,
            wid: node.webhookId,
        }, 'test-hmac-secret', { algorithm: 'HS256', expiresIn: 60 });
        expect(verifyFormUserAuthToken(token, node, 'exec-1')).toEqual(user);
    });
});
