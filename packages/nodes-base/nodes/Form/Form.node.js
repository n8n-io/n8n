import { FORM_NODE_TYPE, FORM_TRIGGER_NODE_TYPE, Node, NodeConnectionTypes, NodeOperationError, updateDisplayOptions, } from 'n8n-workflow';
import { configureWaitTillDate } from '../../utils/sendAndWait/configureWaitTillDate.util';
import { limitWaitTimeProperties } from '../../utils/sendAndWait/descriptions';
import { appendAttributionToForm, formDescription, formFields, formFieldsDynamic, formTitle, } from '../Form/common.descriptions';
...
import { getNodeReference, parseFormFields, prepareFormReturnItem, respondIfCredentialsNotReady, validateFormPageAuth, } from './utils/utils';
...
export const formFieldsProperties = [
    {
    ...
    ...waitTimeProperties,
    {
        ...
        options: [
            { ...formTitle, required: false, displayName: 'Completion Page Title' },
            {
                ...
                description: 'Whether to include the link “Form automated with n8n” at the bottom of the page. Defaults to the Form Trigger’s setting.',
            },
            {
                displayName: 'Custom Form Styling',
                name: 'customCss',
...
export class Form extends Node {
    ...
    async webhook(context) {
        ...
        const returnItem = await prepareFormReturnItem(context, fields, mode, useWorkflowTimezone, userForOutput);
        return {
    ...
    async execute(context) {
        ...
        if (operation === 'completion' && hasNextPage) {
            throw new NodeOperationError(context.getNode(), 'Completion has to be the last Form node in the workflow');
        }
