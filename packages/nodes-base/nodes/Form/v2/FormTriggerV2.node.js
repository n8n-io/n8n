import { ADD_FORM_NOTICE, NodeConnectionTypes, } from 'n8n-workflow';
import { appendAttributionToForm, formDescription, formFields, formFieldsDynamic, formRespondMode, formTitle, formTriggerPanel, ipAllowlist, respondWithOptions, webhookPath, } from '../common.descriptions';
...
const descriptionV2 = {
    ...
    properties: [
        ...
        {
            ...formRespondMode,
            options: formRespondMode.options?.filter((option) => option.value !== 'responseNode'),
