...
function setupErrorTest(workflowFile, error) {
...
describe('Gitlab Node - Issue Operations', () => {
    ...
    describe('issue:create', () => {
        ...
        describe('with a validation error', () => {
            ...
            setupErrorTest('issue.create.error.workflow.json', 'Your request is invalid or could not be processed by the service');
        });
        describe('with invalid credentials', () => {
            beforeEach(() => {
                api().post('/projects/missing%2Fnope/issues').reply(401, { message: '401 Unauthorized' });
            });
            setupErrorTest('issue.create.error.workflow.json', 'Authorization failed - please check your credentials');
        });
        describe('with a missing project', () => {
            ...
            setupErrorTest('issue.create.error.workflow.json', 'The resource you are requesting could not be found');
        });
    });
    describe('issue:createComment', () => {
        ...
        describe('with a missing issue', () => {
            ...
            setupErrorTest('issue.createComment.404.workflow.json', 'The resource you are requesting could not be found');
        });
    });
    describe('issue:edit', () => {
        ...
        describe('with a missing issue', () => {
            ...
            setupErrorTest('issue.edit.404.workflow.json', 'The resource you are requesting could not be found');
        });
    });
    describe('issue:get', () => {
        describe('with a valid issue', () => {
        ...
        describe('with a server error', () => {
            ...
            setupErrorTest('issue.get.500.workflow.json', 'The service was not able to process your request');
        });
...
//# sourceMappingURL=Gitlab.issue.test.js.map