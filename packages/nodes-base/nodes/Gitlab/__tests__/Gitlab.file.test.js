...
describe('Gitlab Node - File Operations', () => {
    ...
    describe('file:create', () => {
        ...
        describe('with a missing project', () => {
            ...
            setupErrorTest('file.create.404.workflow.json', 'The resource you are requesting could not be found');
        });
    });
    describe('file:edit', () => {
        describe('with text content', () => {
        ...
        describe('with a missing file', () => {
            ...
            setupErrorTest('file.edit.404.workflow.json', 'The resource you are requesting could not be found');
        });
    });
    describe('file:get', () => {
        ...
        describe('with a missing file', () => {
            ...
            setupErrorTest('file.get.404.workflow.json', 'The resource you are requesting could not be found');
        });
    });
...
//# sourceMappingURL=Gitlab.file.test.js.map