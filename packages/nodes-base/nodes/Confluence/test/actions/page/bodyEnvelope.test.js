...
import { buildBodyEnvelope, envelopeHasContent, readBodyEnvelope, } from '../../../actions/page/bodyEnvelope';
...
describe('buildBodyEnvelope', () => {
    describe('plainText', () => {
        ...
        it('rejects object content instead of creating an empty page', () => {
            expect(() => buildBodyEnvelope('plainText', { some: 'object' })).toThrow('must be text, got an object');
        });
    });
    describe('storage', () => {
        ...
        it('rejects non-string content', () => {
            expect(() => buildBodyEnvelope('storage', { html: '<p>x</p>' })).toThrow('Storage (HTML) body must be a string');
        });
    });
...
describe('envelopeHasContent', () => {
    const adf = (content) => buildBodyEnvelope('atlas_doc_format', { type: 'doc', version: 1, content });
    it.each([
        ...
        [
            ...
            buildBodyEnvelope('storage', '<div><br /><ul><li></li></ul><table><tr><td></td></tr></table></div>'),
            false,
        ],
        [
        ...
        [
            ...
            buildBodyEnvelope('storage', '<p><ac:image><ri:attachment ri:filename="x.png" /></ac:image></p>'),
            true,
        ],
...
//# sourceMappingURL=bodyEnvelope.test.js.map