...
export const execute = async function (itemIndex) {
    ...
    const page = await fetchPageForWrite.call(this, itemIndex, pageId, body === undefined ? 'storage' : undefined);
    ...
    return await putPage.call(this, itemIndex, pageId, page, title === '' ? page.title : title, body ?? { representation: 'storage', value: page.bodyValue }, status);
};
