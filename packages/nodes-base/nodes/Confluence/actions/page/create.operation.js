...
export const description = [
    ...
    ...bodyProperties(['create']),
    {
        ...
        name: 'parentPage',
        required: false,
        description: 'The page to create the new page under. Leave empty to create under the space homepage.',
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether only the creating user can view and edit the page. The creator is the connected account, which needs permission to restrict content in the space.',
            },
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether to create the page at the space root, outside the space homepage tree. Cannot be combined with a parent page.',
            },
        ],
    },
];
export async function execute(itemIndex) {
    ...
    if (!options.rootLevel) {
        const parentRef = this.getNodeParameter('parentPage', itemIndex, '');
        const rawParentValue = typeof parentRef === 'object' && parentRef !== null ? parentRef.value : parentRef;
