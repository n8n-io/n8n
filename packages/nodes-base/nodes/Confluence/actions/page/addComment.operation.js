...
const hideOnReply = { parentCommentId: [{ _cnd: { regex: '\\S' } }] };
export const description = [
    {
        ...
        description: 'Leave empty to comment directly on a page. Set to reply to an existing footer comment; the page is inferred from the parent.',
...
export const execute = async function (itemIndex) {
    ...
    const parentCommentId = String(this.getNodeParameter('parentCommentId', itemIndex, '') ?? '').trim();
...
//# sourceMappingURL=addComment.operation.js.map