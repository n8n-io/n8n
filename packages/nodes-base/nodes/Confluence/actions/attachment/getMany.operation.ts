...
const showOnGetMany = { resource: ['attachment'], operation: ['getMany'] };
...
export const description: INodeProperties[] = [
	{
		...
		displayOptions: { show: showOnGetMany },
	},
	{
		...pageRLC,
	...
	},
	{
		...
		displayOptions: { show: { ...showOnGetMany, download: [true] } },
	},
];
