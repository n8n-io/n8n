        ...
        try {
            ...
            switch (`${resource}:${operation}`) {
                ...
                case 'space:getMany':
                    ...
                    break;
                default:
                    throw new NodeOperationError(this.getNode(), `The operation "${resource}:${operation}" is not supported`);
            }
            ...
            if (this.continueOnFail()) {
                ...
                const errorData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray({ error: message }), { itemData: { item: i } });
