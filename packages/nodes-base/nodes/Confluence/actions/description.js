...
export const confluenceNodeDescription = {
    ...
    properties: [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: "OAuth 2.0 client credentials for an Atlassian service account. The credential's scopes are fixed when it is created, and space permissions apply on top, like for any other user.",
                },
            ],
            default: 'cloudOAuth2',
        },
