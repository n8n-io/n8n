...
export class ZohoCrm {
    ...
    methods = {
        loadOptions: {
            ...
            // ----------------------------------------
            async getAccounts() {
                const accounts = (await zohoApiRequestAllItems.call(this, 'GET', '/accounts'));
                return toLoadOptions(accounts, 'Account_Name');
            },
            async getContacts() {
                const contacts = (await zohoApiRequestAllItems.call(this, 'GET', '/contacts'));
                return toLoadOptions(contacts, 'Full_Name');
            },
            async getDeals() {
                const deals = (await zohoApiRequestAllItems.call(this, 'GET', '/deals'));
                return toLoadOptions(deals, 'Deal_Name');
            },
            async getProducts() {
                const products = (await zohoApiRequestAllItems.call(this, 'GET', '/products'));
                return toLoadOptions(products, 'Product_Name');
            },
            async getVendors() {
                const vendors = (await zohoApiRequestAllItems.call(this, 'GET', '/vendors'));
