						...
						try {
							if (resource === 'account') {
								...
								if (operation === 'create') {
									...
									const productDetails = this.getNodeParameter(
										'Product_Details',
										i,
									) as ProductDetails;
									...
									if (Object.keys(updateFields).length) {
										Object.assign(
											body,
											adjustInvoicePayloadOnUpdate(updateFields),
										);
									} else {
										throwOnEmptyUpdate.call(this, resource);
									}
								...
								if (operation === 'create') {
									...
									if (Object.keys(additionalFields).length) {
										Object.assign(
											body,
											adjustPurchaseOrderPayload(additionalFields),
										);
									}
									...
									const purchaseOrderId = this.getNodeParameter(
										'purchaseOrderId',
										i,
									);
									...
									if (Object.keys(updateFields).length) {
										Object.assign(
											body,
											adjustPurchaseOrderPayload(updateFields),
										);
									} else {
										throwOnEmptyUpdate.call(this, resource);
									}
								...
								if (operation === 'create') {
									...
									if (Object.keys(additionalFields).length) {
										Object.assign(
											body,
											adjustSalesOrderPayload(additionalFields),
										);
									}
