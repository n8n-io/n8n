...
export class ZohoCrm implements INodeType {
	...
	methods = {
		loadOptions: {
			...
			async getDeals(this: ILoadOptionsFunctions) {
				const deals = (await zohoApiRequestAllItems.call(
					this,
					'GET',
					'/deals',
				)) as LoadedDeals;
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const resolveData = this.getNodeParameter(
			'resolveData',
			0,
			false,
		) as boolean;
					...
					try {
						if (resource === 'account') {
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Account_Name: this.getNodeParameter('accountName', i) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Last_Name: this.getNodeParameter('lastName', i) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Deal_Name: this.getNodeParameter('dealName', i), Stage: this.getNodeParameter('stage', i) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Subject: this.getNodeParameter('subject', i), Product_Details: adjustProductDetails(productDetails) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Company: this.getNodeParameter('Company', i), Last_Name: this.getNodeParameter('lastName', i) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Product_Name: this.getNodeParameter('productName', i) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Subject: this.getNodeParameter('subject', i), Vendor_Name: { id: this.getNodeParameter('vendorId', i) }, Product_Details: adjustProductDetails(productDetails) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Account_Name: { id: this.getNodeParameter('accountId', i) }, Subject: this.getNodeParameter('subject', i), Product_Details: adjustProductDetails(productDetails) };
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { Vendor_Name: this.getNodeParameter('vendorName', i) };
