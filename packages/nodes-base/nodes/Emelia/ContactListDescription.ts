...
export const contactListFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		required: true,
		description:
			'The ID of the contact list to add the contact to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['contactList'],
				operation: ['add'],
