...
export async function mailchimpApiRequest(endpoint, method, body = {}, qs = {}, _headers) {
...
export async function mailchimpApiRequestAllItems(endpoint, method, propertyName, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    query.offset = 0;
    query.count = 500;
