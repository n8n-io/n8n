...
export const conversationFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		default: '',
		description:
			'ID of a mailbox where the conversation is being created. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
	},
	{
		displayName: 'Status',
		name: 'status',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'List of tags to be added to the conversation. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
				displayName: 'User ID',
				name: 'user',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'Filter conversation by tags. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
		],
	},
];
