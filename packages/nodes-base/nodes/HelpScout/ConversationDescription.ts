	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description: 'List of tags to be be added to the conversation. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
			{
				displayName: 'User ID',
				name: 'user',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description: 'Filter conversation by tags. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
		],
	},
];
