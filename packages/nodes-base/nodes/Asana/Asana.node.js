...
import { asanaApiRequest, asanaApiRequestAllItems, getColorOptions, getTaskFields, getWorkspaces, } from './GenericFunctions';
export class Asana {
    description = {
        displayName: 'Asana',
        name: 'asana',
    ...
    methods = {
        loadOptions: {
            ...
            async getSections() {
                ...
                const responseData = await asanaApiRequest.call(this, 'GET', `/projects/${projectId}/sections`, {});
                if (responseData.data === undefined) {
                    throw new NodeApiError(this.getNode(), responseData, {
                        message: 'No data got returned',
                    });
            ...
            async getTeams() {
                ...
                const responseData = await asanaApiRequestAllItems.call(this, 'GET', `/organizations/${workspaceId}/teams`, {});
                const returnData = [];
            ...
            try {
                ...
                if (resource === 'subtask') {
                    if (operation === 'create') {
                        ...
                        responseData = await asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/subtasks`, body, qs);
                    ...
                    if (operation === 'getAll') {
                        ...
                        responseData = await asanaApiRequest.call(this, 'GET', `/tasks/${taskId}/subtasks`, body, qs);
                        responseData = responseData.data;
                        if (!returnAll) {
                ...
                if (resource === 'task') {
                    if (operation === 'create') {
                        ...
                        //         task:delete
                        // ----------------------------------
                        responseData = await asanaApiRequest.call(this, 'DELETE', `/tasks/${this.getNodeParameter('id', i)}`, body, qs);
                        responseData = responseData.data;
                    }
                        ...
                        //         task:get
                        // ----------------------------------
                        responseData = await asanaApiRequest.call(this, 'GET', `/tasks/${this.getNodeParameter('id', i)}`, body, qs);
                        responseData = responseData.data;
                    }
                        ...
                        Object.assign(body);
                        responseData = await asanaApiRequest.call(this, 'POST', `/sections/${sectionId}/addTask`, body, qs);
                        ...
                        const otherProperties = this.getNodeParameter('otherProperties', i);
                        Object.assign(body, otherProperties);
                        responseData = await asanaApiRequest.call(this, 'PUT', `/tasks/${this.getNodeParameter('id', i)}`, body, qs);
                        responseData = responseData.data;
                    }
                        ...
                        responseData = await asanaApiRequest.call(this, 'GET', `/workspaces/${workspaceId}/tasks/search`, body, qs);
                        responseData = responseData.data;
                    }
                }
                if (resource === 'taskComment') {
                    if (operation === 'add') {
                        ...
                        responseData = await asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/stories`, body, qs);
                        responseData = responseData.data;
                    }
                    if (operation === 'remove') {
                        // ----------------------------------
                        ...
                        responseData = await asanaApiRequest.call(this, 'DELETE', `/stories/${commentId}`, body, qs);
                        responseData = { success: true };
                    }
                }
                if (resource === 'taskTag') {
                    if (operation === 'add') {
                        ...
                        responseData = await asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/addTag`, body, qs);
                        responseData = { success: true };
                    }
                    if (operation === 'remove') {
                        // ----------------------------------
                        ...
                        const taskId = this.getNodeParameter('id', i);
                        body.tag = this.getNodeParameter('tag', i);
                        responseData = await asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/removeTag`, body, qs);
                        responseData = { success: true };
                    }
                }
                if (resource === 'taskProject') {
                    if (operation === 'add') {
                        ...
                        Object.assign(body, additionalFields);
                        responseData = await asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/addProject`, body, qs);
                        responseData = { success: true };
                    }
                    if (operation === 'remove') {
                        // ----------------------------------
                        ...
                        const taskId = this.getNodeParameter('id', i);
                        body.project = this.getNodeParameter('project', i);
                        responseData = await asanaApiRequest.call(this, 'POST', `/tasks/${taskId}/removeProject`, body, qs);
                        responseData = { success: true };
                    }
                }
                if (resource === 'user') {
                    if (operation === 'get') {
                        ...
                        // ----------------------------------
                        const workspaceId = this.getNodeParameter('workspace', i);
                        responseData = await asanaApiRequest.call(this, 'GET', `/workspaces/${workspaceId}/users`, body, qs);
                        responseData = responseData.data;
                    }
                }
                if (resource === 'project') {
                    if (operation === 'create') {
                        ...
                        responseData = await asanaApiRequest.call(this, 'POST', `/teams/${teamId}/projects`, body, qs);
                        responseData = responseData.data;
                    }
                    if (operation === 'delete') {
                        // ----------------------------------
                    ...
                    if (operation === 'get') {
                        ...
                        // ----------------------------------
                        const projectId = this.getNodeParameter('id', i);
                        responseData = await asanaApiRequest.call(this, 'GET', `/projects/${projectId}`, body, qs);
                        responseData = responseData.data;
                    }
                    if (operation === 'getAll') {
                        // ----------------------------------
                    ...
                    if (operation === 'update') {
                        ...
                        responseData = await asanaApiRequest.call(this, 'PUT', `/projects/${projectId}`, body, qs);
                        responseData = responseData.data;
                    }
                }
