...
import { NodeOperationError, NodeConnectionTypes, AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, AI_TRANSFORM_JS_CODE, } from 'n8n-workflow';
...
function getValidatedCode(executeFunctions, node) {
    try {
        const code = executeFunctions.getNodeParameter(AI_TRANSFORM_JS_CODE, 0);
        if (code) {
            return code;
        }
