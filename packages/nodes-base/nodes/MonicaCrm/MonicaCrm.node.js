    ...
    methods = {
        loadOptions: {
            async getActivityTypes() {
                const responseData = (await monicaCrmApiRequest.call(this, 'GET', '/activitytypes'));
                return toOptions(responseData);
            },
            async getTagsToAdd() {
                const responseData = await monicaCrmApiRequestAllItems.call(this, 'GET', '/tags', {}, {}, { forLoader: true });
            ...
            async getContactFieldTypes() {
                const responseData = (await monicaCrmApiRequest.call(this, 'GET', '/contactfieldtypes'));
                return toOptions(responseData);
            },
            async getGenders() {
                const responseData = (await monicaCrmApiRequest.call(this, 'GET', '/genders'));
                return toOptions(responseData);
            },
        },
    };
