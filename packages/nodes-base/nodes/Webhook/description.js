...
export const defaultWebhookDescription = {
    name: 'default',
    isFullPath: true,
...
export const credentialsProperty = (propertyName = 'authentication') => [
    {
        name: 'httpBasicAuth',
        required: true,
        displayOptions: {
...
export const authenticationProperty = (propertyName = 'authentication', 
...
export const requireExecuteAccessProperty = (propertyName = 'authentication') => ({
...
export const httpMethodsProperty = {
...
export const responseModeProperty = {
    displayName: 'Respond',
    name: 'responseMode',
    type: 'options',
...
export const responseModePropertyStreaming = {
    displayName: 'Respond',
    name: 'responseMode',
    type: 'options',
    options: [
...
export const responseDataProperty = {
...
export const responseBinaryPropertyNameProperty = {
...
export const responseCodeSelector = {
    displayName: 'Response Code',
    name: 'responseCode',
    type: 'options',
    options: [
...
export const responseCodeOption = {
    displayName: 'Response Code',
    name: 'responseCode',
