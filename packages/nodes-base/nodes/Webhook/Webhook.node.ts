...
export class Webhook implements INodeType {
	description: INodeTypeDescription = {
		...
		triggerPanel: {
			...
			activationHint: 'Once you’ve finished building your workflow, run it without having to click this button by using the production webhook URL. <a data-key=\"help\">More info</a>',
		},
