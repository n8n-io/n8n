...
describe('Webflow -> webflowApiRequestAllItems', () => {
    ...
    it('should return all items for type version 1', async () => {
        const result = await webflowApiRequestAllItems.call(mockExecuteFunctions, 'GET', '/collections/collection_id/items');
...
describe('Webflow -> webflowApiRequest', () => {
    ...
    it('should use live in the url for v2 when live is true', async () => {
        ...
        expect(mockThis.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('webflowOAuth2Api', {
            method: 'PATCH',
