...
describe('Mistral AI Node', () => {
    ...
    describe('Document -> Extract Text', () => {
        beforeAll(() => {
            ...
            // Batching
            mistralAiNock
                .post('/v1/files', (body) => body.includes(JSON.stringify({
                document: {
                    type: 'document_url',
            ...
            mistralAiNock.get('/v1/files/output-file-1/content').reply(200, batchResult
                .slice(0, 2)
...
//# sourceMappingURL=MistralAi.node.test.js.map