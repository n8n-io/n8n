            ...
            try {
                if (operation === 'decompress') {
                    ...
                    for (const [index, binaryPropertyName] of binaryPropertyNames.entries()) {
                        ...
                        if (!fileExtension) {
                            throw new NodeOperationError(this.getNode(), `File extension not found for binary data ${binaryPropertyName}`);
                        }
                        ...
                        if (fileExtension === 'zip' || isTar) {
                            ...
                            throw new NodeOperationError(this.getNode(), `Unsupported archive format ".${fileExtension}" for binary data ${binaryPropertyName}`, {
