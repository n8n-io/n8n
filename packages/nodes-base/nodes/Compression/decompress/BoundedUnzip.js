...
import { DEFLATED, readCentralDirectory, STORED } from './ZipCentralDirectory';
const inflateRawAsync = promisify(inflateRaw);
async function extractEntry(data, entry, budget, maxOutputSize) {
 ...
 */
export async function boundedUnzip(data, maxOutputSize, maxEntries) {
    const entries = [];
