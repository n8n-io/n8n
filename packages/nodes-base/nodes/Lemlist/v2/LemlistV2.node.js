...
import { activityFields, activityOperations, campaignFields, campaignOperations, enrichmentFields, enrichmentOperations, leadFields, leadOperations, teamFields, teamOperations, unsubscribeFields, unsubscribeOperations, } from './descriptions';
            ...
            try {
                if (resource === 'activity') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        responseData = await lemlistApiRequest.call(this, 'GET', `/campaigns/${campaignId}/stats`, {}, qs);
                    }
                }
