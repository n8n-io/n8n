				...
				options: [
					{
						...
						action: 'Exchange Rate an information',
					},
					{
						name: 'Image Metadata',
						value: 'imageMetadata',
						description: 'Retrieve image metadata from a URL',
						action: 'Image Metadata an information',
					},
				],
				...
				options: [
					{
						...
						action: 'Expand URL a utility',
					},
					{
						name: 'Generate QR Code',
						value: 'qrCode',
						description: 'Generate a QR Code',
						action: 'Generate QR Code a utility',
					},
					{
						name: 'Validate Email',
						value: 'validateEmail',
						description: 'Validate an email address',
						action: 'Validate Email a utility',
					},
				],
