...
describe('Bitbucket GenericFunctions', () => {
    describe('bitbucketApiRequest', () => {
        ...
        const mockHookFunctions = mockDeep();
        const mockLoadOptionsFunctions = mockDeep();
        const mockNode = {
            id: 'test-node-id',
            name: 'Bitbucket Test',
        ...
        describe('with access token authentication', () => {
            ...
            it('should make successful API request with access token', async () => {
                ...
                const result = await bitbucketApiRequest.call(mockExecuteFunctions, 'GET', '/repositories', {}, {});
                expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('bitbucketAccessTokenApi', {
                    method: 'GET',
                    qs: {},
            ...
            it('should handle custom URI with access token', async () => {
                ...
                mockExecuteFunctions.helpers.httpRequestWithAuthentication.mockResolvedValue(mockResponse);
                await bitbucketApiRequest.call(mockExecuteFunctions, 'POST', '/repositories', { name: 'test' }, { page: 1 }, customUri);
                expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('bitbucketAccessTokenApi', {
                    method: 'POST',
                    qs: { page: 1 },
                    body: { name: 'test' },
            ...
            it('should remove empty body with access token', async () => {
                ...
                expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('bitbucketAccessTokenApi', expectedOptions);
            });
            it('should work with hook functions', async () => {
                ...
                expect(mockHookFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('bitbucketAccessTokenApi', {
                    method: 'GET',
                    qs: {},
            ...
            it('should work with load options functions', async () => {
                const mockResponse = { values: [] };
                mockLoadOptionsFunctions.helpers.httpRequestWithAuthentication.mockResolvedValue(mockResponse);
                const result = await bitbucketApiRequest.call(mockLoadOptionsFunctions, 'GET', '/hook_events/workspace');
                expect(mockLoadOptionsFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('bitbucketAccessTokenApi', {
                    method: 'GET',
                    qs: {},
        ...
        describe('error handling', () => {
            ...
            it('should throw NodeApiError when request fails', async () => {
                ...
                await expect(bitbucketApiRequest.call(mockExecuteFunctions, 'GET', '/repositories')).rejects.toThrow(NodeApiError);
    ...
    describe('bitbucketApiRequestAllItems', () => {
        ...
        it('should handle single page response', async () => {
            ...
            mockExecuteFunctions.helpers.httpRequestWithAuthentication.mockResolvedValue(mockResponse);
            const result = await bitbucketApiRequestAllItems.call(mockExecuteFunctions, 'values', 'GET', '/repositories');
        ...
        it('should handle multiple pages', async () => {
            ...
            expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenNthCalledWith(2, 'bitbucketAccessTokenApi', {
                method: 'GET',
                qs: {},
                url: 'https://api.bitbucket.org/2.0/repositories?page=2',
                json: true,
            });
            expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenNthCalledWith(3, 'bitbucketAccessTokenApi', {
                method: 'GET',
                qs: {},
        ...
        it('should pass through body and query parameters', async () => {
            ...
            mockExecuteFunctions.helpers.httpRequestWithAuthentication.mockResolvedValue(mockResponse);
            await bitbucketApiRequestAllItems.call(mockExecuteFunctions, 'values', 'POST', '/repositories', body, query);
            expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('bitbucketAccessTokenApi', {
                method: 'POST',
                qs: query,
                body,
        ...
        it('should work with different property names', async () => {
            ...
            mockExecuteFunctions.helpers.httpRequestWithAuthentication.mockResolvedValue(mockResponse);
            const result = await bitbucketApiRequestAllItems.call(mockExecuteFunctions, 'items', 'GET', '/custom-endpoint');
            expect(result).toEqual([{ id: 1 }, { id: 2 }]);
        });
        it('should handle errors during pagination', async () => {
            ...
            await expect(bitbucketApiRequestAllItems.call(mockExecuteFunctions, 'values', 'GET', '/repositories')).rejects.toThrow(NodeApiError);
        });
        it('should work with hook functions', async () => {
            const mockHookFunctions = mockDeep();
            mockHookFunctions.getNode.mockReturnValue(mockNode);
            ...
            mockHookFunctions.helpers.httpRequestWithAuthentication.mockResolvedValue(mockResponse);
            const result = await bitbucketApiRequestAllItems.call(mockHookFunctions, 'values', 'GET', '/hook_events/repository');
        ...
        it('should work with load options functions', async () => {
            ...
            mockLoadOptionsFunctions.helpers.httpRequestWithAuthentication.mockResolvedValue(mockResponse);
            const result = await bitbucketApiRequestAllItems.call(mockLoadOptionsFunctions, 'values', 'GET', '/workspaces');
