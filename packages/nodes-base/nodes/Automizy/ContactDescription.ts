	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description: 'The tags you want to set to the contact. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
		],
	},
		...
		options: [
			{
				...
				default: [],
				description: 'The tags you want to add to the contact. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
			{
				displayName: 'Custom Fields',
				name: 'customFieldsUi',
			...
			},
			{
				...
				default: [],
				description: 'The tags you want to set to the contact. Will replace all existing ones. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
		],
	},
];
