...
export class Aggregate {
    ...
    async execute() {
        ...
        if (aggregate === 'aggregateIndividualFields') {
            ...
            const fieldsToExclude = prepareFieldsArray(this.getNodeParameter('fieldsToExclude', 0, ''), 'Fields To Exclude');
            const fieldsToInclude = prepareFieldsArray(this.getNodeParameter('fieldsToInclude', 0, ''), 'Fields To Include');
