import { fieldValueGetter, aggregateAndSplitData, flattenAggregationResultToArray, } from '../../utils';
describe('Test Summarize Node, aggregateAndSplitData', () => {
    ...
    test('should handle split field values containing spaces when convertKeysToString is not set', () => {
        ...
        expect(flattenAggregationResultToArray(result)).toMatchSnapshot('split-field-with-spaces-array');
    });
...
//# sourceMappingURL=splitData.test.js.map