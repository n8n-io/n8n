		...
		options: [
			{
				name: 'Post',
				value: 'post',
				description: 'Post a conversation into a channel',
			},
		],
		default: 'post',
...
/* -------------------------------------------------------------------------- */
	{
		...
		required: true,
		description: 'The channel to send the conversation to.',
	},
	{
		displayName: 'Text',
		name: 'text',
	...
	},
	{
		...
		description: 'Post the conversation as authenticated user instead of bot.',
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description: 'Text which appears before the conversation block.',
			},
			{
			...
			},
			{
				...
				type: 'dateTime',
				default: '',
				description: 'Time conversation relates to.',
			},
			{
				displayName: 'Fields',
				name: 'fields',
				placeholder: 'Add Fields',
				description: 'Fields to add to conversation.',
		...
		options: [
			{
				...
				type: 'dateTime',
				default: '',
				description: `Represents the due date of the conversation.<br/>
			...
			},
			{
				...
				description: 'Contains a text description of the conversation.',
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Indicates whether a popup reminder has been set for the conversation (true) or not (false).',
			},
			{
				displayName: 'Owner',
				name: 'owner',
			...
			},
			{
				...
				default: '',
				description: `The frequency of the recurring conversation. For example, “2nd” or “3rd.”`,
			},
			{
				...
				type: 'number',
				default: '',
				description: 'The interval between recurring conversations.',
			},
			{
				...
				default: '',
				description: 'The month of the year in which the conversation repeats.',
			},
			{
				...
				type: 'dateTime',
				default: '',
				description: `The date when the recurring conversation begins.<br/>
