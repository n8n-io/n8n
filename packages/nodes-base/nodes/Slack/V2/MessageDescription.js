...
export const advancedInteractivityNotice = {
...
export const captureResponderField = {
...
export const unauthorizedReplyField = {
...
export const postDecisionBehaviorField = {
...
export const replyToMessageField = {
...
export const messageFields = [
    ...
    },
    {
        ...
        description: "Enter the JSON output from Slack's visual Block Kit Builder here, including the top-level wrapper: <code>{ \"blocks\": [ ... ] }</code>. A bare array of blocks is not accepted. You can then use expressions to add variable content to your blocks. To create blocks, use <a target='_blank' href='https://app.slack.com/block-kit-builder'>Slack's Block Kit Builder</a>",
