import { slackApiRequest, slackApiRequestAllItems, toMultiOptionsCsv, validateJSON, } from '../../V1/GenericFunctions';
...
describe('Slack V1 > GenericFunctions', () => {
    ...
    describe('slackApiRequest', () => {
        ...
        it('should use OAuth2 credentials when authentication is oAuth2', async () => {
            ...
            expect(mockExecuteFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('slackOAuth2Api', expect.any(Object), expect.objectContaining({
    ...
    describe('slackApiRequestAllItems', () => {
        it('should use default limit of 100 when no limit is provided', async () => {
            ...
            mockExecuteFunctions.helpers.requestWithAuthentication = vi
                .fn()
                .mockResolvedValue(mockResponse);
            await slackApiRequestAllItems.bind(mockExecuteFunctions)('channels', 'GET', 'conversations.list');
            expect(mockExecuteFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('slackApi', expect.objectContaining({
        ...
        it('should handle pagination with response_metadata next_cursor', async () => {
            ...
            const result = await slackApiRequestAllItems.call(mockExecuteFunctions, 'channels', 'GET', 'conversations.list');
