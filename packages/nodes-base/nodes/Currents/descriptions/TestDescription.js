import { filterAuthorsOption, filterBranchesOption, filterGroupsOption, filterTagsOption, projectRLC, } from './common.descriptions';
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                description: 'Override which test statuses are included in metric calculations. JSON object with optional keys: executions, avgDuration, flakinessRate, failureRate. Each value is an array of status strings: passed, failed, pending, skipped. Example: {"executions":["failed","passed"],"failureRate":["failed"]}',
                placeholder: '{"executions":["failed","passed"],"failureRate":["failed"]}',
            },
        ],
    },
];
//# sourceMappingURL=TestDescription.js.map