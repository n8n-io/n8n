...
describe('Currents Node Structure', () => {
    describe('Currents class', () => {
        ...
        it('should have correct credentials', () => {
            const node = new Currents();
            expect(node.description.credentials).toContainEqual(expect.objectContaining({ name: 'currentsApi' }));
        });
    ...
    describe('Description exports', () => {
        ...
        it.each(descriptionPairs)('$name should export valid operations and fields arrays', ({ operations, fields }) => {
...
//# sourceMappingURL=Currents.structure.test.js.map