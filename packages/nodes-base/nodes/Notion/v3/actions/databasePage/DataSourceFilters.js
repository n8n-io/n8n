...
export function mapDataSourceFilter(filter, timezone) {
...
export function mapDataSourceFilters(filters, matchType, timezone) {
...
export function dataSourceSearchFilterDescriptions() {
    const propertyTypes = [
        'checkbox',
        'created_by',
        'created_time',
