import { blockUrlExtractionRegexp, blockUrlValidationRegexp, databasePageUrlExtractionRegexp, databasePageUrlValidationRegexp, databaseUrlExtractionRegexp, databaseUrlValidationRegexp, idExtractionRegexp, idValidationRegexp, } from '../../shared/constants';
    ...
    modes: [
        {
            ...
            name: 'url',
            type: 'string',
            placeholder: 'https://www.notion.com/Block-Test-88888ccc303e4f44847f27d24bd7ad8e?pvs=4#c44444444444bbbbb4d32fdfdd84e',
            validation: [
                {
                    type: 'regex',
                    properties: {
...
export const dataSourceLocator = {
...
export function blockBuilder(resource, operation, extraDisplayOptions = {}) {
    const show = {
        resource: [resource],
        operation: [operation],
    };
...
export function iconOptions(resource, operations) {
    return {
        displayName: 'Options',
        name: 'options',
        type: 'collection',
...
export function searchOptions(resource, operation) {
    return {
        displayName: 'Options',
        name: 'options',
        type: 'collection',
...
export const returnAllOrLimit = (resource, operation) => [
    {
...
export const simplify = (resource, operations) => ({
