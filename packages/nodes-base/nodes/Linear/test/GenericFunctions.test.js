...
describe('Linear -> GenericFunctions', () => {
    ...
    describe('linearApiRequest', () => {
        ...
        const setupMockFunctions = (authentication) => {
        ...
        it('should make a successful API request', async () => {
            ...
            expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('linearApi', expect.objectContaining({
                method: 'POST',
        ...
        it('should handle API request errors', async () => {
            ...
            await expect(linearApiRequest.call(mockExecuteFunctions, { query: '{ viewer { id } }' })).rejects.toThrow(NodeApiError);
            expect(mockExecuteFunctions.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('linearApi', expect.objectContaining({
                method: 'POST',
                url: 'https://api.linear.app/graphql',
                json: true,
