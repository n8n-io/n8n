...
import { elasticsearchApiRequest, elasticsearchApiRequestAllItems, elasticsearchBulkApiRequest, } from './GenericFunctions';
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            if (resource === 'document') {
                ...
                if (operation === 'delete') {
                    ...
                    if (Object.keys(options).length) {
                        ...
                        if (query) {
                            Object.assign(body, parseAndResolveQueryParameters(query, queryParameters ?? '[]', this.getNode(), i));
                        }
                    ...
                    if (returnAll) {
                        ...
                        qs.size = 10000;
                        if (qs.sort) {
                            responseData = await elasticsearchApiRequestAllItems.call(this, indexId, body, qs);
                        }
                        else {
                            responseData = await elasticsearchApiRequest.call(this, 'POST', `/${toPathSegment(indexId)}/_search`, body, qs);
                ...
                if (operation === 'create') {
                    ...
                    responseData = await elasticsearchApiRequest.call(this, 'PUT', `/${toPathSegment(indexId)}`);
                    ...
                    const indexId = this.getNodeParameter('indexId', i);
                    responseData = await elasticsearchApiRequest.call(this, 'DELETE', `/${toPathSegment(indexId)}`);
                    ...
                    responseData = await elasticsearchApiRequest.call(this, 'GET', `/${toPathSegment(indexId)}`, {}, qs);
            ...
            if (Object.keys(bulkBody).length >= 50) {
                responseData = (await elasticsearchBulkApiRequest.call(this, bulkBody));
