						...
						try {
							if (resource === 'activity') {
								...
								if (operation === 'create') {
									...
									const body: IDataObject = { name, type, start_date_local: moment(startDate).toISOString(), elapsed_time: elapsedTime };
								...
								if (['getLaps', 'getZones', 'getKudos', 'getComments'].includes(operation)) {
									const path: IDataObject = { getComments: 'comments', getZones: 'zones', getKudos: 'kudos', getLaps: 'laps' };
