 ...
 *
 */
export async function spotifyApiRequest(method, endpoint, body, query, uri) {
    const options = {
        method,
        headers: {
...
export async function spotifyApiRequestAllItems(propertyName, method, endpoint, body, query) {
    const returnData = [];
    let responseData;
    let uri;
    do {
