			...
			// -----------------------------------------------
			{
				...
				options: [
					...
					},
					{
						...
						action: 'Get New Releases an album',
					},
					{
						name: `Get Tracks`,
						value: 'getTracks',
			...
			// -------------------------------------------------------------------------------------------------------------
			{
				...
				options: [
					...
					},
					{
						...
						action: 'Create a Playlist a playlist',
					},
					{
						name: 'Get',
						value: 'get',
					...
					},
					{
						...
						action: 'Remove an Item a playlist',
					},
					{
						name: `Search`,
						value: 'search',
			...
			// -----------------------------------------------------
			{
				...
				options: [
					...
					},
					{
						...
						action: 'Get Audio Features a track',
					},
					{
						name: 'Search',
						value: 'search',
						description: 'Search tracks by keyword',
						action: 'Search a track',
					},
				],
				default: 'track',
			},
				...
				options: [
					{
						...
						action: 'Get Liked Tracks a library',
					},
				],
				...
				options: [
					{
						...
						action: 'Get Following Artists a my data',
					},
				],
