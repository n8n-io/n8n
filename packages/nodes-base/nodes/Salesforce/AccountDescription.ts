...
export const accountFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		description:
			'The field to check to see if the account already exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'The source of the account record. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				default: '',
				description:
					'The owner of the account. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				description:
					'Type of account. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'ID of the user who owns the note. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
		],
	},
];
