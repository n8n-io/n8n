...
import { getQuery, salesforceApiRequest, salesforceApiRequestAllItems, sortOptions, getPollStartDate, filterAndManageProcessedItems, } from './GenericFunctions';
export class SalesforceTrigger {
    description = {
    ...
    async poll() {
        ...
        try {
            ...
            const { newItems, updatedProcessedIds } = filterAndManageProcessedItems(responseData, processedIds, changeType === 'Created' ? 'Created' : 'Updated');
