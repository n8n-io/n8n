...
export const customObjectFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'The field to check to see if the object already exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
	},
	{
				...
				values: [
					{
						...
						default: '',
						description:
							'The ID of the field. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
					},
					{
						displayName: 'Value',
						name: 'value',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'Fields to include separated by commas. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
		],
	},
	{
