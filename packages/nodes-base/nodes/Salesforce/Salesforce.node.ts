        ...
        try {
          if (resource === "lead") {
            ...
            if (operation === "create" || operation === "upsert") {
              ...
              const body: ILead = { Company: company, LastName: lastname };
            ...
            if (operation === "addToCampaign") {
              ...
              const options = this.getNodeParameter("options", i) as IDataObject;
              const body: ICampaignMember = { LeadId: leadId, CampaignId: campaignId };
              if (options.status) {
            ...
            if (operation === "addNote") {
              ...
              const options = this.getNodeParameter("options", i) as IDataObject;
              const body: INote = { Title: title, ParentId: leadId };
              if (options.body) {
          ...
          if (resource === "contact") {
            ...
            if (operation === "create" || operation === "upsert") {
              const additionalFields = this.getNodeParameter("additionalFields", i) as IDataObject;
              const lastname = this.getNodeParameter("lastname", i) as string;
              const body: IContact = { LastName: lastname };
            ...
            if (operation === "addToCampaign") {
              ...
              const campaignId = this.getNodeParameter("campaignId", i) as string;
              const options = this.getNodeParameter("options", i) as IDataObject;
              const body: ICampaignMember = { ContactId: contactId, CampaignId: campaignId };
              if (options.status) {
                body.Status = options.status as string;
              }
              responseData = await salesforceApiRequest.call(this, "POST", "/sobjects/CampaignMember", body);
            ...
            if (operation === "addNote") {
              ...
              const title = this.getNodeParameter("title", i) as string;
              const options = this.getNodeParameter("options", i) as IDataObject;
              const body: INote = { Title: title, ParentId: contactId };
          ...
          if (resource === "document") {
            ...
            if (operation === "upload") {
              ...
              let data;
              const body: { entity_content: { [key: string]: string } } = { entity_content: { Title: title, ContentLocation: "S" } };
              ...
              if (items[i].binary && items[i].binary![binaryPropertyName]) {
                ...
                data = { entity_content: { value: JSON.stringify(body.entity_content), options: { contentType: "application/json" } }, VersionData: { value: dataBuffer, options: { filename: body.entity_content["PathOnClient"] } } };
              } else {
          ...
          if (resource === "opportunity") {
            ...
            if (operation === "create" || operation === "upsert") {
              ...
              const additionalFields = this.getNodeParameter("additionalFields", i) as IDataObject;
              const body: IOpportunity = { Name: name, CloseDate: closeDate, StageName: stageName };
            ...
            if (operation === "addNote") {
              ...
              const title = this.getNodeParameter("title", i) as string;
              const options = this.getNodeParameter("options", i) as IDataObject;
              const body: INote = { Title: title, ParentId: opportunityId };
              if (options.body !== undefined) {
                body.Body = options.body as string;
              }
              if (options.owner !== undefined) {
          ...
          if (resource === "account") {
            ...
            if (operation === "addNote") {
              ...
              const title = this.getNodeParameter("title", i) as string;
              const options = this.getNodeParameter("options", i) as IDataObject;
              const body: INote = { Title: title, ParentId: accountId };
              if (options.body !== undefined) {
                body.Body = options.body as string;
              }
              if (options.owner !== undefined) {
          ...
          if (resource === "case") {
            ...
            if (operation === "addComment") {
              const caseId = this.getNodeParameter("caseId", i) as string;
              const options = this.getNodeParameter("options", i) as IDataObject;
              const body: ICaseComment = { ParentId: caseId };
          ...
          if (resource === "task") {
            ...
            if (operation === "create") {
              ...
              const body: ITask = { Status: status };
              if (additionalFields.type !== undefined) {
          ...
          if (resource === "attachment") {
            ...
            if (operation === "create") {
              ...
              const additionalFields = this.getNodeParameter("additionalFields", i) as IDataObject;
              const binaryPropertyName = this.getNodeParameter("binaryPropertyName", i) as string;
              const body: IAttachment = { Name: name, ParentId: parentId };
              if (items[i].binary && items[i].binary![binaryPropertyName]) {
