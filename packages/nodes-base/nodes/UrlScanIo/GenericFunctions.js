export async function urlScanIoApiRequest(method, endpoint, body = {}, qs = {}) {
    const options = {
        method,
        body,
        qs,
...
export async function handleListing(endpoint, qs = {}) {
    const returnData = [];
    let responseData;
    qs.size = 100;
...
export const normalizeId = ({ _id, uuid, ...rest }) => {
    if (_id)
