                ...
                if (resource === 'post') {
                    if (operation === 'create') {
                        ...
                        if (shareMediaCategory === 'IMAGE') {
                            ...
                            const registerObject = await linkedInApiRequest.call(this, 'POST', '/images?action=initializeUpload', registerRequest);
                            ...
                            await linkedInApiRequest.call(this, 'POST', uploadUrl, buffer, true, headers);
                            const imageBody = {
                                content: {
                                    media: {
                                        title,
