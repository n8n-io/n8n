					...
					try {
						...
						if (resource === 'bucket') {
							...
							if (operation === 'create') {
								...
								const body: IDataObject = { CreateBucketConfiguration: { $: { xmlns: 'http://s3.amazonaws.com/doc/2006-03-01/' } } };
								let data = '';
						...
						if (resource === 'folder') {
							...
							if (operation === 'delete') {
								...
								if (responseData.length === 0) {
									...
									const body: IDataObject = { Delete: { $: { xmlns: 'http://s3.amazonaws.com/doc/2006-03-01/' }, Object: [] } };
						...
						if (resource === 'file') {
							...
							if (operation === 'copy') {
								...
								const destination = `/${destinationParts
							...
							if (operation === 'download') {
								...
								let region = await s3ApiRequestSOAP.call(
									this,
									bucketName,
									'GET',
									'',
								...
								const newItem: INodeExecutionData = { json: items[i].json, binary: {} };
