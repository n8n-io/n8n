...
export const contactFields = [
    ...
    },
    {
        ...
        default: false,
        description: 'Whether to flag if the contact changed company since the input data. Only effective when Enrichment Type includes Profile.',
    },
    {
    ...
    },
    {
        ...
        default: '',
        description: 'Company domain to source contacts from. Provide at least one of domain, name or Linkedin URL.',
    },
    {
        displayName: 'Company Name',
        ...
        options: [
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether to skip enrichment of company information (industry, size, etc.) for each contact',
            },
            {
