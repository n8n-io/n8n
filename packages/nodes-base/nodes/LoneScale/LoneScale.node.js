...
import { companyFields, companyOperations, contactFields, contactOperations, itemFields, itemOperations, listFields, listOperations, } from './descriptions';
import { lonescaleApiRequest } from './GenericFunctions';
export class LoneScale {
    description = {
