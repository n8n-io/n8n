...
import { NodeApiError, NodeConnectionTypes, NodeOperationError, UnexpectedError, } from 'n8n-workflow';
import { generateGarbageMemory, runGarbageCollector } from './functions';
import { generateCreditCard, generateIPv4, generateIPv6, generateLocation, generateMAC, generateNanoid, generateRandomAddress, generateRandomEmail, generateRandomUser, generateURL, generateUUID, generateVersion, } from './randomData';
                ...
                switch (category) {
                    ...
                    case 'throwError':
                        ...
                        switch (throwErrorType) {
                            case 'NodeApiError':
                                throw new NodeApiError(this.getNode(), { message: throwErrorMessage }, { message: throwErrorMessage });
                    ...
                    case 'randomData':
                        ...
                        let randomFn = generateRandomUser;
