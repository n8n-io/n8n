...
export async function pushbulletApiRequest(method, path, body = {}, qs = {}, uri, option = {}) {
    const options = {
        method,
        body,
        qs,
...
export async function pushbulletApiRequestAllItems(propertyName, method, endpoint, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    do {
