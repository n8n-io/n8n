...
export class AirtableV1 {
    ...
    async execute() {
        ...
        if (authentication === 'airtableApi') {
            throw new NodeOperationError(this.getNode(), 'The API Key connection was deprecated by Airtable, please use Access Token or OAuth2 instead.');
        }
        ...
        if (operation === 'append') {
            ...
            try {
                ...
                if (downloadAttachments === true) {
                    ...
                    const data = await downloadRecordAttachments.call(this, responseData.records, downloadFieldNames, pairedItem);
                    return [data];
                }
