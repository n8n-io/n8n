        ...
        describe('Create message - markdown', () => {
            beforeAll(() => {
                nock(baseUrl)
                    .matchHeader('X-Gotify-Key', 'test-app-token')
                    .post('/message', (body) => {
                    return (body.message === 'Markdown message' &&
        ...
        describe('Create message - click URL', () => {
            beforeAll(() => {
                nock(baseUrl)
                    .matchHeader('X-Gotify-Key', 'test-app-token')
                    .post('/message', (body) => {
                    return (body.message === 'Message with click URL' &&
        ...
        describe('Create message - big image', () => {
            beforeAll(() => {
                nock(baseUrl)
                    .matchHeader('X-Gotify-Key', 'test-app-token')
                    .post('/message', (body) => {
                    return (body.message === 'Message with big image' &&
        ...
        describe('Create message - intent URL', () => {
            beforeAll(() => {
                nock(baseUrl)
                    .matchHeader('X-Gotify-Key', 'test-app-token')
                    .post('/message', (body) => {
                    return (body.message === 'Message with intent URL' &&
        ...
        describe('Create message - all extras', () => {
            beforeAll(() => {
                nock(baseUrl)
                    .matchHeader('X-Gotify-Key', 'test-app-token')
                    .post('/message', (body) => {
                    return (body.message === 'Message with all extras' &&
                        body.extras?.['client::display']?.contentType === 'text/markdown' &&
                        body.extras?.['client::notification']?.click?.url === 'https://example.com' &&
        ...
        describe('Create message - priority and title', () => {
            beforeAll(() => {
                nock(baseUrl)
                    .matchHeader('X-Gotify-Key', 'test-app-token')
                    .post('/message', (body) => {
                    return (body.message === 'Message with priority and title' &&
                        body.priority === 5 &&
...
//# sourceMappingURL=Gotify.node.test.js.map