...
import { endOfDayDataFields, endOfDayDataOperations, exchangeFields, exchangeOperations, tickerFields, tickerOperations, } from './descriptions';
import { format, marketstackApiRequest, marketstackApiRequestAllItems, validateTimeOptions, } from './GenericFunctions';
export class Marketstack {
    description = {
                ...
                if (resource === 'endOfDayData') {
                    if (operation === 'getAll') {
                        ...
                        if (latest) {
                            ...
                            if (!dateFrom || !dateTo) {
                                throw new NodeOperationError(this.getNode(), 'Please enter a start and end date to filter by timeframe.', { itemIndex: i });
                            }
                            endpoint = '/eod';
