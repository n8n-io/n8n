...
import { getFields, getPortals, getScripts, getToken, layoutsApiRequest, logout, parseFields, parsePortals, parseQuery, parseScripts, parseSort, } from './GenericFunctions';
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                if (typeof response === 'string') {
                    throw new NodeOperationError(this.getNode(), 'DataAPI response body is not valid JSON. Is the DataAPI enabled?', { itemIndex: i });
                }
