 ...
 *
 */
export async function buildBinAPIURL(requestOptions) {
 ...
 *
 */
export async function buildBinTestURL(requestOptions) {
    const binId = parseBinId(this);
    // Assemble the PostBin API URL and put it back to requestOptions
 ...
 *
 */
export async function buildRequestURL(requestOptions) {
 ...
 *
 */
export async function transformBinResponse(items, _response) {
