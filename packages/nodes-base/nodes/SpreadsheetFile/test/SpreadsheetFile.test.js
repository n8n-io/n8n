...
describe('Execute Spreadsheet File Node', () => {
    ...
    const readBinaryFile = (fileName) => readFileSync(path.resolve(__dirname, fileName), 'base64');
    const loadWorkflow = (fileName, csvName) => {
...
//# sourceMappingURL=SpreadsheetFile.test.js.map