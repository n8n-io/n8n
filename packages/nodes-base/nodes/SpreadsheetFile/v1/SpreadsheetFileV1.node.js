import { read as xlsxRead, readFile as xlsxReadFile, utils as xlsxUtils, write as xlsxWrite, } from '@e965/xlsx';
...
import { operationProperty, binaryProperty, toFileProperties, fromFileOptions, toFileOptions, } from '../description';
export class SpreadsheetFileV1 {
    description;
            ...
            for (let i = 0; i < items.length; i++) {
                try {
                    ...
                    if (binaryData.id) {
                        ...
                        workbook = xlsxRead(options.readAsString ? binaryDataBuffer.toString() : binaryDataBuffer, xlsxOptions);
                    }
