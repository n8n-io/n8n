...
describe('Wordpress > GenericFunctions', () => {
    ...
    describe('wordpressApiRequest', () => {
        ...
        it('should use wordpressApi credential for basic auth', async () => {
            ...
            expect(mockFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('wordpressApi', expect.objectContaining({
        ...
        it('should throw NodeApiError on failure', async () => {
            ...
            await expect(wordpressApiRequest.call(mockFunctions, 'GET', '/posts', {}, {})).rejects.toThrow(NodeApiError);
        });
    });
    describe('wordpressApiRequest with OAuth2', () => {
        ...
        it('should use wordpressOAuth2Api credential', async () => {
            ...
            expect(mockFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('wordpressOAuth2Api', expect.objectContaining({ method: 'GET' }));
        });
        it('should always include /sites/{site} in the URL', async () => {
            await wordpressApiRequest.call(mockFunctions, 'GET', '/posts', {}, {});
            expect(mockFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('wordpressOAuth2Api', expect.objectContaining({
