 ...
 */
export function validateNoDisallowedMethodsInRunForEach(code, itemIndex) {
 ...
 */
export function mapItemsNotDefinedErrorIfNeededForRunForAll(code, error) {
 ...
 */
export function mapItemNotDefinedErrorIfNeededForRunForEach(code, error) {
    // anticipate user expecting `items` to pre-exist as in Function Item node
