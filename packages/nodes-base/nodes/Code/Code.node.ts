...
\`.trim()
		...
		properties: [
			...
			},
			{
				...
				builderHint: {
					propertyHint:
						'Default to javaScript — it is the only language with library access and cross-node helpers. Choose pythonNative ONLY when the user explicitly asks for Python, and then write import-free code: the native Python runner forbids every import by default and exposes only _items/_item and print().',
				},
			},
			{
				displayName: 'Language',
