...
export class Code implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Type <code>$</code> for a <a target="_blank" href="https://docs.n8n.io/code-examples/methods-variables-reference/">list of special vars/methods</a>. Debug by using <code>console.log()</code> statements and viewing their output in the browser console.',
				name: 'notice',
				type: 'notice',
				default: '',
			},
