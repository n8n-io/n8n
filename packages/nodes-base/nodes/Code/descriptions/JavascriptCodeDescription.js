const commonDescription = {
    ...
    builderHint: {
        propertyHint: 'The sandbox has NO network access: fetch(), axios, XMLHttpRequest and require of http modules are unavailable and fail at runtime. NEVER make HTTP requests here — use the HTTP Request node and process its output in this node instead.',
    },
};
const v1Properties = [
    {
...
export const javascriptCodeDescription = [
    ...v1Properties,
    ...v2Properties,
    {
