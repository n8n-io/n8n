...
describe('Code Node unit test', () => {
    const workflowDataProxy = mock({ $input: mock() });
    it('should route legacy `python` language to native Python runner', async () => {
        const node = new Code();
        const pythonThisArg = mock();
        pythonThisArg.helpers = { normalizeItems };
        pythonThisArg.getNode.mockReturnValue(mock({ typeVersion: 2 }));
...
//# sourceMappingURL=Code.node.test.js.map