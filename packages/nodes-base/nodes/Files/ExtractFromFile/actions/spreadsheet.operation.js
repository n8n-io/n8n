...
export const description = fromFile.description
...
export async function execute(items, fileFormatProperty, options) {
    const returnData = await fromFile.execute.call(this, items, fileFormatProperty, options);
    return returnData;
}
