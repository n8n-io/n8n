...
import { searchActivities, searchActivityTypes, searchContacts, searchCustomRecords, searchModelRecords, searchModels, searchOpportunities, searchUsers, } from '../../../v2/methods/listSearch';
...
describe('Odoo v2 — listSearch methods', () => {
    ...
    describe('searchModels', () => {
        ...
        it('passes filter as ilike domain', async () => {
            ...
            expect(transport.odooApiRequest).toHaveBeenCalledWith('ir.model', 'search_read', expect.objectContaining({ domain: [['name', 'ilike', 'contact']] }));
        });
    ...
    describe('searchModelRecords', () => {
        ...
        it('searches the res_model with filter', async () => {
            ...
            transport.odooApiRequest.mockResolvedValue([{ id: 5, display_name: 'Alice' }]);
    ...
    describe('searchContacts', () => {
        ...
        it('passes filter as ilike domain', async () => {
            ...
            expect(transport.odooApiRequest).toHaveBeenCalledWith('res.partner', 'search_read', expect.objectContaining({ domain: [['name', 'ilike', 'Alice']] }));
        });
    });
    describe('searchOpportunities', () => {
        ...
        it('passes filter as ilike domain', async () => {
            ...
            expect(transport.odooApiRequest).toHaveBeenCalledWith('crm.lead', 'search_read', expect.objectContaining({ domain: [['name', 'ilike', 'Deal']] }));
        });
    });
    describe('searchActivities', () => {
        ...
        it('passes filter as ilike domain on summary', async () => {
            ...
            expect(transport.odooApiRequest).toHaveBeenCalledWith('mail.activity', 'search_read', expect.objectContaining({ domain: [['summary', 'ilike', 'call']] }));
        });
    });
    describe('searchActivityTypes', () => {
        ...
        it('passes filter as ilike domain', async () => {
            ...
            expect(transport.odooApiRequest).toHaveBeenCalledWith('mail.activity.type', 'search_read', expect.objectContaining({ domain: [['name', 'ilike', 'email']] }));
        });
    });
