...
import { getActivityFields, getContactFields, getOdooFields, getOpportunityFields, } from '../../../v2/methods/resourceMapping';
...
describe('Odoo v2 — resourceMapping methods', () => {
    ...
    beforeEach(() => {
        ctx = mock();
        transport.odooApiRequest.mockResolvedValue(SCHEMA);
    });
    ...
    describe('getContactFields', () => {
        it('fetches fields for res.partner', async () => {
            ...
            expect(transport.odooApiRequest).toHaveBeenCalledWith('res.partner', 'fields_get', expect.any(Object));
        });
