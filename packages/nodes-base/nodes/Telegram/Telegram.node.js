...
import { BINARY_ENCODING, SEND_AND_WAIT_OPERATION, NodeConnectionTypes, NodeOperationError, } from 'n8n-workflow';
import { addAdditionalFields, addReplyMarkup, apiRequest, createSendAndWaitMessageBody, getPropertyName, } from './GenericFunctions';
...
export class Telegram {
    description = {
        ...
        properties: [
            ...
            ], 'message', telegramHitlProperties, {
                noButtonStyle: true,
            ...
            try {
                ...
                if (binaryData) {
                    ...
                    if (!fileName && !itemBinaryData.fileName) {
                        throw new NodeOperationError(this.getNode(), `File name is needed to ${operation}. Make sure the property that holds the binary data
