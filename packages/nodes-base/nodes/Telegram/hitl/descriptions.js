 ...
 */
export const telegramHitlProperties = [
    {
    ...
    },
    {
        ...
        type: 'boolean',
        default: false,
        description: 'Whether approvers respond with one tap on buttons inside the Telegram chat, instead of opening a link in the browser. Requires this n8n instance to be reachable over public HTTPS.',
        displayOptions: {
            show: {
                responseType: ['approval'],
            },
    ...
    },
    {
        ...
        type: 'string',
        default: '',
        description: 'The user IDs allowed to approve or decline. Multiple can be defined separated by comma. If empty, anyone who can see the message can respond.',
        displayOptions: {
            show: {
                responseType: ['approval'],
                chatApproval: [true],
    ...
    },
    {
        ...
        description: 'Popup shown (via Telegram alert) to users who tap a button but are not in the approver list',
        displayOptions: {
            show: {
                responseType: ['approval'],
                chatApproval: [true],
