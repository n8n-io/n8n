...

			{
				...
				options: [
					...
					},
					{
						...
						action: 'Answer Inline Query a callback',
					},
				],
				default: 'answerQuery',
			},
				...
				options: [
					{
						...
						action: 'Delete Chat Message a message',
					},
					{
						name: 'Edit Message Text',
						value: 'editMessageText',
						description: 'Edit a text message',
						action: 'Edit Message Text a message',
					},
					{
						name: 'Pin Chat Message',
						value: 'pinChatMessage',
						description: 'Pin a chat message',
						action: 'Pin Chat Message a message',
					},
					{
						name: 'Send Animation',
						value: 'sendAnimation',
						description: 'Send an animated file',
						action: 'Send Animation a message',
					},
					{
						name: 'Send Audio',
						value: 'sendAudio',
						description: 'Send a audio file',
						action: 'Send Audio a message',
					},
					{
						name: 'Send Chat Action',
						value: 'sendChatAction',
						description: 'Send a chat action',
						action: 'Send Chat Action a message',
					},
					{
						name: 'Send Document',
						value: 'sendDocument',
						description: 'Send a document',
						action: 'Send Document a message',
					},
					{
						name: 'Send Location',
						value: 'sendLocation',
						description: 'Send a location',
						action: 'Send Location a message',
					},
					{
						name: 'Send Media Group',
						value: 'sendMediaGroup',
						description: 'Send group of photos or videos to album',
						action: 'Send Media Group a message',
					},
					{
						name: 'Send Message',
						value: 'sendMessage',
						description: 'Send a text message',
						action: 'Send Message a message',
					},
					{
						name: 'Send Photo',
						value: 'sendPhoto',
						description: 'Send a photo',
						action: 'Send Photo a message',
					},
					{
						name: 'Send Sticker',
						value: 'sendSticker',
						description: 'Send a sticker',
						action: 'Send Sticker a message',
					},
					{
						name: 'Send Video',
						value: 'sendVideo',
						description: 'Send a video',
						action: 'Send Video a message',
					},
					{
						name: 'Unpin Chat Message',
						value: 'unpinChatMessage',
						description: 'Unpin a chat message',
						action: 'Unpin Chat Message a message',
					},
				],
				default: 'sendMessage',
			},
				...
				options: [
					{
						name: 'Find Location',
						value: 'find_location',
						action: 'Find Location a message',
					},
					{
						name: 'Record Audio',
						value: 'record_audio',
						action: 'Record Audio a message',
					},
					{
						name: 'Record Video',
						value: 'record_video',
						action: 'Record Video a message',
					},
					{
						name: 'Record Video Note',
						value: 'record_video_note',
						action: 'Record Video Note a message',
					},
					{
						name: 'Typing',
						value: 'typing',
					...
					},
					{
						name: 'Upload Audio',
						value: 'upload_audio',
						action: 'Upload Audio a message',
					},
					{
						name: 'Upload Document',
						value: 'upload_document',
						action: 'Upload Document a message',
					},
					{
						name: 'Upload Photo',
						value: 'upload_photo',
						action: 'Upload Photo a message',
					},
					{
						name: 'Upload Video',
						value: 'upload_video',
						action: 'Upload Video a message',
					},
					{
						name: 'Upload Video Note',
						value: 'upload_video_note',
						action: 'Upload Video Note a message',
					},
				],
				default: 'typing',
