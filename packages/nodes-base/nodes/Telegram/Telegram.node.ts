				...
				options: [
					{
						...
						default: false,
						description:
							'Do not send a notification to all chat members about the new pinned message.',
					},
				],
			},
						...
						try {
							...
							if (resource === 'callback') {
								if (operation === 'answerQuery') {
									...
									body.callback_query_id = this.getNodeParameter(
										'queryId',
										i,
									) as string;
									...
									body.inline_query_id = this.getNodeParameter(
										'queryId',
										i,
									) as string;
								...
								if (operation === 'editMessageText') {
									...
									if (messageType === 'inlineMessage') {
										body.inline_message_id = this.getNodeParameter(
											'inlineMessageId',
											i,
										) as string;
									} else {
										body.chat_id = this.getNodeParameter('chatId', i) as string;
										body.message_id = this.getNodeParameter(
											'messageId',
											i,
										) as string;
									}
									...
									body.chat_id = this.getNodeParameter('chatId', i) as string;
									body.animation = this.getNodeParameter(
										'file',
										i,
										'',
									) as string;
									...
									body.chat_id = this.getNodeParameter('chatId', i) as string;
									body.document = this.getNodeParameter(
										'file',
										i,
										'',
									) as string;
									...
									body.chat_id = this.getNodeParameter('chatId', i) as string;
									body.latitude = this.getNodeParameter(
										'latitude',
										i,
									) as string;
									body.longitude = this.getNodeParameter(
										'longitude',
										i,
									) as string;
									...
									const mediaItems = this.getNodeParameter(
										'media',
										i,
									) as IDataObject;
									body.media = [];
							...
							if (resource === 'file' && operation === 'get') {
								if (
									(this.getNodeParameter('download', i, false) as boolean) ===
									true
								) {
