...
import { addAdditionalFields, apiRequest, getPropertyName, getSecretToken, } from '../GenericFunctions';
describe('Telegram > GenericFunctions', () => {
    describe('apiRequest', () => {
        ...
        it('should make a successful API request', async () => {
            ...
            const query = { chat_id: '12345' };
            const option = { headers: { 'Custom-Header': 'value' } };
            mockThis.getCredentials.mockResolvedValue(credentials);
            mockThis.helpers.request.mockResolvedValue({ success: true });
        ...
        it('should throw a NodeApiError on request failure', async () => {
            ...
            const body = { text: 'Hello, world!' };
            mockThis.getCredentials.mockResolvedValue(credentials);
            mockThis.helpers.request.mockRejectedValue(new Error('Request failed'));
