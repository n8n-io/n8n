 ...
 */
function hitlForwardUrl(ownWebhookUrl) {
...
export class TelegramTrigger {
    ...
    webhookMethods = {
        default: {
            ...
            async create() {
                ...
                else if (this.getNode().typeVersion >= 1.5 &&
    ...
    async webhook() {
        ...
        if (nodeVersion > 1) {
            ...
            if (secretBuffer.byteLength !== headerSecretBuffer.byteLength ||
            ...
            try {
                ...
                if (ownWebhookUrl) {
                    await this.helpers.httpRequest({
                        ...
                        json: true,
                        headers: {
                            'x-telegram-bot-api-secret-token': deriveHitlSecretToken(credentials.accessToken),
                        },
