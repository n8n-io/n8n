    ...
    describe('validateAttachmentUrl', () => {
        ...
        describe('KoBoToolbox special domains', () => {
            ...
            it('should accept humanitarianresponse.info domain when allowed domain is humanitarianresponse.info', () => {
                expect(() => {
                    validateAttachmentUrl('https://kf.humanitarianresponse.info/file.jpg', 'https://humanitarianresponse.info');
                }).not.toThrow();
            });
            it('should accept cross-domain between kobotoolbox.org subdomains', () => {
                expect(() => {
                    validateAttachmentUrl('https://kc.kobotoolbox.org/file.jpg', 'https://kf.kobotoolbox.org');
                }).not.toThrow();
            });
            it('should accept cross-domain between humanitarianresponse.info subdomains', () => {
                expect(() => {
                    validateAttachmentUrl('https://kc.humanitarianresponse.info/file.jpg', 'https://kf.humanitarianresponse.info');
                }).not.toThrow();
            });
            it('should accept attachment from kobotoolbox.org when allowed is humanitarianresponse.info', () => {
                expect(() => {
                    validateAttachmentUrl('https://kc.kobotoolbox.org/file.jpg', 'https://kf.humanitarianresponse.info');
                }).not.toThrow();
            });
            it('should accept attachment from humanitarianresponse.info when allowed is kobotoolbox.org', () => {
                expect(() => {
                    validateAttachmentUrl('https://kc.humanitarianresponse.info/file.jpg', 'https://kf.kobotoolbox.org');
                }).not.toThrow();
            });
        });
        describe('invalid URLs', () => {
            ...
            it('should throw error for mismatched domains', () => {
                ...
                }).toThrow('Attachment URL domain (malicious.com) does not match allowed domain (example.com)');
            });
            it('should throw error for domain that looks like subdomain but is not', () => {
                ...
                }).toThrow('Attachment URL domain (fakeexample.com) does not match allowed domain (example.com)');
            });
            it('should throw error when attachment is not from KoBoToolbox domains but allowed domain is', () => {
                ...
                }).toThrow('Attachment URL domain (malicious.com) does not match allowed domain (kf.kobotoolbox.org)');
            });
            ...
            it('should throw error for cloud metadata endpoint when allowed domain is public', () => {
                ...
                }).toThrow('Attachment URL domain (169.254.169.254) does not match allowed domain (example.com)');
            });
    ...
    describe('downloadAttachments', () => {
        ...
        describe('error handling', () => {
            it('should throw NodeOperationError for invalid attachment URL', async () => {
                ...
                await expect(downloadAttachments.call(mockExecuteFunctions, submission, options)).rejects.toThrow(NodeOperationError);
            });
