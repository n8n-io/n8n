export const tools = {
	processors: [
		...
		},
		{
		   ...
		   "p":[
			  ...
			  },
			  {
				 ...
				 "r":true,
				 "t":"string",
				 "p":"This is an amazing title for my content"
			  }
		   ]
		},
		{
		...
		},
		{
		   ...
		   "ed":"Allows you to fix the email domain of those misspelled emails (supports all domains)",
		   "g":"communication",
		   "p":[
			  {
				 "n":"email",
		...
		{
		   "k":"getEmailListInSite",
		   "d":"Get Emails In Website",
		   "ed":"Get emails list found inside website by domain or URI (similar to hunter.io)",
		   "g":"communication",
		   "p":[
			  {
				 "n":"domain",
		...
		},
		{
		   ...
		   "ed":"Discover an email by company website or domain and prospect's firstname and lastname.<br><br>If 'verify' method is selected, tool checks multiple email variants in real-time, and returns a result depending on email server response",
		   "g":"communication",
		   "p":[
			  {
				 "n":"domain",
		   ...
		   "p":[
			  {
				 ...
				 "r":true,
				 "t":"string",
				 "p":"https://www.bing.com/search?q=killia+technologies"
			  }
		   ]
		},
		{
		...
		{
		   "k":"getProfileTwitterByEmployeeData",
