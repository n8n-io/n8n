						...
						try {
							...
							if (resource === 'board') {
								...
								if (operation === 'create') {
									...
									const commentId = this.getNodeParameter(
										'commentId',
										i,
									) as string;
								...
								if (operation === 'create') {
									...
									const cardId = this.getNodeParameter('cardId', i) as string;
									const checkItemId = this.getNodeParameter(
										'checkItemId',
										i,
									) as string;
									...
									const checklistId = this.getNodeParameter(
										'checklistId',
										i,
									) as string;
							...
							if (
								returnAll === true &&
								!skipPagination.includes(`${resource}:${operation}`)
							) {
