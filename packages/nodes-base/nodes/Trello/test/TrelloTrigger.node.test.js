...
describe('TrelloTrigger', () => {
    ...
    describe('webhookMethods.checkExists (OAuth1)', () => {
        ...
        it('should delete the stale webhook and return false when config no longer matches', async () => {
            ...
            expect(mockedApiRequest).toHaveBeenNthCalledWith(1, 'GET', 'webhooks/existing-webhook-id', {});
            expect(mockedApiRequest).toHaveBeenNthCalledWith(2, 'DELETE', 'webhooks/existing-webhook-id', {});
...
//# sourceMappingURL=TrelloTrigger.node.test.js.map