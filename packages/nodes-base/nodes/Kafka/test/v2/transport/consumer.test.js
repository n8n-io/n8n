...
import { confluentKafkaModuleMock, getFakeClientConfigs, getFakeConsumers, resetConfluentKafkaRecordings, } from '../../mocks/confluent-kafka';
...
const newConsumer = async (groupId = 'n8n-kafka') => {
...
describe('createKafkaConsumer', () => {
    ...
    it('gives the library a logger only when one is supplied', async () => {
        ...
        await createKafkaConsumer(credentials, { groupId: 'my-group' }, { logger: mock(), onFatalError });
