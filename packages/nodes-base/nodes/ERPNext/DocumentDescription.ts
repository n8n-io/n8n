		...
		options: [
			{
				...
				default: [],
				description: 'Comma-separated list of fields to return. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
