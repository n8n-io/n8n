...
export async function erpNextApiRequest(method, resource, body = {}, query = {}, uri, option = {}) {
...
export async function erpNextApiRequestAllItems(propertyName, method, resource, body, query = {}) {
    const returnData = [];
    let responseData;
    query.limit_start = 0;
