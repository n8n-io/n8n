...
export async function affinityApiRequest(method, resource, body = {}, query = {}, uri, option = {}) {
...
export async function affinityApiRequestAllItems(propertyName, method, resource, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    query.page_size = 500;
    do {
...
export function eventsExist(subscriptions, currentSubsriptions) {
...
export function mapResource(key) {
    return {
        person: 'persons',
        list: 'lists',
        note: 'notes',
