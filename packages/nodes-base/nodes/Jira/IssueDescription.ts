...
export const issueFields: INodeProperties[] = [
	...
	},
	{
		...
		default: false,
		description: 'Whether to return a simplified output of the issues fields',
	},
	{
		displayName: 'Additional Fields',
		name: 'additionalFields',
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						type: 'boolean',
						default: false,
						description: 'Whether to indicate that the notification should be sent to the issue\'s voters',
					},
					{
						...
						type: 'boolean',
						default: false,
						description: 'Whether to indicates that the notification should be sent to the issue\'s assignees',
					},
				],
			},
		],
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether to indicate that transitions with the condition "Hide From User Condition" are included in the response',
			},
		],
	},
];
