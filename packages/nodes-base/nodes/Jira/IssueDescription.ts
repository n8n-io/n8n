		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						default: [],
						description: 'List of users to receive the notification. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
					},
					{
						displayName: 'Groups',
						name: 'groups',
						...
						default: [],
						description: 'List of groups to receive the notification. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
					},
				],
