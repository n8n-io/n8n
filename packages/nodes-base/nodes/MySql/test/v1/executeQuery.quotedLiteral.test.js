...
describe('Test MySqlV1, executeQuery leaves placeholders inside quotes untouched', () => {
    ...
    beforeEach(() => {
        ...
        mockConnection.query.mockResolvedValue([{ success: true }, []]);
    });
    new NodeTestHarness().setupTests({
        ...
        customAssertions() {
            ...
            expect(mockConnection.query).toHaveBeenCalledWith("select * from users where label = '$5' and id = ?", ['7']);
        },
    });
});
//# sourceMappingURL=executeQuery.quotedLiteral.test.js.map