...
describe('Test MySqlV1, executeQuery', () => {
    ...
    new NodeTestHarness().setupTests({
        ...
        customAssertions() {
            ...
            expect(mockConnection.query).toHaveBeenCalledWith("select * from family_parents where (parent_email = 'parent1@mail.com' or parent_email = 'parent2@mail.com') and parent_email <> '';");
        },
    });
});
