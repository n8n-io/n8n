...
import { INPUT_SOURCE, WORKFLOW_INPUTS, JSON_EXAMPLE, VALUES, TYPE_OPTIONS, PASSTHROUGH, FALLBACK_DEFAULT_VALUE, } from '../../../utils/workflowInputsResourceMapping/constants';
...
export class ExecuteWorkflowTrigger {
        ...
        hints: [
            {
                ...
                displayCondition: `={{$parameter['${INPUT_SOURCE}'] === '${WORKFLOW_INPUTS}' && !$parameter['${WORKFLOW_INPUTS}'].keys().length ` +
    ...
    async execute() {
        ...
        const inputSource = this.getNodeParameter(INPUT_SOURCE, 0, PASSTHROUGH);
