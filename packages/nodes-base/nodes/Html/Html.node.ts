...
export class Html implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'<b>Tips</b>: Type ctrl+space for completions. Use <code>{{ }}</code> for expressions and <code>&lt;style&gt;</code> tags for CSS. JS in <code>&lt;script&gt;</code> tags is included but not executed.',
				name: 'notice',
				type: 'notice',
				default: '',
				displayOptions: {
		...
		for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
			try {
				if (operation === 'generateHtmlTemplate') {
					...
					returnData.push(...makeEecutionData.call(this, html, itemIndex));
				...
				if (this.continueOnFail()) {
					returnData.push(...makeEecutionData.call(this, error.message, itemIndex));
					continue;
				}
