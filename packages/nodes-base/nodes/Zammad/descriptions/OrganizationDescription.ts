		...
		options: [
			{
				...
				type: 'boolean',
				default: false,
				description: 'If true, the organization is shared with other instances.',
			},
			{
				displayName: 'Domain',
				name: 'domain',
			...
			},
			{
				...
				type: 'boolean',
				default: true,
				description: 'If true, assigns users based on their email domain.',
			},
			{
				displayName: 'Active',
				name: 'active',
				type: 'boolean',
				default: true,
				description: 'If true, the organization is active.',
			},
			{
				displayName: 'VIP',
				name: 'vip',
				type: 'boolean',
				default: false,
				description: 'If true, the organization is marked as VIP.',
			},
			{
				displayName: 'Notes',
				name: 'note',
