...
describe('Zammad Node', () => {
    ...
    let mockCredentialTestFunctions;
    beforeEach(() => {
        node = new Zammad();
        vi.clearAllMocks();
        mockExecuteFunctions = {
            ...
            helpers: {
                constructExecutionMetaData: vi
                    .fn()
                    .mockImplementation((data, meta) => data.map((item) => ({ json: item, itemData: meta.itemData }))),
                returnJsonArray: vi
                    .fn()
    ...
    describe('Credential Tests', () => {
        it('should test basic auth credentials successfully', async () => {
            ...
            mockCredentialTestFunctions.helpers.request.mockResolvedValue({
                success: true,
            });
            const result = await node.methods.credentialTest.zammadBasicAuthApiTest.call(mockCredentialTestFunctions, credentials);
        ...
        it('should test token auth credentials successfully', async () => {
            ...
            const result = await node.methods.credentialTest.zammadTokenAuthApiTest.call(mockCredentialTestFunctions, credentials);
            expect(result).toEqual({
                status: 'OK',
                message: 'Authentication successful',
            });
        ...
        it('should handle credential test errors', async () => {
            ...
            mockCredentialTestFunctions.helpers.request.mockRejectedValue(error);
            const result = await node.methods.credentialTest.zammadBasicAuthApiTest.call(mockCredentialTestFunctions, credentials);
            expect(result).toEqual({
                status: 'Error',
    ...
    describe('Load Options', () => {
        beforeEach(() => {
            GenericFunctions.getAllFields.mockResolvedValue([
                { id: 1, name: 'Test Field', object: 'User' },
                { id: 2, name: 'Custom Field', object: 'User' },
            ]);
        });
        it('should load group custom fields', async () => {
            GenericFunctions.getGroupCustomFields.mockReturnValue([
                { id: 1, name: 'Group Custom Field' },
            ]);
            GenericFunctions.fieldToLoadOption.mockReturnValue({
                name: 'Group Custom Field',
                value: 1,
            });
            const result = await node.methods.loadOptions.loadGroupCustomFields.call(mockLoadOptionsFunctions);
        ...
        it('should load ticket states', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockStates);
            const result = await node.methods.loadOptions.loadTicketStates.call(mockLoadOptionsFunctions);
        ...
        it('should load groups', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockGroups);
            const result = await node.methods.loadOptions.loadGroups.call(mockLoadOptionsFunctions);
        ...
        it('should load group names', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockGroups);
            const result = await node.methods.loadOptions.loadGroupNames.call(mockLoadOptionsFunctions);
            expect(GenericFunctions.zammadApiRequest).toHaveBeenCalledWith('GET', '/groups');
            expect(result).toEqual([
        ...
        it('should load organization names', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockOrganizations);
            GenericFunctions.isNotZammadFoundation.mockImplementation((org) => org.name !== 'Zammad Foundation');
            const result = await node.methods.loadOptions.loadOrganizationNames.call(mockLoadOptionsFunctions);
        ...
        it('should load customer emails', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockUsers);
            GenericFunctions.isCustomer.mockImplementation((user) => user.role === 'customer');
            const result = await node.methods.loadOptions.loadCustomerEmails.call(mockLoadOptionsFunctions);
    ...
    describe('Execute - User Operations', () => {
        beforeEach(() => {
            mockExecuteFunctions.getNodeParameter.mockImplementation((paramName, _itemIndex) => {
        ...
        it('should create a user', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockUser);
        ...
        it('should throw error on empty update', async () => {
            ...
            GenericFunctions.throwOnEmptyUpdate.mockImplementation(() => {
                throw new NodeOperationError(mockExecuteFunctions.getNode(), 'Please enter at least one field to update for the user resource');
            });
            await expect(node.execute.call(mockExecuteFunctions)).rejects.toThrow('Please enter at least one field to update for the user resource');
        ...
        it('should delete a user', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue({});
            const result = await node.execute.call(mockExecuteFunctions);
        ...
        it('should get all users', async () => {
            ...
            GenericFunctions.zammadApiRequestAllItems.mockResolvedValue(mockUsers);
            const result = await node.execute.call(mockExecuteFunctions);
            expect(GenericFunctions.zammadApiRequestAllItems).toHaveBeenCalledWith('GET', '/users/search', {}, { query: '' }, 0);
    ...
    describe('Execute - Ticket Operations', () => {
        ...
        it('should create a ticket with custom fields if specified', async () => {
            ...
            GenericFunctions.zammadApiRequest
        ...
        it('should update a ticket`s note', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockTicket);
            const result = await node.execute.call(mockExecuteFunctions);
    ...
    describe('Execute - Organization Operations', () => {
        ...
        it('should create an organization', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockOrg);
            const result = await node.execute.call(mockExecuteFunctions);
        ...
        it('should get all organizations', async () => {
            ...
            GenericFunctions.zammadApiRequestAllItems.mockResolvedValue(mockOrgs);
            const result = await node.execute.call(mockExecuteFunctions);
            expect(GenericFunctions.zammadApiRequestAllItems).toHaveBeenCalledWith('GET', '/organizations', {}, {}, 10);
    ...
    describe('Execute - Group Operations', () => {
        ...
        it('should create a group', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockResolvedValue(mockGroup);
            const result = await node.execute.call(mockExecuteFunctions);
        ...
        it('should get all groups with limit', async () => {
            ...
            GenericFunctions.zammadApiRequestAllItems.mockResolvedValue(mockGroups);
            const result = await node.execute.call(mockExecuteFunctions);
            expect(GenericFunctions.zammadApiRequestAllItems).toHaveBeenCalledWith('GET', '/groups', {}, {}, 5);
    ...
    describe('Error Handling', () => {
        ...
        it('should handle API errors and continue on fail', async () => {
            ...
            GenericFunctions.zammadApiRequest.mockRejectedValue(error);
        ...
        it('should throw error when continue on fail is false', async () => {
            ...
            await expect(node.execute.call(mockExecuteFunctions)).rejects.toThrow('User not found');
        });
    });
...
//# sourceMappingURL=Zammad.node.test.js.map