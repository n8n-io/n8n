...
import { BaseError, NodeOperationError, NodeConnectionTypes, } from 'n8n-workflow';
...
export class FilterV2 {
    ...
    constructor(baseDescription) {
        this.description = {
            ...
            parameterPane: 'wide',
            builderHint: {
                searchHint: 'Filter emits 0 items when nothing matches and the chain stops cleanly — no IF gate needed before downstream loops.',
            },
            properties: [
                {
