...
export async function tapfiliateApiRequest(method, endpoint, body = {}, qs = {}, uri, option = {}) {
...
export async function tapfiliateApiRequestAllItems(method, endpoint, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    query.page = 1;
    do {
