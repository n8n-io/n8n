...
vi.mock('mssql');
function getMockedExecuteFunctions(overrides = {}) {
    return mock({
...
describe('MicrosoftSql Node', () => {
    let mockedConnectionPool;
    beforeEach(() => {
        mockedConnectionPool = mssqlDefault.ConnectionPool;
    });
    test('converts numeric credential strings in the pool configuration', () => {
        ...
        expect(mockedConnectionPool).toHaveBeenLastCalledWith(expect.objectContaining({
            port: 1433,
    ...
    test.each([
        ...
        },
        {
            ...
            expectedInputs: [['p1', true]],
        },
    ])('executes query with parameters supplied as $label', async ({ query, queryReplacement, expectedQuery, expectedInputs }) => {
...
//# sourceMappingURL=MicrosoftSql.node.test.js.map