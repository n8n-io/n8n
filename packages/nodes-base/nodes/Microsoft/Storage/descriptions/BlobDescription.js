import { handleErrorPostReceive, HeaderConstants, parseBlobList, parseHeaders, XMsVersion, } from '../GenericFunctions';
export const blobOperations = [
    {
                    ...
                    output: {
                        postReceive: [
                            ...
                            async function (data, _response) {
                                const bodyData = await parseBlobList(data[0].json);
        ...
        options: [
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [HeaderConstants.X_MS_EXPIRY_TIME]: '={{ $value ? DateTime.fromISO($value).format("EEE, dd MMM yyyy HH:mm:ss ZZZ") : undefined }}',
                        },
                    },
                },
                type: 'dateTime',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [HeaderConstants.X_MS_BLOB_CONTENT_DISPOSITION]: "={{ $value ? 'attachment; filename=\"' + $value + '\"' : undefined }}",
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [HeaderConstants.X_MS_IMMUTABILITY_POLICY_UNTIL_DATE]: '={{ $value ? DateTime.fromISO($value).format("EEE, dd MMM yyyy HH:mm:ss ZZZ") : undefined }}',
                        },
                    },
                },
                type: 'dateTime',
                        ...
                        preSend: [
                            async function (requestOptions) {
                                ...
                                for (const data of metadata.metadataValues) {
                                    requestOptions.headers[`${HeaderConstants.PREFIX_X_MS_META}${data.fieldName}`] = data.fieldValue;
                                }
                                return requestOptions;
                            },
                        ],
                    ...
                    send: {
                        preSend: [
                            async function (requestOptions) {
                                ...
                                requestOptions.headers[HeaderConstants.X_MS_TAGS] = tags.tagValues
