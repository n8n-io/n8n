...
export async function microsoftApiRequest(method, resource, body = {}, qs = {}, uri, option = {}) {
...
export async function getPicklistOptions(entityName, attributeName) {
    const returnData = [];
...
export async function getEntityFields(entityName) {
