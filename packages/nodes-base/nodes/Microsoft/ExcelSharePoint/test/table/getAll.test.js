...
describe('Microsoft Excel (SharePoint) — Table: Get Many', () => {
    ...
    it('lists the tables in the workbook, up to the given limit', async () => {
        ...
        expect(apiRequest).toHaveBeenCalledWith('GET', `${WORKBOOK_ROOT}/workbook/tables`, {}, { $top: 50 });
    ...
    it('requests only the chosen fields', async () => {
        ...
        expect(apiRequest).toHaveBeenCalledWith('GET', `${WORKBOOK_ROOT}/workbook/tables`, {}, { $select: 'id,name', $top: 100 });
    });
