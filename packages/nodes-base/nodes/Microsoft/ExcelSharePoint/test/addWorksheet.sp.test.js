...
describe('Microsoft Excel (SharePoint), Service Principal workbook => addWorksheet smoke', () => {
    nock('https://graph.microsoft.com')
        ...
        .post('/v1.0/sites/contoso.sharepoint.com%2Cg1%2Cg2/drives/b!drive1/items/ITEM123/workbook/createSession', { persistChanges: true })
        .reply(200, { id: 'session-abc' })
        .post('/v1.0/sites/contoso.sharepoint.com%2Cg1%2Cg2/drives/b!drive1/items/ITEM123/workbook/worksheets/add', { name: 'Q4 Report' })
        ...
        .post('/v1.0/sites/contoso.sharepoint.com%2Cg1%2Cg2/drives/b!drive1/items/ITEM123/workbook/closeSession')
        .matchHeader('workbook-session-id', 'session-abc')
        .reply(200, {});
...
//# sourceMappingURL=addWorksheet.sp.test.js.map