...
describe('Microsoft Excel (SharePoint) — Sheet: Get Many', () => {
    ...
    it('lists the sheets in the workbook, up to the given limit', async () => {
        ...
        expect(apiRequest).toHaveBeenCalledWith('GET', `${WORKBOOK_ROOT}/workbook/worksheets`, {}, { $top: 50 });
    ...
    it('requests only the chosen fields', async () => {
        ...
        expect(apiRequest).toHaveBeenCalledWith('GET', `${WORKBOOK_ROOT}/workbook/worksheets`, {}, { $select: 'id,name', $top: 100 });
    });
