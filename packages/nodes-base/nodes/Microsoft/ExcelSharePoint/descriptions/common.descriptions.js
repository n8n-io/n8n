    ...
    modes: [
        {
            ...
            placeholder: 'e.g. https://contoso.sharepoint.com/:x:/r/sites/mysite/_layouts/15/Doc.aspx?sourcedoc=%7B5A58BB09-…%7D&file=book.xlsx',
            validation: [
                {
                    type: 'regex',
                    properties: {
...
export const siteRLC = {
    ...
    description: 'The SharePoint site the workbook lives in. Only needed when the workbook is chosen from the list or by ID.',
...
export const libraryRLC = {
    displayName: 'Document Library',
    name: 'library',
    type: 'resourceLocator',
    default: { mode: 'list', value: '' },
    description: 'The document library the workbook lives in. Only needed when the workbook is chosen from the list or by ID.',
    typeOptions: {
