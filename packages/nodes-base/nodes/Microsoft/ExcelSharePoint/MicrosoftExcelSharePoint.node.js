...
export class MicrosoftExcelSharePoint {
    description = {
    ...
    async execute() {
        ...
        throw new NodeOperationError(this.getNode(), `The operation "${String(operation)}" is not supported!`);
    }
}
//# sourceMappingURL=MicrosoftExcelSharePoint.node.js.map