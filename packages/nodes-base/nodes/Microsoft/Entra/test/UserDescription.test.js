...
import { entraGroupGuid as groupGuid, entraGuid as guid, entraWorkflow, expectNoGraphRequests, microsoftEntraApiResponse, microsoftEntraNodeResponse, } from './mocks';
...
describe('Microsoft Entra Node', () => {
                    ...
                    mocks: [
                        {
                            ...
                            responseBody: {
                                ...
                                '@odata.nextLink': 'https://graph.microsoft.com/v1.0/users?$select=id,createdDateTime,displayName,userPrincipalName,mail,mailNickname,securityIdentifier&$skiptoken=RFNwdAIAAQAAACpHcm91cF9jYzEzY2Y5Yy1lOWNiLTQ3NjUtODMzYS05MDIzZDhhMjhlZjMqR3JvdXBfY2MxM2NmOWMtZTljYi00NzY1LTgzM2EtOTAyM2Q4YTI4ZWYzAAAAAAAAAAAAAAA',
    ...
    describe('Accepted user IDs', () => {
        ...
        const deleteUser = (description, user, path) => ({
            description,
            input: {
        ...
        const tests = [
            deleteUser('should delete a user addressed by an expression-driven UPN', { __rl: true, mode: 'id', value: '={{ "john.doe@contoso.com" }}' }, '/users/john.doe%40contoso.com'),
            deleteUser('should delete a guest user addressed by UPN', { __rl: true, mode: 'id', value: guestUpn }, guestPath),
            deleteUser('should delete a user picked from the list', { __rl: true, mode: 'list', value: guid }, `/users/${guid}`),
            {
    ...
    describe('Rejected user IDs', () => {
        ...
        it('reports an empty user as a node issue', () => {
            ...
            const issues = NodeHelpers.getNodeParametersIssues(node.description.properties, entra, node.description);
...
//# sourceMappingURL=UserDescription.test.js.map