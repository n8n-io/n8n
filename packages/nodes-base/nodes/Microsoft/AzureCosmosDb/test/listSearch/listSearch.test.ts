...
describe('Azure Cosmos DB', () => {
	describe('List search', () => {
		it('should list search containers', async () => {
			...
			const listSearchResult = await node.methods.listSearch.searchContainers.call(mockContext);
		...
		it('should list search items', async () => {
			...
			const listSearchResult = await node.methods.listSearch.searchItems.call(mockContext);
