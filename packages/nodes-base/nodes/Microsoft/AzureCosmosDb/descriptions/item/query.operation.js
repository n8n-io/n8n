                ...
                values: [
                    {
                        ...
                        default: '',
                        description: 'Comma-separated list of string values used as query parameters. Use $1, $2, $3, etc., in your query. All values are treated as strings — use "Query Parameters (JSON)" for typed values.',
                    ...
                    },
                    {
                        ...
                        default: '',
                        description: 'JSON array of values used as query parameters. Preserves types (numbers, booleans, null, strings with leading zeros). Use $1, $2, $3, etc., in your query.',
