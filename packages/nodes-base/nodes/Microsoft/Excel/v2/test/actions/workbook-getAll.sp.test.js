...
describe('Microsoft Excel workbook:getAll under the Service Principal credential', () => {
    ...
    it('throws "Search is not supported" instead of issuing a drive search', async () => {
        ...
        await expect(execute.call(ctx, [{ json: {} }])).rejects.toThrow('Search is not supported with the Service Principal credential');
    });
});
//# sourceMappingURL=workbook-getAll.sp.test.js.map