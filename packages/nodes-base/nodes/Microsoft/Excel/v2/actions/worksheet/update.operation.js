...
import { checkRange, prepareOutput, updateByAutoMaping, updateByDefinedValues, } from '../../helpers/utils';
...
export async function execute(items) {
    ...
    try {
        ...
        if (dataMode === 'raw') {
            ...
            responseData = await microsoftApiRequest.call(this, 'PATCH', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/range(address='${range}')`, { values }, qs, undefined, undefined, 0);
