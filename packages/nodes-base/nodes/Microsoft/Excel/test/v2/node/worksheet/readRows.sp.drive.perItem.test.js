...
describe('Test MicrosoftExcelV2, Service Principal worksheet => readRows per-item drive target', () => {
    nock('https://graph.microsoft.com/v1.0')
        ...
        .get('/drives/b!driveA/items/01FUWX3BQ4ATCOZNR265GLA6IJEZDQUE4I/workbook/worksheets/%7BA0883CFE-D27E-4ECC-B94B-981830AAD55B%7D/usedRange')
        .reply(200, { values: [['row'], ['drive-a-row']] });
    nock('https://graph.microsoft.com/v1.0')
        .matchHeader('Authorization', 'Bearer test-access-token')
        .get('/drives/b!driveB/items/01FUWX3BQ4ATCOZNR265GLA6IJEZDQUE4I/workbook/worksheets/%7BA0883CFE-D27E-4ECC-B94B-981830AAD55B%7D/usedRange')
...
//# sourceMappingURL=readRows.sp.drive.perItem.test.js.map