...
describe('Test MicrosoftExcelV2, Service Principal worksheet => upsert uses item 0 target for the whole batch', () => {
    nock('https://graph.microsoft.com/v1.0')
        ...
        .get('/users/alice%40contoso.com/drive/items/01FUWX3BQ4ATCOZNR265GLA6IJEZDQUE4I/workbook/worksheets/%7BA0883CFE-D27E-4ECC-B94B-981830AAD55B%7D/usedRange')
        .reply(200, {
    ...
    nock('https://graph.microsoft.com/v1.0')
        .matchHeader('Authorization', 'Bearer test-access-token')
        .patch("/users/alice%40contoso.com/drive/items/01FUWX3BQ4ATCOZNR265GLA6IJEZDQUE4I/workbook/worksheets/%7BA0883CFE-D27E-4ECC-B94B-981830AAD55B%7D/range(address='A1:B4')", {
        values: [
            ['id', 'data'],
            ['1', 'new1'],
            ['2', 'old2'],
...
//# sourceMappingURL=upsert.sp.batch.test.js.map