...
import { checkRange, findAppendRange, nextExcelColumn, parseAddress, prepareOutput, updateByAutoMaping, updateByDefinedValues, } from '../../../v2/helpers/utils';
const node = {
    id: '1',
...
const fakeExecute = (nodeParameters) => {
...
describe('Test MicrosoftExcelV2, updateByDefinedValues', () => {
    it('should update single row', () => {
        ...
        const updateSummary = updateByDefinedValues.call(fakeExecute(nodeParameters), nodeParameters.length, sheetData, false);
    ...
    it('should update all occurances', () => {
        ...
        const updateSummary = updateByDefinedValues.call(fakeExecute(nodeParameters), nodeParameters.length, sheetData, true);
        expect(updateSummary).toBeDefined();
        expect(updateSummary.updatedRows).toContain(0); //header row
