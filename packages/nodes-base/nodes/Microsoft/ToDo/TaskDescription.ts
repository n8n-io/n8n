...
export const taskFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		default: '',
		description:
			'The identifier of the list, unique in the user\'s mailbox. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
	},
	{
		displayName: 'Subject',
		name: 'title',
