 ...
 */
export function getServicePrincipalResourceRoot(rawId, node) {
...
// not an index.
export async function microsoftApiRequest(method, resource, itemIndex, body = {}, qs = {}, uri, option = { json: true }) {
...
export async function microsoftApiRequestAllItems(propertyName, method, endpoint, itemIndex, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    let uri;
    query.$top = 100;
    do {
        responseData = await microsoftApiRequest.call(this, method, endpoint, itemIndex, body, query, uri);
