...
import { assertPathSegment, ITEM_SIMPLIFY_EXPAND, ITEM_SIMPLIFY_SELECT, simplifyItem, } from '../../helpers/utils';
...
export async function execute(i, siteIdCache) {
    ...
    const response = await microsoftApiRequest.call(this, 'GET', `/v1.0/sites/${encodeURIComponent(siteId)}/lists/${encodeURIComponent(list)}/items/${encodeURIComponent(item)}`, {}, qs);
    if (simplify) {
