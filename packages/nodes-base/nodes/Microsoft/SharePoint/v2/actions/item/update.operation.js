...
export async function execute(i, siteIdCache) {
    ...
    const ids = await resolveMatchedItemIds.call(this, siteId, listIdOrTitle, matchingColumns, values);
    if (ids.length === 0) {
