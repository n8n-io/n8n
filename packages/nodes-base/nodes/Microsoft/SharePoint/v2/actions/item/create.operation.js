...
import { addUniqueConstraintHint, assertPathSegment, HYPERLINK_WRITE_HEADERS, } from '../../helpers/utils';
...
export async function execute(i, siteIdCache) {
    ...
    try {
        return await microsoftApiRequest.call(this, 'POST', `/v1.0/sites/${encodeURIComponent(siteId)}/lists/${encodeURIComponent(listIdOrTitle)}/items`, { fields }, {}, undefined, hasHyperlink ? HYPERLINK_WRITE_HEADERS : {});
    }
    catch (error) {
