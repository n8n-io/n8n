...
export async function execute(i, siteIdCache) {
    ...
    return await microsoftApiRequest.call(this, 'PUT', `/v1.0/sites/${encodeURIComponent(siteId)}/drive/items/${encodeURIComponent(folderId)}:/${encodeURIComponent(fileName)}:/content`, body, {}, undefined, { 'Content-Type': contentType });
}
