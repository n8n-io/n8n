...
describe('Microsoft SharePoint Node', () => {
    describe('List search', () => {
        ...
        beforeEach(() => {
            ...
            loadOptionsFunctions.getCredentials.mockResolvedValue(credentials.microsoftSharePointOAuth2Api);
        ...
        it('should list search files', async () => {
            const mockResponse = {
                '@odata.nextLink': 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/items?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
                value: [
                    {
            ...
            const listSearchResult = await node.methods.listSearch.getFiles.call(loadOptionsFunctions, 'file');
            ...
            expect(listSearchResult).toEqual({
                ...
                paginationToken: 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/items?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
            });
        });
        ...
        it('should list search files with pagination', async () => {
            ...
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('site');
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('folder');
            const listSearchResult = await node.methods.listSearch.getFiles.call(loadOptionsFunctions, undefined, 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/items?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
        ...
        it('should list search folders', async () => {
            ...
            mockRequestWithAuthentication.mockReturnValue(mockResponse);
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('site');
            const listSearchResult = await node.methods.listSearch.getFolders.call(loadOptionsFunctions, 'folder');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
                qs: {
        ...
        it('should list search folders with pagination', async () => {
            ...
            mockRequestWithAuthentication.mockReturnValue(mockResponse);
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('site');
            const listSearchResult = await node.methods.listSearch.getFolders.call(loadOptionsFunctions, undefined, 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/items?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
                url: 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/items?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
            });
        ...
        it('should list search items', async () => {
            const mockResponse = {
                '@odata.nextLink': 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/listItems?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
                value: [
                    {
            ...
            const listSearchResult = await node.methods.listSearch.getItems.call(loadOptionsFunctions, 'Title');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
                qs: {
            ...
            expect(listSearchResult).toEqual({
                ...
                paginationToken: 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/listItems?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
            });
        });
        it('properly escapes filter parameter', async () => {
            const mockResponse = {
        ...
        it('should list search items with pagination', async () => {
            ...
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('site');
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('list');
            const listSearchResult = await node.methods.listSearch.getItems.call(loadOptionsFunctions, undefined, 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/listItems?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
        ...
        it('should list search lists', async () => {
            const mockResponse = {
                '@odata.nextLink': 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/lists?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
                value: [
                    {
            ...
            mockRequestWithAuthentication.mockReturnValue(mockResponse);
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('site');
            const listSearchResult = await node.methods.listSearch.getLists.call(loadOptionsFunctions, 'List');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
                qs: {
            ...
            expect(listSearchResult).toEqual({
                ...
                paginationToken: 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/lists?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
            });
        });
        it('properly escapes filter parameter', async () => {
            const mockResponse = {
        ...
        it('should list search lists with pagination', async () => {
            ...
            mockRequestWithAuthentication.mockReturnValue(mockResponse);
            loadOptionsFunctions.getNodeParameter.mockReturnValueOnce('site');
            const listSearchResult = await node.methods.listSearch.getLists.call(loadOptionsFunctions, undefined, 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/lists?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
        ...
        it('should list search sites', async () => {
            const mockResponse = {
                '@odata.nextLink': 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/sites?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
                value: [
                    {
            ...
            mockRequestWithAuthentication.mockReturnValue(mockResponse);
            const listSearchResult = await node.methods.listSearch.getSites.call(loadOptionsFunctions, 'Site');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
                qs: {
                    $search: 'Site',
            ...
            expect(listSearchResult).toEqual({
                results: [
                    {
                        name: 'Site 1',
                        value: 'mydomain.sharepoint.com,3286a459-bc45-4aab-8200-b9ba7edcca96,3abe66fd-ec23-469f-abc6-332e3a95bf75',
                    },
                    {
                        name: 'Site 2',
                        value: 'mydomain.sharepoint.com,cf38a104-c767-48c7-93d0-c093e3909c78,3abe66fd-ec23-469f-abc6-332e3a95bf75',
                    },
                ],
                paginationToken: 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/sites?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB',
            });
        });
        it('should list search sites and pagination', async () => {
            ...
            mockRequestWithAuthentication.mockReturnValue(mockResponse);
            const listSearchResult = await node.methods.listSearch.getSites.call(loadOptionsFunctions, undefined, 'https://mydomain.sharepoint.com/_api/v2.0/sites(%27mydomain.sharepoint.com,site1%27)/sites?%24skiptoken=aWQ9MjFFQkEzOUMtMkU3My00NzgwLUFBQzEtMTVDNzlDMTk4QjlB');
            expect(mockRequestWithAuthentication).toHaveBeenCalledTimes(1);
            expect(mockRequestWithAuthentication.mock.calls[0][1]).toMatchObject({
