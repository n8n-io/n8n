...
describe('Microsoft SharePoint Node', () => {
	const workflows = ['nodes/Microsoft/SharePoint/test/item/upsert.workflow.json'];
				...
				},
				{
					...
					responseBody: {
						...
						parentReference: {
							...
							siteId:
								'feelgoodinterface.sharepoint.com,f3a17c1d-7279-439d-a175-47a758b65c98,3abe66fd-ec23-469f-abc6-332e3a95bf75',
						},
