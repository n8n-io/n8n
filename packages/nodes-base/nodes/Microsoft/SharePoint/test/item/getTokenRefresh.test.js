...
describe('Microsoft SharePoint Node - Token Refresh', () => {
    ...
    const itemPath = '/sites/site1/lists/list1/items/item1?%24select=id%2CcreatedDateTime%2ClastModifiedDateTime%2CwebUrl&%24expand=fields%28select%3DTitle%29';
    ...
    beforeEach(() => {
        ...
        nock(tokenRefreshUrl).post('/common/oauth2/v2.0/token').reply(200, {
            token_type: 'Bearer',
            scope: 'https://mydomain.sharepoint.com/Sites.Manage.All https://mydomain.sharepoint.com/.default',
            expires_in: 3599,
            ext_expires_in: 3599,
...
//# sourceMappingURL=getTokenRefresh.test.js.map