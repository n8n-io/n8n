...
describe('MicrosoftSharePoint (versioned root)', () => {
    ...
    it('should trim the subdomain in the declarative base URL', () => {
        const node = new MicrosoftSharePoint();
        expect(node.nodeVersions[1].description.requestDefaults?.baseURL).toBe('=https://{{ ($credentials.subdomain || "").trim() }}.sharepoint.com/_api/v2.0/');
    });
    ...
    it('describes every version 2 operation for a model choosing between tools', () => {
        const operationProperties = versionDescription.properties.filter((property) => property.name === 'operation');
...
//# sourceMappingURL=MicrosoftSharePoint.node.test.js.map