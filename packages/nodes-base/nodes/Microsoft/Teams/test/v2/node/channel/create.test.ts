...
describe('Test MicrosoftTeamsV2, channel => create', () => {
	nock('https://graph.microsoft.com')
		...
		.reply(200, {
			...
			email: '',
			webUrl:
				'https://teams.microsoft.com/l/channel/19%3a16259efabba44a66916d91dd91862a6f%40thread.tacv2/New+Channel?groupId=hide-ai-build&tenantId=tenantId-111-222-333',
