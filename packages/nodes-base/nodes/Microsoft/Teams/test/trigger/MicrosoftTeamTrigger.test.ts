...
describe('Microsoft Teams Trigger Node', () => {
	...
	describe('webhookMethods with different baseUrls', () => {
		describe('create with custom baseUrl', () => {
			it('should create subscription with US Government baseUrl', async () => {
			...
			it('should create subscription with China baseUrl', async () => {
			...
			it('should create subscription with default baseUrl when no credentials', async () => {
		...
		describe('delete with custom baseUrl', () => {
			it('should delete subscription with US Government DOD baseUrl', async () => {
		...
		describe('checkExists with custom baseUrl', () => {
			it('should check subscription existence with custom baseUrl', async () => {
