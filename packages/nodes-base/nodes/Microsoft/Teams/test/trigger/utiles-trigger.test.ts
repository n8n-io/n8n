...
describe('Microsoft Teams Helpers Functions', () => {
	...
	describe('microsoftApiRequest with different baseUrls', () => {
		it('should use default baseUrl when no credentials provided', async () => {
			// Mock getCredentials to return empty object
			...
			await fetchAllTeams.call(mockLoadOptionsFunctions);

			// Verify that microsoftApiRequest was called with the default baseUrl
			expect(microsoftApiRequest.call).toHaveBeenCalledWith(
				mockLoadOptionsFunctions,
				'GET',
				'/v1.0/me/joinedTeams',
		...
		it('should use custom baseUrl from credentials - US Government', async () => {
			// Mock getCredentials to return US Government baseUrl
			mockLoadOptionsFunctions.getCredentials.mockResolvedValue({
			...
			// Verify that microsoftApiRequest was called with the custom baseUrl
			expect(microsoftApiRequest.call).toHaveBeenCalledWith(
				mockLoadOptionsFunctions,
				'GET',
				'/v1.0/me/joinedTeams',
		...
		it('should use custom baseUrl from credentials - China', async () => {
			// Mock getCredentials to return China baseUrl
			mockLoadOptionsFunctions.getCredentials.mockResolvedValue({
			...
			// Verify that microsoftApiRequest was called with the China baseUrl
			expect(microsoftApiRequest.call).toHaveBeenCalledWith(
				mockLoadOptionsFunctions,
				'GET',
				'/v1.0/me/joinedTeams',
		...
		it('should use custom baseUrl from credentials - US Government DOD', async () => {
			// Mock getCredentials to return US Government DOD baseUrl
			mockLoadOptionsFunctions.getCredentials.mockResolvedValue({
				baseUrl: 'https://dod-graph.microsoft.us',
			});
			...
			// Verify that microsoftApiRequest was called with the DOD baseUrl
			expect(microsoftApiRequest.call).toHaveBeenCalledWith(
				mockLoadOptionsFunctions,
				'GET',
				'/v1.0/me/joinedTeams',
		...
		it('should handle baseUrl with trailing slashes', async () => {
			// Mock getCredentials to return baseUrl with trailing slash
			mockLoadOptionsFunctions.getCredentials.mockResolvedValue({
			...
			// Verify that microsoftApiRequest was called (trailing slash should be removed)
			expect(microsoftApiRequest.call).toHaveBeenCalledWith(
				mockLoadOptionsFunctions,
				'GET',
				'/v1.0/me/joinedTeams',
		...
		it('should use custom baseUrl in createSubscription', async () => {
			// Mock getCredentials to return custom baseUrl
			...
			// Verify that microsoftApiRequest was called with custom baseUrl
			expect(microsoftApiRequest.call).toHaveBeenCalledWith(
				mockHookFunctions,
				'POST',
				'/v1.0/subscriptions',
