...
export async function getPollResponse(pollStartDate, pollEndDate) {
    let responseData;
    const qs = {};
    try {
        ...
        if (options.downloadAttachments) {
            ...
            // Poll context: 0 is the transport's fallback read, not an item index.
            executionData = await downloadAttachments.call(this, responseData, prefix, 0);
        }
        else {
