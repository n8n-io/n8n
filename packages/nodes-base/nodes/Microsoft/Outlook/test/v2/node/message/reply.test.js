...
describe('Test MicrosoftOutlookV2, message => reply', () => {
    nock('https://graph.microsoft.com/v1.0/me')
        .post('/messages/AAMkADlhOTA0MTc5LWUwOTMtNDRkZS05NzE0LTNlYmI0ZWM5OWI5OABGAAAAAABPLqzvT6b9RLP0CKzHiJrRBwBZf4De-LkrSqpPI8eyjUmAAAAAAAEJAABZf4De-LkrSqpPI8eyjUmAAAFXBEVwAAA=/createReply', {
        message: {
        ...
        .post('/messages/AAMkADlhOTA0MTc5LWUwOTMtNDRkZS05NzE0LTNlYmI0ZWM5OWI5OABGAAAAAABPLqzvT6b9RLP0CKzHiJrRBwBZf4De-LkrSqpPI8eyjUmAAAAAAAEPAABZf4De-LkrSqpPI8eyjUmAAAFXBDurAAA=/send')
        .reply(200);
    new NodeTestHarness().setupTests({
        workflowFiles: ['reply.workflow.json'],
    });
});
//# sourceMappingURL=reply.test.js.map