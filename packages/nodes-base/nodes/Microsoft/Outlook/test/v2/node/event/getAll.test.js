...
describe('Test MicrosoftOutlookV2, event => getAll', () => {
    nock('https://graph.microsoft.com/v1.0/me')
        .get('/calendars/AAMkADlhOTA0MTc5LWUwOTMtNDRkZS05NzE0LTNlYmI0ZWM5OWI5OABGAAAAAABPLqzvT6b9RLP0CKzHiJrRBwBZf4De-LkrSqpPI8eyjUmAAAAAAAEGAABZf4De-LkrSqpPI8eyjUmAAAAJ9-JDAAA=/events')
        .query(true)
        .reply(200, {
        value: [
            {
