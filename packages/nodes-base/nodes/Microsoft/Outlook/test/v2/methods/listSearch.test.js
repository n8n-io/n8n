...
import { searchContacts, searchCalendars, searchDrafts, searchMessages, searchEvents, searchFolders, searchAttachments, } from '../../../v2/methods/listSearch';
...
describe('MicrosoftOutlookV2 - listSearch methods', () => {
    ...
    describe('searchContacts', () => {
        it('should search contacts without filter', async () => {
            ...
            expect(mockTransport.microsoftApiRequest).toHaveBeenCalledWith('GET', '/contacts', 0, undefined, {
        ...
        it('should handle pagination token', async () => {
            ...
            expect(mockTransport.microsoftApiRequest).toHaveBeenCalledWith('GET', '', 0, undefined, undefined, paginationToken);
        });
    });
    describe('searchCalendars', () => {
        it('should search calendars successfully', async () => {
            ...
            expect(mockTransport.microsoftApiRequest).toHaveBeenCalledWith('GET', '/calendars', 0, undefined, {
                $select: 'id,name',
                $top: 100,
            });
            expect(result).toEqual({
    ...
    describe('searchDrafts', () => {
        it('should search drafts without filter', async () => {
            ...
            expect(mockTransport.microsoftApiRequest).toHaveBeenCalledWith('GET', '/messages', 0, undefined, {
    ...
    describe('searchEvents', () => {
        ...
        it('should search events successfully', async () => {
            ...
            expect(mockLoadOptionsFunctions.getNodeParameter).toHaveBeenCalledWith('calendarId', undefined, {
                extractValue: true,
            });
            expect(mockTransport.microsoftApiRequest).toHaveBeenCalledWith('GET', `/calendars/${calendarId}/events`, 0, undefined, {
    ...
    describe('searchFolders', () => {
        ...
        it('should search folders successfully', async () => {
            ...
            expect(mockTransport.microsoftApiRequest).toHaveBeenCalledWith('GET', '/mailFolders', 0, undefined, {
                $top: 100,
            });
    ...
    describe('searchAttachments', () => {
        it('should search attachments successfully', async () => {
            ...
            expect(mockLoadOptionsFunctions.getNodeParameter).toHaveBeenCalledWith('messageId', undefined, {
                extractValue: true,
            });
            expect(mockTransport.microsoftApiRequest).toHaveBeenCalledWith('GET', `/messages/${messageId}/attachments`, 0, undefined, {
                $select: 'id,name',
                $top: 100,
            });
            expect(result).toEqual({
        ...
        it('should handle pagination for attachments', async () => {
            const messageId = 'msg123';
            const paginationToken = 'https://graph.microsoft.com/v1.0/me/messages/msg123/attachments?$skip=100';
            const mockResponse = {
    ...
    describe('Error Handling', () => {
        ...
        it('should handle API errors in searchEvents', async () => {
            ...
            mockTransport.microsoftApiRequest.mockRejectedValue(apiError);
            await expect(searchEvents.call(mockLoadOptionsFunctions)).rejects.toThrow('Calendar not found');
        });
        it('should handle API errors in searchFolders', async () => {
            const apiError = new Error('Folders not accessible');
            mockTransport.microsoftApiRequest.mockRejectedValue(apiError);
            await expect(searchFolders.call(mockLoadOptionsFunctions)).rejects.toThrow('Folders not accessible');
        });
    });
    describe('Edge Cases', () => {
