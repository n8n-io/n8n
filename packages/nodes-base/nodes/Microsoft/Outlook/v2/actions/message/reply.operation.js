...
export async function execute(index, _) {
    ...
    const responseData = await microsoftApiRequest.call(this, 'POST', `/messages/${messageId}/${action}`, index, body);
    if (additionalFields.attachments) {
        ...
        for (const attachment of data) {
            await microsoftApiRequest.call(this, 'POST', `/messages/${responseData.id}/attachments`, index, attachment, {});
        }
    }
    if (!saveAsDraft) {
