...
// the real requestWithAuthentication helper. The binary path's JSON.parse of the
// string body is covered by the direct-unit file.upload.test.ts.
describe('Test MicrosoftOneDrive, Service Principal file:upload (text path, scoped)', () => {
	nock('https://graph.microsoft.com/v1.0')
		.matchHeader('Authorization', 'Bearer test-access-token')
		.put('/drives/b!targetdrive/drive/items/PARENT123:/report.txt:/content', 'hello world')
		.reply(200, {
			id: 'UPLOADED1',
			name: 'report.txt',
		});
