...
import { getOneDriveCredentialType, microsoftApiRequest, microsoftApiRequestAllItems, resolveDriveScopeRoot, validateOneDriveFileName, } from './GenericFunctions';
    ...
    async execute() {
        ...
        const resolveDestinationDriveId = async (providedDriveId, itemIndex, driveScopeRoot) => {
            ...
            if (resolvedDriveId === undefined) {
                const drive = (await microsoftApiRequest.call(this, 'GET', '/drive', {}, { $select: 'id' }, undefined, {}, { json: true }, driveScopeRoot));
                const driveId = typeof drive?.id === 'string' ? drive.id : '';
                if (!driveId) {
                    throw new NodeOperationError(this.getNode(), 'Could not resolve a destination Drive ID for the app-only copy/move', {
                        itemIndex,
            ...
            try {
                ...
                if (resource === 'file') {
                    ...
                    if (operation === 'copy') {
                        ...
                        responseData = await microsoftApiRequest.call(this, 'POST', `/drive/items/${encodeURIComponent(fileId)}/copy`, body, {}, undefined, {}, { json: true, resolveWithFullResponse: true }, driveScopeRoot);
                    ...
                    if (operation === 'delete') {
                        ...
                        responseData = await microsoftApiRequest.call(this, 'DELETE', `/drive/items/${fileId}`, {}, {}, undefined, {}, { json: true }, driveScopeRoot);
                    ...
                    if (operation === 'download') {
                        ...
                        responseData = await microsoftApiRequest.call(this, 'GET', `/drive/items/${fileId}`, {}, {}, undefined, {}, { json: true }, driveScopeRoot);
                        ...
                        try {
                            responseData = await microsoftApiRequest.call(this, 'GET', `/drive/items/${fileId}/content`, {}, {}, undefined, {}, { encoding: null, resolveWithFullResponse: true }, driveScopeRoot);
                        }
                        catch (error) {
                    ...
                    if (operation === 'share') {
                        ...
                        responseData = await microsoftApiRequest.call(this, 'POST', `/drive/items/${fileId}/createLink`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                    ...
                    if (operation === 'upload') {
                        ...
                        if (isBinaryData) {
                            ...
                            responseData = await microsoftApiRequest.call(this, 'PUT', `/drive/items/${encodedParentId}:/${encodedFilename}:/content`, body, {}, undefined, { 'Content-Type': binaryData.mimeType, 'Content-length': body.length }, {}, driveScopeRoot);
                            ...
                            responseData = await microsoftApiRequest.call(this, 'PUT', `/drive/items/${encodedParentId}:/${encodedFilename}:/content`, body, {}, undefined, { 'Content-Type': 'text/plain' }, { json: true }, driveScopeRoot);
                        }
                    }
                }
                if (resource === 'folder') {
                    ...
                    if (operation === 'create') {
                        ...
                        for (const name of names) {
                            ...
                            responseData = await microsoftApiRequest.call(this, 'POST', endpoint, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                            if (!responseData.id) {
                                break;
                            }
                    ...
                    if (operation === 'delete') {
                        ...
                        responseData = await microsoftApiRequest.call(this, 'DELETE', `/drive/items/${folderId}`, {}, {}, undefined, {}, { json: true }, driveScopeRoot);
                        responseData = { success: true };
                    }
                    //https://docs.microsoft.com/en-us/onedrive/developer/rest-api/api/driveitem_list_children?view=odsp-graph-online
                    if (operation === 'getChildren') {
                        const folderId = encodeURIComponent(this.getNodeParameter('folderId', i));
                        responseData = await microsoftApiRequestAllItems.call(this, 'value', 'GET', `/drive/items/${folderId}/children`, {}, {}, driveScopeRoot);
                    }
                    //https://docs.microsoft.com/en-us/onedrive/developer/rest-api/api/driveitem_search?view=odsp-graph-online
                    if (operation === 'search') {
                        if (isServicePrincipal) {
                    ...
                    if (operation === 'share') {
                        ...
                        responseData = await microsoftApiRequest.call(this, 'POST', `/drive/items/${folderId}/createLink`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                }
                if (resource === 'file' || resource === 'folder') {
                    if (operation === 'rename') {
                        ...
                        responseData = await microsoftApiRequest.call(this, 'PATCH', `/drive/items/${itemId}`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                    ...
                    if (operation === 'move') {
                        ...
                        if (!destinationFolderId && !renameName) {
                            throw new NodeOperationError(this.getNode(), 'Set a Destination Folder ID to move the item (use `root` for the drive root), or a Name to rename it in place.', { itemIndex: i });
                        }
                        ...
                        // any `/ : ? #` in the id from changing which item the URL addresses.
                        responseData = await microsoftApiRequest.call(this, 'PATCH', `/drive/items/${encodeURIComponent(itemId)}`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                }
            }
            catch (error) {
