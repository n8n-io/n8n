 ...
 */
export function stampItemIndexOnError(error, itemIndex) {
...
const DEFAULT_MESSAGES = {
    required: {
        ...
        description: 'Set the User ID under "Access As" — app-only Microsoft Graph has no personal context to default to.',
    },
    dotsOnly: {
 ...
 */
export function validateUserTargetId(id, node, messages = DEFAULT_MESSAGES) {
    if (id === '') {
