...
describe('Test MicrosoftGraphSecurity, secureScoreControlProfile => update', () => {
    ...
    beforeAll(() => {
        nock('https://graph.microsoft.com')
            ...
            .reply(200, {
            '@odata.context': 'https://graph.microsoft.com/v1.0/$metadata#security/secureScoreControlProfiles/$entity',
...
//# sourceMappingURL=secureScoreControlProfile.update.test.js.map