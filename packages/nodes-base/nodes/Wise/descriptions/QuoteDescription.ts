...
export const quoteFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		description:
			'ID of the user profile to create the quote under. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['quote'],
				operation: ['create'],
