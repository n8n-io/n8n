...
import { escapeSnowflakeObjectIdentifier, getConnectionOptions, isFileTransferQuery, prepareQueryResults, } from '../GenericFunctions';
vi.mock('crypto');
...
describe('escapeSnowflakeObjectIdentifier', () => {
    ...
    it('does not split on dots inside quoted segments', () => {
        expect(escapeSnowflakeObjectIdentifier('"my.schema"."my.table"')).toBe('"my.schema"."my.table"');
    });
});
