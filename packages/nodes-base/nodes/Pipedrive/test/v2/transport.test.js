...
import { pipedriveApiRequest, pipedriveApiRequestAllItemsCursor, pipedriveApiRequestAllItemsOffset, pipedriveGetCustomProperties, sortOptionParameters, } from '../../v2/transport/pipedrive.api';
describe('Pipedrive v2 Transport', () => {
    ...
    describe('pipedriveApiRequest', () => {
        it('should use v2 base URL by default', async () => {
            ...
            expect(mockExecuteFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('pipedriveApi', expect.objectContaining({
        ...
        it('should use v1 base URL when apiVersion is v1', async () => {
            ...
            await pipedriveApiRequest.call(mockExecuteFunctions, 'GET', '/leads', {}, {}, {
                apiVersion: 'v1',
            });
            expect(mockExecuteFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('pipedriveApi', expect.objectContaining({
        ...
        it('should use OAuth2 credentials when authentication is oAuth2', async () => {
            ...
            await pipedriveApiRequest.call(mockExecuteFunctions, 'GET', '/deals', {});
            expect(mockExecuteFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('pipedriveOAuth2Api', expect.any(Object));
        });
        ...
        it('should handle download file option', async () => {
            ...
            const result = await pipedriveApiRequest.call(mockExecuteFunctions, 'GET', '/files/1/download', {}, {}, { downloadFile: true });
            expect(mockExecuteFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('pipedriveApi', expect.objectContaining({
                encoding: null,
            }));
        ...
        it('should throw NodeApiError when API returns success: false', async () => {
            ...
            await expect(pipedriveApiRequest.call(mockExecuteFunctions, 'GET', '/deals', {})).rejects.toThrow(NodeApiError);
        });
        it('should throw NodeApiError on request failure', async () => {
            mockExecuteFunctions.helpers.requestWithAuthentication.mockRejectedValue(new Error('Network error'));
            await expect(pipedriveApiRequest.call(mockExecuteFunctions, 'GET', '/deals', {})).rejects.toThrow(NodeApiError);
        });
        it('should pass formData when provided', async () => {
            ...
            await pipedriveApiRequest.call(mockExecuteFunctions, 'POST', '/files', {}, {}, { formData: { file: 'binary-data' } });
            expect(mockExecuteFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('pipedriveApi', expect.objectContaining({
    ...
    describe('pipedriveApiRequestAllItemsCursor', () => {
        it('should follow cursor tokens across multiple pages', async () => {
            ...
            const result = await pipedriveApiRequestAllItemsCursor.call(mockExecuteFunctions, 'GET', '/deals', {});
    ...
    describe('pipedriveApiRequestAllItemsOffset', () => {
        it('should follow offset pagination across multiple pages', async () => {
            ...
            const result = await pipedriveApiRequestAllItemsOffset.call(mockExecuteFunctions, 'GET', '/leadFields', {});
    ...
    describe('pipedriveGetCustomProperties', () => {
        ...
        it('should throw for unsupported resources', async () => {
            await expect(pipedriveGetCustomProperties.call(mockExecuteFunctions, 'unsupported')).rejects.toThrow(NodeOperationError);
        });
    });
