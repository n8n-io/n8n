...
import { pipedriveApiRequest, pipedriveApiRequestAllItemsCursor, pipedriveGetCustomProperties, } from '../../v2/transport';
...
const mockApiRequestAllItemsCursor = pipedriveApiRequestAllItemsCursor;
...
describe('Pipedrive v2 maps user_id parameter to owner_id on outgoing requests', () => {
    ...
    it('deal/getAll sends owner_id as query filter', async () => {
        ...
        const [, method, endpoint, , qs] = mockApiRequest.call.mock.calls[0];
...
//# sourceMappingURL=userIdRemap.test.js.map