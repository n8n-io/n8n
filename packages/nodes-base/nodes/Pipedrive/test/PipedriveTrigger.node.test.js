    ...
    describe('Webhook Methods', () => {
        describe('checkExists', () => {
            it('should return true if webhook already exists', async () => {
                ...
                pipedriveApiRequest.mockResolvedValue({
                    data: [
                        {
                            id: '123',
                ...
                const result = await pipedriveTrigger.webhookMethods.default.checkExists.call(mockHookFunctions);
        ...
        describe('create', () => {
            it('should create a webhook successfully', async () => {
                ...
                expect(result).toBe(true);
                expect(pipedriveApiRequest).toHaveBeenCalledWith('POST', '/webhooks', expect.objectContaining({
                    event_action: '*',
                    event_object: 'deal',
                    subscription_url: 'http://test-webhook-url',
                }));
...
//# sourceMappingURL=PipedriveTrigger.node.test.js.map