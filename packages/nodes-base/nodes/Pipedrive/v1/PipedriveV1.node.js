...
import { pipedriveApiRequest, pipedriveApiRequestAllItems, pipedriveEncodeCustomProperties, pipedriveGetCustomProperties, pipedriveResolveCustomProperties, sortOptionParameters, } from './GenericFunctions';
    ...
    methods = {
        loadOptions: {
            ...
            async getFilters() {
                ...
                const { data } = await pipedriveApiRequest.call(this, 'GET', '/filters', {}, { type: type[resource] });
            ...
            // select them easily
            async getLeadLabels() {
                const { data } = (await pipedriveApiRequest.call(this, 'GET', '/leadLabels', {}));
                return sortOptionParameters(data.map(({ id, name }) => ({ value: id, name })));
            },
            // Get all the labels to display them to user so that they can
            // select them easily
...
//# sourceMappingURL=PipedriveV1.node.js.map