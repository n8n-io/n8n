 ...
 *
 */
export async function pipedriveApiRequest(method, endpoint, body, query = {}, formData, downloadFile) {
 ...
 */
export async function pipedriveApiRequestAllItems(method, endpoint, body, query) {
    if (query === undefined) {
        query = {};
    }
    query.limit = 100;
 ...
 *
 */
export function pipedriveEncodeCustomProperties(customProperties, item) {
 ...
 *
 */
export function pipedriveResolveCustomProperties(customProperties, item) {
    let customPropertyData;
