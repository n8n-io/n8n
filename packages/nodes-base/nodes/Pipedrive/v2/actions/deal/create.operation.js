...
import { encodeCustomFieldsV2, resolveCustomFieldsV2, coerceToNumber, toDateOnly, addFieldsToBody, } from '../../helpers';
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            if (body.expected_close_date) {
                body.expected_close_date = toDateOnly(body.expected_close_date);
            }
