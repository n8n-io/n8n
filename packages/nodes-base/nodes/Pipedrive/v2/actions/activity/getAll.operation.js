    ...
    rawCustomFieldOutputOption,
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether the Activity is done or not. If omitted returns both Done and Not done activities.',
            },
            {
...
export async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            let responseData;
            if (returnAll) {
                responseData = await pipedriveApiRequestAllItemsCursor.call(this, 'GET', '/activities', {}, qs);
            }
            else {
