...
export async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            let responseData;
            if (returnAll) {
                responseData = await pipedriveApiRequestAllItemsOffset.call(this, 'GET', '/organizations/search', {}, qs);
            }
            else {
                responseData = await pipedriveApiRequest.call(this, 'GET', '/organizations/search', {}, qs, { apiVersion: 'v1' });
            }
