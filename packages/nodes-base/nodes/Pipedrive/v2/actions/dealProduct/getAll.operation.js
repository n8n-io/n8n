...
export async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            let responseData;
            if (returnAll) {
                responseData = await pipedriveApiRequestAllItemsCursor.call(this, 'GET', `/deals/${dealId}/products`, {}, qs);
            }
            else {
                responseData = await pipedriveApiRequest.call(this, 'GET', `/deals/${dealId}/products`, {}, qs);
            }
