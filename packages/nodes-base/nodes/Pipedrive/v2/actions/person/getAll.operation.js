    ...
    rawCustomFieldOutputOption,
    {
        ...
        options: [
            ...
            },
            {
                ...
                default: '',
                description: 'Predefined filter to apply to the persons to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
            },
        ],
    },
];
...
export async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            let responseData;
            if (returnAll) {
                responseData = await pipedriveApiRequestAllItemsCursor.call(this, 'GET', '/persons', {}, qs);
            }
            else {
