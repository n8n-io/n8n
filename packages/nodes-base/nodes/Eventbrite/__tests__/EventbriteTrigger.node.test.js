...
describe('EventbriteTrigger node', () => {
    describe('webhook', () => {
        const mockWebhookFunctions = mockDeep();
        beforeEach(() => {
            vi.resetAllMocks();
        ...
        it('should throw an error when the `api_url` is not provided', async () => {
            ...
            await expect(eventbriteTrigger.webhook.call(mockWebhookFunctions)).rejects.toThrow('The received data does not contain a valid Eventbrite API URL!');
        });
...
//# sourceMappingURL=EventbriteTrigger.node.test.js.map