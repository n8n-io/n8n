			...
			// ----------------------------------
			{
				...
				options: [
					...
					},
					{
						...
						default: '',
						description:
							'Level of detail returned by the request. Eventbrite APIs can retrieve entities at three different levels of depth: minimal, partial, and complete. Any other values passed are reset to minimal by default.'
					},
					{
	...
	methods = {
		loadOptions: {
			...
			async getContactFields(
				...
				const response = await eventbriteApiRequest.call(
					this,
					'GET',
