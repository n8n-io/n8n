...
import { evaluateExpression, isJSON, replaceEmptyStringsByNulls, stringToArray, } from '../../helpers/utils';
...
export async function execute(runQueries, items, nodeOptions, _db) {
    const queries = replaceEmptyStringsByNulls(items, nodeOptions.replaceEmptyStrings).map((_, index) => {
