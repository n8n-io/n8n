 ...
 * @param {pgPromise.IMain<{}, IClient>} pgp The pgPromise instance
 * @param string returning The comma separated string
 * @returns string
 */
export function generateReturning(pgp: pgPromise.IMain<{}, IClient>, returning: string): string {
 ...
 * @param {pgPromise.IMain<{}, IClient>} pgp The pgPromise instance
 * @param {pgPromise.IDatabase<{}, IClient>} db The pgPromise database connection
 * @param {input[]} input The Node's input data
 * @returns Promise<Array<IDataObject>>
 */
export async function pgQuery(
	getNodeParam: Function,
	pgp: pgPromise.IMain<{}, IClient>,
