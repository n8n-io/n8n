...
const runQueries = vi.fn().mockResolvedValue([]);
const node = {
    id: '1',
    name: 'Postgres node',
    typeVersion: 2,
...
const createMockExecuteFunction = (nodeParameters) => {
    const fakeExecuteFunction = {
        ...
        evaluateExpression(str, _) {
            return str.replace('{{', '').replace('}}', '');
        },
    };
    return fakeExecuteFunction;
};
const createMockDb = (columnInfo) => {
    return {
        async any() {
            return columnInfo;
        },
...
describe('Test PostgresV2, deleteTable operation', () => {
    ...
    it('deleteCommand: delete, should call runQueries with', async () => {
        ...
        await deleteTable.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
    ...
    it('deleteCommand: delete, should throw on invalid where clause', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        const promise = deleteTable.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
...
describe('Test PostgresV2, executeQuery operation', () => {
    ...
    it('should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await executeQuery.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
        expect(runQueries).toHaveBeenCalledWith([{ query: 'select * from $1:name;', values: ['my_table'], options: { partial: true } }], nodeOptions);
    });
    it('should call runQueries and insert enclosed placeholder into values', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await executeQuery.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
        expect(runQueries).toHaveBeenCalledWith([{ query: 'select $1;', values: ['$1'], options: { partial: true } }], nodeOptions);
    });
    it('should call runQueries and not insert enclosed placeholder into values because queryReplacement is defined', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await executeQuery.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
        expect(runQueries).toHaveBeenCalledWith([{ query: "select '$1';", values: ['my_table'], options: { partial: true } }], nodeOptions);
    });
    it('should call runQueries and insert enclosed placeholder into values because treatQueryParametersInSingleQuotesAsText is true', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await executeQuery.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
        expect(runQueries).toHaveBeenCalledWith([{ query: 'select $2;', values: ['my_table', '$1'], options: { partial: true } }], nodeOptions);
    });
    ...
    it('should execute queries with multiple json key/value pairs', async () => {
        const nodeParameters = {
            ...
            query: 'SELECT *\nFROM users\nWHERE username IN ($1, $2, $3)',
            options: {
                queryReplacement: '={{ JSON.stringify({id: "7",id2: "848da11d-e72e-44c5-yyyy-c6fb9f17d366"}) }}',
            },
        };
        const nodeOptions = nodeParameters.options;
        expect(async () => {
    ...
    const createMockExecuteForArrayQuery = (nodeParameters, returnArray, matchString) => ({
        getNodeParameter(parameterName, _itemIndex, fallbackValue, options) {
            const parameter = options?.extractValue ? `${parameterName}.value` : parameterName;
            return get(nodeParameters, parameter, fallbackValue);
        },
...
describe('Test PostgresV2, insert operation', () => {
    ...
    it('dataMode: define, should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await insert.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions, createMockDb(columnsInfo), pgPromise());
        expect(runQueries).toHaveBeenCalledWith([
            {
    ...
    it('dataMode: autoMapInputData, should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await insert.execute.call(createMockExecuteFunction(nodeParameters), runQueries, inputItems, nodeOptions, createMockDb(columnsInfo), pgPromise());
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'INSERT INTO $1:name.$2:name($3:name) VALUES($3:csv) RETURNING *',
    ...
    it('dataMode: define, should accept an array with values if column is of type json', async () => {
        ...
        values.forEach(async (value) => {
            ...
            const nodeOptions = nodeParameters.options;
            const pg = pgPromise();
            await insert.execute.call(createMockExecuteFunction(nodeParameters), runQueries, inputItems, nodeOptions, createMockDb(columnsInfo), pg);
            expect(runQueries).toHaveBeenCalledWith([
                {
                    query: 'INSERT INTO $1:name.$2:name($3:name) VALUES($3:csv) RETURNING *',
    ...
    it('should handle type validation errors with continueOnFail=true', async () => {
        ...
        fakeExecuteFunction.getNodeParameter = ((parameterName, _itemIndex, fallbackValue, options) => {
            if (parameterName === 'columns.value') {
                throw error;
            }
            return originalGetNodeParameter(parameterName, _itemIndex, fallbackValue, options);
        });
        const result = await insert.execute.call(fakeExecuteFunction, runQueries, items, nodeOptions, createMockDb(columnsInfo), pgPromise());
...
describe('Test PostgresV2, select operation', () => {
    ...
    it('returnAll, should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await select.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
        expect(runQueries).toHaveBeenCalledWith([
            {
    ...
    it('limit, whereClauses, sortRules, should call runQueries with', async () => {
        ...
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'SELECT $3:name FROM $1:name.$2:name WHERE $4:name >= $5 AND $6:name = $7 ORDER BY $8:name ASC LIMIT $9',
    ...
    it('limit, throw on invalid value', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        const promise = select.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions);
...
describe('Test PostgresV2, update operation', () => {
    ...
    it('dataMode: define, should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await update.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions, createMockDb(columnsInfo));
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'UPDATE $1:name.$2:name SET $5:name = $6, $7:name = $8 WHERE $3:name = $4 RETURNING $9:name',
                values: [
                    'public',
                    'my_table',
                    'id',
    ...
    it('dataMode: autoMapInputData, should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await update.execute.call(createMockExecuteFunction(nodeParameters), runQueries, inputItems, nodeOptions, createMockDb(columnsInfo));
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'UPDATE $1:name.$2:name SET $5:name = $6, $7:name = $8 WHERE $3:name = $4 RETURNING *',
                values: ['public', 'my_table', 'id', 1, 'json', { test: 15 }, 'foo', 'data 1'],
            },
            {
                query: 'UPDATE $1:name.$2:name SET $5:name = $6, $7:name = $8 WHERE $3:name = $4 RETURNING *',
    ...
    it('should handle type validation errors with continueOnFail=true', async () => {
        ...
        const result = await update.execute.call(fakeExecuteFunction, runQueries, items, nodeOptions, createMockDb(columnsInfo));
        expect(result).toEqual([
            {
                json: { error },
                pairedItem: { item: 0 },
...
describe('Test PostgresV2, upsert operation', () => {
    it('dataMode: define, should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await upsert.execute.call(createMockExecuteFunction(nodeParameters), runQueries, items, nodeOptions, createMockDb(columnsInfo));
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'INSERT INTO $1:name.$2:name($4:name) VALUES($4:csv) ON CONFLICT ($3:name) DO UPDATE  SET $5:name = $6, $7:name = $8 RETURNING $9:name',
                values: [
                    'public',
                    'my_table',
                    'id',
    ...
    it('dataMode: autoMapInputData, should call runQueries with', async () => {
        ...
        const nodeOptions = nodeParameters.options;
        await upsert.execute.call(createMockExecuteFunction(nodeParameters), runQueries, inputItems, nodeOptions, createMockDb(columnsInfo));
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'INSERT INTO $1:name.$2:name($4:name) VALUES($4:csv) ON CONFLICT ($3:name) DO UPDATE  SET $5:name = $6, $7:name = $8 RETURNING *',
                values: [
                    'public',
                    'my_table',
                    'id',
    ...
    it('should handle type validation errors with continueOnFail=true', async () => {
        ...
        const result = await upsert.execute.call(fakeExecuteFunction, runQueries, items, nodeOptions, createMockDb(columnsInfo));
        expect(result).toEqual([
            {
                json: { error },
                pairedItem: { item: 0 },
...
describe('When matching on all columns', () => {
    it('dataMode: define, should call runQueries with', async () => {
        ...
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'INSERT INTO $1:name.$2:name($6:name) VALUES($6:csv) ON CONFLICT ($3:name,$4:name,$5:name) DO NOTHING  RETURNING $7:name',
                values: [
                    'public',
                    'my_table',
                    'id',
    ...
    it('dataMode: autoMapInputData, should call runQueries with', async () => {
        ...
        expect(runQueries).toHaveBeenCalledWith([
            {
                query: 'INSERT INTO $1:name.$2:name($6:name) VALUES($6:csv) ON CONFLICT ($3:name,$4:name,$5:name) DO NOTHING  RETURNING *',
                values: [
                    'public',
                    'my_table',
                    'id',
