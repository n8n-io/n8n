...
export class CodeAgent implements INodeType {
	description: INodeTypeDescription = {
		...
		version: [1, 2],
		defaultVersion: 2,
		description: 'Run custom JavaScript or Python code via an agent',
		defaults: {
			name: 'Code',
		},
		inputs: ['main'],
	...
	async execute(this: IExecuteFunctions) {
		...
		const data = await this.callAgent(language.toLowerCase(), {
			nodeMode,
			code,
		});
		console.log('CodeAgent', data);
