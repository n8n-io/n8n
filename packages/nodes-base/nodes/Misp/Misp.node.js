...
import { attributeFields, attributeOperations, eventFields, eventOperations, eventTagFields, eventTagOperations, feedFields, feedOperations, galaxyFields, galaxyOperations, noticelistFields, noticelistOperations, objectOperations, objectFields, organisationFields, organisationOperations, tagFields, tagOperations, userFields, userOperations, warninglistFields, warninglistOperations, } from './descriptions';
import { mispApiRequest, mispApiRequestAllItems, mispApiRestSearch, throwOnEmptyUpdate, throwOnInvalidUrl, throwOnMissingSharingGroup, } from './GenericFunctions';
export class Misp {
    description = {
        displayName: 'MISP',
        name: 'misp',
    ...
    methods = {
        loadOptions: {
            async getOrgs() {
                const responseData = (await mispApiRequest.call(this, 'GET', '/organisations'));
                return responseData.map((i) => ({ name: i.Organisation.name, value: i.Organisation.id }));
            },
            async getSharingGroups() {
                const responseData = (await mispApiRequest.call(this, 'GET', '/sharing_groups'));
            ...
            async getTags() {
                const responseData = (await mispApiRequest.call(this, 'GET', '/tags'));
                return responseData.Tag.map((i) => ({ name: i.name, value: i.id }));
            },
            async getUsers() {
                const responseData = (await mispApiRequest.call(this, 'GET', '/admin/users'));
            ...
            try {
                if (resource === 'attribute') {
                    ...
                    if (operation === 'create') {
                        ...
                        //               feed: getAll
                        // ----------------------------------------
                        responseData = (await mispApiRequestAllItems.call(this, '/feeds'));
                    ...
                    if (operation === 'delete') {
                        ...
                        //              galaxy: getAll
                        // ----------------------------------------
                        responseData = (await mispApiRequestAllItems.call(this, '/galaxies'));
                    ...
                    if (operation === 'get') {
                        ...
                        //            noticelist: getAll
                        // ----------------------------------------
                        responseData = (await mispApiRequestAllItems.call(this, '/noticelists'));
                    ...
                    if (operation === 'create') {
                        ...
                        //           organisation: getAll
                        // ----------------------------------------
                        responseData = (await mispApiRequestAllItems.call(this, '/organisations'));
                    ...
                    if (operation === 'create') {
                        ...
                        //               tag: getAll
                        // ----------------------------------------
                        responseData = (await mispApiRequest.call(this, 'GET', '/tags'));
                    ...
                    if (operation === 'create') {
                        ...
                        //               user: getAll
                        // ----------------------------------------
                        responseData = (await mispApiRequestAllItems.call(this, '/admin/users'));
                    ...
                    if (operation === 'get') {
                        ...
                        //           warninglist: getAll
                        // ----------------------------------------
                        responseData = (await mispApiRequest.call(this, 'GET', '/warninglists'));
                        const returnAll = this.getNodeParameter('returnAll', 0);
                        if (!returnAll) {
                            const limit = this.getNodeParameter('limit', 0);
