    ...
    async trigger() {
            ...
            return await imapConnect(config).then((conn) => {
                ...
                conn.on('close', (_hadError) => {
                    if (isCurrentlyReconnecting) {
                        ...
                        this.emitError(new NodeOperationError(this.getNode(), 'IMAP connection closed unexpectedly', {
        ...
        const closeFunction = async () => {
            ...
            try {
                ...
                throw new TriggerCloseError(this.getNode(), { cause: error, level: 'warning' });
            }
        };
