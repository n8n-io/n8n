		...
		options: [
			{
				name: 'Create',
				value: 'create',
				description: 'Create a Neptune instance',
			...
			},
			{
				name: 'Delete',
				value: 'delete',
				description: 'Delete a Neptune instance',
			...
			},
			{
				name: 'List',
				value: 'list',
				description: 'List all Neptune instances',
			...
			},
			{
				name: 'Modify',
				value: 'modify',
				description: 'Modify a Neptune instance',
			...
			},
			{
				name: 'Reboot',
				value: 'reboot',
				description: 'Reboot a Neptune instance',
...
export const instanceFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			{ name: 'db.r5.4xlarge', value: 'db.r5.4xlarge' },
