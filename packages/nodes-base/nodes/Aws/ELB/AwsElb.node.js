...
import { listenerCertificateFields, listenerCertificateOperations, } from './ListenerCertificateDescription';
    ...
    methods = {
        loadOptions: {
            ...
            async getSecurityGroups() {
                ...
                const data = await awsApiRequestSOAP.call(this, 'ec2', 'POST', '/', body, {}, {
