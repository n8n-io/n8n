    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                const responseData = await awsApiRequestREST.call(this, 'lambda', 'POST', `/2015-03-31/functions/${params.FunctionName}/invocations?Qualifier=${params.Qualifier}`, params.Payload, {
