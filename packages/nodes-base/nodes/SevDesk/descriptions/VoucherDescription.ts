...
export const voucherFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description: 'The Date Interval in which recurring vouchers are generated. Necessary attribute for all recurring vouchers.<br/>One of "P0Y0M1W", "P0Y0M2W", "P0Y1M0W", "P0Y3M0W", "P0Y6M0W", "P1Y0M0W", "P2Y0M0W", "P3Y0M0W", "P4Y0M0W", "P5Y0M0W".',
				type: 'string',
				default: '',
			},
			{
	...
	},
	{
		...
		type: 'collection',
		placeholder: 'Add Field',
		description: 'There are a multitude of parameter which can be used to filter. A few of them are attached but for a complete list please check out <a href="https://5677.extern.sevdesk.dev/apiOverview/index.html#/doc-vouchers#filtering">this</> list.',
		default: {},
		displayOptions: {
			show: {
				resource: [
		...
		options: [
			{
				...
				name: 'contactId',
				description: 'Retrieve all vouchers with this contact. Must be provided with Contact Object Name.',
				type: 'number',
				default: 0,
			},
			{
			...
			{
				displayName: 'Credit or Debit?',
				name: 'creditDebit',
				description: 'Define if you only want credit or debit vouchers. One of "C", "D".',
				type: 'string',
				default: '',
			},
			{
				displayName: 'Description Like',
			...
			},
			{
				displayName: 'Status',
				name: 'status',
				description: 'Status of the vouchers to retrieve. One of "50", "100", "1000".',
				type: 'number',
				default: 0,
			},
		],
	},
	{
		...
		description: 'There are a multitude of parameter which can be used to filter. A few of them are attached but for a complete list please check out <a href="https://5677.extern.sevdesk.dev/apiOverview/index.html#/doc-vouchers#filtering">this</> list. Provide filters as JSON.',
		type: 'json',
		default: {},
		displayOptions: {
			show: {
