...
export const orderFields: INodeProperties[] = [
	...
	},
	{
		...
		type: 'collection',
		placeholder: 'Add Field',
		description: 'There are a multitude of parameter which can be used to filter. A few of them are attached but for a complete list please check out <a href="https://5677.extern.sevdesk.dev/apiOverview/index.html#/doc-orders#filtering">this</> list. Provide filters as JSON.',
		default: {},
		displayOptions: {
			show: {
				resource: [
