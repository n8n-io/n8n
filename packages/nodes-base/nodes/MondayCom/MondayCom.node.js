...
import { mondayComApiPaginatedRequest, mondayComApiRequest, mondayComApiRequestAllItems, } from './GenericFunctions';
export class MondayCom {
    description = {
            ...
            try {
                ...
                if (resource === 'boardItem') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (returnAll) {
                            responseData = await mondayComApiPaginatedRequest.call(this, 'data.boards[0].groups[0].items_page', fieldsToReturn, body);
                        }
                        else {
                            body.variables.limit = this.getNodeParameter('limit', i);
                            responseData = await mondayComApiRequest.call(this, body);
                    ...
                    if (operation === 'getByColumnValue') {
                        ...
                        if (returnAll) {
                            responseData = await mondayComApiPaginatedRequest.call(this, 'data.items_page_by_column_values', fieldsToReturn, body);
                        }
                        else {
                            body.variables.limit = this.getNodeParameter('limit', i);
                            responseData = await mondayComApiRequest.call(this, body);
