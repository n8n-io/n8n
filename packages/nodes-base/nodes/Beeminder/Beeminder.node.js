...
import { NodeConnectionTypes, NodeOperationError, jsonParse, assertParamIsString, validateNodeParameters, assertParamIsNumber, assertParamIsArray, } from 'n8n-workflow';
import { createDatapoint, deleteDatapoint, getAllDatapoints, updateDatapoint, createCharge, uncleGoal, createAllDatapoints, getSingleDatapoint, getGoal, getAllGoals, getArchivedGoals, createGoal, updateGoal, refreshGoal, shortCircuitGoal, stepDownGoal, cancelStepDownGoal, getUser, } from './Beeminder.node.functions';
...
async function executeDatapointCreateAll(context, goalName, itemIndex) {
    ...
    assertParamIsArray('datapoints', parsedDatapoints, (val) => typeof val === 'object' && val !== null && 'value' in val, context.getNode());
    const data = {
        goalName,
