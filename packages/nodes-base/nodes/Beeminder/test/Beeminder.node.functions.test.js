...
import { createDatapoint, getAllDatapoints, updateDatapoint, deleteDatapoint, createCharge, uncleGoal, createAllDatapoints, getSingleDatapoint, getGoal, getAllGoals, getArchivedGoals, createGoal, updateGoal, refreshGoal, shortCircuitGoal, stepDownGoal, cancelStepDownGoal, getUser, } from '../Beeminder.node.functions';
    ...
    describe('Datapoint Operations', () => {
        describe('createDatapoint', () => {
            it('should create a datapoint with required parameters', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/users/me/goals/testgoal/datapoints.json', data, {});
        ...
        describe('getAllDatapoints', () => {
            it('should get all datapoints when count is not specified', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequestAllItems).toHaveBeenCalledWith('GET', '/users/me/goals/testgoal/datapoints.json', {}, data);
                expect(result).toBe(mockResponse);
            });
            it('should get limited datapoints when count is specified', async () => {
                ...
                const result = await getAllDatapoints.call(mockContext, data);
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals/testgoal/datapoints.json', {}, data);
                expect(result).toBe(mockResponse);
            });
        ...
        describe('updateDatapoint', () => {
            it('should update a datapoint with required parameters', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('PUT', '/users/me/goals/testgoal/datapoints/123.json', data, {});
                expect(result).toBe(mockResponse);
            });
        ...
        describe('deleteDatapoint', () => {
            it('should delete a datapoint', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('DELETE', '/users/me/goals/testgoal/datapoints/123.json');
                expect(result).toBe(mockResponse);
            });
        });
        describe('createAllDatapoints', () => {
            it('should create multiple datapoints', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/users/me/goals/testgoal/datapoints/create_all.json', { datapoints }, {});
                expect(result).toBe(mockResponse);
            });
        });
        describe('getSingleDatapoint', () => {
            it('should get a single datapoint', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals/testgoal/datapoints/123.json');
                expect(result).toBe(mockResponse);
            });
        });
    });
    describe('Goal Operations', () => {
        describe('getGoal', () => {
            it('should get a goal with basic parameters', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals/testgoal.json', {}, data);
                expect(result).toBe(mockResponse);
            });
        ...
        describe('getAllGoals', () => {
            it('should get all goals without parameters', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals.json', {}, {});
                expect(result).toBe(mockResponse);
            });
            it('should get all goals with emaciated parameter', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals.json', {}, data);
                expect(result).toBe(mockResponse);
            });
        });
        describe('getArchivedGoals', () => {
            it('should get archived goals without parameters', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals/archived.json', {}, {});
                expect(result).toBe(mockResponse);
            });
            it('should get archived goals with emaciated parameter', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals/archived.json', {}, data);
                expect(result).toBe(mockResponse);
            });
        });
        describe('createGoal', () => {
            it('should create a goal with required parameters', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/users/me/goals.json', data, {});
                expect(result).toBe(mockResponse);
            });
        ...
        describe('updateGoal', () => {
            it('should update a goal with goalName', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('PUT', '/users/me/goals/testgoal.json', data, {});
                expect(result).toBe(mockResponse);
            });
        ...
        describe('refreshGoal', () => {
            it('should refresh a goal', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me/goals/testgoal/refresh_graph.json');
                expect(result).toBe(mockResponse);
            });
        });
        describe('shortCircuitGoal', () => {
            it('should short circuit a goal', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/users/me/goals/testgoal/shortcircuit.json');
                expect(result).toBe(mockResponse);
            });
        });
        describe('stepDownGoal', () => {
            it('should step down a goal', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/users/me/goals/testgoal/stepdown.json');
                expect(result).toBe(mockResponse);
            });
        });
        describe('cancelStepDownGoal', () => {
            it('should cancel step down for a goal', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/users/me/goals/testgoal/cancel_stepdown.json');
                expect(result).toBe(mockResponse);
            });
        });
    });
    describe('Charge Operations', () => {
        describe('createCharge', () => {
            it('should create a charge with required amount', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/charges.json', {
                    user_id: 'me',
                    amount: 5,
                }, {});
                expect(result).toBe(mockResponse);
        ...
        describe('uncleGoal', () => {
            it('should uncle a goal', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('POST', '/users/me/goals/testgoal/uncleme.json');
                expect(result).toBe(mockResponse);
            });
        });
    });
    describe('User Operations', () => {
        describe('getUser', () => {
            it('should get user information', async () => {
                ...
                expect(mockedGenericFunctions.beeminderApiRequest).toHaveBeenCalledWith('GET', '/users/me.json', {}, data);
                expect(result).toBe(mockResponse);
            });
        });
    });
});
//# sourceMappingURL=Beeminder.node.functions.test.js.map