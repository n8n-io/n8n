...
export function withIntervalDefaults(interval) {
...
export function validateInterval(node, itemIndex, interval) {
    let errorMessage = '';
...
export function recurrenceCheck(recurrence, recurrenceRules, timezone) {
...
export const toCronExpression = (interval, nodeKey) => {
 ...
 */
export const toCronSource = (interval) => {
...
export function intervalToRecurrence(interval, index) {
 ...
 */
export function resetStaleRecurrence(staticData, rules) {
