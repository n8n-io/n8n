...
import { accountFields, accountOperations, appointmentFields, appointmentOperations, contactFields, contactOperations, dealFields, dealOperations, noteFields, noteOperations, salesActivityFields, salesActivityOperations, searchFields, searchOperations, taskFields, taskOperations, } from './descriptions';
import { adjustAccounts, adjustAttendees, freshworksCrmApiRequest, getAllItemsViewId, handleListing, loadResource, throwOnEmptyUpdate, } from './GenericFunctions';
export class FreshworksCrm {
    ...
    methods = {
        loadOptions: {
            ...
            async getCurrencies() {
                const response = (await freshworksCrmApiRequest.call(this, 'GET', '/selector/currencies'));
            ...
            async getUsers() {
                ...
                const response = (await freshworksCrmApiRequest.call(this, 'GET', '/selector/owners'));
                const key = Object.keys(response)[0];
