...
import { BINARY_ENCODING, deepCopy, jsonParse, NodeConnectionTypes, NodeOperationError, } from 'n8n-workflow';
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (mode === 'binaryToJson') {
                ...
                if (options.dataIsBase64 !== true) {
                    ...
                    data = iconv.encode(value, encoding, { addBOM: options.addBOM });
                }
                else {
                    data = Buffer.from(value, BINARY_ENCODING);
                }
