                ...
                try {
                    ...
                    if (protocol === 'sftp') {
                        if (operation === 'list') {
                            ...
                            const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(serializeDates ? json.map((item) => deepCopy(item)) : json), { itemData: { item: i } });
                        ...
                        if (operation === 'download') {
                            ...
                            try {
                                ...
                                items[i].binary[dataPropertyNameDownload] = await this.nodeHelpers.copyBinaryFile(binaryFile.path, basename(remoteFilePath));
