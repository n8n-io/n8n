...
describe('NocoDB Transport API', () => {
    ...
    describe('apiRequest', () => {
        it('should make a successful API request with authentication', async () => {
            ...
            expect(mockThis.helpers.httpRequestWithAuthentication).toHaveBeenCalledWith('nocoDbApiToken', {
                method: 'GET',
                qs: { param: 'value' },
    ...
    describe('downloadRecordAttachments', () => {
        it('should download attachments for records', async () => {
            ...
            expect(mockThis.helpers.prepareBinaryData).toHaveBeenCalledWith(mockFileBuffer, 'image.jpg', 'image/jpeg');
        ...
        it('should handle attachments as string (json parsed)', async () => {
            ...
            expect(mockThis.helpers.prepareBinaryData).toHaveBeenCalledWith(mockFileBuffer, 'doc.pdf', 'application/pdf');
            expect(result).toEqual([
                {
                    json: {
                        id: 1,
