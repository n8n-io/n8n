...
describe('NocoDB  base get action', () => {
    ...
    describe('execute', () => {
        it('should return data for a base and its tables', async () => {
            ...
            mockExecuteFunctions.getNodeParameter.mockReturnValue(mockBaseId);
            apiRequest.call
            ...
            expect(apiRequest.call).toHaveBeenCalledWith(expect.anything(), 'GET', `/api/v3/meta/bases/${mockBaseId}`, {}, {});
            expect(apiRequest.call).toHaveBeenCalledWith(expect.anything(), 'GET', `/api/v3/meta/bases/${mockBaseId}/tables`, {}, {});
            expect(apiRequest.call).toHaveBeenCalledWith(expect.anything(), 'GET', `/api/v3/meta/bases/${mockBaseId}/tables/table1`, {}, {});
            expect(apiRequest.call).toHaveBeenCalledWith(expect.anything(), 'GET', `/api/v3/meta/bases/${mockBaseId}/tables/table2`, {}, {});
