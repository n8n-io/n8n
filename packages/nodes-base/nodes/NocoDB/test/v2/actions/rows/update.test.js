...
describe('NocoDB Rows Update Action', () => {
    ...
    it('should create a row with autoMapInputData', async () => {
        ...
        expect(mockExecuteFunctions.getNodeParameter).toHaveBeenCalledWith('id', 0, undefined, expect.anything());
        expect(mockExecuteFunctions.getNodeParameter).toHaveBeenCalledWith('dataToSend', 0);
        expect(apiRequest.call).toHaveBeenCalledWith(expect.anything(), 'PATCH', `/api/v3/data/${mockBase}/${mockTable}/records`, [
            {
                id: '1',
                fields: mockColumnsToInsert,
            },
