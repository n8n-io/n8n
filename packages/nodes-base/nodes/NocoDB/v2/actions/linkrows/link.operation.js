...
export const description = updateDisplayOptions({
    ...
    },
    {
        ...
        required: true,
        description: 'Name of the fields of type \'link\' that will be uploaded. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
    },
    {
        ...
        try {
            ...
            for (const linkId of linkIds) {
                ...
                if (Array.isArray(linkId)) {
                    body.push.apply(body, linkId.map((id) => {
...
//# sourceMappingURL=link.operation.js.map