        ...
        loadOptions: {
            ...
            async getBases() {
                ...
                try {
                    ...
                    throw new NodeOperationError(this.getNode(), new Error(`Error while fetching ${version === 3 ? 'bases' : 'projects'}!`, {
                        cause: e,
                    }), {
                        level: 'warning',
                    });
            ...
            async getTables() {
                ...
                if (baseId) {
                    try {
                        ...
                        throw new NodeOperationError(this.getNode(), new Error('Error while fetching tables!', { cause: e }), {
                            level: 'warning',
                        });
                    }
                }
                else {
                    throw new NodeOperationError(this.getNode(), `No  ${version === 3 ? 'base' : 'project'} selected!`, {
                        level: 'warning',
                    });
                }
            },
                    ...
                    if (dataToSend === 'autoMapInputData') {
                        ...
                        for (const field of fields) {
                            if (!field.binaryData) {
                                ...
                                responseData = await apiRequest.call(this, 'POST', postUrl, {}, version === 3 ? { base_id: baseId } : { project_id: baseId }, undefined, {
                                    formData,
                                });
