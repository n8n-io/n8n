...
import { firedAlertOperations, searchConfigurationFields, searchConfigurationOperations, searchJobFields, searchJobOperations, searchResultFields, searchResultOperations, userFields, userOperations, } from './descriptions';
import { formatFeed, formatResults, formatSearch, getId, populate, setCount, splunkApiRequest, toUnixEpoch, } from './GenericFunctions';
    ...
    methods = {
        loadOptions: {
            async getRoles() {
                ...
                const responseData = (await splunkApiRequest.call(this, 'GET', endpoint));
            ...
            try {
                if (resource === 'firedAlert') {
                    ...
                    if (operation === 'delete') {
                        ...
                        const searchConfigurationId = getId.call(this, i, 'searchConfigurationId', '/search/saved/searches/'); // id endpoint differs from operation endpoint
                    ...
                    if (operation === 'create') {
                        ...
                        setCount.call(this, qs);
                        const endpoint = '/services/search/jobs';
                        responseData = (await splunkApiRequest.call(this, 'GET', endpoint, {}, qs));
