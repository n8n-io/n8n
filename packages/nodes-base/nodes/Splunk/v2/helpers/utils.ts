...
export function setReturnAllOrLimit(this: IExecuteFunctions, qs: IDataObject, i: number) {
	qs.count = this.getNodeParameter('returnAll', i) ? 0 : this.getNodeParameter('limit', i);
}
