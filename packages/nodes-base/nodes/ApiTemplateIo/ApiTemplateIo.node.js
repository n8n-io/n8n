...
import { apiTemplateIoApiRequest, downloadImage, loadResource, validateJSON, } from './GenericFunctions';
export class ApiTemplateIo {
    description = {
            ...
            if (operation === 'create') {
                ...
                for (let i = 0; i < length; i++) {
                    try {
                        ...
                        if (!jsonParameters) {
                            const overrides = this.getNodeParameter('overridesUi', i)
                                ?.overrideValues || [];
            ...
            if (operation === 'create') {
                ...
                for (let i = 0; i < length; i++) {
                    try {
                        ...
                        let data;
                        if (!jsonParameters) {
                            const properties = this.getNodeParameter('propertiesUi', i)
                                ?.propertyValues || [];
