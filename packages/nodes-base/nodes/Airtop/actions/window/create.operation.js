...
import { validateAirtopApiResponse, validateSessionId, validateUrl, validateScreenResolution, } from '../../GenericFunctions';
...
export async function execute(index) {
    ...
    if (getLiveView) {
        // Get Window info
        response = await apiRequest.call(this, 'GET', `/sessions/${sessionId}/windows/${windowId}`, undefined, {
