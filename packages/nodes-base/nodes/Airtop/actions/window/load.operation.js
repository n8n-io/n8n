import { validateRequiredStringField, validateSessionAndWindowId, validateUrl, validateAirtopApiResponse, } from '../../GenericFunctions';
...
export async function execute(index) {
    ...
    const response = await apiRequest.call(this, 'POST', `/sessions/${sessionId}/windows/${windowId}`, {
        url,
