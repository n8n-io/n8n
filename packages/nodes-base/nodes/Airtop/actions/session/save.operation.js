import { validateAirtopApiResponse, validateProfileName, validateRequiredStringField, validateSessionId, } from '../../GenericFunctions';
...
export const description = [
    ...
    },
    {
        ...profileNameField,
        required: true,
        description: 'The ID to save this session\'s <a href="https://docs.airtop.ai/guides/how-to/saving-a-profile" target="_blank">Browser Profile</a> under. A profile with this ID is created if it does not exist yet.',
        displayOptions: {
            show: {
                resource: ['session'],
                operation: ['save'],
...
export async function execute(index) {
    ...
    let profileName = validateRequiredStringField.call(this, index, 'profileName', 'Browser Profile ID');
