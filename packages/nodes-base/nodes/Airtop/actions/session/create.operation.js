...
import { createSession, validateProfileName, validateProxy, validateSaveProfileOnTermination, validateTimeoutMinutes, } from '../../GenericFunctions';
...
export async function execute(index) {
    ...
    const solveCaptcha = this.getNodeParameter('additionalFields.solveCaptcha', index, false);
