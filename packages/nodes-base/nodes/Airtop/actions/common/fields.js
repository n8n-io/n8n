...
export const profileNameField = {
    ...
    type: 'string',
    default: '',
    description: 'The Airtop browser profile ID to load or create. Newer profiles are identified by a generated UUID; older ones can use a custom name.',
 ...
 */
export const outputSchemaField = {
...
export const parseJsonOutputField = {
 ...
 */
export const elementDescriptionField = {
...
export function getSessionModeFields(resource, operations) {
    return [
        {
...
export const includeHiddenElementsField = {
