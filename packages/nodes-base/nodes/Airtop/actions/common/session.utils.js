import { validateSessionAndWindowId, createSessionAndWindow, shouldCreateNewSession, validateAirtopApiResponse, } from '../../GenericFunctions';
 ...
 */
export async function executeRequestWithSessionManagement(index, request) {
    let airtopSessionId = '';
    try {
