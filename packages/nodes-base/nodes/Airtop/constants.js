...
export const getN8NVersion = () => {
    ...
    try {
        ...
        const n8nPackageJson = jsonParse(readFileSync(packageJsonPath, 'utf8'));
...
export const AIRTOP_HOOKS_BASE_URL = process.env.AIRTOP_HOOKS_BASE_URL ?? 'https://api.airtop.ai/api/hooks';
// Session operations
...
export const ERROR_MESSAGES = {
    ...
    PROFILE_NAME_INVALID: "'Browser Profile ID' should only contain letters, numbers and dashes",
