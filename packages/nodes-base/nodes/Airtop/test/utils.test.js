...
import { createSession, createSessionAndWindow, validateProfileName, validateTimeoutMinutes, validateSaveProfileOnTermination, validateSessionAndWindowId, validateAirtopApiResponse, validateSessionId, validateUrl, validateProxy, validateRequiredStringField, shouldCreateNewSession, convertScreenshotToBinary, } from '../GenericFunctions';
...
vi.mock('../transport', async () => {
    ...
    return {
        ...originalModule,
        apiRequest: vi.fn(async (method, endpoint, params) => {
...
describe('Test Airtop utils', () => {
    describe('validateRequiredStringField', () => {
        it('should validate non-empty string field', () => {
            ...
            const result = validateRequiredStringField.call(createMockExecuteFunction(nodeParameters), 0, 'testField', 'Test Field');
        ...
        it('should throw error for empty string field', () => {
            ...
            expect(() => validateRequiredStringField.call(createMockExecuteFunction(nodeParameters), 0, 'testField', 'Test Field')).toThrow(ERROR_MESSAGES.REQUIRED_PARAMETER.replace('{{field}}', 'Test Field'));
        });
    ...
    describe('validateProfileName', () => {
        ...
        it('should throw error for invalid profile name', () => {
            ...
            expect(() => validateProfileName.call(createMockExecuteFunction(nodeParameters), 0)).toThrow(ERROR_MESSAGES.PROFILE_NAME_INVALID);
        });
    });
    describe('validateTimeoutMinutes', () => {
        ...
        it('should throw error for timeout below minimum', () => {
            ...
            expect(() => validateTimeoutMinutes.call(createMockExecuteFunction(nodeParameters), 0)).toThrow(ERROR_MESSAGES.TIMEOUT_MINUTES_INVALID);
        });
    ...
    describe('validateSaveProfileOnTermination', () => {
        it('should validate when save profile is false', () => {
            ...
            const result = validateSaveProfileOnTermination.call(createMockExecuteFunction(nodeParameters), 0, '');
        ...
        it('should validate when save profile is true with profile name', () => {
            ...
            const result = validateSaveProfileOnTermination.call(createMockExecuteFunction(nodeParameters), 0, 'test-profile');
        ...
        it('should throw error when save profile is true without profile name', () => {
            ...
            expect(() => validateSaveProfileOnTermination.call(createMockExecuteFunction(nodeParameters), 0, '')).toThrow(ERROR_MESSAGES.PROFILE_NAME_REQUIRED);
        });
    });
    describe('validateSessionId', () => {
        ...
        it('should throw error for empty session ID', () => {
            ...
            expect(() => validateSessionId.call(createMockExecuteFunction(nodeParameters), 0)).toThrow(ERROR_MESSAGES.SESSION_ID_REQUIRED);
        });
    ...
    describe('validateSessionAndWindowId', () => {
        ...
        it('should throw error for empty session ID', () => {
            ...
            expect(() => validateSessionAndWindowId.call(createMockExecuteFunction(nodeParameters), 0)).toThrow(ERROR_MESSAGES.SESSION_ID_REQUIRED);
        });
        it('should throw error for empty window ID', () => {
            ...
            expect(() => validateSessionAndWindowId.call(createMockExecuteFunction(nodeParameters), 0)).toThrow(ERROR_MESSAGES.WINDOW_ID_REQUIRED);
        });
    ...
    describe('validateUrl', () => {
        ...
        it('should throw error for invalid URL', () => {
            ...
            expect(() => validateUrl.call(createMockExecuteFunction(nodeParameters), 0)).toThrow(ERROR_MESSAGES.URL_INVALID);
        });
    ...
    describe('validateProxy', () => {
        ...
        it('should throw error for empty proxyUrl', () => {
            ...
            expect(() => validateProxy.call(createMockExecuteFunction(nodeParameters), 0)).toThrow(ERROR_MESSAGES.REQUIRED_PARAMETER.replace('{{field}}', 'Proxy URL'));
        });
    ...
    describe('createSession', () => {
        ...
        it('should throw an error if no session ID is returned', async () => {
            await expect(createSession.call(createMockExecuteFunction({}), { fail: true })).rejects.toThrow();
        });
    });
    describe('createSessionAndWindow', () => {
        it("should create a new session and window when sessionMode is 'new'", async () => {
            ...
            const result = await createSessionAndWindow.call(createMockExecuteFunction(nodeParameters), 0);
            expect(result).toEqual({
                sessionId: 'new-session-123',
