...
describe('Test Airtop, window list operation', () => {
    ...
    it('should list windows successfully', async () => {
        ...
        expect(transport.apiRequest).toHaveBeenCalledWith('GET', '/sessions/test-session-123/windows', undefined);
    ...
    it('should throw error when sessionId is empty', async () => {
        ...
        await expect(list.execute.call(createMockExecuteFunction(nodeParameters), 0)).rejects.toThrow(ERROR_MESSAGES.SESSION_ID_REQUIRED);
    });
});
