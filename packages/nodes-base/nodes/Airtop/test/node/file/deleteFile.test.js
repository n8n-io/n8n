...
describe('Test Airtop, delete file operation', () => {
    ...
    it('should throw error when fileId is empty', async () => {
        ...
        await expect(deleteFile.execute.call(createMockExecuteFunction(nodeParameters), 0)).rejects.toThrow(ERROR_MESSAGES.REQUIRED_PARAMETER.replace('{{field}}', 'File ID'));
    });
});
//# sourceMappingURL=deleteFile.test.js.map