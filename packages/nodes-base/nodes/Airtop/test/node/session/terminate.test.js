...
describe('Test Airtop, session terminate operation', () => {
    ...
    it('should throw error when sessionId is empty', async () => {
        ...
        await expect(terminate.execute.call(createMockExecuteFunction(nodeParameters), 0)).rejects.toThrow(ERROR_MESSAGES.SESSION_ID_REQUIRED);
    });
...
//# sourceMappingURL=terminate.test.js.map