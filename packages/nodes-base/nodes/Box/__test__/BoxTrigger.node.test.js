...
const mockedVerifySignature = verifySignature;
describe('Box Trigger Webhook Lifecycle', () => {
    const mockHookFunctions = mock();
    ...
    beforeEach(() => {
        ...
        mockHookFunctions.getNodeParameter.mockImplementation((parameterName) => {
    ...
    describe('create', () => {
        it('should create a new webhook and store its ID', async () => {
            ...
            expect(mockRequestOAuth2).toHaveBeenCalledWith(expect.anything(), expect.objectContaining({
                method: 'POST',
...
describe('Box Trigger webhook()', () => {
    ...
    beforeEach(() => {
        ...
        mockWebhookFunctions.getResponseObject.mockReturnValue(mockResponseObject);
...
//# sourceMappingURL=BoxTrigger.node.test.js.map