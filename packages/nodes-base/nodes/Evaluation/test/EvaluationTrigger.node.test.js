    ...
    describe('execute', () => {
        describe('without filters', () => {
            beforeEach(() => {
                ...
                vi.spyOn(GoogleSheet.prototype, 'getData').mockImplementation(async (range) => {
    ...
    describe('customOperations.dataset.getRows', () => {
        describe('Data tables', () => {
            ...
            test('should return the rows with limits applied, without filters', async () => {
                ...
                const result = await new EvaluationTrigger().customOperations.dataset.getRows.call(mockExecuteFunctions);
        ...
        describe('Google Sheets', () => {
            ...
            test('should return all relevant rows from google sheet using filters', async () => {
                ...
                vi.spyOn(utils, 'getRowsLeft').mockResolvedValue(0);
                const evaluationTrigger = new EvaluationTrigger();
                const result = await evaluationTrigger.customOperations.dataset.getRows.call(mockExecuteFunctions);
                expect(result).toEqual([
                    [
                        {
...
//# sourceMappingURL=EvaluationTrigger.node.test.js.map