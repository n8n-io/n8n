...
import { CORRECTNESS_PROMPT, CORRECTNESS_INPUT_PROMPT, HELPFULNESS_PROMPT, HELPFULNESS_INPUT_PROMPT, } from './CannedMetricPrompts.ee';
import { document, sheet } from '../../Google/Sheet/GoogleSheetsTrigger.node';
export const setInputsProperties = [
    {
...
export const setOutputProperties = [
    {
...
export const setCheckIfEvaluatingProperties = [
    {
...
export const setMetricsProperties = [
    {
