...
export const epicFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		name: 'projectId',
		description:
			'ID of the project to which the epic belongs. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
		type: 'options',
		typeOptions: {
		...
		options: [
			{
				...
				default: '',
				description:
					'ID of the user to assign the epic to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
		...
		options: [
			{
				...
				default: '',
				description:
					'ID of the user whom the epic is assigned to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
	...
	// ----------------------------------------
	{
		...
		default: '',
		description:
			'ID of the project to set the epic to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['epic'],
				operation: ['update'],
		...
		options: [
			{
				...
				default: '',
				description:
					'ID of the user to whom the epic is assigned. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
				displayName: 'Blocked Note',
				name: 'blocked_note',
