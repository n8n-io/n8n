...
export const userStoryFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		name: 'projectId',
		description:
			'ID of the project to which the user story belongs. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
		type: 'options',
		typeOptions: {
		...
		options: [
			{
				...
				default: '',
				description:
					'ID of the user to whom the user story is assigned. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				default: '',
				description:
					'ID of the milestone of the user story. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				default: '',
				description:
					'ID of the status of the user story. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
		...
		options: [
			{
				...
				name: 'assigned_to',
				description:
					'ID of the user whom the user story is assigned to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
				type: 'options',
				typeOptions: {
					loadOptionsDependsOn: ['projectId'],
					loadOptionsMethod: 'getUsers',
			...
			},
			{
				...
				name: 'epic',
				description:
					'ID of the epic to which the user story belongs. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
				type: 'options',
				typeOptions: {
					loadOptionsDependsOn: ['projectId'],
	...
	// ----------------------------------------
	{
		...
		default: '',
		description:
			'ID of the project to set the user story to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['userStory'],
				operation: ['update'],
		...
		options: [
			{
				...
				default: '',
				description:
					'ID of the user to assign the the user story to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
				displayName: 'Backlog Order',
				name: 'backlog_order',
