					...
					for (let i = 0; i < length; i++) {
						if (resource === 'customer') {
							...
							if (operation === 'create') {
								...
								const body = { email: this.getNodeParameter('email', i) } as IDataObject;
								...
								const qs: IDataObject = { force: true }; // required, customers do not support trashing
