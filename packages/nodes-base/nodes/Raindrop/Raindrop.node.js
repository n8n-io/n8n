...
import { bookmarkFields, bookmarkOperations, collectionFields, collectionOperations, tagFields, tagOperations, userFields, userOperations, } from './descriptions';
                ...
                if (resource === 'bookmark') {
                    ...
                    if (operation === 'create') {
                        ...
                        if (updateFields.cover) {
                            ...
                            responseData = await raindropApiRequest.call(this, 'PUT', requestEndpoint, {}, {}, { 'Content-Type': 'multipart/form-data', formData });
                            responseData = responseData.item;
                        }
                    }
                }
