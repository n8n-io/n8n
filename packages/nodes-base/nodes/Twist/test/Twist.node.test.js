...
describe('Twist Node - prepareBinariesDataList usage', () => {
    ...
    beforeEach(() => {
        ...
        GenericFunctions.twistApiRequest.mockResolvedValue({
            id: 'test-id',
        });
    });
    describe('comment create with string binaryProperties', () => {
        it('should process comma-separated string binaryProperties', async () => {
            ...
            mockExecuteFunctions.helpers.getBinaryDataBuffer.mockResolvedValue(Buffer.from('test data'));
    ...
    describe('comment create with IBinaryData[] binaryProperties', () => {
        it('should process IBinaryData array', async () => {
            ...
            mockExecuteFunctions.helpers.assertBinaryData.mockImplementation((_, data) => {
...
//# sourceMappingURL=Twist.node.test.js.map