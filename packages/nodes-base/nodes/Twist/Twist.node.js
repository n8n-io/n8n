...
import { messageConversationFields, messageConversationOperations, } from './MessageConversationDescription';
                ...
                if (resource === 'comment') {
                    ...
                    if (operation === 'create') {
                        ...
                        if (body.binaryProperties) {
                            const binaryProperties = prepareBinariesDataList(body.binaryProperties);
                            const attachments = [];
                            for (const binaryProperty of binaryProperties) {
                                ...
                                attachments.push((await twistApiRequest.call(this, 'POST', '/attachments/upload', {}, {}, {
                                    formData: {
                                        file_name: {
                                            value: dataBuffer,
                                            options: {
