		...
		options: [
			{
				...
				action: 'Create a message conversation',
			},
			{
				name: 'Delete',
				value: 'delete',
				description: 'Delete a message in a conversation',
				action: 'Delete a message conversation',
			},
			{
				name: 'Get',
				value: 'get',
				description: 'Get a message in a conversation',
				action: 'Get a message conversation',
			},
			{
				name: 'Get All',
				value: 'getAll',
				description: 'Get all messages in a conversation',
				action: 'Get all message conversations',
			},
			{
				name: 'Update',
				value: 'update',
				description: 'Update a message in a conversation',
				action: 'Update a message conversation',
			},
		],
		default: 'create',
	},
