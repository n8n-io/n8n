...
describe('Search Functions', () => {
    ...
    describe('getUsers', () => {
        it('should fetch users', async () => {
            ...
            mockLoadOptionsFunctions.helpers.requestWithAuthentication.mockResolvedValue(responseData);
            ...
            expect(mockLoadOptionsFunctions.helpers.requestWithAuthentication).toHaveBeenCalledWith('githubOAuth2Api', expect.objectContaining({
                method: 'GET',
    ...
    describe('getRepositories', () => {
        it('should fetch repositories', async () => {
            ...
            mockLoadOptionsFunctions.getCurrentNodeParameter.mockReturnValue(owner);
            mockLoadOptionsFunctions.helpers.requestWithAuthentication.mockResolvedValue(responseData);
    ...
    describe('getWorkflows', () => {
        it('should fetch workflows', async () => {
            ...
            mockLoadOptionsFunctions.getCurrentNodeParameter
    ...
    describe('getRefs', () => {
        it('should fetch branches and tags using git/refs endpoint', async () => {
            ...
            mockLoadOptionsFunctions.helpers.requestWithAuthentication.mockResolvedValue(refsResponse);
