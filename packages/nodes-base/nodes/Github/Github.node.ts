...

			{
				...
				options: [
					...
					},
					{
						...
						action: 'Create Comment an issue',
					},
					{
						name: 'Edit',
						value: 'edit',
				...
				options: [
					{
						...
						action: 'Get Repositories a user',
					},
					{
						name: 'Invite',
						value: 'invite',
