...
import { getFileSha, githubApiRequest, githubApiRequestAllItems, isBase64, validateJSON, } from './GenericFunctions';
...
export class Github {
    ...
    async execute() {
        ...
        if (resource === 'workflow' && operation === 'dispatchAndWait') {
            ...
            const inputs = validateJSON(this.getNodeParameter('inputs', 0));
            if (!inputs) {
            ...
            try {
                ...
                if (error.httpCode === '404' || error.statusCode === 404) {
                    throw new NodeOperationError(this.getNode(), 'The workflow to dispatch could not be found. Adjust the "workflow" parameter setting to dispatch the workflow correctly.', { itemIndex: 0 });
                }
            ...
            try {
                ...
                if (resource === 'file') {
                    ...
                    if (operation === 'create') {
                        ...
                        const responseText = await githubApiRequest.call(this, 'GET', `/repos/${owner}/${repository}/pulls/${pullRequestNumber}`, {}, {}, options);
                    ...
                    if (operation === 'dispatch') {
                        ...
                        body.ref = ref;
                        const inputs = validateJSON(this.getNodeParameter('inputs', i));
                        if (inputs === undefined) {
                            throw new NodeOperationError(this.getNode(), 'Inputs: Invalid JSON', {
                                itemIndex: i,
                            });
