            ...
            try {
                if (resource === 'category') {
                    ...
                    if (operation === 'update') {
                        ...
                        responseData = await discourseApiRequest.call(this, 'PUT', `/categories/${categoryId}.json`, body);
                        responseData = responseData.category;
                    }
                }
                if (resource === 'group') {
                ...
                if (resource === 'post') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        while (lastPost.id !== previousLastPostID) {
                            ...
                            const chunk = await discourseApiRequest.call(this, 'GET', `/posts.json?before=${lastPost.id}`, {}, qs);
                    ...
                    if (operation === 'update') {
                        ...
                        Object.assign(body, updateFields);
                        responseData = await discourseApiRequest.call(this, 'PUT', `/posts/${postId}.json`, body);
                ...
                if (resource === 'user') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        responseData = await discourseApiRequest.call(this, 'GET', `/admin/users/list/${flag}.json`, {}, qs);
                        if (!returnAll) {
                            const limit = this.getNodeParameter('limit', i);
                            responseData = responseData.splice(0, limit);
                        }
                ...
                if (resource === 'userGroup') {
                    ...
                    if (operation === 'add') {
                        ...
                        responseData = await discourseApiRequest.call(this, 'PUT', `/groups/${groupId}/members.json`, body);
                    }
                    ...
                    if (operation === 'remove') {
                        ...
                        responseData = await discourseApiRequest.call(this, 'DELETE', `/groups/${groupId}/members.json`, body);
                    }
                }
