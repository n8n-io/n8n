		...
		options: [
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether provided, returned timeentry\'s duration will be rounded to minutes or seconds based on duration format (hh:mm or hh:mm:ss) from workspace settings',
			},
			{
