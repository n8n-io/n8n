...
import { balanceOperations, chargeFields, chargeOperations, couponFields, couponOperations, customerCardFields, customerCardOperations, customerFields, customerOperations, meterEventFields, meterEventOperations, sourceFields, sourceOperations, tokenFields, tokenOperations, } from './descriptions';
import { adjustChargeFields, adjustCustomerFields, adjustMetadata, handleListing, loadResource, stripeApiRequest, } from './helpers';
export class Stripe {
    description = {
        displayName: 'Stripe',
        name: 'stripe',
            ...
            try {
                if (resource === 'balance') {
                    ...
                    if (operation === 'create') {
                        ...
                        responseData = await stripeApiRequest.call(this, 'POST', '/billing/meter_events', body, {});
                    }
                }
            }
            catch (error) {
