...
describe('Mailjet Node', () => {
    ...
    beforeEach(() => {
        ...
        mockExecuteFunctions = mockDeep({
            helpers: {
                ...
                returnJsonArray: vi
                    .fn()
                    .mockImplementation((data) => Array.isArray(data) ? data.map((item) => ({ json: item })) : [{ json: data }]),
            },
        });
        vi.clearAllMocks();
    ...
    describe('Email Resource - Send Operation', () => {
        ...
        it('should send email with customCampaign field', async () => {
            ...
            expect(mailjetApiRequestSpy).toHaveBeenCalledWith('POST', '/v3.1/send', expect.objectContaining({
    ...
    describe('Multiple Items Processing', () => {
        it('should handle multiple items with different customCampaign values', async () => {
            ...
            mockExecuteFunctions.getNodeParameter.mockImplementation((paramName, index) => {
            ...
            expect(mailjetApiRequestSpy).toHaveBeenNthCalledWith(1, 'POST', '/v3.1/send', expect.objectContaining({
                Messages: expect.arrayContaining([
                    expect.objectContaining({
                        CustomCampaign: 'campaign-1',
                        DeduplicateCampaign: true,
            ...
            expect(mailjetApiRequestSpy).toHaveBeenNthCalledWith(2, 'POST', '/v3.1/send', expect.objectContaining({
                Messages: expect.arrayContaining([
                    expect.objectContaining({
                        CustomCampaign: 'campaign-2',
                    }),
...
//# sourceMappingURL=Mailjet.node.test.js.map