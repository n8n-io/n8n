	...
	},
	{
		...
		options: [
						...
						values: [
							{
								...
								default: '',
								description:
									'Custom field ID. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
							},
							{
								displayName: 'Value',
								name: 'value',
			...
			},
			{
				...
				default: '',
				description:
					'The group this ticket is assigned to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				default: [],
				description:
					'The array of tags applied to this ticket. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
				displayName: 'Type',
				name: 'type',
		...
		options: [
			{
				...
				default: '',
				description:
					'The group to search. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
				displayName: 'Query',
				name: 'query',
