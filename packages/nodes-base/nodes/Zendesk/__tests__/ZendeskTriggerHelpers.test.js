...
describe('ZendeskTriggerHelpers', () => {
    describe('verifySignature', () => {
        ...
        beforeEach(() => {
            mockWebhookFunctions = {
                ...
                getHeaderData: vi.fn().mockReturnValue({
                    'x-zendesk-webhook-signature': generateValidSignature(testTimestamp, testBody, testWebhookSecret),
        ...
        it('should handle different timestamp formats', () => {
            ...
            const validSignature = generateValidSignature(differentTimestamp, testBody, testWebhookSecret);
            mockWebhookFunctions.getHeaderData.mockReturnValue({
        ...
        it('should handle complex JSON body with special characters', () => {
            const complexBody = '{"ticket":{"id":"123","subject":"Test with émojis 🎉 and spëcial chars"}}';
...
//# sourceMappingURL=ZendeskTriggerHelpers.test.js.map