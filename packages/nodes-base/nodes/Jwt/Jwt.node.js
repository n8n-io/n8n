        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            try {
                if (operation === 'sign') {
                    ...
                    let payload = {};
                    if (useJson) {
                        payload = parseJsonParameter(this.getNodeParameter('claimsJson', itemIndex), this.getNode(), itemIndex);
                    }
                    else {
                    ...
                    const headerClaims = parseJsonParameter(this.getNodeParameter('headerClaims', itemIndex, {}), this.getNode(), itemIndex);
