    ...
    methods = {
        loadOptions: {
            ...
            async getPublications() {
                ...
                const publications = await mediumApiRequest.call(this, 'GET', `/users/${userId}/publications`);
            ...
            try {
                ...
                if (resource === 'post') {
                    ...
                    if (operation === 'create') {
                        ...
                        if (underPublication) {
                            ...
                            responseData = await mediumApiRequest.call(this, 'POST', `/publications/${publicationId}/posts`, bodyRequest, qs);
                        }
                        else {
                            const responseAuthorId = await mediumApiRequest.call(this, 'GET', '/me', {}, qs);
                            const authorId = responseAuthorId.data.id;
                            responseData = await mediumApiRequest.call(this, 'POST', `/users/${authorId}/posts`, bodyRequest, qs);
                ...
                if (resource === 'publication') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        const userId = user.data.id;
                        //Get all publications of that user
                        responseData = await mediumApiRequest.call(this, 'GET', `/users/${userId}/publications`);
                        responseData = responseData.data;
                        if (!returnAll) {
