    ...
    },
    {
        ...
        options: [
                        ...
                        values: [
                            {
                                ...
                                type: 'string',
                                default: 'Email',
                                description: 'The field to filter by. The special fields listed above such as phone, email, defaultmail etc. cannot be queried by filter, but "Email" and "Telefon1" will work.',
                            },
                            {
            ...
            },
            {
                ...
                default: 0,
                description: 'Offset of the list, that means from which data record onwards the list should be output',
            },
            {
                displayName: 'Sort by',
                name: 'sortby',
            ...
            },
            {
                ...
                default: '',
                description: 'Causes the field "Land" to be displayed as a ISO-3166-2 or ISO-3166-3 country code',
            },
        ]
    }
];
