        ...
        for (let i = 0; i < length; i++) {
            try {
                if (resource === 'chat') {
                    ...
                    if (operation === 'get') {
                        const subscriptionsResponse = (await rocketchatApiRequest.call(this, '/subscriptions', 'GET', 'get', {}));
                        responseData = [
                    ...
                    if (operation === 'messages') {
                        ...
                        const qs = { roomId };
                        if (returnAll) {
                            responseData = await rocketchatApiRequestAllItems.call(this, 'messages', '/dm', 'GET', 'messages', {}, qs);
                        }
                        else {
                            qs.count = this.getNodeParameter('limit', i);
                            const messagesResponse = (await rocketchatApiRequest.call(this, '/dm', 'GET', 'messages', {}, qs));
