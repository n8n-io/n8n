import { dimensionDropdown, dimensionFilterField, metricDropdown, metricsFilterField, } from './FiltersDescription';
import { checkDuplicates, defaultEndDate, defaultStartDate, prepareDateRange, processFilters, simplifyGA4, } from '../../helpers/utils';
        ...
        if (expression) {
            body.dimensionFilter = {
                [filterExpressionType]: {
                    expressions: processFilters(expression),
                },
            };
        }
    }
