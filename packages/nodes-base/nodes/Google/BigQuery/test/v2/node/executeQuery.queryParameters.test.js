    ...
    nock('https://bigquery.googleapis.com/bigquery')
        ...
        configuration: {
            query: {
                ...
                query: 'SELECT * FROM bigquery_node_dev_test_dataset.test_json WHERE email = @email AND name = @name AND n8n_variable = @n8n_variable;',
                useLegacySql: false,
                parameterMode: 'NAMED',
            },
        },
...
//# sourceMappingURL=executeQuery.queryParameters.test.js.map