...
export async function execute() {
    ...
    const schema = (await googleBigQueryApiRequest.call(this, 'GET', `/v2/projects/${projectId}/datasets/${datasetId}/tables/${tableId}`, {})).schema;
    if (schema === undefined) {
    ...
    for (let i = 0; i < rows.length; i += batchSize) {
        ...
        body.rows = batch;
        const responseData = await googleBigQueryApiRequest.call(this, 'POST', `/v2/projects/${projectId}/datasets/${datasetId}/tables/${tableId}/insertAll`, body);
        ...
        const executionData = this.helpers.constructExecutionMetaData(wrapData(responseData), { itemData });
