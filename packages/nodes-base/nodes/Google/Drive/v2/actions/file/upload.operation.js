...
import { getItemBinaryData, setFileProperties, setUpdateCommonParams, setParentFolder, processInChunks, } from '../../helpers/utils';
...
export async function execute(i) {
    ...
    const { contentLength, fileContent, originalFilename, mimeType } = await getItemBinaryData.call(this, inputDataFieldName, i);
    ...
    if (Buffer.isBuffer(fileContent)) {
        ...
        const response = await googleApiRequest.call(this, 'POST', '/upload/drive/v3/files', multiPartBody.getBuffer(), {
        ...
        const resumableUpload = await googleApiRequest.call(this, 'POST', '/upload/drive/v3/files', metadata, {
    ...
    const response = await googleApiRequest.call(this, 'PATCH', `/drive/v3/files/${uploadId}`, body, qs);
