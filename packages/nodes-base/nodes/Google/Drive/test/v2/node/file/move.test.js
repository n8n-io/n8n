...
describe('test GoogleDriveV2: file move', () => {
    it('should be called with', async () => {
        ...
        expect(transport.googleApiRequest).toHaveBeenCalledWith('GET', '/drive/v3/files/fileIDxxxxxx', undefined, {
            corpora: 'allDrives',
            fields: 'parents',
        ...
        expect(transport.googleApiRequest).toHaveBeenCalledWith('PATCH', '/drive/v3/files/fileIDxxxxxx', undefined, {
