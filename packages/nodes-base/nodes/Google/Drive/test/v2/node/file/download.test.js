...
describe('test GoogleDriveV2: file download', () => {
    ...
    it('should be called with', async () => {
        ...
        expect(transport.googleApiRequest).toHaveBeenCalledWith('GET', '/drive/v3/files/fileIDxxxxxx', {}, { fields: 'mimeType,name', supportsTeamDrives: true, supportsAllDrives: true });
        expect(transport.googleApiRequest).toHaveBeenCalledWith('GET', '/drive/v3/files/fileIDxxxxxx', {}, { alt: 'media', supportsAllDrives: true }, undefined, { encoding: 'arraybuffer', json: false, returnFullResponse: true, useStream: true });
    });
    it('should export Google Docs as Markdown', async () => {
        ...
        expect(transport.googleApiRequest).toHaveBeenNthCalledWith(2, 'GET', '/drive/v3/files/fileIDxxxxxx/export', {}, { mimeType: 'text/markdown', supportsAllDrives: true }, undefined, { encoding: 'arraybuffer', json: false, returnFullResponse: true, useStream: true });
    });
    it('should export Google Sheets with a supported format by default', async () => {
        ...
        await download.execute.call(fakeExecuteFunction, 0, { json: {} });
        expect(transport.googleApiRequest).toHaveBeenCalledTimes(2);
        expect(transport.googleApiRequest).toHaveBeenNthCalledWith(2, 'GET', '/drive/v3/files/fileIDxxxxxx/export', {}, {
            mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
            supportsAllDrives: true,
        }, undefined, { encoding: 'arraybuffer', json: false, returnFullResponse: true, useStream: true });
    });
});
