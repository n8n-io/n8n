...
describe('test GoogleDriveV2: drive update', () => {
    it('should be called with', async () => {
        ...
        expect(transport.googleApiRequest).toHaveBeenCalledWith('PATCH', '/drive/v3/drives/sharedDriveIDxxxxx', { colorRgb: '#F4BEBE', name: 'newName', restrictions: { driveMembersOnly: true } });
    });
});
