...
describe('test GoogleDriveV2: folder share', () => {
    it('should be called with', async () => {
        ...
        expect(transport.googleApiRequest).toHaveBeenCalledWith('POST', '/drive/v3/files/folderIDxxxxxx/permissions', { allowFileDiscovery: true, role: 'reader', type: 'anyone' }, { moveToNewOwnersRoot: true, supportsAllDrives: true });
    });
});
