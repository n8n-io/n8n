...
describe('test GoogleDriveV2: file createFromText', () => {
    it('should be called with', async () => {
        ...
        expect(transport.googleApiRequest).toHaveBeenCalledWith('POST', '/upload/drive/v3/files', expect.anything(), // Buffer of content goes here
        { uploadType: 'multipart', supportsAllDrives: true }, undefined, {
            headers: {
                'Content-Length': 503,
                'Content-Type': expect.stringMatching(/^multipart\/related; boundary=(\\S)*/),
            },
        });
        expect(transport.googleApiRequest).toHaveBeenCalledWith('PATCH', '/drive/v3/files/42', {
...
//# sourceMappingURL=createFromText.test.js.map