...
export async function apiRequest(method, resource, body = {}, qs = {}, uri, headers = {}, option = {}, service = 'sheetV2') {
...
export async function apiRequestAllItems(propertyName, method, endpoint, body = {}, query = {}, uri) {
    const returnData = [];
    let responseData;
