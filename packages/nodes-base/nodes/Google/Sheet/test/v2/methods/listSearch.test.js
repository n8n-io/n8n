...
describe('Google Sheets Search Functions', () => {
    ...
    describe('spreadSheetsSearch', () => {
        it('should return search results without filter', async () => {
            ...
            const result = await spreadSheetsSearch.call(mockLoadOptionsFunctions);
            expect(apiRequest.call).toHaveBeenCalledWith(mockLoadOptionsFunctions, 'GET', '', {}, {
        ...
        it('should handle search with filter', async () => {
            ...
            apiRequest.call.mockResolvedValue(mockResponse);
            const result = await spreadSheetsSearch.call(mockLoadOptionsFunctions, 'Test');
            expect(apiRequest.call).toHaveBeenCalledWith(mockLoadOptionsFunctions, 'GET', '', {}, {
        ...
        it('should escape single quotes in filter', async () => {
            ...
            apiRequest.call.mockResolvedValue(mockResponse);
            await spreadSheetsSearch.call(mockLoadOptionsFunctions, "Test's Sheet");
            expect(apiRequest.call).toHaveBeenCalledWith(expect.anything(), 'GET', '', {}, expect.objectContaining({
        ...
        it('should handle pagination token', async () => {
            const mockResponse = { files: [] };
            apiRequest.call.mockResolvedValue(mockResponse);
            await spreadSheetsSearch.call(mockLoadOptionsFunctions, undefined, 'page-token');
            expect(apiRequest.call).toHaveBeenCalledWith(expect.anything(), 'GET', '', {}, expect.objectContaining({
    ...
    describe('sheetsSearch', () => {
        it('should return empty results when no documentId is provided', async () => {
            ...
            const result = await sheetsSearch.call(mockLoadOptionsFunctions);
        ...
        it('should return sheets list for valid spreadsheet', async () => {
            ...
            apiRequest.call.mockResolvedValue(mockResponse);
            const result = await sheetsSearch.call(mockLoadOptionsFunctions);
            expect(apiRequest.call).toHaveBeenCalledWith(mockLoadOptionsFunctions, 'GET', '/v4/spreadsheets/spreadsheet-id', {}, { fields: 'sheets.properties' });
        ...
        it('should throw error when no data is returned', async () => {
            ...
            apiRequest.call.mockResolvedValue(undefined);
            const promise = sheetsSearch.call(mockLoadOptionsFunctions);
