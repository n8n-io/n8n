...
describe('GoogleSheetsTrigger', () => {
    ...
    describe('anyUpdate event', () => {
        ...
        const buildPreviousRevisionBuffer = (rows) => {
                ...
                revisions: [
                    {
                        id: '2',
                        exportLinks: {
                            'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet': 'https://example.com/export/current',
                        },
                    },
                ],
            });
    ...
    describe('node description', () => {
        ...
        it('should gate the googleApi credential behind the serviceAccount auth option', () => {
            const googleApi = description.credentials?.find((credential) => credential.name === 'googleApi');
        ...
        it('should gate the OAuth2 credential behind the triggerOAuth2 auth option', () => {
            const oauth2 = description.credentials?.find((credential) => credential.name === 'googleSheetsTriggerOAuth2Api');
        ...
        it('should register the googleApi credential test method', () => {
            expect(new GoogleSheetsTrigger().methods.credentialTest.googleApiCredentialTest).toBeDefined();
        });
    });
});
//# sourceMappingURL=GoogleSheetsTrigger.test.js.map