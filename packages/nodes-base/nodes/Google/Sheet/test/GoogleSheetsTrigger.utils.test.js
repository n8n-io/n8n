...
import { BINARY_MIME_TYPE, arrayOfArraysToJson, compareRevisions, getRevisionFile, sheetBinaryToArrayOfArrays, } from '../GoogleSheetsTrigger.utils';
...
describe('GoogleSheetsTrigger.utils', () => {
    ...
    describe('BINARY_MIME_TYPE', () => {
        it('should have correct Excel mime type', () => {
            expect(BINARY_MIME_TYPE).toBe('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
        });
    });
    describe('getRevisionFile', () => {
        it('should make correct API call and return buffer', async () => {
            ...
            const result = await getRevisionFile.call(mockPollFunctions, exportLink);
            expect(apiRequest.call).toHaveBeenCalledWith(mockPollFunctions, 'GET', '', undefined, { mimeType: BINARY_MIME_TYPE }, exportLink, undefined, {
        ...
        it('should handle API request errors', async () => {
            ...
            await expect(getRevisionFile.call(mockPollFunctions, exportLink)).rejects.toThrow('API request failed');
        });
    });
    ...
    describe('compareRevisions', () => {
        ...
        it('should detect row updates with current output', () => {
            ...
            const result = compareRevisions(previousData, currentData, 1, // keyRow
        ...
        it('should watch only specific columns when specified', () => {
            ...
            const result = compareRevisions(previousForColumnTest, currentForColumnTest, 1, // keyRow
            'current', // includeInOutput
        ...
        it('should handle rowUpdate event by ignoring empty previous rows', () => {
            ...
            const result = compareRevisions(previousWithEmpty, currentWithData, 1, // keyRow
            'current', // includeInOutput
            [], // columnsToWatch
            0, // dataStartIndex
            'rowUpdate');
        ...
        it('should handle different sheet sizes by padding shorter arrays', () => {
            ...
            const result = compareRevisions(shorterPrevious, longerCurrent, 1, // keyRow
            'current', // includeInOutput
            [], // columnsToWatch
            0, // dataStartIndex
            'anyUpdate');
        ...
        it('should skip the key row when comparing data', () => {
            ...
            const result = compareRevisions(dataWithKeyRowInMiddle, currentWithKeyRowInMiddle, 2, // keyRow at index 1
            'current', [], 0, 'anyUpdate');
            expect(result).toEqual([
                {
                    row_number: 1,
...
//# sourceMappingURL=GoogleSheetsTrigger.utils.test.js.map