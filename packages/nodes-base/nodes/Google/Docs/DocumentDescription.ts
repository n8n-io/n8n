		...
		options: [
			{
				...
				values: [
					...
					// delete positioned object
					{
						...
						type: 'string',
						description:
							'The ID of the positioned object to delete (An object that is tied to a paragraph and positioned relative to its beginning), See the Google <a href="https://developers.google.com/workspace/docs/api/reference/rest/v1/documents#positionedobject">documentation</a>',
						default: '',
						displayOptions: {
							show: {
								object: ['positionedObject'],
