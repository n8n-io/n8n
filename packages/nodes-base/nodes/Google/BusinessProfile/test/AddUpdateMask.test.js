...
describe('GenericFunctions - addUpdateMask', () => {
    ...
    it('should add updateMask with mapped properties to the query string', async () => {
        ...
        const result = await addUpdateMaskPresend.call(mockContext, opts);
        expect(result.qs).toEqual({
            updateMask: 'topicType,callToAction.url,event.schedule.startDate,event.schedule.startTime,offer.couponCode',
        });
    });
...
//# sourceMappingURL=AddUpdateMask.test.js.map