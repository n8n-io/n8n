			...
			[
				{
					json: {
						date: '2024-08-31T00:00:00.000Z',
						from: {
							html: '<span class="mp_address_group"><span class="mp_address_name">From</span> &lt;<a href="mailto:from@example.com" class="mp_address_email">from@example.com</a>&gt;</span>',
							text: '"From" <from@example.com>',
						...
						threadId: 'testThreadId',
						to: {
							html: '<span class="mp_address_group"><span class="mp_address_name">To</span> &lt;<a href="mailto:to@example.com" class="mp_address_email">to@example.com</a>&gt;</span>',
							text: '"To" <to@example.com>',
