        ...
        beforeAll(() => {
            gmailNock
                ...
                try {
                    ...
                    parsedBody.message.raw = Buffer.from(mail
                        .replace(/boundary=".*"/g, 'boundary="--test-boundary"')
                        .replace(/----.*/g, '----test-boundary')
                        .replace(/Message-ID:.*/g, 'Message-ID: <test-message-id@mail.com>'), 'utf-8').toString('base64');
                ...
                return (typeof body.message?.raw === 'string' && body.message.threadId === 'test-thread-id');
            })
                .query({ userId: 'me', uploadType: 'media' })
                .reply(200, messages[0]);
    ...
    describe('Threads', () => {
        ...
        beforeAll(() => {
            ...
            gmailNock
                ...
                .query((query) => {
                return (query.includeSpamTrash === 'true' &&
                    query.labelIds === 'CHAT' &&
                    !!query.q &&
...
//# sourceMappingURL=GmailV2.node.test.js.map