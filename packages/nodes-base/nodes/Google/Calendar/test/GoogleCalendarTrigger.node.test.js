...
describe('GoogleCalendarTrigger', () => {
    ...
    describe('Poll Function - Parameter Validation', () => {
        ...
        it('should throw error when calendarId is empty', async () => {
            ...
            await expect(trigger.poll.call(mockPollFunctions)).rejects.toThrow('Please select a calendar');
        });
    });
    describe('Poll Function - Event Created Trigger', () => {
        ...
        it('should fetch events and filter by created date', async () => {
            ...
            expect(googleApiRequestAllItemsSpy).toHaveBeenCalledWith('items', 'GET', '/calendar/v3/calendars/test%40example.com/events', {}, expect.objectContaining({
                showDeleted: false,
                orderBy: 'updated',
            }));
    ...
    describe('Poll Function - Manual Mode', () => {
        ...
        it('should fetch single event in manual mode', async () => {
            ...
            const result = await trigger.poll.call(mockPollFunctions);
            expect(googleApiRequestSpy).toHaveBeenCalledWith('GET', '/calendar/v3/calendars/test%40example.com/events', {}, expect.objectContaining({
                maxResults: 1,
            }));
            expect(result).toBeDefined();
            expect(result[0]).toHaveLength(1);
...
//# sourceMappingURL=GoogleCalendarTrigger.node.test.js.map