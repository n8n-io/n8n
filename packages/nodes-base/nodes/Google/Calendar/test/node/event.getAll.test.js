...
vi.mock('../../GenericFunctions', async () => {
    ...
    return {
        ...
        addNextOccurrence: vi.fn(function (data) {
            return data;
        }),
    };
});
describe('Google Calendar Node', () => {
    ...
    describe('Google Calendar > Event > Get Many', () => {
        it('should configure get all request parameters in version 1.3', async () => {
            ...
            expect(genericFunctions.googleApiRequestAllItems).toHaveBeenCalledWith('items', 'GET', '/calendar/v3/calendars/myCalendar/events', {}, {
                iCalUID: 'uid',
                maxAttendees: 25,
                orderBy: 'startTime',
                q: 'test query',
        ...
        it('should configure get all recurringEventHandling equals next in version 1.3', async () => {
            ...
            expect(genericFunctions.googleApiRequestWithRetries).toHaveBeenCalledWith(expect.objectContaining({
                method: 'GET',
                itemIndex: 0,
...
//# sourceMappingURL=event.getAll.test.js.map