...
export const documentFields = [
    ...
    },
    {
        ...
        description: 'JSON query to execute. Use $1, $2, and so on as complete values to reference Query Parameters below.',
        hint: 'Use query parameters for dynamic values instead of embedding expressions in the query',
        required: true,
        placeholder: '{"structuredQuery": {"where": {"fieldFilter": {"field": {"fieldPath": "age"},"op": "EQUAL", "value": {"integerValue": "$1"}}}, "from": [{"collectionId": "users-collection"}]}}',
    },
    {
