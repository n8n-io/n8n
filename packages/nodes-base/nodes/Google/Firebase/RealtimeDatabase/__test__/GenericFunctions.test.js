    ...
    describe('googleApiRequest', () => {
        ...
        describe('successful requests', () => {
            ...
            it('should make successful API request with default options', async () => {
                ...
                const result = await googleApiRequest.call(mockExecuteFunctions, 'test-project', 'GET', '/users');
                expect(result).toEqual(mockResponse);
                expect(mockRequestOAuth2).toHaveBeenCalledWith('googleFirebaseRealtimeDatabaseOAuth2Api', expect.objectContaining({
                    method: 'GET',
            ...
            it('should include body for POST requests', async () => {
                ...
                mockRequestOAuth2.mockResolvedValue(mockResponse);
                await googleApiRequest.call(mockExecuteFunctions, 'test-project', 'POST', '/users', requestBody);
                expect(mockRequestOAuth2).toHaveBeenCalledWith('googleFirebaseRealtimeDatabaseOAuth2Api', expect.objectContaining({
                    method: 'POST',
                    body: requestBody,
                }));
            ...
            it('should remove empty body for GET requests', async () => {
                ...
                expect(mockRequestOAuth2).toHaveBeenCalledWith('googleFirebaseRealtimeDatabaseOAuth2Api', 
            ...
            it('should include query parameters', async () => {
                ...
                mockRequestOAuth2.mockResolvedValue(mockResponse);
                await googleApiRequest.call(mockExecuteFunctions, 'test-project', 'GET', '/users', {}, queryParams);
                expect(mockRequestOAuth2).toHaveBeenCalledWith('googleFirebaseRealtimeDatabaseOAuth2Api', expect.objectContaining({
                    qs: queryParams,
                }));
            });
            it('should include custom headers', async () => {
                ...
                mockRequestOAuth2.mockResolvedValue(mockResponse);
                await googleApiRequest.call(mockExecuteFunctions, 'test-project', 'GET', '/users', {}, {}, customHeaders);
                expect(mockRequestOAuth2).toHaveBeenCalledWith('googleFirebaseRealtimeDatabaseOAuth2Api', expect.objectContaining({
                    headers: {
                        'Content-Type': 'application/json',
            ...
            it('should use custom URI when provided', async () => {
                ...
                mockRequestOAuth2.mockResolvedValue(mockResponse);
                await googleApiRequest.call(mockExecuteFunctions, 'test-project', 'GET', '/users', {}, {}, {}, customUri);
                expect(mockRequestOAuth2).toHaveBeenCalledWith('googleFirebaseRealtimeDatabaseOAuth2Api', expect.objectContaining({
                    url: customUri,
                }));
            });
        ...
        describe('error handling', () => {
            ...
            it('should throw NodeApiError on API failure', async () => {
                ...
                await expect(googleApiRequest.call(mockExecuteFunctions, 'test-project', 'GET', '/users')).rejects.toThrow(NodeApiError);
            ...
            it('should handle credential errors', async () => {
                ...
                await expect(googleApiRequest.call(mockExecuteFunctions, 'test-project', 'GET', '/users')).rejects.toThrow('Invalid credentials');
            });
