...
describe('Test MergeV3, combineBySql operation', () => {
    ...
    it('handles query parameters', async () => {
        ...
        const returnData = await mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, { ...node, typeVersion: 3.2 }), inputsData);
    ...
    it('handles unsupported query parameter objects', async () => {
        ...
        await expect(mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, { ...node, typeVersion: 3.2 }), inputsData)).rejects.toMatchObject({
    ...
    it('LEFT JOIN, missing input 2(empty array)', async () => {
        ...
        const returnData = await mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, node), [inputsData[0], []]);
    ...
    it('LEFT JOIN, missing data in input 2', async () => {
        ...
        await expect(mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, node), [
            inputsData[0],
    ...
    it('LEFT JOIN, invalid syntax', async () => {
        const nodeParameters = {
            operation: 'combineBySql',
            query: 'SELECTTT *, input1.data as data_1\nFROM input1\nLEFT JOIN input2\nON input1.id = input2.id\n',
        };
        await expect(mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, node), inputsData)).rejects.toMatchObject({
            message: 'Issue while executing query',
    ...
    it('should collect pairedItems data, if version >= 3.1 and SELECT query', async () => {
        ...
        const returnData = await mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, { ...node, typeVersion: 3.1 }), inputs);
        expect(returnData.length).toEqual(1);
        expect(returnData).toEqual([
            [
                {
    ...
    it('Empty successful query should return [{ success: true }] at version <= 3.1', async () => {
        ...
        const returnData = await mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, { ...node, typeVersion: 3.1 }), [[]]);
        expect(returnData.length).toEqual(1);
    ...
    it('Empty successful query should return [] at version >= 3.2 if no option set', async () => {
        ...
        const returnData = await mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, { ...node, typeVersion: 3.2 }), [[]]);
        expect(returnData).toEqual([[]]);
    });
    ...
    describe('Advanced SQL Query Tests', () => {
        ...
        it('should handle DISTINCT queries', async () => {
            const nodeParameters = {
                operation: 'combineBySql',
                query: 'SELECT DISTINCT SUBSTR(name, 1, 1) as first_letter FROM input1 ORDER BY first_letter',
            };
            const returnData = await mode.combineBySql.execute.call(createMockExecuteFunction(nodeParameters, node), inputsData);
            expect(returnData.length).toEqual(1);
...
describe('Test MergeV3, append operation', () => {
    it('append inputs', async () => {
        const nodeParameters = {};
        const returnData = await mode.append.execute.call(createMockExecuteFunction(nodeParameters, node), inputsData);
        expect(returnData.length).toEqual(1);
        expect(returnData[0].length).toEqual(10);
        expect(returnData[0][0].json).toEqual({
            id: 1,
...
describe('Test MergeV3, combineByFields operation', () => {
    it('merge inputs', async () => {
        ...
        const returnData = await mode.combineByFields.execute.call(createMockExecuteFunction(nodeParameters, node), inputsData);
        expect(returnData.length).toEqual(1);
        expect(returnData[0].length).toEqual(3);
        expect(returnData[0][1].json).toEqual({
            id: 2,
...
describe('Test MergeV3, combineByPosition operation', () => {
    it('combine inputs', async () => {
        const nodeParameters = {};
        const returnData = await mode.combineByPosition.execute.call(createMockExecuteFunction(nodeParameters, node), inputsData);
        expect(returnData.length).toEqual(1);
        expect(returnData[0].length).toEqual(5);
        expect(returnData[0][4].json).toEqual({
            id: 5,
...
describe('Test MergeV3, chooseBranch operation', () => {
    it('choose input', async () => {
        ...
        const returnData = await mode.chooseBranch.execute.call(createMockExecuteFunction(nodeParameters, node), inputsData);
        expect(returnData.length).toEqual(1);
        expect(returnData[0].length).toEqual(5);
        expect(returnData[0][0].json).toEqual({
            id: 1,
...
describe('Test MergeV3, combineAll operation', () => {
    it('combine inputs', async () => {
        ...
        const returnData = await mode.combineAll.execute.call(createMockExecuteFunction(nodeParameters, node), inputsData);
        expect(returnData.length).toEqual(1);
        expect(returnData[0].length).toEqual(25);
        expect(returnData[0][0].json).toEqual({
            id: 1,
