...
import { addSourceField, addSuffixToEntriesKeys, checkInput, checkMatchFieldsInput, findMatches, mergeMatched, selectMergeMethod, } from './utils';
export class MergeV2 {
    description;
    ...
    async execute() {
        ...
        if (mode === 'combine') {
            ...
            if (combinationMode === 'mergeByFields') {
                const matchFields = checkMatchFieldsInput(this.getNodeParameter('mergeByFields.values', 0, []));
