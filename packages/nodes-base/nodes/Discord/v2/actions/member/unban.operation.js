...
const properties = [userRLC, moderationReason, moderationReasonCustom];
...
export async function execute(guildId) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            await discordApiRequest.call(this, 'DELETE', `/guilds/${guildId}/bans/${userId}`, undefined, undefined, getAuditLogReasonHeaders.call(this, i));
...
//# sourceMappingURL=unban.operation.js.map