...
import { createSendAndWaitMessageBody, parseDiscordError, sendDiscordMessage, } from '../../helpers/utils';
import { sendToProperties } from '../common.description';
export const description = getSendAndWaitProperties(sendToProperties, 'message', undefined, {
    noButtonStyle: true,
