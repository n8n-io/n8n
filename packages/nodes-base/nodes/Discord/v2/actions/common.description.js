...
export const moderationReasonCustom = {
...
export const embedsFixedCollection = {
    displayName: 'Embeds',
    name: 'embeds',
...
// -------------------------------------------------------------------------------------------
export const filesFixedCollection = {
    displayName: 'Files',
    name: 'files',
    type: 'fixedCollection',
