...
export const getCredentialsType = (authentication) => {
    let credentialType = '';
...
export async function handleRateLimitHeaders(headers) {
...
export async function requestApi(options, credentialType, endpoint) {
