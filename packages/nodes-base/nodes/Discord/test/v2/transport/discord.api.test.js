...
describe('Discord v2 > transport', () => {
    ...
    describe('requestApi', () => {
        it('returns the response on success', async () => {
            ...
            const result = await requestApi.call(context, { url: 'https://discord.com/api/v10/x', headers: {} }, 'discordBotApi', '/x');
        ...
        it('uses a 1s fallback when retry-after is missing on a 429', async () => {
            ...
            requestWithAuthentication
                ...
                .mockResolvedValueOnce(response);
            await requestApi.call(context, { url: 'https://discord.com/api/v10/x', headers: {} }, 'discordBotApi', '/x');
            expect(sleepMock).toHaveBeenCalledWith(1000);
        });
        it('throws after exhausting max retries on repeated 429s', async () => {
            ...
            await expect(requestApi.call(context, { url: 'https://discord.com/api/v10/x', headers: {} }, 'discordBotApi', '/x')).rejects.toBe(error);
        ...
        it('fetches OAuth2 credentials once even across retries', async () => {
            ...
            const getCredentials = context.getCredentials;
            ...
            await requestApi.call(context, { url: 'https://discord.com/api/v10/x', headers: {} }, 'discordOAuth2Api', '/x');
    ...
    describe('discordApiRequest', () => {
        ...
        it('forwards custom headers (e.g. audit-log reason) to the request', async () => {
            ...
            expect(requestWithAuthentication).toHaveBeenCalledWith('discordBotApi', expect.objectContaining({
        ...
        it('wraps non-429 errors as NodeApiError', async () => {
            ...
            await expect(discordApiRequest.call(context, 'POST', '/channels/1/messages', { content: 'hi' })).rejects.toThrow();
        });
    });
    describe('discordApiMultiPartRequest', () => {
        it('sleeps for reset-after (in ms) when remaining is 0 on a successful response', async () => {
            ...
            const result = await discordApiMultiPartRequest.call(context, 'POST', '/channels/1/messages', {});
            expect(result).toEqual({ id: '1' });
            expect(sleepMock).toHaveBeenCalledWith(2000);
        });
...
//# sourceMappingURL=discord.api.test.js.map