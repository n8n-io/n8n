...
export const incidentFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'The incident will be created on this service. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
	},
	{
		displayName: 'Email',
		name: 'email',
		...
		options: [
			{
				...
				default: '',
				description:
					'Delegate this incident to the specified escalation policy. Cannot be specified if an assignee is given. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'Returns only the incidents associated with the passed service(s). Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/data/expressions/">expression</a>.',
			},
			{
				displayName: 'Since',
				name: 'since',
