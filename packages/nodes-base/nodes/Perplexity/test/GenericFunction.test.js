...
import { agentErrorPostReceive, embeddingsErrorPostReceive, searchErrorPostReceive, sendErrorPostReceive, } from '../GenericFunctions';
...
describe('Generic Functions', () => {
    describe('sendErrorPostReceive', () => {
        ...
        it('should return data if status code is not 4xx or 5xx', async () => {
            const result = await sendErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse);
            expect(result).toEqual(testData);
        });
        it('should throw NodeApiError if status code is 4xx', async () => {
            testResponse.statusCode = 400;
            await expect(sendErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse)).rejects.toThrow(NodeApiError);
        });
        ...
        it('should throw NodeApiError with "Invalid model" message if error type is invalid_model', async () => {
            ...
            const execution = sendErrorPostReceive.call(mockExecuteSingleFunctions, testData, errorResponse);
    ...
    describe('agentErrorPostReceive', () => {
        ...
        it('should return data if status code is not 4xx or 5xx', async () => {
            const result = await agentErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse);
            expect(result).toEqual(testData);
        });
        it('should throw NodeApiError if status code is 4xx', async () => {
            testResponse.statusCode = 400;
            testResponse.body = { error: { message: 'Bad request' } };
            await expect(agentErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse)).rejects.toThrow(NodeApiError);
        });
        it('should throw NodeApiError if status code is 5xx', async () => {
            testResponse.statusCode = 500;
        ...
        it('should use statusMessage as fallback when error message is not a string', async () => {
            ...
            await expect(agentErrorPostReceive.call(mockExecuteSingleFunctions, testData, errorResponse)).rejects.toThrow(NodeApiError);
        });
        it('should include agent API documentation in the description', async () => {
            testResponse.statusCode = 400;
            testResponse.body = { error: { message: 'Invalid param' } };
            await expect(agentErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse)).rejects.toThrowError(expect.objectContaining({
    ...
    describe('searchErrorPostReceive', () => {
        ...
        it('should return data if status code is not 4xx or 5xx', async () => {
            const result = await searchErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse);
            expect(result).toEqual(testData);
        });
        it('should throw NodeApiError if status code is 4xx', async () => {
            testResponse.statusCode = 400;
            testResponse.body = { error: { message: 'Bad request' } };
            await expect(searchErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse)).rejects.toThrow(NodeApiError);
        });
        it('should throw NodeApiError if status code is 5xx', async () => {
            testResponse.statusCode = 500;
            testResponse.body = { error: { message: 'Server error' } };
        ...
        it('should include search API documentation in the description', async () => {
            ...
            await expect(searchErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse)).rejects.toThrowError(expect.objectContaining({
                description: expect.stringContaining('https://docs.perplexity.ai/api-reference/search-post'),
            }));
        });
    });
    describe('embeddingsErrorPostReceive', () => {
        ...
        it('should return data if status code is not 4xx or 5xx', async () => {
            const result = await embeddingsErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse);
            expect(result).toEqual(testData);
        });
        it('should throw NodeApiError if status code is 4xx', async () => {
            testResponse.statusCode = 400;
            testResponse.body = { error: { message: 'Bad request' } };
            await expect(embeddingsErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse)).rejects.toThrow(NodeApiError);
        });
        it('should throw NodeApiError if status code is 5xx', async () => {
            testResponse.statusCode = 500;
            testResponse.body = { error: { message: 'Server error' } };
        ...
        it('should include embeddings API documentation in the description', async () => {
            ...
            await expect(embeddingsErrorPostReceive.call(mockExecuteSingleFunctions, testData, testResponse)).rejects.toThrowError(expect.objectContaining({
                description: expect.stringContaining('https://docs.perplexity.ai/api-reference/embeddings-post'),
            }));
        });
    });
});
//# sourceMappingURL=GenericFunction.test.js.map