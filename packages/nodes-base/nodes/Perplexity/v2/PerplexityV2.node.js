                    ...
                    options: [
                        {
                            name: 'Agent',
                            value: 'agent',
                            description: 'Recommended. Create responses using the Agent API with third-party models, presets, tools, and structured outputs.',
                        },
                        {
                            name: 'Chat',
                            value: 'chat',
                            description: 'Send messages using Sonar models with built-in web search. Perplexity ends Sonar support on September 27, 2026; switch to the Agent resource.',
                        },
                        {
                            name: 'Embedding',
                            value: 'embedding',
...
//# sourceMappingURL=PerplexityV2.node.js.map