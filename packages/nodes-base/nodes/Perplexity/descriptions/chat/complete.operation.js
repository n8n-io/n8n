    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'json',
                default: '',
                description: 'JSON schema for structured output. Set type to "json_schema" with a schema property.',
                displayOptions: {
                    show: {
                        '@version': [2],
                    },
            ...
            },
            {
                ...
                description: 'Comma-separated list of ISO 639-1 language codes to filter results by (max 20)',
                displayOptions: {
                    show: {
                        '@version': [2],
                    },
