...
import { getGoogleAnalyticsDomainsArray, getTags, getToEmailArray, mandrillApiRequest, validateJSON, } from './GenericFunctions';
                ...
                if (resource === 'message') {
                    ...
                    if (jsonActive) {
                        ...
                        if (!isEmpty(metadataUi)) {
                            // @ts-ignore
                            body.message.metadata = map(metadataUi.metadataValues, (o) => {
                                const aux = {};
                                aux[o.name] = o.value;
                                return aux;
                            });
                        ...
                        if (!isEmpty(attachmentsUi)) {
                            if (attachmentsUi.hasOwnProperty('attachmentsValues') &&
                                ...
                                // @ts-ignore
                                attachmentsValues = map(attachmentsUi.attachmentsValues, (o) => {
                                    const aux = {};
                                    aux.name = o.name;
                                    aux.content = o.content;
                                    aux.type = o.type;
                            ...
                            if (attachmentsUi.hasOwnProperty('attachmentsBinary') &&
                                ...
                                items[i].binary) {
                                // @ts-ignore
                                attachmentsBinary = map(attachmentsUi.attachmentsBinary, (o) => {
