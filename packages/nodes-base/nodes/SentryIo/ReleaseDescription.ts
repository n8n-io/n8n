...
export const releaseFields: INodeProperties[] = [
	...
	},
	{
		...
		required: true,
		description: 'A list of project slugs that are involved in this release. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
	},
	{
		displayName: 'Additional Fields',
		name: 'additionalFields',
