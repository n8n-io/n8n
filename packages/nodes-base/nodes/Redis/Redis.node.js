...
import { setupRedisClient, redisConnectionTest, convertInfoToObject, getValue, setValue, } from './utils';
export class Redis {
    description = {
        displayName: 'Redis',
        name: 'redis',
    ...
    async execute() {
        ...
        try {
            ...
            else if (['delete', 'get', 'keys', 'llen', 'set', 'incr', 'publish', 'push', 'pop'].includes(operation)) {
