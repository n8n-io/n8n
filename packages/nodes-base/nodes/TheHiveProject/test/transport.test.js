...
vi.mock('../transport/requestApi', async () => {
    const originalModule = await vi.importActual('../transport/requestApi');
    return {
        ...originalModule,
...
describe('Test TheHiveProject, theHiveApiQuery', () => {
    it('should make list query request', async () => {
        ...
        await theHiveApiQuery.call(fakeExecuteFunction, scope, filtersValues, sortFields, limit, returnCount);
    ...
    it('should make get query request', async () => {
        ...
        await theHiveApiQuery.call(fakeExecuteFunction, scope, filtersValues, sortFields, limit, returnCount, extraData);
    ...
    it('should make return count query request', async () => {
        ...
        await theHiveApiQuery.call(fakeExecuteFunction, scope, undefined, undefined, undefined, returnCount);
