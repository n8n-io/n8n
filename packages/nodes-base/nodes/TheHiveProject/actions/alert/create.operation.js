...
export async function execute(i, item) {
    ...
    if (observableUi) {
        ...
        if (values) {
            ...
            for (const value of values) {
                ...
                observable.tags = splitAndTrim(value.tags);
    ...
    if (multiPartRequest) {
        ...
        responseData = await theHiveApiRequest.call(this, 'POST', '/v1/alert', undefined, undefined, undefined, {
            Headers: {
        ...
        responseData = await theHiveApiRequest.call(this, 'POST', '/v1/alert', body);
    }
