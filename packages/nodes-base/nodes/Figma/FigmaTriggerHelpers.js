...
export function verifySignature() {
    ...
    return verifySignatureGeneric({
        getExpectedSignature: () => typeof expectedPasscode === 'string' && expectedPasscode.length > 0 ? expectedPasscode : null,
        skipIfNoExpectedSignature: true,
        getActualSignature: () => typeof actualPasscode === 'string' && actualPasscode.length > 0 ? actualPasscode : null,
    });
}
//# sourceMappingURL=FigmaTriggerHelpers.js.map