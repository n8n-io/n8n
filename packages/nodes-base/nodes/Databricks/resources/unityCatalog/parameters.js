export const unityCatalogParameters = [
    ...
    // Input Parameters - for create function
    {
        ...
        description: 'Array of input parameters. Each parameter requires name, type_name, and type_text.',
        displayOptions: {
            show: {
                operation: ['createFunction'],
            },
    ...
    // Storage Location - for createTable (required; API only supports EXTERNAL tables)
    {
        ...
        description: 'External storage root URL for the table. The Create Table API only supports external Delta tables.',
        displayOptions: {
            show: {
                operation: ['createTable'],
            },
        ...
        options: [
            {
                ...
                type: 'json',
                default: '[]',
                description: 'Array of column definitions. Each column requires name and type_name (e.g. STRING, LONG, DOUBLE, BOOLEAN, DATE, TIMESTAMP).',
            },
            {
                displayName: 'Comment',
                name: 'comment',
