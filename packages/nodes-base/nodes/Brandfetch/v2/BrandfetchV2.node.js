        ...
        for (let i = 0; i < length; i++) {
            try {
                if (operation === 'context') {
                    ...
                    const response = await brandfetchApiRequest.call(this, 'GET', `/context/${encodeURIComponent(domain)}`, {}, qs, undefined, requestOptions);
                    let contextJson;
                    ...
                    if (download) {
                        ...
                        for (const logoUrl of logoUrls) {
                            ...
                            for (const logoFormat of formats) {
                                ...
                                await fetchAndPrepareBinaryData.call(this, imageType, format, logoFormat, identifier, newItem, suffix);
                                matchCounter++;
                            }
                        }
