                                ...
                                for (const logoUrl of logoUrls) {
                                    ...
                                    for (const logoFormats of logoUrl.formats) {
                                        if (logoFormats.format === imageFormat && logoFormats.src !== null) {
                                            await fetchAndPrepareBinaryData.call(this, imageType, imageFormat, logoFormats, domain, newItem);
                                            items[i] = newItem;
                                        }
                                    }
                                }
...
//# sourceMappingURL=BrandfetchV1.node.js.map