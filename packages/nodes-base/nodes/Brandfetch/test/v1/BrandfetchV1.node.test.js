...
describe('BrandfetchV1.execute', () => {
    ...
    it('should download logos as binary data when download is true', async () => {
        ...
        const [imageType, format, logoFormat, domain] = GenericFunctions.fetchAndPrepareBinaryData.mock.calls[0];
    ...
    it('exposes a valid node description', () => {
        ...
        expect(operationParam?.options?.map((o) => o.value)).toEqual(expect.arrayContaining(['color', 'company', 'font', 'industry', 'logo']));
    });
});
//# sourceMappingURL=BrandfetchV1.node.test.js.map