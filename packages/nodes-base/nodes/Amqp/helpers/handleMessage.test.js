...
describe('handleMessage', () => {
    let mockTriggerFunctions;
    let mockContext;
    let mockDeferredPromise;
    beforeEach(() => {
        vi.clearAllMocks();
        vi.useFakeTimers();
        mockDeferredPromise = {
    ...
    describe('message handling', () => {
        ...
        it('should emit message data correctly', async () => {
            ...
            expect(mockTriggerFunctions.emit).toHaveBeenCalledWith([[mockContext.message]], undefined, expect.anything());
        });
    ...
    describe('onlyBody option', () => {
        it('should return only body when onlyBody is true', async () => {
            ...
            expect(mockTriggerFunctions.emit).toHaveBeenCalledWith([[{ nested: { data: 'value' } }]], undefined, expect.anything());
        });
    ...
    describe('parallelProcessing option', () => {
        it('should create deferred promise when parallelProcessing is false', async () => {
            ...
            expect(mockTriggerFunctions.emit).toHaveBeenCalledWith([[mockContext.message]], undefined, mockDeferredPromise);
        });
        ...
        it('should await promise when parallelProcessing is false', async () => {
            ...
            mockDeferredPromise.promise = new Promise((resolve) => {
                setTimeout(() => {
...
//# sourceMappingURL=handleMessage.test.js.map