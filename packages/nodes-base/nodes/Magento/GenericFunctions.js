...
export async function magentoApiRequest(method, resource, body = {}, qs = {}, uri, _headers = {}, option = {}) {
...
export async function magentoApiRequestAllItems(propertyName, method, resource, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    do {
...
export function adjustAddresses(addresses) {
    const _addresses = [];
...
export function getSearchFilters(resource, filterableAttributeFunction, sortableAttributeFunction) {
    return [
        {
            displayName: 'Filter',
            name: 'filterType',
...
export async function getProductAttributes(filter, extraValue) {
