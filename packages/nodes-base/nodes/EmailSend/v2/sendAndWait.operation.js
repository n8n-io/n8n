...
import { createButton, getSendAndWaitConfig, getSendAndWaitProperties, } from '../../../utils/sendAndWait/utils';
import { toMailString } from '../utils';
export const description = getSendAndWaitProperties([fromEmailProperty, toEmailProperty], 'email');
