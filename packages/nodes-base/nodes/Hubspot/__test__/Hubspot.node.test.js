    ...
    describe('companies', () => {
        beforeAll(() => {
            hubspotNock
                ...
                .query('properties=name&properties=description&properties=country&propertyMode=value_and_history&limit=2')
                .reply(200, companies)
    ...
    describe('deals', () => {
        beforeAll(() => {
            hubspotNock
                ...
                .reply(200, deals)
                .get('/deals/v1/deal/recent/created?since=1745193600000&includePropertyVersions=true&count=2')
...
//# sourceMappingURL=Hubspot.node.test.js.map