...
import { clean, getAssociations, getCallMetadata, getEmailMetadata, getMeetingMetadata, getTaskMetadata, getAllProperties, hubspotApiRequest, hubspotApiRequestAllItems, validateCredentials, } from './GenericFunctions';
import { ticketFields, ticketOperations } from './TicketDescription';
export class HubspotV1 {
    description;
