	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description: 'Contacts associated with the ticket. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description: 'Contact associated with the ticket. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
			{
				displayName: 'Category Name or ID',
				name: 'category',
