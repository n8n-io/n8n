...
export async function hubspotApiRequest(method, endpoint, body = {}, query = {}, uri) {
 ...
 */
export async function hubspotApiRequestAllItems(propertyName, method, endpoint, body = {}, query = {}) {
    const returnData = [];
    let responseData;
...
export async function getAllProperties(objectType) {
    const returnData = [];
...
export const getEmailMetadata = (meta) => {
    return {
        from: {
...
export const getTaskMetadata = (meta) => {
    return {
...
export const getMeetingMetadata = (meta) => {
    return {
        ...(meta.body && { body: meta.body }),
        ...(meta.startTime && { startTime: moment(meta.startTime).unix() }),
        ...(meta.endTime && { endTime: moment(meta.endTime).unix() }),
        ...(meta.title && { title: meta.title }),
        ...(meta.internalMeetingNotes && { internalMeetingNotes: meta.internalMeetingNotes }),
    };
};
export const getCallMetadata = (meta) => {
    return {
