const parametersDescription = 'JSON array of values to use for $1, $2, and so on, in order. Values can be strings, numbers, booleans, null, or arrays of these values. You can also use an expression that returns an array.';
export const nodeProperties = [
    ...
    // ----------------------------------
    {
        ...
        options: [
            ...
            },
            {
                ...
                description: 'A JSON that defines the sort order of the result set. Use $1, $2, and so on as complete field names or values to reference Sort Parameters.',
            },
            {
            ...
            },
            {
                ...
                description: 'A JSON that defines a selection of fields to retrieve or exclude from the result set. Use $1, $2, and so on as complete field names or values to reference Projection Parameters.',
            },
            {
    ...
    },
    {
        ...
        default: '{}',
        required: true,
        description: 'The search index definition. Use $1, $2, and so on as complete field names or values to reference Index Definition Parameters below.',
    },
    {
