...
export async function paddleApiRequest(endpoint, method, body = {}, _query, _uri) {
...
export async function paddleApiRequestAllItems(propertyName, endpoint, method, body = {}, query = {}) {
    const returnData = [];
    let responseData;
