import { ExecutionBaseError, NodeApiError, NodeConnectionTypes, NodeOperationError, jsonParse, } from 'n8n-workflow';
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            try {
                ...
                if (oAuth1Api !== undefined) {
                    ...
                    response = await this.helpers.requestWithAuthentication.call(this, nodeCredentialType, requestOptions, additionalOAuth2Options && { oauth2: additionalOAuth2Options }, itemIndex);
                }
                else {
