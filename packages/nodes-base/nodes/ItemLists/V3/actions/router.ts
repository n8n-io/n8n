...
import * as summarize from './itemList/summarize.operation';
import { compareItems, flattenKeys, shuffleArray } from '../helpers/utils';
...
export async function router(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
	...
	if (resource === 'itemList') {
		...
		} else if (operation === 'concatenateItems') {
