...
export const rowFields = [
    ...
    // See https://supabase.com/docs/guides/api/sql-to-rest for the order parameter syntax.
    {
        ...
        description: 'Column(s) to order results by, e.g. <code>ID</code> or <code>created_at.desc</code>. Recommended when using Return All or Limit ≥ 1000 to avoid duplicate or missing records.',
    },
