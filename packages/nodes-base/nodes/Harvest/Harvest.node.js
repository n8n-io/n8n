            ...
            try {
                ...
                if (resource === 'timeEntry') {
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'time_entries', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'clients', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'projects', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else if (operation === 'create') {
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'users', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'contacts', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else if (operation === 'create') {
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'tasks', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else if (operation === 'create') {
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'invoices', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else if (operation === 'create') {
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'expenses', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else if (operation === 'create') {
                    ...
                    if (operation === 'get') {
                        ...
                        //         getAll
                        // ----------------------------------
                        const responseData = await getAllResource.call(this, 'estimates', i);
                        const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: i } });
                        returnData.push(...executionData);
                    }
                    else if (operation === 'create') {
