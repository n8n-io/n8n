...
export async function harvestApiRequest(method, qs, path, body = {}, option = {}, uri) {
    let options = {
        headers: {
 ...
 */
export async function harvestApiRequestAllItems(method, qs, uri, resource, body = {}, option = {}) {
    const returnData = [];
    let responseData;
    do {
 ...
 */
export async function getAllResource(resource, i) {
