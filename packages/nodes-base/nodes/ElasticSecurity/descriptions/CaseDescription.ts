...
export const caseOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				name: 'Get Status',
				value: 'getStatus',
				description: 'Retrieve a case\'s status',
			},
			{
				name: 'Get Summary',
...
export const caseFields: INodeProperties[] = [
	...
	},
	{
		...
		name: 'connectorId',
		description: 'Connectors allow you to send Elastic Security cases into other systems. Only ServiceNow, Jira, and IBM Resilient connectors are available via API.',
		type: 'options',
		required: true,
		default: '',
		typeOptions: {
