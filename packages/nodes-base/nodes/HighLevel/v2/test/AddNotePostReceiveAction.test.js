...
describe('GenericFunctions - highLevelApiRequest', () => {
    let mockContext;
    let mockHttpRequestWithAuthentication;
    beforeEach(() => {
    ...
    test('should make a successful request with all parameters', async () => {
        ...
        const result = await highLevelApiRequest.call(mockContext, method, resource, body, qs, url, option);
...
//# sourceMappingURL=AddNotePostReceiveAction.test.js.map