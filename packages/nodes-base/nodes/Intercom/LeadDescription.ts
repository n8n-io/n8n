	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description: 'Identifies the companies this user belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
			},
			{
				displayName: 'Email',
				name: 'email',
