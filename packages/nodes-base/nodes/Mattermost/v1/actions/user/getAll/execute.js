...
export async function getAll(index) {
    ...
    if (additionalFields.sort) {
        qs.sort = snakeCase(additionalFields.sort);
    }
    const validRules = {
    ...
    if (additionalFields.sort) {
        if (additionalFields.inTeam !== undefined || additionalFields.inChannel !== undefined) {
            if (additionalFields.inTeam !== undefined &&
                !validRules.inTeam.includes(snakeCase(additionalFields.sort))) {
            ...
            if (additionalFields.inChannel !== undefined &&
                !validRules.inChannel.includes(snakeCase(additionalFields.sort))) {
