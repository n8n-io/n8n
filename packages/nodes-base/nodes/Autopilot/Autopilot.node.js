            ...
            try {
                if (resource === 'contact') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        responseData = await autopilotApiRequestAllItems.call(this, 'contacts', 'GET', '/contacts', {}, qs);
                        if (!returnAll) {
                ...
                if (resource === 'contactJourney') {
                    if (operation === 'add') {
                        ...
                        const contactId = this.getNodeParameter('contactId', i);
                        responseData = await autopilotApiRequest.call(this, 'POST', `/trigger/${triggerId}/contact/${contactId}`);
                        responseData = { success: true };
                    }
                }
                if (resource === 'contactList') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        responseData = await autopilotApiRequestAllItems.call(this, 'contacts', 'GET', `/list/${listId}/contacts`, {}, qs);
                        if (!returnAll) {
                            responseData = responseData.splice(0, qs.limit);
                        }
                    }
