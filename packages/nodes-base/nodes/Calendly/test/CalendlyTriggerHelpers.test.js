...
describe('CalendlyTriggerHelpers', () => {
    ...
    function buildSignatureHeader(secret, timestamp, payload) {
    ...
    function createMockContext(opts) {
        return {
            getWorkflowStaticData: vi
                .fn()
                .mockReturnValue(opts.webhookSecret !== undefined ? { webhookSecret: opts.webhookSecret } : {}),
            getRequestObject: vi.fn().mockReturnValue({
                header: vi
                    .fn()
                    .mockImplementation((name) => name === 'calendly-webhook-signature' ? opts.headerValue : null),
...
//# sourceMappingURL=CalendlyTriggerHelpers.test.js.map