...
export class DatabricksOAuth2Api {
    ...
    properties = [
        ...
        {
            displayName: 'The default scopes needed for the node to work are already set. If you change them the node may not function correctly.',
        ...
        },
        {
            ...
            displayName: 'The default scopes needed for the node to work are already set. If you change them the node may not function correctly. <code>offline_access</code> is required to keep the connection alive past one hour and is re-added automatically if removed.',
