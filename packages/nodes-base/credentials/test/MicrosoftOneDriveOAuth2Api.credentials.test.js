...
describe('MicrosoftOneDriveOAuth2Api Credential', () => {
    ...
    describe('credential metadata', () => {
        ...
        it('should define a hidden scope expression that resolves to the enabled scopes', () => {
            ...
            expect(scopeProperty?.default).toBe('={{$self["customScopes"] ? $self["enabledScopes"] : "openid offline_access Files.ReadWrite.All"}}');
        });
    });
...
//# sourceMappingURL=MicrosoftOneDriveOAuth2Api.credentials.test.js.map