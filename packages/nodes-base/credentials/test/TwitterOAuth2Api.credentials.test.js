...
describe('TwitterOAuth2Api Credential', () => {
    ...
    it('should default scope to the full scope list', () => {
        ...
        expect(scopeProperty?.default).toBe('tweet.read users.read tweet.write tweet.moderate.write users.read follows.read follows.write offline.access like.read like.write dm.write dm.read list.read list.write');
    });
});
//# sourceMappingURL=TwitterOAuth2Api.credentials.test.js.map