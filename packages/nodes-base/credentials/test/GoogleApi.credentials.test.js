...
describe('GoogleApi Credential', () => {
    ...
    describe('region property', () => {
        ...
        const regionOptions = (regionProperty?.options ?? []);
    ...
    describe('authenticate', () => {
        it('returns the request unchanged when not set up for the HTTP Request node', async () => {
            const result = await credential.authenticate({ ...baseCredentials, httpNode: false }, requestOptions);
...
//# sourceMappingURL=GoogleApi.credentials.test.js.map