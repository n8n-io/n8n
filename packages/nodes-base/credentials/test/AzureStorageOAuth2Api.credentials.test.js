...
describe('AzureStorageOAuth2Api Credential', () => {
    ...
    const property = (name) => credential.properties.find((p) => p.name === name);
    ...
    it('should keep the scope hidden and default to the standard scopes when custom scopes are off', () => {
        ...
        expect(property('scope')?.default).toBe('={{$self["customScopes"] ? $self["enabledScopes"] : "https://storage.azure.com/.default"}}');
    });
});
//# sourceMappingURL=AzureStorageOAuth2Api.credentials.test.js.map