...
describe('MicrosoftToDoOAuth2Api Credential', () => {
    ...
    it('should have correct credential metadata', () => {
        ...
        const enabledScopesProperty = microsoftToDoOAuth2Api.properties.find((p) => p.name === 'enabledScopes');
    ...
    it('should keep the scope hidden and default to the standard scopes when custom scopes are off', () => {
        ...
        expect(scopeProperty?.default).toBe('={{$self["customScopes"] ? $self["enabledScopes"] : "openid offline_access Tasks.ReadWrite"}}');
    });
...
//# sourceMappingURL=MicrosoftToDoOAuth2Api.credentials.test.js.map