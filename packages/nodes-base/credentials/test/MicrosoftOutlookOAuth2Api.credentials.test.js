...
describe('MicrosoftOutlookOAuth2Api Credential', () => {
    ...
    it('should have correct credential metadata', () => {
        ...
        const enabledScopesProperty = microsoftOutlookOAuth2Api.properties.find((p) => p.name === 'enabledScopes');
        expect(enabledScopesProperty?.default).toBe(defaultScopes.join(' '));
    });
    it('should expose a customScopes toggle defaulting to false', () => {
        const customScopesProperty = microsoftOutlookOAuth2Api.properties.find((p) => p.name === 'customScopes');
...
//# sourceMappingURL=MicrosoftOutlookOAuth2Api.credentials.test.js.map