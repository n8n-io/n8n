...
describe('OpenAiApi Credential', () => {
    ...
    it('should allow custom header expressions to be omitted during design-time resolution', () => {
        expect(openAiApi.properties).toEqual(expect.arrayContaining([
    ...
    describe('authenticate', () => {
        ...
        it('should preserve existing headers', async () => {
            ...
            const result = await openAiApi.authenticate(credentials, requestOptions);
            const raw = typeof result.headers?.get === 'function'
...
//# sourceMappingURL=OpenAiApi.credentials.test.js.map