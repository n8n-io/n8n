...
async function authenticate(credentialData, requestOptions) {
    if (typeof credential.authenticate !== 'function')
        throw new Error('Expected an authenticator');
...
//# sourceMappingURL=HttpTemplatedCustomAuth.credentials.test.js.map