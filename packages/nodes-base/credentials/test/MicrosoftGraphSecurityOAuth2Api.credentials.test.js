...
describe('MicrosoftGraphSecurityOAuth2Api Credential', () => {
    ...
    it('should keep the scope hidden and default to the standard scopes when custom scopes are off', () => {
        ...
        expect(property('scope')?.default).toBe('={{$self["customScopes"] ? $self["enabledScopes"] : "SecurityEvents.ReadWrite.All offline_access"}}');
    });
});
//# sourceMappingURL=MicrosoftGraphSecurityOAuth2Api.credentials.test.js.map