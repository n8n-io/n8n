...
describe('MicrosoftAzureMonitorOAuth2Api Credential', () => {
    ...
    it('should keep the scope hidden, substituting the token and falling back to the defaults when custom scopes are off, cleared, or untouched', () => {
        ...
        expect(property('scope')?.default).toBe('={{(($self["customScopes"] && $self["enabledScopes"] && $self["enabledScopes"] !== "{resource}/.default") ? $self["enabledScopes"] : ($self["grantType"] === "clientCredentials" ? "{resource}/.default" : "")).replace(/\\{resource\\}/g, $self["resource"])}}');
    });
});
//# sourceMappingURL=MicrosoftAzureMonitorOAuth2Api.credentials.test.js.map