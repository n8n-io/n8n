...
describe('ZendeskOAuth2Api Credential', () => {
    ...
    it('should have correct credential metadata', () => {
        ...
        expect(authUrlProperty?.default).toBe('=https://{{$self["subdomain"]}}.zendesk.com/oauth/authorizations/new');
        const accessTokenUrlProperty = credential.properties.find((p) => p.name === 'accessTokenUrl');
        expect(accessTokenUrlProperty?.default).toBe('=https://{{$self["subdomain"]}}.zendesk.com/oauth/tokens');
    });
...
//# sourceMappingURL=ZendeskOAuth2Api.credentials.test.js.map