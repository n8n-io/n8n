...
describe('DeepLApi Credential', () => {
    ...
    it('should have correct test request configuration', () => {
        ...
        expect(deepLApi.test.request.baseURL).toBe('={{$credentials.apiPlan === "pro" ? "https://api.deepl.com/v2" : "https://api-free.deepl.com/v2" }}');
    });
...
//# sourceMappingURL=DeepLApi.credentials.test.js.map