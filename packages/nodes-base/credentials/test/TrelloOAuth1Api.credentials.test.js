...
describe('TrelloOAuth1Api credentials', () => {
    ...
    const getDefault = (name) => credential.properties.find((p) => p.name === name)?.default;
    ...
    it('embeds required Trello query params on the authorization URL', () => {
        const authUrl = getDefault('authUrl');
...
//# sourceMappingURL=TrelloOAuth1Api.credentials.test.js.map