...
describe('JiraSoftwareCloudOAuth2Api Credential', () => {
    ...
    const defaultScopes = (jiraOAuth2Api.properties.find((p) => p.name === 'enabledScopes')?.default).split(' ');
    ...
    it('should resolve the extends chain', () => {
        ...
        const byName = (name) => resolved.find((p) => p.name === name);
...
//# sourceMappingURL=JiraSoftwareCloudOAuth2Api.credentials.test.js.map