...
describe('MicrosoftTeamsOAuth2Api Credential', () => {
    ...
    it('should have correct credential metadata', () => {
        ...
        const enabledScopesProperty = microsoftTeamsOAuth2Api.properties.find((p) => p.name === 'enabledScopes');
        expect(enabledScopesProperty?.default).toBe('openid offline_access User.Read.All Group.ReadWrite.All Chat.ReadWrite ChannelMessage.Read.All OnlineMeetings.ReadWrite');
    });
...
//# sourceMappingURL=MicrosoftTeamsOAuth2Api.credentials.test.js.map