...
const { mockProvider, mockFromTemporaryCredentials, mockSmithySignFn, MockSignatureV4 } = vi.hoisted(() => {
    ...
    const MockSignatureV4 = vi.fn(function () {
...
describe('AwsAssumeRole Credential', () => {
    ...
    it('should sign Bedrock requests with the bedrock service namespace', async () => {
        ...
        expect(MockSignatureV4).toHaveBeenLastCalledWith(expect.objectContaining({
            region: 'us-east-1',
            service: 'bedrock',
        }));
        expect(mockSmithySignFn).toHaveBeenLastCalledWith(expect.objectContaining({
...
//# sourceMappingURL=AwsAssumeRole.credentials.test.js.map