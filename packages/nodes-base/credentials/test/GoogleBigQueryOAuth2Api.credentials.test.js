...
describe('GoogleBigQueryOAuth2Api Credential', () => {
    ...
    it('should have correct credential metadata', () => {
        ...
        const enabledScopesProperty = googleBigQueryOAuth2Api.properties.find((p) => p.name === 'enabledScopes');
        expect(enabledScopesProperty?.default).toBe(defaultScopes.join(' '));
    });
    it('should default the customScopes toggle to false', () => {
        const customScopesProperty = googleBigQueryOAuth2Api.properties.find((p) => p.name === 'customScopes');
...
//# sourceMappingURL=GoogleBigQueryOAuth2Api.credentials.test.js.map