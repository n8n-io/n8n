...
describe('MicrosoftSharePointOAuth2Api Credential', () => {
    ...
    describe('credential metadata', () => {
        ...
        it('should expose an enabledScopes property with the default scopes', () => {
            ...
            expect(enabledScopesProperty?.default).toBe('openid offline_access https://{subdomain}.sharepoint.com/.default');
        ...
        it('should define a hidden scope expression that substitutes the subdomain placeholder', () => {
            ...
            expect(scopeProperty?.default).toBe('={{($self["customScopes"] ? $self["enabledScopes"] : "openid offline_access https://{subdomain}.sharepoint.com/.default").replace(/\\{subdomain\\}/g, ($self["subdomain"] || "").trim())}}');
        });
    });
    describe('OAuth2 flow with default scopes', () => {
        ...
        it('should retrieve token successfully with default scopes', async () => {
            ...
            expect(token.data.scope).toBe(`openid offline_access https://${subdomain}.sharepoint.com/.default`);
        });
    });
...
//# sourceMappingURL=MicrosoftSharePointOAuth2Api.credentials.test.js.map