...
export class JiraSoftwareCloudOAuth2Api {
    ...
    properties = [
        {
            ...
            required: true,
            description: 'The URL of your Atlassian site, e.g. https://your-site.atlassian.net. The scheme and any path (like /wiki) are ignored.',
        },
        {
