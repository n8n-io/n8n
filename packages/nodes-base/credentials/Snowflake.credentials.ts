...
export class Snowflake implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			description:
				'Private PEM key for Key-pair authentication with Snowflake, follow guide <a href="https://docs.snowflake.com/en/user-guide/key-pair-auth _target=blank">here</a>',
		},
		{
