...
export declare const TOKEN_REQUEST_TIMEOUT = 30000;
/**
 ...
 */
export declare function getTokenRequestClient(host: 'fixed-vendor' | 'user-controlled'): HttpRequestClient;
export declare function hasAccessToken(response: unknown): response is {
    access_token: string;
};
