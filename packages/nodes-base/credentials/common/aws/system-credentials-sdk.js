 ...
 */
export function usesSdk(resolver) {
...
export async function resolveEnvironmentViaSdk() {
...
export async function resolveWebIdentityViaSdk(region) {
...
export async function resolvePodIdentityViaSdk() {
...
export async function resolveContainerMetadataViaSdk() {
...
export async function resolveInstanceMetadataViaSdk() {
