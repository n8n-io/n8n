...
export class MicrosoftSharePointOAuth2Api {
    ...
    properties = [
        ...
        {
            displayName: 'The default scopes needed for the node to work are already set, If you change these the node may not function correctly. Use the <code>{subdomain}</code> placeholder to reference the Subdomain value above.',
