...
export const useAuth0 = (
	...
	instance.init(onRedirectCallback, redirectUri, auth0Options);
...
export const Auth0Plugin = {
	install(vue: VueConstructor, options: Auth0PluginOptions) {
		vue.prototype.$auth = useAuth0(options.onRedirectCallback, window.location.origin, options.auth0Options);
	},
};
