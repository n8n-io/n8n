...
export async function validateSignupToken(context: IRestApiContext, params: {token: string}): Promise<void> {
	 await makeRestApiRequest(context, 'GET', '/resolve-signup-token', params);
}
