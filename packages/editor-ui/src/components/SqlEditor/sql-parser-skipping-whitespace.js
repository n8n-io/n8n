...
const parser$1 = /*@__PURE__*/LRParser.deserialize({
  ...
  nodeNames: "⚠ LineComment BlockComment String Number Bool Null ( ) { } [ ] ; . Operator Punctuation SpecialVar Identifier QuotedIdentifier Keyword Type Bits Bytes Builtin Script Statement CompositeIdentifier Parens Braces Brackets Resolvable Statement",
  maxTerm: 38,
  skippedNodes: [0,1,2],
  repeatNodeCount: 3,
  tokenData: "#g~RP#o#pU~XP#o#p[~_TO#O[#O#Pn#P#q[#q#r!x#rG|[~qTO#O[#O#Pn#P#q[#q#r!Q#rG|[~!TTO#q[#q#r!d#r;'S[;'S;=`#a<%lO[~!iTo~O#O[#O#Pn#P#q[#q#r!x#rG|[~!{TO#q[#q#r#[#r;'S[;'S;=`#a<%lO[~#aOo~~#dP;=`<%l[",
  tokenizers: [0, tokens],
...
function getAliases(doc, at) {
    ...
    for (let scan = statement.firstChild, sawFrom = false, prevID = null; scan; scan = scan.nextSibling) {
        if (SKIP_TOKENS.includes(scan.name))
            continue;
