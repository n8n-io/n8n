...
import type { ConnectionType, INodeTypeDescription } from 'n8n-workflow';
...
export function AINodesView(_nodes: SimplifiedNodeType[]): NodeView {
	...
	function getAISubcategoryProperties(nodeConnectionType: ConnectionType) {
		return {
		...
		items: [
			{
				...
				properties: {
					...
					icon: 'file-import',
					...getAISubcategoryProperties('ai_document'),
				},
			},
			{
				...
				properties: {
					...
					icon: 'language',
					...getAISubcategoryProperties('ai_languageModel'),
				},
			},
			{
				...
				properties: {
					...
					icon: 'brain',
					...getAISubcategoryProperties('ai_memory'),
				},
			},
			{
				...
				properties: {
					...
					icon: 'list',
					...getAISubcategoryProperties('ai_outputParser'),
				},
			},
			{
				...
				properties: {
					...
					icon: 'search',
					...getAISubcategoryProperties('ai_retriever'),
				},
			},
			{
				...
				properties: {
					...
					...getAISubcategoryProperties('ai_textSplitter'),
				},
			},
			{
				...
				properties: {
					...
					icon: 'tools',
					...getAISubcategoryProperties('ai_tool'),
				},
			},
			{
				...
				properties: {
					...
					icon: 'vector-square',
					...getAISubcategoryProperties('ai_embedding'),
				},
			},
			{
				...
				properties: {
					...
					...getAISubcategoryProperties('ai_vectorStore'),
				},
			},
			{
