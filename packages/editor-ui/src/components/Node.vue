...
export default mixins(externalHooks, nodeBase, nodeHelpers, workflowHelpers).extend({
	...
	computed: {
		...
		shouldShowTriggerTooltip () : boolean {
			return !!this.node && this.workflowRunning && !this.isExecuting && this.workflowDataItems === 0 && this.isTriggerNode && this.isSingleActiveTriggerNode && !this.isTriggerNodeTooltipEmpty && !this.isNodeDisabled && !this.hasIssues && !this.dragging;
		},
 	},
	watch: {
