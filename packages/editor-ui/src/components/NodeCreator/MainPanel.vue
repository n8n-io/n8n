		...
		<div class="main-panel">
			...
			<div class="type-selector">
				<el-tabs v-model="selectedType" stretch>
					<el-tab-pane :label="$translateBase('mainPanel.filters.all')" :name="ALL_NODE_FILTER"></el-tab-pane>
					<el-tab-pane :label="$translateBase('mainPanel.filters.regular')" :name="REGULAR_NODE_FILTER"></el-tab-pane>
					<el-tab-pane :label="$translateBase('mainPanel.filters.trigger')" :name="TRIGGER_NODE_FILTER"></el-tab-pane>
				</el-tabs>
			</div>
