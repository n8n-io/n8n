	...
	methods: {
		closeDialog(): void {
			if (!this.isEmailValid) {
				this.$telemetry.track('Some msg', { instance_id: this.$store.getters.instanceId, email: null });
			}
		...
		send(): void {
			if (this.isEmailValid) {
				this.$telemetry.track('Some msg', { instance_id: this.$store.getters.instanceId, email: this.email });
			}
			this.closeDialog();
		},
