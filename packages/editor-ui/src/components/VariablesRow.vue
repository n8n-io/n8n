...
<template>
	<tr :class="$style.variablesRow">
		...
		<td class="text-right">
			<div v-if="editing">
				<n8n-button type="tertiary" class="mr-xs" @click="onCancel">
					{{ i18n.baseText('variables.row.button.cancel') }}
				</n8n-button>
				<n8n-button :disabled="!formValid" type="primary" @click="onSave">
					{{ i18n.baseText('variables.row.button.save') }}
				</n8n-button>
			</div>
			<div :class="$style.hoverButtons" v-else>
				<n8n-button type="tertiary" class="mr-xs" @click="onEdit">
					{{ i18n.baseText('variables.row.button.edit') }}
				</n8n-button>
				<n8n-button type="tertiary" class="mr-xs" @click="onDelete">
