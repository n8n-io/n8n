...
import { resolveParameter, resolveRelevantParameters } from '@/mixins/workflowHelpers';
...
async function loadFieldsToMap(): Promise<void> {
	...
	const requestParams: ResourceMapperReqParams = {
		...
		currentNodeParameters: resolveRelevantParameters(props.parameter, props.node.parameters) as INodeParameters,
		path: props.path,
