...
import { resolveParameter, resolveRequiredParameters } from '@/mixins/workflowHelpers';
...
async function loadFieldsToMap(): Promise<void> {
	...
	const requestParams: ResourceMapperReqParams = {
		...
		currentNodeParameters: resolveRequiredParameters(props.parameter, props.node.parameters) as INodeParameters,
		path: props.path,
