...
export default defineComponent({
	...
	data() {
		return {
			...
			formFields: [
				{ name: 'field1', label: 'Whatever', type: 'text', value: '' },
				{ name: 'field2', label: 'Field 2', type: 'text', value: '' },
				{ name: 'field3', label: 'Field 3', type: 'text', value: '' },
			],
		};
	},
	computed: {
	...
	created() {
		...
		console.log('mutableValues', this.mutableValues);
	},
	methods: {
