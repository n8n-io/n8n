	...
	<RunData
		...
		<template v-slot:node-not-run>
			<div :class="$style.noOutputData" v-if="parentNodes.length">
				...
				<NodeExecuteButton type="secondary" :transparent="true" :nodeName="currentNodeName" :label="$locale.baseText('ndv.input.noOutputData.executePrevious')" @execute="onNodeExecute" />
