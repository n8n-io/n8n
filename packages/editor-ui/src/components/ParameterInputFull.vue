<template>
	<el-row class="parameter-wrapper" :class="{'multi-line': isMultiLineParameter}">
		...
		<el-col :span="isMultiLineParameter ? 24 : 14" class="parameter-value">
			<parameter-input :parameter="parameter" :value="value" :displayOptions="displayOptions" :path="path" :isReadOnly="isReadOnly" @valueChanged="valueChanged" :multiline="isMultiLineParameter" inputSize="small" />
		</el-col>
	</el-row>
</template>
