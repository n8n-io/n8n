...
export const WEBSITE_TEMPLATES_URLS = {
	BASE_URL: 'https://n8n.io/workflows',
	AI_CATEGORY: 'categories=25',
	UTM_QUERY: `utm_source=n8n_app&utm_medium=template_library&utm_instance=${window.location.host}`,
};
