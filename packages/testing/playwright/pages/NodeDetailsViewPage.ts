...
export class NodeDetailsViewPage extends BasePage {
	...
	getAssignmentCollectionDropArea() {
		return this.assignmentCollection.getDropArea();
	}

	async clickAssignmentCollectionDropArea() {
		await this.assignmentCollection.clickDropArea();
	}

	getAssignmentValue(paramName: string) {
		return this.assignmentCollection.getValue(paramName);
	}
	...
	getAssignmentName(paramName: string, index = 0) {
		return this.assignmentCollection.getName(paramName, index);
	}

	getAssignmentNameTextbox(paramName: string, index = 0) {
		return this.assignmentCollection.getNameTextbox(paramName, index);
	}
