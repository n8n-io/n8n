...
test.describe('AI Assistant Credential Help', () => {
	test('should start credential help from node credential', async ({ n8n, setupRequirements }) => {
	...
	test('should start credential help from credential list', async ({ n8n, setupRequirements }) => {
		await setupRequirements(aiEnabledWithSimpleChatRequirements);
