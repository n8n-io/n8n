...
const CLOUD_RESOURCE_PROFILES: Record<PerformancePlanName, ExtendedPerformancePlan> = {
	trial: {
		...
		description: 'Trial (384MB, 200 millicore)',
		initDelay: 5000,
		dbResetDelay: 10000,
		maxRetries: 3,
	},
	starter: {
		...
		description: 'Starter (384MB, 200 millicore)',
		initDelay: 5000,
		dbResetDelay: 10000,
		maxRetries: 3,
	},
	pro1: {
		...
		description: 'Pro-1 (640MB, 500 millicore)',
		initDelay: 4000,
		dbResetDelay: 10000,
		maxRetries: 3,
	},
	pro2: {
		...
		description: 'Pro-2 (1.25GB, 750 millicore)',
		initDelay: 3000,
		dbResetDelay: 5000,
		maxRetries: 3,
	},
	enterprise: {
		...
		description: 'Enterprise (4GB, 1 core)',
		initDelay: 3000,
		dbResetDelay: 5000,
		maxRetries: 3,
	},
