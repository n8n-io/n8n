...
| `packages/cli/src/public-api/**/*.{css,yaml,yml}`, `packages/cli/src/public-api/v1/openapi-gen/**/*.ts`, `packages/@n8n/api-types/src/{dto,schemas}/**/*.ts` | `util-sync-api-docs.yml`    | master     |
