...
`n8n-workflows` (the source of truth; committed JSON stays a local-dev
escape hatch via `source: disk`). To
...
Evals: Experiments"): full knob set (branch, filter, tier, source/suite,
