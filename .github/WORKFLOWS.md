...
| `packages/cli/src/public-api/**/*.{css,yaml,yml}`, `packages/cli/src/public-api/v1/openapi-gen/**/*.ts`, `packages/@n8n/api-types/src/dto/**/*.ts`, `packages/@n8n/api-types/src/schemas/**/*.ts`, `packages/cli/scripts/build.mjs`, `packages/cli/package.json` | `util-publish-api-schema.yml` | master   |
